...
interface Link2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/link2}
 */
const Link2Icon = React.forwardRef<SVGSVGElement, Link2IconProps>(
