...
interface PoliceBadgeIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/police-badge}
 */
const PoliceBadgeIcon = React.forwardRef<SVGSVGElement, PoliceBadgeIconProps>(
...
PoliceBadgeIcon.displayName = 'PoliceBadgeIcon';
