...
interface DashboardSquare02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/dashboard-square02)
 * @see {@link https://clicons.dev/icon/dashboard-square02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const DashboardSquare02Icon = React.forwardRef<SVGSVGElement, DashboardSquare02IconProps>(
  (
    {
      size,
      color,
...
DashboardSquare02Icon.displayName = 'DashboardSquare02Icon';
export default DashboardSquare02Icon;
