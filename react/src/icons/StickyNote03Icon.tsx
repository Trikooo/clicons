...
const StickyNote03Icon = React.forwardRef<SVGSVGElement, StickyNote03IconProps>(
  (
    ...
    const iconData = [["path", { d: "M14 20.5V20C14 17.1716 14 15.7574 14.8787 14.8787C15.7574 14 17.1716 14 20 14H20.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
