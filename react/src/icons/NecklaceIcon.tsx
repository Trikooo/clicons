 ...
 * @see {@link https://clicons.dev/icon/necklace} - Icon preview
...
const NecklaceIcon = React.forwardRef<SVGSVGElement, NecklaceIconProps>(
  (
    ...
    const iconData = [["path", { d: "M10.542 12.0002L10.9325 8.87621C11.0235 8.14822 11.3545 8.00024 12.042 8.00024C12.7295 8.00024 13.0605 8.14822 13.1515 8.87621L13.542 12.0002", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
