...
interface CallIncoming4IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name CallIncoming4Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/call-incoming4)
 * @see {@link https://clicons.dev/icon/call-incoming4} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallIncoming4Icon = React.forwardRef<SVGSVGElement, CallIncoming4IconProps>(
  (
    {
      size,
      color,
...
CallIncoming4Icon.displayName = 'CallIncoming4Icon';
export default CallIncoming4Icon;
