...
interface StackStarIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const StackStarIcon = React.forwardRef<SVGSVGElement, StackStarIconProps>(
  (
    {
      size,
      color,
...
StackStarIcon.displayName = 'StackStarIcon';
