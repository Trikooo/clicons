...
interface ChatPreview01IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name ChatPreview01Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/chat-preview01)
 * @see {@link https://clicons.dev/icon/chat-preview01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ChatPreview01Icon = React.forwardRef<SVGSVGElement, ChatPreview01IconProps>(
  (
    {
      size,
      color,
...
ChatPreview01Icon.displayName = 'ChatPreview01Icon';
export default ChatPreview01Icon;
