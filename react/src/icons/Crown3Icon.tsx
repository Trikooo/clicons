...
interface Crown3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Crown3Icon = React.forwardRef<SVGSVGElement, Crown3IconProps>(
  (
    {
      size,
      color,
...
Crown3Icon.displayName = 'Crown3Icon';
export default Crown3Icon;
