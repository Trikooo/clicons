...
interface BashIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/bash}
 */
const BashIcon = React.forwardRef<SVGSVGElement, BashIconProps>(
