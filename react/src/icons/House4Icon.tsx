...
interface House4IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @preview ![img](https://clicons.dev/icon/house4)
 * @see {@link https://clicons.dev/icon/house4}
 */
const House4Icon = React.forwardRef<SVGSVGElement, House4IconProps>(
...
House4Icon.displayName = 'House4Icon';
