...
interface DialpadCircle2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name DialpadCircle2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/dialpad-circle2)
 * @see {@link https://clicons.dev/icon/dialpad-circle2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const DialpadCircle2Icon = React.forwardRef<SVGSVGElement, DialpadCircle2IconProps>(
  (
    {
      size,
      color,
...
DialpadCircle2Icon.displayName = 'DialpadCircle2Icon';
export default DialpadCircle2Icon;
