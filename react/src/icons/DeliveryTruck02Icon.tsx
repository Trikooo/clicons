...
interface DeliveryTruck02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/delivery-truck02)
 * @see {@link https://clicons.dev/icon/delivery-truck02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const DeliveryTruck02Icon = React.forwardRef<SVGSVGElement, DeliveryTruck02IconProps>(
  (
    {
      size,
      color,
...
DeliveryTruck02Icon.displayName = 'DeliveryTruck02Icon';
