...
interface PathfinderCropIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pathfinder-crop)
 * @see {@link https://clicons.dev/icon/pathfinder-crop} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PathfinderCropIcon = React.forwardRef<SVGSVGElement, PathfinderCropIconProps>(
  (
    {
      size,
      color,
...
PathfinderCropIcon.displayName = 'PathfinderCropIcon';
