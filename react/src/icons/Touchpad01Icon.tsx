...
interface Touchpad01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/touchpad01)
 * @see {@link https://clicons.dev/icon/touchpad01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Touchpad01Icon = React.forwardRef<SVGSVGElement, Touchpad01IconProps>(
  (
    {
      size,
      color,
...
Touchpad01Icon.displayName = 'Touchpad01Icon';
export default Touchpad01Icon;
