...
interface Pacman2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pacman2)
 * @see {@link https://clicons.dev/icon/pacman2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Pacman2Icon = React.forwardRef<SVGSVGElement, Pacman2IconProps>(
  (
    {
      size,
      color,
...
Pacman2Icon.displayName = 'Pacman2Icon';
export default Pacman2Icon;
