...
interface FileEmpty2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/file-empty2)
 * @see {@link https://clicons.dev/icon/file-empty2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FileEmpty2Icon = React.forwardRef<SVGSVGElement, FileEmpty2IconProps>(
  (
    {
      size,
      color,
...
FileEmpty2Icon.displayName = 'FileEmpty2Icon';
export default FileEmpty2Icon;
