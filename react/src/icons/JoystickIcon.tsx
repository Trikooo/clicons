...
interface JoystickIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/joystick)
 * @see {@link https://clicons.dev/icon/joystick} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const JoystickIcon = React.forwardRef<SVGSVGElement, JoystickIconProps>(
  (
    {
      size,
      color,
