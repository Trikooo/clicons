...
interface UsbConnected2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name UsbConnected2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/usb-connected2)
 * @see {@link https://clicons.dev/icon/usb-connected2}
 */
const UsbConnected2Icon = React.forwardRef<SVGSVGElement, UsbConnected2IconProps>(
...
UsbConnected2Icon.displayName = 'UsbConnected2Icon';
