...
interface Sheriff02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/sheriff02)
 * @see {@link https://clicons.dev/icon/sheriff02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Sheriff02Icon = React.forwardRef<SVGSVGElement, Sheriff02IconProps>(
  (
    {
      size,
      color,
...
Sheriff02Icon.displayName = 'Sheriff02Icon';
