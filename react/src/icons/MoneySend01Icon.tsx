...
interface MoneySend01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/money-send01)
 * @see {@link https://clicons.dev/icon/money-send01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MoneySend01Icon = React.forwardRef<SVGSVGElement, MoneySend01IconProps>(
  (
    {
      size,
      color,
...
MoneySend01Icon.displayName = 'MoneySend01Icon';
export default MoneySend01Icon;
