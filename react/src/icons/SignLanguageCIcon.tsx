...
interface SignLanguageCIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const SignLanguageCIcon = React.forwardRef<SVGSVGElement, SignLanguageCIconProps>(
  (
    {
      size,
      color,
...
SignLanguageCIcon.displayName = 'SignLanguageCIcon';
