...
interface ShoppingCartCheckIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const ShoppingCartCheckIcon = React.forwardRef<SVGSVGElement, ShoppingCartCheckIconProps>(
  (
    {
      size,
      color,
...
ShoppingCartCheckIcon.displayName = 'ShoppingCartCheckIcon';
