...
const KayakIcon = React.forwardRef<SVGSVGElement, KayakIconProps>(
  (
    ...
    const iconData = [["path", { d: "M20.8198 3.1806C10.9252 1.49952 2.07124 11.6154 3.03263 20.9246C12.3645 21.8836 22.505 13.0512 20.8198 3.1806Z", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
