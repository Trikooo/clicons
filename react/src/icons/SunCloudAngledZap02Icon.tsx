...
interface SunCloudAngledZap02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/sun-cloud-angled-zap02)
 * @see {@link https://clicons.dev/icon/sun-cloud-angled-zap02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SunCloudAngledZap02Icon = React.forwardRef<SVGSVGElement, SunCloudAngledZap02IconProps>(
  (
    {
      size,
      color,
...
SunCloudAngledZap02Icon.displayName = 'SunCloudAngledZap02Icon';
