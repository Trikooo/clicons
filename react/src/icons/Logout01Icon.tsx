...
interface Logout01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/logout01)
 * @see {@link https://clicons.dev/icon/logout01} - Icon preview
