...
interface Download04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/download04)
 * @see {@link https://clicons.dev/icon/download04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Download04Icon = React.forwardRef<SVGSVGElement, Download04IconProps>(
  (
    {
      size,
      color,
