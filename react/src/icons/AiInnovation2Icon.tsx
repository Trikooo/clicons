...
interface AiInnovation2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name AiInnovation2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/ai-innovation2)
 * @see {@link https://clicons.dev/icon/ai-innovation2}
 */
const AiInnovation2Icon = React.forwardRef<SVGSVGElement, AiInnovation2IconProps>(
...
AiInnovation2Icon.displayName = 'AiInnovation2Icon';
