...
interface SkullIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/skull)
 * @see {@link https://clicons.dev/icon/skull} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SkullIcon = React.forwardRef<SVGSVGElement, SkullIconProps>(
  (
    {
      size,
      color,
