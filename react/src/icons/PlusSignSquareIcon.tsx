...
interface PlusSignSquareIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/plus-sign-square)
 * @see {@link https://clicons.dev/icon/plus-sign-square} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PlusSignSquareIcon = React.forwardRef<SVGSVGElement, PlusSignSquareIconProps>(
  (
    {
      size,
      color,
...
PlusSignSquareIcon.displayName = 'PlusSignSquareIcon';
