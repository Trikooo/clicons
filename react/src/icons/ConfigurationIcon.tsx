...
interface ConfigurationIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/configuration)
 * @see {@link https://clicons.dev/icon/configuration} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ConfigurationIcon = React.forwardRef<SVGSVGElement, ConfigurationIconProps>(
  (
    {
      size,
      color,
