...
interface Rar2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/rar2}
 */
const Rar2Icon = React.forwardRef<SVGSVGElement, Rar2IconProps>(
