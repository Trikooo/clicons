...
interface Location08IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/location08)
 * @see {@link https://clicons.dev/icon/location08} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Location08Icon = React.forwardRef<SVGSVGElement, Location08IconProps>(
  (
    {
      size,
      color,
...
Location08Icon.displayName = 'Location08Icon';
