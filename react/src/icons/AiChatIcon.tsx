...
interface AiChatIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/ai-chat)
 * @see {@link https://clicons.dev/icon/ai-chat} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AiChatIcon = React.forwardRef<SVGSVGElement, AiChatIconProps>(
  (
    {
      size,
      color,
