...
interface YenSquareIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const YenSquareIcon = React.forwardRef<SVGSVGElement, YenSquareIconProps>(
  (
    {
      size,
      color,
...
YenSquareIcon.displayName = 'YenSquareIcon';
export default YenSquareIcon;
