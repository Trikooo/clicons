...
interface FanIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/fan}
 */
const FanIcon = React.forwardRef<SVGSVGElement, FanIconProps>(
