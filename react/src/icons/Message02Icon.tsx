...
interface Message02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/message02)
 * @see {@link https://clicons.dev/icon/message02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Message02Icon = React.forwardRef<SVGSVGElement, Message02IconProps>(
  (
    {
      size,
      color,
...
Message02Icon.displayName = 'Message02Icon';
