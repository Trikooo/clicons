...
interface Notion01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/notion01)
 * @see {@link https://clicons.dev/icon/notion01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Notion01Icon = React.forwardRef<SVGSVGElement, Notion01IconProps>(
  (
    {
      size,
      color,
...
Notion01Icon.displayName = 'Notion01Icon';
