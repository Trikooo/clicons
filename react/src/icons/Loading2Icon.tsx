...
interface Loading2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/loading2}
 */
const Loading2Icon = React.forwardRef<SVGSVGElement, Loading2IconProps>(
...
Loading2Icon.displayName = 'Loading2Icon';
