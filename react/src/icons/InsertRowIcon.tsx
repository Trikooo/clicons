...
interface InsertRowIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const InsertRowIcon = React.forwardRef<SVGSVGElement, InsertRowIconProps>(
  (
    {
      size,
      color,
...
InsertRowIcon.displayName = 'InsertRowIcon';
