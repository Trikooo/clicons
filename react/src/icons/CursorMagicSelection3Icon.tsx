...
interface CursorMagicSelection3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name CursorMagicSelection3Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/cursor-magic-selection3)
 * @see {@link https://clicons.dev/icon/cursor-magic-selection3}
 */
const CursorMagicSelection3Icon = React.forwardRef<SVGSVGElement, CursorMagicSelection3IconProps>(
...
CursorMagicSelection3Icon.displayName = 'CursorMagicSelection3Icon';
