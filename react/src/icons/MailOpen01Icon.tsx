...
interface MailOpen01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mail-open01)
 * @see {@link https://clicons.dev/icon/mail-open01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MailOpen01Icon = React.forwardRef<SVGSVGElement, MailOpen01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M2 19L8.91302 14.2905C11.4387 12.5698 12.5613 12.5698 15.087 14.2905L22 19", stroke: "currentColor", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
