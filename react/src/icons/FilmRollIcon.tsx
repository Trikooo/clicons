...
interface FilmRollIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/film-roll)
 * @see {@link https://clicons.dev/icon/film-roll} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FilmRollIcon = React.forwardRef<SVGSVGElement, FilmRollIconProps>(
  (
    {
      size,
      color,
...
FilmRollIcon.displayName = 'FilmRollIcon';
export default FilmRollIcon;
