...
interface Dress5IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/dress5}
 */
const Dress5Icon = React.forwardRef<SVGSVGElement, Dress5IconProps>(
...
Dress5Icon.displayName = 'Dress5Icon';
