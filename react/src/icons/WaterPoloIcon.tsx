...
const WaterPoloIcon = React.forwardRef<SVGSVGElement, WaterPoloIconProps>(
  (
    ...
    const iconData = [["path", { d: "M2 21.1925C2.68524 22.2429 3.57104 22.2429 4.27299 21.1925C6.52985 17.7424 8.67954 23.6741 10.273 21.2314C12.703 17.5711 14.4508 23.9193 16.273 21.1925C18.6492 17.5599 20.1295 23.5754 22 21.5833", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
