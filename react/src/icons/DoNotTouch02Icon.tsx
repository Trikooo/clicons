...
interface DoNotTouch02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/do-not-touch02)
 * @see {@link https://clicons.dev/icon/do-not-touch02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const DoNotTouch02Icon = React.forwardRef<SVGSVGElement, DoNotTouch02IconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M2.5 2L22.5 22", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "2" }]];
...
DoNotTouch02Icon.displayName = 'DoNotTouch02Icon';
