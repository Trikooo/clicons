...
interface DashboardSquareAddIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/dashboard-square-add)
 * @see {@link https://clicons.dev/icon/dashboard-square-add} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const DashboardSquareAddIcon = React.forwardRef<SVGSVGElement, DashboardSquareAddIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M17.25 3V10.5M21 6.75L13.5 6.75", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
DashboardSquareAddIcon.displayName = 'DashboardSquareAddIcon';
export default DashboardSquareAddIcon;
