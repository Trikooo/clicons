...
interface Layers02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/layers02)
 * @see {@link https://clicons.dev/icon/layers02} - Icon preview
...
const Layers02Icon = React.forwardRef<SVGSVGElement, Layers02IconProps>(
  (
    ...
    const iconData = [["rect", { x: "11", y: "2", width: "11", height: "11", rx: "2.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
