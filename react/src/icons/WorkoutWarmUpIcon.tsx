...
const WorkoutWarmUpIcon = React.forwardRef<SVGSVGElement, WorkoutWarmUpIconProps>(
  (
    ...
    const iconData = [["path", { d: "M14.5002 4.5C14.5002 5.32843 13.8286 6 13.0002 6C12.1717 6 11.5002 5.32843 11.5002 4.5C11.5002 3.67157 12.1717 3 13.0002 3C13.8286 3 14.5002 3.67157 14.5002 4.5Z", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
