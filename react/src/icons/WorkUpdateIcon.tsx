...
interface WorkUpdateIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/work-update}
 */
const WorkUpdateIcon = React.forwardRef<SVGSVGElement, WorkUpdateIconProps>(
...
WorkUpdateIcon.displayName = 'WorkUpdateIcon';
