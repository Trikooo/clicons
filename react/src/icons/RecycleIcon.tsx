...
interface RecycleIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/recycle)
 * @see {@link https://clicons.dev/icon/recycle} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const RecycleIcon = React.forwardRef<SVGSVGElement, RecycleIconProps>(
  (
    {
      size,
      color,
