 ...
 * @see {@link https://clicons.dev/icon/w3-schools}
 */
const W3SchoolsIcon = React.forwardRef<SVGSVGElement, W3SchoolsIconProps>(
  ...
  [
    'path',
    {
      d: 'M19 6H22L20 8H20.5C21.3284 8 22 8.67157 22 9.5C22 10.3284 21.3284 11 20.5 11C19.8469 11 19.2059 10.5826 19 10'
    }
  ]
];
