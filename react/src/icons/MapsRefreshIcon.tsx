...
interface MapsRefreshIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MapsRefreshIcon = React.forwardRef<SVGSVGElement, MapsRefreshIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M8 2L8 17", stroke: "currentColor", strokeLinejoin: "round", strokeWidth: "1.5", key: "2" }],
  ["path", { d: "M15 5V11.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "3" }]];
...
MapsRefreshIcon.displayName = 'MapsRefreshIcon';
