...
interface MessageFavourite01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/message-favourite01)
 * @see {@link https://clicons.dev/icon/message-favourite01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MessageFavourite01Icon = React.forwardRef<SVGSVGElement, MessageFavourite01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M8.5 15H15.5M8.5 10H12", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
MessageFavourite01Icon.displayName = 'MessageFavourite01Icon';
