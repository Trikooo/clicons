...
interface ShockedIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/shocked}
 */
const ShockedIcon = React.forwardRef<SVGSVGElement, ShockedIconProps>(
...
ShockedIcon.displayName = 'ShockedIcon';
