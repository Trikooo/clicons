...
interface ComputerArrowDownIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const ComputerArrowDownIcon = React.forwardRef<SVGSVGElement, ComputerArrowDownIconProps>(
  (
    {
      size,
      color,
...
ComputerArrowDownIcon.displayName = 'ComputerArrowDownIcon';
export default ComputerArrowDownIcon;
