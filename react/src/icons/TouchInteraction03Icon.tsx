...
interface TouchInteraction03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/touch-interaction03)
 * @see {@link https://clicons.dev/icon/touch-interaction03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TouchInteraction03Icon = React.forwardRef<SVGSVGElement, TouchInteraction03IconProps>(
  (
    {
      size,
      color,
...
TouchInteraction03Icon.displayName = 'TouchInteraction03Icon';
