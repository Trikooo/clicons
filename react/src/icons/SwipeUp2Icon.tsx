...
interface SwipeUp2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/swipe-up2}
 */
const SwipeUp2Icon = React.forwardRef<SVGSVGElement, SwipeUp2IconProps>(
