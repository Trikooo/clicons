...
interface UngroupItemsIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const UngroupItemsIcon = React.forwardRef<SVGSVGElement, UngroupItemsIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M6 4C6 5.10457 5.10457 6 4 6C2.89543 6 2 5.10457 2 4C2 2.89543 2.89543 2 4 2C5.10457 2 6 2.89543 6 4Z", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
...
UngroupItemsIcon.displayName = 'UngroupItemsIcon';
export default UngroupItemsIcon;
