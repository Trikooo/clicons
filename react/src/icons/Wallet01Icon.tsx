...
interface Wallet01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/wallet01)
 * @see {@link https://clicons.dev/icon/wallet01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Wallet01Icon = React.forwardRef<SVGSVGElement, Wallet01IconProps>(
  (
    {
      size,
      color,
