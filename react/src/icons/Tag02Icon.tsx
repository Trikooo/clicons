...
interface Tag02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/tag02)
 * @see {@link https://clicons.dev/icon/tag02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Tag02Icon = React.forwardRef<SVGSVGElement, Tag02IconProps>(
  (
    {
      size,
      color,
