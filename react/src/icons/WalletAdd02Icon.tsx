...
interface WalletAdd02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/wallet-add02)
 * @see {@link https://clicons.dev/icon/wallet-add02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const WalletAdd02Icon = React.forwardRef<SVGSVGElement, WalletAdd02IconProps>(
  (
    {
      size,
      color,
...
WalletAdd02Icon.displayName = 'WalletAdd02Icon';
export default WalletAdd02Icon;
