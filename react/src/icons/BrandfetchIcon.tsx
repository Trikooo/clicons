 ...
 * @see {@link https://clicons.dev/icon/brandfetch}
 */
const BrandfetchIcon = React.forwardRef<SVGSVGElement, BrandfetchIconProps>(
  ...
  [
    'path',
    {
      d: 'M5 6.85746C10.5 2.42557 19 3.53936 19 7.52832C19 10.5665 11.5 12 11.5 12C11.5 12 17.5 11.6935 17.5 14.451C17.5 19.0482 8 17.8628 8 17.8628'
    }
  ],
  [
    'path',
