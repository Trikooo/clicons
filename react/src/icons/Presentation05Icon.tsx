...
interface Presentation05IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/presentation05)
 * @see {@link https://clicons.dev/icon/presentation05} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Presentation05Icon = React.forwardRef<SVGSVGElement, Presentation05IconProps>(
  (
    {
      size,
      color,
...
Presentation05Icon.displayName = 'Presentation05Icon';
export default Presentation05Icon;
