...
interface CallUnlocked02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-unlocked02)
 * @see {@link https://clicons.dev/icon/call-unlocked02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallUnlocked02Icon = React.forwardRef<SVGSVGElement, CallUnlocked02IconProps>(
  (
    {
      size,
      color,
...
CallUnlocked02Icon.displayName = 'CallUnlocked02Icon';
