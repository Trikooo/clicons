...
interface ThreeDViewIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/three-d-view)
 * @see {@link https://clicons.dev/icon/three-d-view} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ThreeDViewIcon = React.forwardRef<SVGSVGElement, ThreeDViewIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M12 11.5C12.4955 11.5 12.9562 11.3015 13.8775 10.9045L14.5423 10.618C16.1808 9.91202 17 9.55902 17 9C17 8.44098 16.1808 8.08798 14.5423 7.38197L13.8775 7.09549C12.9562 6.6985 12.4955 6.5 12 6.5C11.5045 6.5 11.0438 6.6985 10.1225 7.09549L9.45768 7.38197C7.81923 8.08798 7 8.44098 7 9C7 9.55902 7.81923 9.91202 9.45768 10.618L10.1225 10.9045C11.0438 11.3015 11.5045 11.5 12 11.5ZM12 11.5V17.5", stroke: "currentColor", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
  ["path", { d: "M17 9V15C17 15.559 16.1808 15.912 14.5423 16.618L13.8775 16.9045C12.9562 17.3015 12.4955 17.5 12 17.5C11.5045 17.5 11.0438 17.3015 10.1225 16.9045L9.45768 16.618C7.81923 15.912 7 15.559 7 15V9", stroke: "currentColor", strokeLinejoin: "round", strokeWidth: "1.5", key: "1" }],
...
ThreeDViewIcon.displayName = 'ThreeDViewIcon';
