...
interface CursorRectangleSelectionIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name CursorRectangleSelectionIcon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/cursor-rectangle-selection)
 * @see {@link https://clicons.dev/icon/cursor-rectangle-selection}
 */
const CursorRectangleSelectionIcon = React.forwardRef<SVGSVGElement, CursorRectangleSelectionIconProps>(
...
CursorRectangleSelectionIcon.displayName = 'CursorRectangleSelectionIcon';
