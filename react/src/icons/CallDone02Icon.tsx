...
interface CallDone02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-done02)
 * @see {@link https://clicons.dev/icon/call-done02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallDone02Icon = React.forwardRef<SVGSVGElement, CallDone02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M13 7.5L15.5 10L21 4", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
CallDone02Icon.displayName = 'CallDone02Icon';
export default CallDone02Icon;
