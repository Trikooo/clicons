...
interface MailSend2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MailSend2Icon = React.forwardRef<SVGSVGElement, MailSend2IconProps>(
  (
    {
      size,
      color,
...
MailSend2Icon.displayName = 'MailSend2Icon';
export default MailSend2Icon;
