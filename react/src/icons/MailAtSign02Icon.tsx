...
interface MailAtSign02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mail-at-sign02)
 * @see {@link https://clicons.dev/icon/mail-at-sign02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MailAtSign02Icon = React.forwardRef<SVGSVGElement, MailAtSign02IconProps>(
  (
    {
      size,
      color,
...
MailAtSign02Icon.displayName = 'MailAtSign02Icon';
export default MailAtSign02Icon;
