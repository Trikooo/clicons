...
interface Menu01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/menu01)
 * @see {@link https://clicons.dev/icon/menu01} - Icon preview
