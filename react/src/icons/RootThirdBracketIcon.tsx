...
interface RootThirdBracketIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const RootThirdBracketIcon = React.forwardRef<SVGSVGElement, RootThirdBracketIconProps>(
  (
    {
      size,
      color,
...
RootThirdBracketIcon.displayName = 'RootThirdBracketIcon';
