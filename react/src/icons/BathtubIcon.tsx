...
interface BathtubIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/bathtub}
 */
const BathtubIcon = React.forwardRef<SVGSVGElement, BathtubIconProps>(
