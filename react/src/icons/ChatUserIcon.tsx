...
interface ChatUserIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/chat-user)
 * @see {@link https://clicons.dev/icon/chat-user} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ChatUserIcon = React.forwardRef<SVGSVGElement, ChatUserIconProps>(
  (
    {
      size,
      color,
...
ChatUserIcon.displayName = 'ChatUserIcon';
