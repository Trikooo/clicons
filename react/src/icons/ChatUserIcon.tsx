...
const ChatUserIcon = React.forwardRef<SVGSVGElement, ChatUserIconProps>(
  ...
  [
    'path',
    {
      d: 'M8.5 13.9984C8.5 12.0654 10.067 10.4984 12 10.4984C13.933 10.4984 15.5 12.0654 15.5 13.9984M14 8.5C14 9.60457 13.1046 10.5 12 10.5C10.8954 10.5 10 9.60457 10 8.5C10 7.39543 10.8954 6.5 12 6.5C13.1046 6.5 14 7.39543 14 8.5Z',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
