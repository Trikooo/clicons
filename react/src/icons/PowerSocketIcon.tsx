...
interface PowerSocketIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/power-socket)
 * @see {@link https://clicons.dev/icon/power-socket} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PowerSocketIcon = React.forwardRef<SVGSVGElement, PowerSocketIconProps>(
  (
    {
      size,
      color,
