...
interface CreditCardNotAcceptIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/credit-card-not-accept}
 */
const CreditCardNotAcceptIcon = React.forwardRef<SVGSVGElement, CreditCardNotAcceptIconProps>(
...
CreditCardNotAcceptIcon.displayName = 'CreditCardNotAcceptIcon';
