...
interface MailMinusIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/mail-minus}
 */
const MailMinusIcon = React.forwardRef<SVGSVGElement, MailMinusIconProps>(
