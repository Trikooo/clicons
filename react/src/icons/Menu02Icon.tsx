...
interface Menu02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/menu02)
 * @see {@link https://clicons.dev/icon/menu02} - Icon preview
...
const Menu02Icon = React.forwardRef<SVGSVGElement, Menu02IconProps>(
  (
    ...
    const iconData = [["path", { d: "M4 5L16 5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
