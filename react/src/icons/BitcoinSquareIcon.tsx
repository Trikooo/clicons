...
interface BitcoinSquareIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/bitcoin-square)
 * @see {@link https://clicons.dev/icon/bitcoin-square} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BitcoinSquareIcon = React.forwardRef<SVGSVGElement, BitcoinSquareIconProps>(
  (
    {
      size,
      color,
...
BitcoinSquareIcon.displayName = 'BitcoinSquareIcon';
export default BitcoinSquareIcon;
