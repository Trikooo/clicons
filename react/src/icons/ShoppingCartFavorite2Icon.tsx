...
interface ShoppingCartFavorite2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name ShoppingCartFavorite2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/shopping-cart-favorite2)
 * @see {@link https://clicons.dev/icon/shopping-cart-favorite2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ShoppingCartFavorite2Icon = React.forwardRef<SVGSVGElement, ShoppingCartFavorite2IconProps>(
  (
    {
      size,
      color,
...
ShoppingCartFavorite2Icon.displayName = 'ShoppingCartFavorite2Icon';
export default ShoppingCartFavorite2Icon;
