...
interface SquareArrowDownIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/square-arrow-down}
 */
const SquareArrowDownIcon = React.forwardRef<SVGSVGElement, SquareArrowDownIconProps>(
