...
interface Zip01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/zip01)
 * @see {@link https://clicons.dev/icon/zip01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Zip01Icon = React.forwardRef<SVGSVGElement, Zip01IconProps>(
  (
    {
      size,
      color,
...
Zip01Icon.displayName = 'Zip01Icon';
