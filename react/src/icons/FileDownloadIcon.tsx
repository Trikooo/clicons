...
interface FileDownloadIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/file-download)
 * @see {@link https://clicons.dev/icon/file-download} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FileDownloadIcon = React.forwardRef<SVGSVGElement, FileDownloadIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M4 7C4.58984 7.60684 6.15973 10 7 10C7.84027 10 9.41016 7.60684 10 7M7 9L7 2", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
