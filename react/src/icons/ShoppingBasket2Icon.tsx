...
interface ShoppingBasket2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name ShoppingBasket2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/shopping-basket2)
 * @see {@link https://clicons.dev/icon/shopping-basket2}
 */
const ShoppingBasket2Icon = React.forwardRef<SVGSVGElement, ShoppingBasket2IconProps>(
...
ShoppingBasket2Icon.displayName = 'ShoppingBasket2Icon';
