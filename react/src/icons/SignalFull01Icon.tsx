...
interface SignalFull01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/signal-full01)
 * @see {@link https://clicons.dev/icon/signal-full01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SignalFull01Icon = React.forwardRef<SVGSVGElement, SignalFull01IconProps>(
  (
    {
      size,
      color,
...
SignalFull01Icon.displayName = 'SignalFull01Icon';
export default SignalFull01Icon;
