...
interface CallRinging3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const CallRinging3Icon = React.forwardRef<SVGSVGElement, CallRinging3IconProps>(
  (
    {
      size,
      color,
...
CallRinging3Icon.displayName = 'CallRinging3Icon';
export default CallRinging3Icon;
