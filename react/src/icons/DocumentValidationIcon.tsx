...
interface DocumentValidationIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/document-validation}
 */
const DocumentValidationIcon = React.forwardRef<SVGSVGElement, DocumentValidationIconProps>(
...
DocumentValidationIcon.displayName = 'DocumentValidationIcon';
