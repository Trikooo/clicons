...
interface TabletIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/tablet)
 * @see {@link https://clicons.dev/icon/tablet} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TabletIcon = React.forwardRef<SVGSVGElement, TabletIconProps>(
  (
    {
      size,
      color,
