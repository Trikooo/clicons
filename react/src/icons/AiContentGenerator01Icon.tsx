...
interface AiContentGenerator01IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name AiContentGenerator01Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/ai-content-generator01)
 * @see {@link https://clicons.dev/icon/ai-content-generator01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AiContentGenerator01Icon = React.forwardRef<SVGSVGElement, AiContentGenerator01IconProps>(
  (
    {
      size,
      color,
...
AiContentGenerator01Icon.displayName = 'AiContentGenerator01Icon';
export default AiContentGenerator01Icon;
