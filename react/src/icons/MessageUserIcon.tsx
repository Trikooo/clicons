...
interface MessageUserIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name MessageUserIcon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/message-user)
 * @see {@link https://clicons.dev/icon/message-user}
 */
const MessageUserIcon = React.forwardRef<SVGSVGElement, MessageUserIconProps>(
...
MessageUserIcon.displayName = 'MessageUserIcon';
