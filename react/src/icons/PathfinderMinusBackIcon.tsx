...
const PathfinderMinusBackIcon = React.forwardRef<SVGSVGElement, PathfinderMinusBackIconProps>(
  (
    ...
    const iconData = [["path", { d: "M15 9.00017C15.1616 9 15.3282 9 15.5 9C18.3165 9 19.7247 9 20.6822 9.76359C20.8871 9.92699 21.073 10.1129 21.2364 10.3178C22 11.2753 22 12.6835 22 15.5C22 18.3165 22 19.7247 21.2364 20.6822C21.073 20.8871 20.8871 21.073 20.6822 21.2364C19.7247 22 18.3165 22 15.5 22C12.6835 22 11.2753 22 10.3178 21.2364C10.1129 21.073 9.92699 20.8871 9.76359 20.6822C9 19.7247 9 18.3165 9 15.5C9 15.3282 9 15.1616 9.00017 15", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
  ["path", { d: "M15 8.99993C14.9973 11.4866 14.9536 12.7831 14.2366 13.6821C14.0732 13.887 13.8873 14.0729 13.6824 14.2363C12.7833 14.9533 11.4868 14.9971 9.00017 14.9998", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "1" }],
