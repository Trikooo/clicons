...
interface FootballIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/football}
 */
const FootballIcon = React.forwardRef<SVGSVGElement, FootballIconProps>(
