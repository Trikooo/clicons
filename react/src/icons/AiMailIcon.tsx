...
interface AiMailIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/ai-mail)
 * @see {@link https://clicons.dev/icon/ai-mail} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AiMailIcon = React.forwardRef<SVGSVGElement, AiMailIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M8 10L9.61165 5.39528C9.69427 5.15922 9.92623 5 10.1875 5C10.4488 5 10.6807 5.15922 10.7633 5.39528L12.375 10M15 5V10M8.875 8.33333H11.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "3" }]];
...
AiMailIcon.displayName = 'AiMailIcon';
