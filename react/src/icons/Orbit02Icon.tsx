...
interface Orbit02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/orbit02)
 * @see {@link https://clicons.dev/icon/orbit02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Orbit02Icon = React.forwardRef<SVGSVGElement, Orbit02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M14 7C14 8.10457 13.1046 9 12 9C10.8954 9 10 8.10457 10 7C10 5.89543 10.8954 5 12 5C13.1046 5 14 5.89543 14 7Z", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
...
Orbit02Icon.displayName = 'Orbit02Icon';
