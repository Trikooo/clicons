...
interface JusticeScaleIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const JusticeScaleIcon = React.forwardRef<SVGSVGElement, JusticeScaleIconProps>(
  (
    {
      size,
      color,
...
JusticeScaleIcon.displayName = 'JusticeScaleIcon';
