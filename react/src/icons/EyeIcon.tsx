 ...
 * @see {@link https://clicons.dev/icon/eye} - Icon preview
...
const EyeIcon = React.forwardRef<SVGSVGElement, EyeIconProps>(
  (
    ...
    const iconData = [["path", { d: "M2 8C2 8 6.47715 3 12 3C17.5228 3 22 8 22 8", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
