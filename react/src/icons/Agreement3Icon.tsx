...
interface Agreement3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/agreement3}
 */
const Agreement3Icon = React.forwardRef<SVGSVGElement, Agreement3IconProps>(
...
Agreement3Icon.displayName = 'Agreement3Icon';
