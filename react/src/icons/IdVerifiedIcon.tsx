...
interface IdVerifiedIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/id-verified)
 * @see {@link https://clicons.dev/icon/id-verified} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const IdVerifiedIcon = React.forwardRef<SVGSVGElement, IdVerifiedIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M16.177 18.4559C16.4776 18.6002 16.8504 18.973 17.0308 19.2737C17.0909 19.6945 17.3916 18.0711 18.8586 17.1091M21.5 18.001C21.5 20.2101 19.7091 22.001 17.5 22.001C15.2909 22.001 13.5 20.2101 13.5 18.001C13.5 15.7918 15.2909 14.001 17.5 14.001C19.7091 14.001 21.5 15.7918 21.5 18.001Z", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
  ["circle", { cx: "11.0078", cy: "12.001", r: "2", stroke: "currentColor", strokeWidth: "1.5", key: "1" }],
