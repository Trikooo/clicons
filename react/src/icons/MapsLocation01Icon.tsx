...
interface MapsLocation01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/maps-location01)
 * @see {@link https://clicons.dev/icon/maps-location01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MapsLocation01Icon = React.forwardRef<SVGSVGElement, MapsLocation01IconProps>(
  (
    {
      size,
      color,
...
MapsLocation01Icon.displayName = 'MapsLocation01Icon';
