...
interface Presentation06IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/presentation06)
 * @see {@link https://clicons.dev/icon/presentation06} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Presentation06Icon = React.forwardRef<SVGSVGElement, Presentation06IconProps>(
  (
    {
      size,
      color,
...
Presentation06Icon.displayName = 'Presentation06Icon';
