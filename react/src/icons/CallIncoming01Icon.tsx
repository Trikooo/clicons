...
interface CallIncoming01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-incoming01)
 * @see {@link https://clicons.dev/icon/call-incoming01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallIncoming01Icon = React.forwardRef<SVGSVGElement, CallIncoming01IconProps>(
  (
    {
      size,
      color,
...
export default CallIncoming01Icon;
