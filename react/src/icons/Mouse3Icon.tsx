...
interface Mouse3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Mouse3Icon = React.forwardRef<SVGSVGElement, Mouse3IconProps>(
  (
    {
      size,
      color,
...
Mouse3Icon.displayName = 'Mouse3Icon';
export default Mouse3Icon;
