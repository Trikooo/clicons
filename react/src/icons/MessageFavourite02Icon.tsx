...
interface MessageFavourite02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/message-favourite02)
 * @see {@link https://clicons.dev/icon/message-favourite02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MessageFavourite02Icon = React.forwardRef<SVGSVGElement, MessageFavourite02IconProps>(
  (
    {
      size,
      color,
...
MessageFavourite02Icon.displayName = 'MessageFavourite02Icon';
