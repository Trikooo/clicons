...
interface Share08IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/share08)
 * @see {@link https://clicons.dev/icon/share08} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Share08Icon = React.forwardRef<SVGSVGElement, Share08IconProps>(
  (
    {
      size,
      color,
