...
interface Tap07IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/tap07)
 * @see {@link https://clicons.dev/icon/tap07} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Tap07Icon = React.forwardRef<SVGSVGElement, Tap07IconProps>(
  (
    {
      size,
      color,
...
Tap07Icon.displayName = 'Tap07Icon';
