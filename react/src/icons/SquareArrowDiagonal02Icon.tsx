...
interface SquareArrowDiagonal02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/square-arrow-diagonal02)
 * @see {@link https://clicons.dev/icon/square-arrow-diagonal02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SquareArrowDiagonal02Icon = React.forwardRef<SVGSVGElement, SquareArrowDiagonal02IconProps>(
  (
    {
      size,
      color,
...
SquareArrowDiagonal02Icon.displayName = 'SquareArrowDiagonal02Icon';
