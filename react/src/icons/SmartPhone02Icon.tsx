...
interface SmartPhone02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/smart-phone02)
 * @see {@link https://clicons.dev/icon/smart-phone02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SmartPhone02Icon = React.forwardRef<SVGSVGElement, SmartPhone02IconProps>(
  (
    {
      size,
      color,
...
SmartPhone02Icon.displayName = 'SmartPhone02Icon';
