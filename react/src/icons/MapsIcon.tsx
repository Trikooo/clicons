...
interface MapsIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/maps)
 * @see {@link https://clicons.dev/icon/maps} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MapsIcon = React.forwardRef<SVGSVGElement, MapsIconProps>(
  (
    {
      size,
      color,
