...
interface TickDouble03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/tick-double03)
 * @see {@link https://clicons.dev/icon/tick-double03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TickDouble03Icon = React.forwardRef<SVGSVGElement, TickDouble03IconProps>(
  (
    {
      size,
      color,
...
TickDouble03Icon.displayName = 'TickDouble03Icon';
