...
interface SwipeUp5IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/swipe-up5}
 */
const SwipeUp5Icon = React.forwardRef<SVGSVGElement, SwipeUp5IconProps>(
...
SwipeUp5Icon.displayName = 'SwipeUp5Icon';
