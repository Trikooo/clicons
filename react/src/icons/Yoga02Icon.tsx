...
interface Yoga02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/yoga02)
 * @see {@link https://clicons.dev/icon/yoga02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Yoga02Icon = React.forwardRef<SVGSVGElement, Yoga02IconProps>(
  (
    {
      size,
      color,
...
Yoga02Icon.displayName = 'Yoga02Icon';
