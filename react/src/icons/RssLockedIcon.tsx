...
interface RssLockedIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const RssLockedIcon = React.forwardRef<SVGSVGElement, RssLockedIconProps>(
  (
    {
      size,
      color,
...
RssLockedIcon.displayName = 'RssLockedIcon';
