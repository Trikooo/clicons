...
interface UserLove01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/user-love01)
 * @see {@link https://clicons.dev/icon/user-love01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const UserLove01Icon = React.forwardRef<SVGSVGElement, UserLove01IconProps>(
  (
    {
      size,
      color,
...
UserLove01Icon.displayName = 'UserLove01Icon';
