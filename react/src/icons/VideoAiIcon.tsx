...
interface VideoAiIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/video-ai)
 * @see {@link https://clicons.dev/icon/video-ai} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const VideoAiIcon = React.forwardRef<SVGSVGElement, VideoAiIconProps>(
  (
    {
      size,
      color,
...
VideoAiIcon.displayName = 'VideoAiIcon';
export default VideoAiIcon;
