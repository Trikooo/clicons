...
interface SunCloudLittleSnowIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const SunCloudLittleSnowIcon = React.forwardRef<SVGSVGElement, SunCloudLittleSnowIconProps>(
  (
    {
      size,
      color,
...
SunCloudLittleSnowIcon.displayName = 'SunCloudLittleSnowIcon';
export default SunCloudLittleSnowIcon;
