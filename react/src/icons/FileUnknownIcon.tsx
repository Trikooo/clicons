...
interface FileUnknownIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/file-unknown}
 */
const FileUnknownIcon = React.forwardRef<SVGSVGElement, FileUnknownIconProps>(
