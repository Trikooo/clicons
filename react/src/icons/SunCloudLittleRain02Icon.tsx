...
const SunCloudLittleRain02Icon = React.forwardRef<SVGSVGElement, SunCloudLittleRain02IconProps>(
  (
    ...
    const iconData = [["path", { d: "M11.9972 14.5V16M8.99609 17.5V19M14.9961 17.5V19M6.49609 20.5V22M17.4961 20.5V22M11.9961 20.5V22", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
