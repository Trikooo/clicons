...
interface SunCloudLittleRain02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/sun-cloud-little-rain02)
 * @see {@link https://clicons.dev/icon/sun-cloud-little-rain02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SunCloudLittleRain02Icon = React.forwardRef<SVGSVGElement, SunCloudLittleRain02IconProps>(
  (
    {
      size,
      color,
...
SunCloudLittleRain02Icon.displayName = 'SunCloudLittleRain02Icon';
