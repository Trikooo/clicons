...
interface FolderLinksIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const FolderLinksIcon = React.forwardRef<SVGSVGElement, FolderLinksIconProps>(
  (
    {
      size,
      color,
...
FolderLinksIcon.displayName = 'FolderLinksIcon';
