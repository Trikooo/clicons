...
interface HotelIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/hotel}
 */
const HotelIcon = React.forwardRef<SVGSVGElement, HotelIconProps>(
