...
interface Tree04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/tree04)
 * @see {@link https://clicons.dev/icon/tree04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Tree04Icon = React.forwardRef<SVGSVGElement, Tree04IconProps>(
  (
    {
      size,
      color,
...
Tree04Icon.displayName = 'Tree04Icon';
export default Tree04Icon;
