...
interface ArtificialIntelligence05IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/artificial-intelligence05)
 * @see {@link https://clicons.dev/icon/artificial-intelligence05} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ArtificialIntelligence05Icon = React.forwardRef<SVGSVGElement, ArtificialIntelligence05IconProps>(
  (
    {
      size,
      color,
...
ArtificialIntelligence05Icon.displayName = 'ArtificialIntelligence05Icon';
