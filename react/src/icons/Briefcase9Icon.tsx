...
interface Briefcase9IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/briefcase9)
 * @see {@link https://clicons.dev/icon/briefcase9} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Briefcase9Icon = React.forwardRef<SVGSVGElement, Briefcase9IconProps>(
  (
    {
      size,
      color,
...
Briefcase9Icon.displayName = 'Briefcase9Icon';
export default Briefcase9Icon;
