...
interface BorderAllIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/border-all}
 */
const BorderAllIcon = React.forwardRef<SVGSVGElement, BorderAllIconProps>(
