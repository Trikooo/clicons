...
interface MailUnlock01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mail-unlock01)
 * @see {@link https://clicons.dev/icon/mail-unlock01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MailUnlock01Icon = React.forwardRef<SVGSVGElement, MailUnlock01IconProps>(
  (
    {
      size,
      color,
...
MailUnlock01Icon.displayName = 'MailUnlock01Icon';
