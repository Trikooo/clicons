...
interface GridOffIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const GridOffIcon = React.forwardRef<SVGSVGElement, GridOffIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M7 21V7", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
