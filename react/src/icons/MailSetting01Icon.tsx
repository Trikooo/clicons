...
interface MailSetting01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mail-setting01)
 * @see {@link https://clicons.dev/icon/mail-setting01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MailSetting01Icon = React.forwardRef<SVGSVGElement, MailSetting01IconProps>(
  (
    {
      size,
      color,
...
MailSetting01Icon.displayName = 'MailSetting01Icon';
