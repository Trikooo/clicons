...
interface GunIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const GunIcon = React.forwardRef<SVGSVGElement, GunIconProps>(
  (
    {
      size,
      color,
