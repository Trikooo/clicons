...
interface WindowsNewIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/windows-new}
 */
const WindowsNewIcon = React.forwardRef<SVGSVGElement, WindowsNewIconProps>(
...
WindowsNewIcon.displayName = 'WindowsNewIcon';
