...
interface Sheriff2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/sheriff2}
 */
const Sheriff2Icon = React.forwardRef<SVGSVGElement, Sheriff2IconProps>(
...
Sheriff2Icon.displayName = 'Sheriff2Icon';
