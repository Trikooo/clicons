...
interface LayoutTableIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const LayoutTableIcon = React.forwardRef<SVGSVGElement, LayoutTableIconProps>(
  (
    {
      size,
      color,
...
LayoutTableIcon.displayName = 'LayoutTableIcon';
