...
interface BatteryMediumIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const BatteryMediumIcon = React.forwardRef<SVGSVGElement, BatteryMediumIconProps>(
  (
    {
      size,
      color,
