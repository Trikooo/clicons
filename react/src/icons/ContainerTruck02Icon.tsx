...
interface ContainerTruck02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/container-truck02)
 * @see {@link https://clicons.dev/icon/container-truck02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ContainerTruck02Icon = React.forwardRef<SVGSVGElement, ContainerTruck02IconProps>(
  (
    {
      size,
      color,
...
ContainerTruck02Icon.displayName = 'ContainerTruck02Icon';
export default ContainerTruck02Icon;
