...
interface CursorCircleSelection2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name CursorCircleSelection2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/cursor-circle-selection2)
 * @see {@link https://clicons.dev/icon/cursor-circle-selection2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CursorCircleSelection2Icon = React.forwardRef<SVGSVGElement, CursorCircleSelection2IconProps>(
  (
    {
      size,
      color,
...
CursorCircleSelection2Icon.displayName = 'CursorCircleSelection2Icon';
export default CursorCircleSelection2Icon;
