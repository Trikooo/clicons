...
interface TrafficJam2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const TrafficJam2Icon = React.forwardRef<SVGSVGElement, TrafficJam2IconProps>(
  (
    {
      size,
      color,
...
TrafficJam2Icon.displayName = 'TrafficJam2Icon';
export default TrafficJam2Icon;
