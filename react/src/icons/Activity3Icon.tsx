...
interface Activity3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/activity3)
 * @see {@link https://clicons.dev/icon/activity3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Activity3Icon = React.forwardRef<SVGSVGElement, Activity3IconProps>(
  (
    {
      size,
      color,
...
Activity3Icon.displayName = 'Activity3Icon';
