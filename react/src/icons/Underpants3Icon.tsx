...
interface Underpants3IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name Underpants3Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/underpants3)
 * @see {@link https://clicons.dev/icon/underpants3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Underpants3Icon = React.forwardRef<SVGSVGElement, Underpants3IconProps>(
  (
    {
      size,
      color,
...
Underpants3Icon.displayName = 'Underpants3Icon';
export default Underpants3Icon;
