...
interface SourceCodeIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const SourceCodeIcon = React.forwardRef<SVGSVGElement, SourceCodeIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M17 8L18.8398 9.85008C19.6133 10.6279 20 11.0168 20 11.5C20 11.9832 19.6133 12.3721 18.8398 13.1499L17 15", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
