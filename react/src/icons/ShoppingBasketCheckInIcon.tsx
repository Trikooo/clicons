...
interface ShoppingBasketCheckInIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name ShoppingBasketCheckInIcon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/shopping-basket-check-in)
 * @see {@link https://clicons.dev/icon/shopping-basket-check-in}
 */
const ShoppingBasketCheckInIcon = React.forwardRef<SVGSVGElement, ShoppingBasketCheckInIconProps>(
...
ShoppingBasketCheckInIcon.displayName = 'ShoppingBasketCheckInIcon';
