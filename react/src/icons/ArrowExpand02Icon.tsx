...
interface ArrowExpand02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/arrow-expand02)
 * @see {@link https://clicons.dev/icon/arrow-expand02} - Icon preview
