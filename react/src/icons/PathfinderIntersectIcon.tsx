...
interface PathfinderIntersectIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pathfinder-intersect)
 * @see {@link https://clicons.dev/icon/pathfinder-intersect} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PathfinderIntersectIcon = React.forwardRef<SVGSVGElement, PathfinderIntersectIconProps>(
  (
    {
      size,
      color,
...
PathfinderIntersectIcon.displayName = 'PathfinderIntersectIcon';
