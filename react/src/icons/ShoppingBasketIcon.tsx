...
interface ShoppingBasketIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/shopping-basket)
 * @see {@link https://clicons.dev/icon/shopping-basket} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ShoppingBasketIcon = React.forwardRef<SVGSVGElement, ShoppingBasketIconProps>(
  (
    {
      size,
      color,
