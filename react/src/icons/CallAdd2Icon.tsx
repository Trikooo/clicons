...
interface CallAdd2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/call-add2}
 */
const CallAdd2Icon = React.forwardRef<SVGSVGElement, CallAdd2IconProps>(
...
CallAdd2Icon.displayName = 'CallAdd2Icon';
