...
interface Configuration01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/configuration01)
 * @see {@link https://clicons.dev/icon/configuration01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Configuration01Icon = React.forwardRef<SVGSVGElement, Configuration01IconProps>(
  (
    {
      size,
      color,
...
Configuration01Icon.displayName = 'Configuration01Icon';
export default Configuration01Icon;
