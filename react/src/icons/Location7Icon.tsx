...
interface Location7IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/location7}
 */
const Location7Icon = React.forwardRef<SVGSVGElement, Location7IconProps>(
...
Location7Icon.displayName = 'Location7Icon';
