...
interface Tv02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/tv02)
 * @see {@link https://clicons.dev/icon/tv02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Tv02Icon = React.forwardRef<SVGSVGElement, Tv02IconProps>(
  (
    {
      size,
      color,
