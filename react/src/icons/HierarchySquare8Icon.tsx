...
interface HierarchySquare8IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name HierarchySquare8Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/hierarchy-square8)
 * @see {@link https://clicons.dev/icon/hierarchy-square8}
 */
const HierarchySquare8Icon = React.forwardRef<SVGSVGElement, HierarchySquare8IconProps>(
...
HierarchySquare8Icon.displayName = 'HierarchySquare8Icon';
