...
interface CallDone2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/call-done2}
 */
const CallDone2Icon = React.forwardRef<SVGSVGElement, CallDone2IconProps>(
...
CallDone2Icon.displayName = 'CallDone2Icon';
