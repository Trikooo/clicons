...
interface MusicNoteSquare02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/music-note-square02)
 * @see {@link https://clicons.dev/icon/music-note-square02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MusicNoteSquare02Icon = React.forwardRef<SVGSVGElement, MusicNoteSquare02IconProps>(
  (
    {
      size,
      color,
...
MusicNoteSquare02Icon.displayName = 'MusicNoteSquare02Icon';
