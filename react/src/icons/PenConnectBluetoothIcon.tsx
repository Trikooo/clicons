...
interface PenConnectBluetoothIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/pen-connect-bluetooth}
 */
const PenConnectBluetoothIcon = React.forwardRef<SVGSVGElement, PenConnectBluetoothIconProps>(
...
PenConnectBluetoothIcon.displayName = 'PenConnectBluetoothIcon';
