...
interface BingIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/bing)
 * @see {@link https://clicons.dev/icon/bing} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BingIcon = React.forwardRef<SVGSVGElement, BingIconProps>(
  (
    {
      size,
      color,
