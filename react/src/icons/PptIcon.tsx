...
interface PptIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/ppt)
 * @see {@link https://clicons.dev/icon/ppt} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PptIcon = React.forwardRef<SVGSVGElement, PptIconProps>(
  (
    {
      size,
      color,
