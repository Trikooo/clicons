...
interface MessagePreviewIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MessagePreviewIcon = React.forwardRef<SVGSVGElement, MessagePreviewIconProps>(
  (
    {
      size,
      color,
...
MessagePreviewIcon.displayName = 'MessagePreviewIcon';
export default MessagePreviewIcon;
