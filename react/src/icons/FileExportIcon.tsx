...
interface FileExportIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const FileExportIcon = React.forwardRef<SVGSVGElement, FileExportIconProps>(
  (
    {
      size,
      color,
