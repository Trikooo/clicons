...
interface Layout2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Layout2Icon = React.forwardRef<SVGSVGElement, Layout2IconProps>(
  (
    {
      size,
      color,
...
Layout2Icon.displayName = 'Layout2Icon';
