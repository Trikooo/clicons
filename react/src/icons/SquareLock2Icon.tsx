...
interface SquareLock2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const SquareLock2Icon = React.forwardRef<SVGSVGElement, SquareLock2IconProps>(
  (
    {
      size,
      color,
...
SquareLock2Icon.displayName = 'SquareLock2Icon';
export default SquareLock2Icon;
