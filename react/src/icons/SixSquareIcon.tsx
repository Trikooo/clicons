 ...
 * @see {@link https://clicons.dev/icon/six-square}
 */
const SixSquareIcon = React.forwardRef<SVGSVGElement, SixSquareIconProps>(
  ...
  [
    'path',
    {
      d: 'M11.4971 12H13.4971C14.6016 12 15.4971 12.8954 15.4971 14V15C15.4971 16.1046 14.6016 17 13.4971 17H11.4971C10.3925 17 9.49707 16.1046 9.49707 15V14C9.49707 12.8954 10.3925 12 11.4971 12Z'
    }
  ],
  [
    'path',
    {
      d: 'M9.49707 14.5V9C9.49707 7.89543 10.3925 7 11.4971 7H13.4971C14.6016 7 15.4971 7.89543 15.4971 9'
    }
  ]
];
