...
interface Settings5IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/settings5}
 */
const Settings5Icon = React.forwardRef<SVGSVGElement, Settings5IconProps>(
...
Settings5Icon.displayName = 'Settings5Icon';
