...
interface File02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/file02)
 * @see {@link https://clicons.dev/icon/file02} - Icon preview
...
const File02Icon = React.forwardRef<SVGSVGElement, File02IconProps>(
  (
    ...
    const iconData = [["path", { d: "M8 17H16", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
