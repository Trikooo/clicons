...
interface Select02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/select02)
 * @see {@link https://clicons.dev/icon/select02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Select02Icon = React.forwardRef<SVGSVGElement, Select02IconProps>(
  (
    {
      size,
      color,
...
Select02Icon.displayName = 'Select02Icon';
