...
interface DoNotTouch01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/do-not-touch01)
 * @see {@link https://clicons.dev/icon/do-not-touch01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const DoNotTouch01Icon = React.forwardRef<SVGSVGElement, DoNotTouch01IconProps>(
  (
    {
      size,
      color,
...
DoNotTouch01Icon.displayName = 'DoNotTouch01Icon';
