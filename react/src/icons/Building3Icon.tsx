...
interface Building3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/building3)
 * @see {@link https://clicons.dev/icon/building3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Building3Icon = React.forwardRef<SVGSVGElement, Building3IconProps>(
  (
    {
      size,
      color,
