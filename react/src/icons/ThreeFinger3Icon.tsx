...
interface ThreeFinger3IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name ThreeFinger3Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/three-finger3)
 * @see {@link https://clicons.dev/icon/three-finger3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ThreeFinger3Icon = React.forwardRef<SVGSVGElement, ThreeFinger3IconProps>(
  (
    {
      size,
      color,
...
ThreeFinger3Icon.displayName = 'ThreeFinger3Icon';
export default ThreeFinger3Icon;
