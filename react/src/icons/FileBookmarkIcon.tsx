...
interface FileBookmarkIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/file-bookmark}
 */
const FileBookmarkIcon = React.forwardRef<SVGSVGElement, FileBookmarkIconProps>(
...
FileBookmarkIcon.displayName = 'FileBookmarkIcon';
