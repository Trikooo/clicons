...
const StepOverIcon = React.forwardRef<SVGSVGElement, StepOverIconProps>(
  (
    ...
    const iconData = [["path", { d: "M14 14L15.5858 15.8398C16.2525 16.6133 16.5858 17 17 17C17.4142 17 17.7475 16.6133 18.4142 15.8398L20 14", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
