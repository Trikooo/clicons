...
interface CursorHoldIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/cursor-hold}
 */
const CursorHoldIcon = React.forwardRef<SVGSVGElement, CursorHoldIconProps>(
...
CursorHoldIcon.displayName = 'CursorHoldIcon';
