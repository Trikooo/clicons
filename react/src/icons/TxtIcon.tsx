...
interface TxtIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/txt)
 * @see {@link https://clicons.dev/icon/txt} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TxtIcon = React.forwardRef<SVGSVGElement, TxtIconProps>(
  (
    {
      size,
      color,
