...
const Castle02Icon = React.forwardRef<SVGSVGElement, Castle02IconProps>(
  ...
  [
    'path',
    {
      d: 'M12 5C13.491 5.68354 16 4.5 16 2C14.3578 2.62289 13.5105 2.61424 12 2V5ZM12 5V8',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
