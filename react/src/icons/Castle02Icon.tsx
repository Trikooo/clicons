...
interface Castle02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/castle02)
 * @see {@link https://clicons.dev/icon/castle02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Castle02Icon = React.forwardRef<SVGSVGElement, Castle02IconProps>(
  (
    {
      size,
      color,
...
Castle02Icon.displayName = 'Castle02Icon';
