...
interface Share5IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/share5)
 * @see {@link https://clicons.dev/icon/share5} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Share5Icon = React.forwardRef<SVGSVGElement, Share5IconProps>(
  (
    {
      size,
      color,
...
Share5Icon.displayName = 'Share5Icon';
export default Share5Icon;
