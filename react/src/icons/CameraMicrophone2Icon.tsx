...
interface CameraMicrophone2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name CameraMicrophone2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/camera-microphone2)
 * @see {@link https://clicons.dev/icon/camera-microphone2}
 */
const CameraMicrophone2Icon = React.forwardRef<SVGSVGElement, CameraMicrophone2IconProps>(
...
CameraMicrophone2Icon.displayName = 'CameraMicrophone2Icon';
