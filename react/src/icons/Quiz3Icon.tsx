...
interface Quiz3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Quiz3Icon = React.forwardRef<SVGSVGElement, Quiz3IconProps>(
  (
    {
      size,
      color,
...
Quiz3Icon.displayName = 'Quiz3Icon';
export default Quiz3Icon;
