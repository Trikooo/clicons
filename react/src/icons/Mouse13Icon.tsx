...
const Mouse13Icon = React.forwardRef<SVGSVGElement, Mouse13IconProps>(
  (
    ...
    const iconData = [["path", { d: "M5.1851 18.9941C9.48005 21.4312 12.2743 19.1116 14.3687 15.5464C16.463 11.9811 17.1098 8.44303 12.8149 6.00594C8.51993 3.56885 5.72575 5.8884 3.63136 9.45367C1.53697 13.0189 0.890156 16.557 5.1851 18.9941Z", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
