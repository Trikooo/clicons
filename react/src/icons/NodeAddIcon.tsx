...
const NodeAddIcon = React.forwardRef<SVGSVGElement, NodeAddIconProps>(
  (
    ...
    const iconData = [["path", { d: "M13.5 19.5H13C10.1716 19.5 8.75736 19.5 7.87868 18.6213C7 17.7426 7 16.3284 7 13.5V11.5M7 10.5V11.5M7 11.5H13.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
