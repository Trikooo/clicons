...
interface ChartLineData02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/chart-line-data02)
 * @see {@link https://clicons.dev/icon/chart-line-data02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ChartLineData02Icon = React.forwardRef<SVGSVGElement, ChartLineData02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["circle", { cx: "8.5", cy: "10.5", r: "1.5", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
...
ChartLineData02Icon.displayName = 'ChartLineData02Icon';
