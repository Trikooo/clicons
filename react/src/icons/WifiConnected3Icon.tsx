...
interface WifiConnected3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name WifiConnected3Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/wifi-connected3)
 * @see {@link https://clicons.dev/icon/wifi-connected3}
 */
const WifiConnected3Icon = React.forwardRef<SVGSVGElement, WifiConnected3IconProps>(
...
WifiConnected3Icon.displayName = 'WifiConnected3Icon';
