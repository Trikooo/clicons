...
interface Root2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Root2Icon = React.forwardRef<SVGSVGElement, Root2IconProps>(
  (
    {
      size,
      color,
...
Root2Icon.displayName = 'Root2Icon';
