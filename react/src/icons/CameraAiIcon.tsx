...
interface CameraAiIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const CameraAiIcon = React.forwardRef<SVGSVGElement, CameraAiIconProps>(
  (
    {
      size,
      color,
