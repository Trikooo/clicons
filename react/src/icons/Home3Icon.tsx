...
interface Home3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Home3Icon = React.forwardRef<SVGSVGElement, Home3IconProps>(
  (
    {
      size,
      color,
...
Home3Icon.displayName = 'Home3Icon';
