...
interface CursorHold01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/cursor-hold01)
 * @see {@link https://clicons.dev/icon/cursor-hold01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CursorHold01Icon = React.forwardRef<SVGSVGElement, CursorHold01IconProps>(
  (
    {
      size,
      color,
...
CursorHold01Icon.displayName = 'CursorHold01Icon';
