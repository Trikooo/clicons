...
interface HierarchySquare2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const HierarchySquare2Icon = React.forwardRef<SVGSVGElement, HierarchySquare2IconProps>(
  (
    {
      size,
      color,
...
HierarchySquare2Icon.displayName = 'HierarchySquare2Icon';
