...
interface NeuralNetworkIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const NeuralNetworkIcon = React.forwardRef<SVGSVGElement, NeuralNetworkIconProps>(
  (
    {
      size,
      color,
