...
interface AiSettingIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/ai-setting)
 * @see {@link https://clicons.dev/icon/ai-setting} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AiSettingIcon = React.forwardRef<SVGSVGElement, AiSettingIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M15.5 11.5C15.5 13.433 13.933 15 12 15C10.067 15 8.5 13.433 8.5 11.5C8.5 9.567 10.067 8 12 8C13.933 8 15.5 9.567 15.5 11.5Z", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
...
AiSettingIcon.displayName = 'AiSettingIcon';
