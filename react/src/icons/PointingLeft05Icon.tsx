...
interface PointingLeft05IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pointing-left05)
 * @see {@link https://clicons.dev/icon/pointing-left05} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PointingLeft05Icon = React.forwardRef<SVGSVGElement, PointingLeft05IconProps>(
  (
    {
      size,
      color,
...
PointingLeft05Icon.displayName = 'PointingLeft05Icon';
