...
interface ChampionIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const ChampionIcon = React.forwardRef<SVGSVGElement, ChampionIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M12 17C10.3264 17 8.86971 18.265 8.11766 20.1312C7.75846 21.0225 8.27389 22 8.95877 22H15.0412C15.7261 22 16.2415 21.0225 15.8823 20.1312C15.1303 18.265 13.6736 17 12 17Z", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
