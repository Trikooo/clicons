...
interface PaintBrush03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/paint-brush03)
 * @see {@link https://clicons.dev/icon/paint-brush03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PaintBrush03Icon = React.forwardRef<SVGSVGElement, PaintBrush03IconProps>(
  (
    {
      size,
      color,
...
PaintBrush03Icon.displayName = 'PaintBrush03Icon';
