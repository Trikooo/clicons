...
interface Leaf2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/leaf2}
 */
const Leaf2Icon = React.forwardRef<SVGSVGElement, Leaf2IconProps>(
...
Leaf2Icon.displayName = 'Leaf2Icon';
