...
interface RestoreBinIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const RestoreBinIcon = React.forwardRef<SVGSVGElement, RestoreBinIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M19.75 5.5L19.25 11.5M4.75 5.5L5.35461 15.5368C5.50945 18.1073 5.58688 19.3925 6.22868 20.3167C6.546 20.7737 6.9548 21.1594 7.42905 21.4493C8.01127 21.8051 8.71343 21.945 9.75 22", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
...
RestoreBinIcon.displayName = 'RestoreBinIcon';
