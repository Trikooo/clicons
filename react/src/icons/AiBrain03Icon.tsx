...
interface AiBrain03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/ai-brain03)
 * @see {@link https://clicons.dev/icon/ai-brain03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AiBrain03Icon = React.forwardRef<SVGSVGElement, AiBrain03IconProps>(
  (
    {
      size,
      color,
...
AiBrain03Icon.displayName = 'AiBrain03Icon';
