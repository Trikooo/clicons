...
const Saturn02Icon = React.forwardRef<SVGSVGElement, Saturn02IconProps>(
  (
    ...
    const iconData = [["path", { d: "M22 8.5C22 9.88071 20.8807 11 19.5 11C18.1193 11 17 9.88071 17 8.5C17 7.11929 18.1193 6 19.5 6C20.8807 6 22 7.11929 22 8.5Z", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
