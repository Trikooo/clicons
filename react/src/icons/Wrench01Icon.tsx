...
interface Wrench01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/wrench01)
 * @see {@link https://clicons.dev/icon/wrench01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Wrench01Icon = React.forwardRef<SVGSVGElement, Wrench01IconProps>(
  (
    {
      size,
      color,
