...
interface MailLock02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mail-lock02)
 * @see {@link https://clicons.dev/icon/mail-lock02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MailLock02Icon = React.forwardRef<SVGSVGElement, MailLock02IconProps>(
  (
    {
      size,
      color,
...
MailLock02Icon.displayName = 'MailLock02Icon';
