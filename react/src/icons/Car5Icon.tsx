...
interface Car5IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Car5Icon = React.forwardRef<SVGSVGElement, Car5IconProps>(
  (
    {
      size,
      color,
...
Car5Icon.displayName = 'Car5Icon';
export default Car5Icon;
