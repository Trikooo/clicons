...
interface MailAtSign2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name MailAtSign2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/mail-at-sign2)
 * @see {@link https://clicons.dev/icon/mail-at-sign2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MailAtSign2Icon = React.forwardRef<SVGSVGElement, MailAtSign2IconProps>(
  (
    {
      size,
      color,
...
MailAtSign2Icon.displayName = 'MailAtSign2Icon';
export default MailAtSign2Icon;
