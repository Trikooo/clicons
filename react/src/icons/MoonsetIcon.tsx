...
const MoonsetIcon = React.forwardRef<SVGSVGElement, MoonsetIconProps>(
  (
    ...
    const iconData = [["path", { d: "M17 6.5C17.4915 7.0057 18.7998 9 19.5 9M22 6.5C21.5085 7.0057 20.2002 9 19.5 9M19.5 9V3", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
