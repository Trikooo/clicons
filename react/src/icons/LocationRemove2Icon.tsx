...
interface LocationRemove2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name LocationRemove2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/location-remove2)
 * @see {@link https://clicons.dev/icon/location-remove2}
 */
const LocationRemove2Icon = React.forwardRef<SVGSVGElement, LocationRemove2IconProps>(
...
LocationRemove2Icon.displayName = 'LocationRemove2Icon';
