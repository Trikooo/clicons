...
interface SwipeRight9IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name SwipeRight9Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/swipe-right9)
 * @see {@link https://clicons.dev/icon/swipe-right9} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SwipeRight9Icon = React.forwardRef<SVGSVGElement, SwipeRight9IconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M22 4.5H15.5M22 4.5C22 3.79977 20.0057 2.49153 19.5 2M22 4.5C22 5.20023 20.0057 6.50847 19.5 7',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
SwipeRight9Icon.displayName = 'SwipeRight9Icon';
export default SwipeRight9Icon;
