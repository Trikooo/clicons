...
interface RotateLeft06IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/rotate-left06)
 * @see {@link https://clicons.dev/icon/rotate-left06} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const RotateLeft06Icon = React.forwardRef<SVGSVGElement, RotateLeft06IconProps>(
  (
    {
      size,
      color,
...
RotateLeft06Icon.displayName = 'RotateLeft06Icon';
