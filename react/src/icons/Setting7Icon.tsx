...
interface Setting7IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Setting7Icon = React.forwardRef<SVGSVGElement, Setting7IconProps>(
  (
    {
      size,
      color,
...
Setting7Icon.displayName = 'Setting7Icon';
export default Setting7Icon;
