...
interface ImageDownload02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/image-download02)
 * @see {@link https://clicons.dev/icon/image-download02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ImageDownload02Icon = React.forwardRef<SVGSVGElement, ImageDownload02IconProps>(
  (
    {
      size,
      color,
...
ImageDownload02Icon.displayName = 'ImageDownload02Icon';
