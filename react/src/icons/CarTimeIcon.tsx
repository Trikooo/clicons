...
interface CarTimeIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const CarTimeIcon = React.forwardRef<SVGSVGElement, CarTimeIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M17 4V6L18.5 6.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "4" }]];
...
CarTimeIcon.displayName = 'CarTimeIcon';
