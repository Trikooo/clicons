...
interface Books2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/books2)
 * @see {@link https://clicons.dev/icon/books2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Books2Icon = React.forwardRef<SVGSVGElement, Books2IconProps>(
  (
    {
      size,
      color,
...
Books2Icon.displayName = 'Books2Icon';
export default Books2Icon;
