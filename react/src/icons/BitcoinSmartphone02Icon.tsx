...
interface BitcoinSmartphone02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/bitcoin-smartphone02)
 * @see {@link https://clicons.dev/icon/bitcoin-smartphone02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BitcoinSmartphone02Icon = React.forwardRef<SVGSVGElement, BitcoinSmartphone02IconProps>(
  (
    {
      size,
      color,
...
BitcoinSmartphone02Icon.displayName = 'BitcoinSmartphone02Icon';
