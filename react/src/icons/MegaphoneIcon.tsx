...
interface MegaphoneIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/megaphone)
 * @see {@link https://clicons.dev/icon/megaphone} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MegaphoneIcon = React.forwardRef<SVGSVGElement, MegaphoneIconProps>(
  (
    {
      size,
      color,
