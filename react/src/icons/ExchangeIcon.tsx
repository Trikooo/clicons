...
interface ExchangeIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/exchange)
 * @see {@link https://clicons.dev/icon/exchange} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ExchangeIcon = React.forwardRef<SVGSVGElement, ExchangeIconProps>(
  (
    {
      size,
      color,
