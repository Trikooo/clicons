...
interface Share4IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Share4Icon = React.forwardRef<SVGSVGElement, Share4IconProps>(
  (
    {
      size,
      color,
...
Share4Icon.displayName = 'Share4Icon';
export default Share4Icon;
