...
interface SwipeUp03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/swipe-up03)
 * @see {@link https://clicons.dev/icon/swipe-up03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SwipeUp03Icon = React.forwardRef<SVGSVGElement, SwipeUp03IconProps>(
  (
    {
      size,
      color,
...
SwipeUp03Icon.displayName = 'SwipeUp03Icon';
