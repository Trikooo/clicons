 ...
 * @see {@link https://clicons.dev/icon/biomass-energy} - Icon preview
...
const BiomassEnergyIcon = React.forwardRef<SVGSVGElement, BiomassEnergyIconProps>(
  (
    ...
    const iconData = [["path", { d: "M20 14.4986C20 18.6415 16.4183 22 12 22C7.58172 22 4 18.6415 4 14.4986L4 14.2794C4 13.5451 4 13.178 4.25365 13.0433C4.80339 12.7515 6 14 6 14", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
