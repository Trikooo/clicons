...
const FloppyDiskIcon = React.forwardRef<SVGSVGElement, FloppyDiskIconProps>(
  (
    ...
    const iconData = [["path", { d: "M8 22V19C8 17.1144 8 16.1716 8.58579 15.5858C9.17157 15 10.1144 15 12 15C13.8856 15 14.8284 15 15.4142 15.5858C16 16.1716 16 17.1144 16 19V22", stroke: "currentColor", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
