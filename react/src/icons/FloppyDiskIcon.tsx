...
interface FloppyDiskIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/floppy-disk)
 * @see {@link https://clicons.dev/icon/floppy-disk} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FloppyDiskIcon = React.forwardRef<SVGSVGElement, FloppyDiskIconProps>(
  (
    {
      size,
      color,
