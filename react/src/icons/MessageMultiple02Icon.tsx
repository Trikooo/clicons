...
interface MessageMultiple02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/message-multiple02)
 * @see {@link https://clicons.dev/icon/message-multiple02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MessageMultiple02Icon = React.forwardRef<SVGSVGElement, MessageMultiple02IconProps>(
  (
    {
      size,
      color,
...
MessageMultiple02Icon.displayName = 'MessageMultiple02Icon';
