...
interface CursorIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/cursor)
 * @see {@link https://clicons.dev/icon/cursor} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CursorIcon = React.forwardRef<SVGSVGElement, CursorIconProps>(
  (
    {
      size,
      color,
