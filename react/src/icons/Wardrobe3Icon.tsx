...
interface Wardrobe3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/wardrobe3}
 */
const Wardrobe3Icon = React.forwardRef<SVGSVGElement, Wardrobe3IconProps>(
...
Wardrobe3Icon.displayName = 'Wardrobe3Icon';
export default Wardrobe3Icon;
