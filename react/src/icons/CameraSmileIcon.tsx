...
interface CameraSmileIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const CameraSmileIcon = React.forwardRef<SVGSVGElement, CameraSmileIconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M8.50024 14.5C9.29835 15.7144 10.569 16.5 12.0002 16.5C13.4315 16.5 14.7021 15.7144 15.5002 14.5',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
CameraSmileIcon.displayName = 'CameraSmileIcon';
export default CameraSmileIcon;
