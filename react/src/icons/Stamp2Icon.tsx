...
interface Stamp2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Stamp2Icon = React.forwardRef<SVGSVGElement, Stamp2IconProps>(
  (
    {
      size,
      color,
...
Stamp2Icon.displayName = 'Stamp2Icon';
export default Stamp2Icon;
