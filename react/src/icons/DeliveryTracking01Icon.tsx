...
interface DeliveryTracking01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/delivery-tracking01)
 * @see {@link https://clicons.dev/icon/delivery-tracking01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const DeliveryTracking01Icon = React.forwardRef<SVGSVGElement, DeliveryTracking01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M2.5 7.5V13.5C2.5 17.2712 2.5 19.1569 3.67157 20.3284C4.84315 21.5 6.72876 21.5 10.5 21.5H14M21.5 11V7.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
