...
interface AiBrain3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/ai-brain3}
 */
const AiBrain3Icon = React.forwardRef<SVGSVGElement, AiBrain3IconProps>(
...
AiBrain3Icon.displayName = 'AiBrain3Icon';
