...
interface Flag02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/flag02)
 * @see {@link https://clicons.dev/icon/flag02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Flag02Icon = React.forwardRef<SVGSVGElement, Flag02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M4 7L4 21", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
