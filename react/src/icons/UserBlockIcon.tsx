...
interface UserBlockIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const UserBlockIcon = React.forwardRef<SVGSVGElement, UserBlockIconProps>(
  (
    {
      size,
      color,
...
UserBlockIcon.displayName = 'UserBlockIcon';
