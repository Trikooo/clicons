...
interface SwipeLeft3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/swipe-left3)
 * @see {@link https://clicons.dev/icon/swipe-left3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SwipeLeft3Icon = React.forwardRef<SVGSVGElement, SwipeLeft3IconProps>(
  (
    {
      size,
      color,
...
SwipeLeft3Icon.displayName = 'SwipeLeft3Icon';
export default SwipeLeft3Icon;
