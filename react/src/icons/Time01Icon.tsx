...
interface Time01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/time01)
 * @see {@link https://clicons.dev/icon/time01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Time01Icon = React.forwardRef<SVGSVGElement, Time01IconProps>(
  (
    {
      size,
      color,
