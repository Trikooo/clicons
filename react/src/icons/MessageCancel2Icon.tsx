...
interface MessageCancel2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name MessageCancel2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/message-cancel2)
 * @see {@link https://clicons.dev/icon/message-cancel2}
 */
const MessageCancel2Icon = React.forwardRef<SVGSVGElement, MessageCancel2IconProps>(
...
MessageCancel2Icon.displayName = 'MessageCancel2Icon';
