...
interface CalendarSetting01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/calendar-setting01)
 * @see {@link https://clicons.dev/icon/calendar-setting01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CalendarSetting01Icon = React.forwardRef<SVGSVGElement, CalendarSetting01IconProps>(
  (
    {
      size,
      color,
...
CalendarSetting01Icon.displayName = 'CalendarSetting01Icon';
