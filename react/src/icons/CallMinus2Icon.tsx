...
interface CallMinus2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/call-minus2}
 */
const CallMinus2Icon = React.forwardRef<SVGSVGElement, CallMinus2IconProps>(
...
CallMinus2Icon.displayName = 'CallMinus2Icon';
