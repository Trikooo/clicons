...
interface Clapping02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/clapping02)
 * @see {@link https://clicons.dev/icon/clapping02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Clapping02Icon = React.forwardRef<SVGSVGElement, Clapping02IconProps>(
  (
    {
      size,
      color,
...
Clapping02Icon.displayName = 'Clapping02Icon';
