...
interface Airpod03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/airpod03)
 * @see {@link https://clicons.dev/icon/airpod03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Airpod03Icon = React.forwardRef<SVGSVGElement, Airpod03IconProps>(
  (
    {
      size,
      color,
...
Airpod03Icon.displayName = 'Airpod03Icon';
