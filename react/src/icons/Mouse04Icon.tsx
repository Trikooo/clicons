...
interface Mouse04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mouse04)
 * @see {@link https://clicons.dev/icon/mouse04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Mouse04Icon = React.forwardRef<SVGSVGElement, Mouse04IconProps>(
  (
    {
      size,
      color,
...
Mouse04Icon.displayName = 'Mouse04Icon';
