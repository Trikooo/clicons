...
interface GoogleSheetIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/google-sheet)
 * @see {@link https://clicons.dev/icon/google-sheet} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const GoogleSheetIcon = React.forwardRef<SVGSVGElement, GoogleSheetIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M15 2.5V4C15 5.41421 15 6.12132 15.4393 6.56066C15.8787 7 16.5858 7 18 7H19.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
