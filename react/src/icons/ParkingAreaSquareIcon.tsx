...
interface ParkingAreaSquareIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/parking-area-square)
 * @see {@link https://clicons.dev/icon/parking-area-square} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ParkingAreaSquareIcon = React.forwardRef<SVGSVGElement, ParkingAreaSquareIconProps>(
  (
    {
      size,
      color,
...
ParkingAreaSquareIcon.displayName = 'ParkingAreaSquareIcon';
