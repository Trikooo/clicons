...
interface ResourcesRemoveIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const ResourcesRemoveIcon = React.forwardRef<SVGSVGElement, ResourcesRemoveIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M22 6L14 6", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "3" }]];
...
ResourcesRemoveIcon.displayName = 'ResourcesRemoveIcon';
