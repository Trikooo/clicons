...
interface CottonCandyIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/cotton-candy)
 * @see {@link https://clicons.dev/icon/cotton-candy} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CottonCandyIcon = React.forwardRef<SVGSVGElement, CottonCandyIconProps>(
  (
    {
      size,
      color,
...
CottonCandyIcon.displayName = 'CottonCandyIcon';
