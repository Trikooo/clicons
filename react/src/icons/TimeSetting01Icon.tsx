...
interface TimeSetting01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/time-setting01)
 * @see {@link https://clicons.dev/icon/time-setting01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TimeSetting01Icon = React.forwardRef<SVGSVGElement, TimeSetting01IconProps>(
  (
    {
      size,
      color,
...
TimeSetting01Icon.displayName = 'TimeSetting01Icon';
export default TimeSetting01Icon;
