...
interface ShippingTruckIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const ShippingTruckIcon = React.forwardRef<SVGSVGElement, ShippingTruckIconProps>(
  (
    {
      size,
      color,
