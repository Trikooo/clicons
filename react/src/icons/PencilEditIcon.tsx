...
interface PencilEditIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/pencil-edit}
 */
const PencilEditIcon = React.forwardRef<SVGSVGElement, PencilEditIconProps>(
...
PencilEditIcon.displayName = 'PencilEditIcon';
