...
interface InstallingUpdates01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/installing-updates01)
 * @see {@link https://clicons.dev/icon/installing-updates01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const InstallingUpdates01Icon = React.forwardRef<SVGSVGElement, InstallingUpdates01IconProps>(
  (
    {
      size,
      color,
...
InstallingUpdates01Icon.displayName = 'InstallingUpdates01Icon';
export default InstallingUpdates01Icon;
