...
interface MailReceive2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MailReceive2Icon = React.forwardRef<SVGSVGElement, MailReceive2IconProps>(
  (
    {
      size,
      color,
...
MailReceive2Icon.displayName = 'MailReceive2Icon';
export default MailReceive2Icon;
