...
interface Medal01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/medal01)
 * @see {@link https://clicons.dev/icon/medal01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Medal01Icon = React.forwardRef<SVGSVGElement, Medal01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M8.5 2V10.5M15.5 2V10.5", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
...
Medal01Icon.displayName = 'Medal01Icon';
