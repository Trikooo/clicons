...
interface Typescript3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name Typescript3Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/typescript3)
 * @see {@link https://clicons.dev/icon/typescript3}
 */
const Typescript3Icon = React.forwardRef<SVGSVGElement, Typescript3IconProps>(
...
Typescript3Icon.displayName = 'Typescript3Icon';
