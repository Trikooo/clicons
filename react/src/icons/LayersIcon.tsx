...
interface LayersIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/layers)
 * @see {@link https://clicons.dev/icon/layers} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const LayersIcon = React.forwardRef<SVGSVGElement, LayersIconProps>(
  (
    {
      size,
      color,
