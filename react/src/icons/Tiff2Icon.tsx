...
interface Tiff2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/tiff2)
 * @see {@link https://clicons.dev/icon/tiff2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Tiff2Icon = React.forwardRef<SVGSVGElement, Tiff2IconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M6.5 14H8M8 14H9.5M8 14V19M21 14H19V16.5M19 16.5V19M19 16.5H21M16.5 14H14.5V16.5M14.5 16.5V19M14.5 16.5H16.5M12 14V19',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
Tiff2Icon.displayName = 'Tiff2Icon';
export default Tiff2Icon;
