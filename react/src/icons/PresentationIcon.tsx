...
interface PresentationIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/presentation)
 * @see {@link https://clicons.dev/icon/presentation} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PresentationIcon = React.forwardRef<SVGSVGElement, PresentationIconProps>(
  (
    {
      size,
      color,
