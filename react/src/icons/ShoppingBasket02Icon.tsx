...
interface ShoppingBasket02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/shopping-basket02)
 * @see {@link https://clicons.dev/icon/shopping-basket02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ShoppingBasket02Icon = React.forwardRef<SVGSVGElement, ShoppingBasket02IconProps>(
  (
    {
      size,
      color,
...
ShoppingBasket02Icon.displayName = 'ShoppingBasket02Icon';
