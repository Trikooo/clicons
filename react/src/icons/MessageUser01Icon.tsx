...
interface MessageUser01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/message-user01)
 * @see {@link https://clicons.dev/icon/message-user01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MessageUser01Icon = React.forwardRef<SVGSVGElement, MessageUser01IconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M8.5 15H15.5M8.5 10H10.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "3" }]];
...
MessageUser01Icon.displayName = 'MessageUser01Icon';
export default MessageUser01Icon;
