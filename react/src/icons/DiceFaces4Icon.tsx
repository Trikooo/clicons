...
interface DiceFaces4IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/dice-faces4}
 */
const DiceFaces4Icon = React.forwardRef<SVGSVGElement, DiceFaces4IconProps>(
...
DiceFaces4Icon.displayName = 'DiceFaces4Icon';
