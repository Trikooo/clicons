...
interface Bitcoin3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/bitcoin3)
 * @see {@link https://clicons.dev/icon/bitcoin3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Bitcoin3Icon = React.forwardRef<SVGSVGElement, Bitcoin3IconProps>(
  (
    {
      size,
      color,
...
Bitcoin3Icon.displayName = 'Bitcoin3Icon';
export default Bitcoin3Icon;
