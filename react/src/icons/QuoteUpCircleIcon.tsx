...
interface QuoteUpCircleIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/quote-up-circle)
 * @see {@link https://clicons.dev/icon/quote-up-circle} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const QuoteUpCircleIcon = React.forwardRef<SVGSVGElement, QuoteUpCircleIconProps>(
  (
    {
      size,
      color,
