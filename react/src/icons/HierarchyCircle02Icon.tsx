...
interface HierarchyCircle02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/hierarchy-circle02)
 * @see {@link https://clicons.dev/icon/hierarchy-circle02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const HierarchyCircle02Icon = React.forwardRef<SVGSVGElement, HierarchyCircle02IconProps>(
  (
    {
      size,
      color,
...
HierarchyCircle02Icon.displayName = 'HierarchyCircle02Icon';
