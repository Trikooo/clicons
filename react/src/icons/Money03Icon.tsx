...
interface Money03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/money03)
 * @see {@link https://clicons.dev/icon/money03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Money03Icon = React.forwardRef<SVGSVGElement, Money03IconProps>(
  (
    {
      size,
      color,
...
Money03Icon.displayName = 'Money03Icon';
export default Money03Icon;
