...
interface Edit4IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Edit4Icon = React.forwardRef<SVGSVGElement, Edit4IconProps>(
  (
    {
      size,
      color,
...
Edit4Icon.displayName = 'Edit4Icon';
export default Edit4Icon;
