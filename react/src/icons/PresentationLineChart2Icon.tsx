...
interface PresentationLineChart2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name PresentationLineChart2Icon
 ...
 */
const PresentationLineChart2Icon = React.forwardRef<SVGSVGElement, PresentationLineChart2IconProps>(
  (
    {
      size,
      color,
...
PresentationLineChart2Icon.displayName = 'PresentationLineChart2Icon';
export default PresentationLineChart2Icon;
