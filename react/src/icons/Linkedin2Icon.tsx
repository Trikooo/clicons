...
interface Linkedin2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Linkedin2Icon = React.forwardRef<SVGSVGElement, Linkedin2IconProps>(
  (
    {
      size,
      color,
...
Linkedin2Icon.displayName = 'Linkedin2Icon';
