...
interface KeyframeAlignHorizontalIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const KeyframeAlignHorizontalIcon = React.forwardRef<SVGSVGElement, KeyframeAlignHorizontalIconProps>(
  (
    {
      size,
      color,
