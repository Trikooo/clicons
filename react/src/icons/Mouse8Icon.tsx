...
interface Mouse8IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/mouse8}
 */
const Mouse8Icon = React.forwardRef<SVGSVGElement, Mouse8IconProps>(
...
Mouse8Icon.displayName = 'Mouse8Icon';
