...
interface AirplaneTakeOff01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/airplane-take-off01)
 * @see {@link https://clicons.dev/icon/airplane-take-off01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AirplaneTakeOff01Icon = React.forwardRef<SVGSVGElement, AirplaneTakeOff01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M2.00031 20H18.0003", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
