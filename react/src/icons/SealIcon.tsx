...
interface SealIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/seal}
 */
const SealIcon = React.forwardRef<SVGSVGElement, SealIconProps>(
