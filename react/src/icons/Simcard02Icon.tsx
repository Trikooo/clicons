...
interface Simcard02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/simcard02)
 * @see {@link https://clicons.dev/icon/simcard02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Simcard02Icon = React.forwardRef<SVGSVGElement, Simcard02IconProps>(
  (
    {
      size,
      color,
...
Simcard02Icon.displayName = 'Simcard02Icon';
