...
interface Invoice03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/invoice03)
 * @see {@link https://clicons.dev/icon/invoice03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Invoice03Icon = React.forwardRef<SVGSVGElement, Invoice03IconProps>(
  (
    {
      size,
      color,
...
Invoice03Icon.displayName = 'Invoice03Icon';
export default Invoice03Icon;
