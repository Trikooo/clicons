...
interface Minimize03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/minimize03)
 * @see {@link https://clicons.dev/icon/minimize03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Minimize03Icon = React.forwardRef<SVGSVGElement, Minimize03IconProps>(
  (
    {
      size,
      color,
...
Minimize03Icon.displayName = 'Minimize03Icon';
