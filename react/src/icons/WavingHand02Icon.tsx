...
interface WavingHand02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/waving-hand02)
 * @see {@link https://clicons.dev/icon/waving-hand02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const WavingHand02Icon = React.forwardRef<SVGSVGElement, WavingHand02IconProps>(
  (
    {
      size,
      color,
...
WavingHand02Icon.displayName = 'WavingHand02Icon';
