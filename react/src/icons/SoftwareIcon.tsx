...
const SoftwareIcon = React.forwardRef<SVGSVGElement, SoftwareIconProps>(
  (
    ...
    const iconData = [["path", { d: "M10 10C10 11.1046 10.8954 12 12 12C13.1046 12 14 11.1046 14 10C14 8.89543 13.1046 8 12 8C10.8954 8 10 8.89543 10 10Z", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
