...
interface LegalDocumentIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name LegalDocumentIcon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/legal-document)
 * @see {@link https://clicons.dev/icon/legal-document}
 */
const LegalDocumentIcon = React.forwardRef<SVGSVGElement, LegalDocumentIconProps>(
...
LegalDocumentIcon.displayName = 'LegalDocumentIcon';
