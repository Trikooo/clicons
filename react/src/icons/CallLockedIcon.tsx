...
interface CallLockedIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/call-locked}
 */
const CallLockedIcon = React.forwardRef<SVGSVGElement, CallLockedIconProps>(
  ...
  [
    'path',
    {
      d: 'M14.5 6.5V5C14.5 3.89543 15.3954 3 16.5 3C17.6046 3 18.5 3.89543 18.5 5V6.5'
    }
  ],
  [
    'path',
...
CallLockedIcon.displayName = 'CallLockedIcon';
