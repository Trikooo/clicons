...
interface Folder02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/folder02)
 * @see {@link https://clicons.dev/icon/folder02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Folder02Icon = React.forwardRef<SVGSVGElement, Folder02IconProps>(
  (
    {
      size,
      color,
...
Folder02Icon.displayName = 'Folder02Icon';
