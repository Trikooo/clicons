...
interface Cursor01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/cursor01)
 * @see {@link https://clicons.dev/icon/cursor01} - Icon preview
