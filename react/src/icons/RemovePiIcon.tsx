 ...
 * @see {@link https://clicons.dev/icon/remove-pi}
 */
const RemovePiIcon = React.forwardRef<SVGSVGElement, RemovePiIconProps>(
  ...
  [
    'path',
    {
      d: 'M18.3333 17.5H15.6667M21 17.5C21 19.7091 19.2091 21.5 17 21.5C14.7909 21.5 13 19.7091 13 17.5C13 15.2909 14.7909 13.5 17 13.5C19.2091 13.5 21 15.2909 21 17.5Z'
    }
  ]
];
