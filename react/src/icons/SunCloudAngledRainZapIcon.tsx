...
interface SunCloudAngledRainZapIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name SunCloudAngledRainZapIcon
 ...
 */
const SunCloudAngledRainZapIcon = React.forwardRef<SVGSVGElement, SunCloudAngledRainZapIconProps>(
  (
    {
      size,
      color,
...
SunCloudAngledRainZapIcon.displayName = 'SunCloudAngledRainZapIcon';
export default SunCloudAngledRainZapIcon;
