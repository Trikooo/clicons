...
interface CodeSquareIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/code-square)
 * @see {@link https://clicons.dev/icon/code-square} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CodeSquareIcon = React.forwardRef<SVGSVGElement, CodeSquareIconProps>(
  (
    {
      size,
      color,
