...
interface Recycle01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/recycle01)
 * @see {@link https://clicons.dev/icon/recycle01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Recycle01Icon = React.forwardRef<SVGSVGElement, Recycle01IconProps>(
  (
    {
      size,
      color,
...
Recycle01Icon.displayName = 'Recycle01Icon';
