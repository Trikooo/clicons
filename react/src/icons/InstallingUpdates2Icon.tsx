...
interface InstallingUpdates2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const InstallingUpdates2Icon = React.forwardRef<SVGSVGElement, InstallingUpdates2IconProps>(
  (
    {
      size,
      color,
...
InstallingUpdates2Icon.displayName = 'InstallingUpdates2Icon';
export default InstallingUpdates2Icon;
