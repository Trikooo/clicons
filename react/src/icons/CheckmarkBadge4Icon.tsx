...
interface CheckmarkBadge4IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name CheckmarkBadge4Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/checkmark-badge4)
 * @see {@link https://clicons.dev/icon/checkmark-badge4} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CheckmarkBadge4Icon = React.forwardRef<SVGSVGElement, CheckmarkBadge4IconProps>(
  (
    {
      size,
      color,
...
CheckmarkBadge4Icon.displayName = 'CheckmarkBadge4Icon';
export default CheckmarkBadge4Icon;
