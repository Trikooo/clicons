...
interface MailReplyAllIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MailReplyAllIcon = React.forwardRef<SVGSVGElement, MailReplyAllIconProps>(
  (
    {
      size,
      color,
...
MailReplyAllIcon.displayName = 'MailReplyAllIcon';
