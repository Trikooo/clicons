...
interface CameraAutomatically01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/camera-automatically01)
 * @see {@link https://clicons.dev/icon/camera-automatically01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CameraAutomatically01Icon = React.forwardRef<SVGSVGElement, CameraAutomatically01IconProps>(
  (
    {
      size,
      color,
...
CameraAutomatically01Icon.displayName = 'CameraAutomatically01Icon';
export default CameraAutomatically01Icon;
