...
interface Activity01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/activity01)
 * @see {@link https://clicons.dev/icon/activity01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Activity01Icon = React.forwardRef<SVGSVGElement, Activity01IconProps>(
  (
    {
      size,
      color,
...
Activity01Icon.displayName = 'Activity01Icon';
export default Activity01Icon;
