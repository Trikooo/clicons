...
interface MessageUser2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MessageUser2Icon = React.forwardRef<SVGSVGElement, MessageUser2IconProps>(
  (
    {
      size,
      color,
...
MessageUser2Icon.displayName = 'MessageUser2Icon';
export default MessageUser2Icon;
