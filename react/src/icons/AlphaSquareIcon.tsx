...
interface AlphaSquareIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/alpha-square)
 * @see {@link https://clicons.dev/icon/alpha-square} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AlphaSquareIcon = React.forwardRef<SVGSVGElement, AlphaSquareIconProps>(
  (
    {
      size,
      color,
...
AlphaSquareIcon.displayName = 'AlphaSquareIcon';
