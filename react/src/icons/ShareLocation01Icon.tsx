...
interface ShareLocation01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/share-location01)
 * @see {@link https://clicons.dev/icon/share-location01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ShareLocation01Icon = React.forwardRef<SVGSVGElement, ShareLocation01IconProps>(
  (
    {
      size,
      color,
...
ShareLocation01Icon.displayName = 'ShareLocation01Icon';
