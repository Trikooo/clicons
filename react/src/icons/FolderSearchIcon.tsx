...
interface FolderSearchIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/folder-search)
 * @see {@link https://clicons.dev/icon/folder-search} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FolderSearchIcon = React.forwardRef<SVGSVGElement, FolderSearchIconProps>(
  (
    {
      size,
      color,
