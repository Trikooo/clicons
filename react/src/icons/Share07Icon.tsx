...
interface Share07IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/share07)
 * @see {@link https://clicons.dev/icon/share07} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Share07Icon = React.forwardRef<SVGSVGElement, Share07IconProps>(
  (
    {
      size,
      color,
