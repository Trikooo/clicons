...
interface MessageLock02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/message-lock02)
 * @see {@link https://clicons.dev/icon/message-lock02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MessageLock02Icon = React.forwardRef<SVGSVGElement, MessageLock02IconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M11.9953 12.5H12.0043M7.99982 12.5H8.00879", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", key: "2" }]];
...
MessageLock02Icon.displayName = 'MessageLock02Icon';
export default MessageLock02Icon;
