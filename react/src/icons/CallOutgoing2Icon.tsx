...
interface CallOutgoing2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name CallOutgoing2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/call-outgoing2)
 * @see {@link https://clicons.dev/icon/call-outgoing2}
 */
const CallOutgoing2Icon = React.forwardRef<SVGSVGElement, CallOutgoing2IconProps>(
...
CallOutgoing2Icon.displayName = 'CallOutgoing2Icon';
