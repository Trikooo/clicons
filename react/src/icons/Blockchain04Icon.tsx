...
interface Blockchain04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/blockchain04)
 * @see {@link https://clicons.dev/icon/blockchain04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Blockchain04Icon = React.forwardRef<SVGSVGElement, Blockchain04IconProps>(
  (
    {
      size,
      color,
...
Blockchain04Icon.displayName = 'Blockchain04Icon';
