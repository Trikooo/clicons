...
interface Clock2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/clock2}
 */
const Clock2Icon = React.forwardRef<SVGSVGElement, Clock2IconProps>(
