...
interface Scooter01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/scooter01)
 * @see {@link https://clicons.dev/icon/scooter01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Scooter01Icon = React.forwardRef<SVGSVGElement, Scooter01IconProps>(
  (
    {
      size,
      color,
...
Scooter01Icon.displayName = 'Scooter01Icon';
