...
interface MaskTheater01IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name MaskTheater01Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/mask-theater01)
 * @see {@link https://clicons.dev/icon/mask-theater01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MaskTheater01Icon = React.forwardRef<SVGSVGElement, MaskTheater01IconProps>(
  (
    {
      size,
      color,
...
MaskTheater01Icon.displayName = 'MaskTheater01Icon';
export default MaskTheater01Icon;
