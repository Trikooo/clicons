...
interface SwipeDown3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/swipe-down3)
 * @see {@link https://clicons.dev/icon/swipe-down3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SwipeDown3Icon = React.forwardRef<SVGSVGElement, SwipeDown3IconProps>(
  (
    {
      size,
      color,
...
SwipeDown3Icon.displayName = 'SwipeDown3Icon';
export default SwipeDown3Icon;
