...
interface Dress05IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/dress05)
 * @see {@link https://clicons.dev/icon/dress05} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Dress05Icon = React.forwardRef<SVGSVGElement, Dress05IconProps>(
  (
    {
      size,
      color,
...
Dress05Icon.displayName = 'Dress05Icon';
