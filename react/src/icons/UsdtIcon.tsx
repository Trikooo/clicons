...
interface UsdtIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/usdt}
 */
const UsdtIcon = React.forwardRef<SVGSVGElement, UsdtIconProps>(
