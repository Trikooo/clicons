...
interface CriteoLogoIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
}
 ...
 * @preview ![img](https://clicons.dev/icon/criteo-logo)
 * @see {@link https://clicons.dev/icon/criteo-logo}
 */
const CriteoLogoIcon = React.forwardRef<SVGSVGElement, CriteoLogoIconProps>(
...
CriteoLogoIcon.displayName = 'CriteoLogoIcon';
export default CriteoLogoIcon;
