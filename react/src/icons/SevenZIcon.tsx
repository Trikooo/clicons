...
interface SevenZIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/seven-z)
 * @see {@link https://clicons.dev/icon/seven-z} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SevenZIcon = React.forwardRef<SVGSVGElement, SevenZIconProps>(
  (
    {
      size,
      color,
...
SevenZIcon.displayName = 'SevenZIcon';
