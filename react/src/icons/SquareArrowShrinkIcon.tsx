...
interface SquareArrowShrinkIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name SquareArrowShrinkIcon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/square-arrow-shrink)
 * @see {@link https://clicons.dev/icon/square-arrow-shrink}
 */
const SquareArrowShrinkIcon = React.forwardRef<SVGSVGElement, SquareArrowShrinkIconProps>(
...
SquareArrowShrinkIcon.displayName = 'SquareArrowShrinkIcon';
