...
interface LowSignalIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/low-signal)
 * @see {@link https://clicons.dev/icon/low-signal} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const LowSignalIcon = React.forwardRef<SVGSVGElement, LowSignalIconProps>(
  (
    {
      size,
      color,
...
LowSignalIcon.displayName = 'LowSignalIcon';
