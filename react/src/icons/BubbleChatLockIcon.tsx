...
interface BubbleChatLockIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/bubble-chat-lock}
 */
const BubbleChatLockIcon = React.forwardRef<SVGSVGElement, BubbleChatLockIconProps>(
  ...
  [
    'path',
    {
      d: 'M10 11V9.5C10 8.39543 10.8954 7.5 12 7.5C13.1046 7.5 14 8.39543 14 9.5V11'
    }
  ],
  [
    'path',
...
BubbleChatLockIcon.displayName = 'BubbleChatLockIcon';
