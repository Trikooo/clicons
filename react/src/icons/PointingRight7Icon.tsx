...
interface PointingRight7IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name PointingRight7Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/pointing-right7)
 * @see {@link https://clicons.dev/icon/pointing-right7}
 */
const PointingRight7Icon = React.forwardRef<SVGSVGElement, PointingRight7IconProps>(
...
PointingRight7Icon.displayName = 'PointingRight7Icon';
