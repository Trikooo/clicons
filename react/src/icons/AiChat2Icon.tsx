...
interface AiChat2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const AiChat2Icon = React.forwardRef<SVGSVGElement, AiChat2IconProps>(
  (
    {
      size,
      color,
