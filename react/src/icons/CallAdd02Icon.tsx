...
interface CallAdd02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-add02)
 * @see {@link https://clicons.dev/icon/call-add02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallAdd02Icon = React.forwardRef<SVGSVGElement, CallAdd02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M17.5 3V10M21 6.5H14", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
CallAdd02Icon.displayName = 'CallAdd02Icon';
export default CallAdd02Icon;
