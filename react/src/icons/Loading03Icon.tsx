...
interface Loading03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/loading03)
 * @see {@link https://clicons.dev/icon/loading03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Loading03Icon = React.forwardRef<SVGSVGElement, Loading03IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M12 3V6", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
