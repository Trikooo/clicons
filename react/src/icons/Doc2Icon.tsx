...
interface Doc2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/doc2)
 * @see {@link https://clicons.dev/icon/doc2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Doc2Icon = React.forwardRef<SVGSVGElement, Doc2IconProps>(
  (
    {
      size,
      color,
...
Doc2Icon.displayName = 'Doc2Icon';
export default Doc2Icon;
