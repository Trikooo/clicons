...
interface SunCloudAngledRainZap02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/sun-cloud-angled-rain-zap02)
 * @see {@link https://clicons.dev/icon/sun-cloud-angled-rain-zap02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SunCloudAngledRainZap02Icon = React.forwardRef<SVGSVGElement, SunCloudAngledRainZap02IconProps>(
  (
    {
      size,
      color,
...
SunCloudAngledRainZap02Icon.displayName = 'SunCloudAngledRainZap02Icon';
