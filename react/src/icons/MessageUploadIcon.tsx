...
interface MessageUploadIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MessageUploadIcon = React.forwardRef<SVGSVGElement, MessageUploadIconProps>(
  (
    {
      size,
      color,
...
MessageUploadIcon.displayName = 'MessageUploadIcon';
export default MessageUploadIcon;
