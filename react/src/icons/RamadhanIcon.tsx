...
interface RamadhanIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/ramadhan)
 * @see {@link https://clicons.dev/icon/ramadhan} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const RamadhanIcon = React.forwardRef<SVGSVGElement, RamadhanIconProps>(
  (
    {
      size,
      color,
...
RamadhanIcon.displayName = 'RamadhanIcon';
export default RamadhanIcon;
