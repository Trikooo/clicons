...
interface DialpadSquare2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name DialpadSquare2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/dialpad-square2)
 * @see {@link https://clicons.dev/icon/dialpad-square2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const DialpadSquare2Icon = React.forwardRef<SVGSVGElement, DialpadSquare2IconProps>(
  (
    {
      size,
      color,
...
DialpadSquare2Icon.displayName = 'DialpadSquare2Icon';
export default DialpadSquare2Icon;
