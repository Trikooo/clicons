...
interface Call02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call02)
 * @see {@link https://clicons.dev/icon/call02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Call02Icon = React.forwardRef<SVGSVGElement, Call02IconProps>(
  (
    {
      size,
      color,
