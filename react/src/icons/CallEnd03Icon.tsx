...
interface CallEnd03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-end03)
 * @see {@link https://clicons.dev/icon/call-end03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallEnd03Icon = React.forwardRef<SVGSVGElement, CallEnd03IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M21 9L15 3M21 3L15 9", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
CallEnd03Icon.displayName = 'CallEnd03Icon';
export default CallEnd03Icon;
