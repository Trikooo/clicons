...
interface FilePinIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/file-pin)
 * @see {@link https://clicons.dev/icon/file-pin} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FilePinIcon = React.forwardRef<SVGSVGElement, FilePinIconProps>(
  (
    {
      size,
      color,
...
FilePinIcon.displayName = 'FilePinIcon';
