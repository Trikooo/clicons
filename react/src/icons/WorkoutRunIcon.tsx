...
const WorkoutRunIcon = React.forwardRef<SVGSVGElement, WorkoutRunIconProps>(
  (
    ...
    const iconData = [["path", { d: "M17 4.5C17 5.32843 16.3284 6 15.5 6C14.6716 6 14 5.32843 14 4.5C14 3.67157 14.6716 3 15.5 3C16.3284 3 17 3.67157 17 4.5Z", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
