...
interface ArrowUpRight2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name ArrowUpRight2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/arrow-up-right2)
 * @see {@link https://clicons.dev/icon/arrow-up-right2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ArrowUpRight2Icon = React.forwardRef<SVGSVGElement, ArrowUpRight2IconProps>(
  (
    {
      size,
      color,
...
ArrowUpRight2Icon.displayName = 'ArrowUpRight2Icon';
