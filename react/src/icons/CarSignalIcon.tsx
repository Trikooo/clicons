...
interface CarSignalIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const CarSignalIcon = React.forwardRef<SVGSVGElement, CarSignalIconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M2 11L4 12.5L5.76114 12.9403C5.91978 12.9799 6.08269 13 6.24621 13H16.7538C16.9173 13 17.0802 12.9799 17.2389 12.9403L19 12.5L21 11',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
CarSignalIcon.displayName = 'CarSignalIcon';
export default CarSignalIcon;
