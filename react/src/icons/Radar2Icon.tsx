...
interface Radar2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/radar2}
 */
const Radar2Icon = React.forwardRef<SVGSVGElement, Radar2IconProps>(
