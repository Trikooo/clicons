...
interface Chart2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Chart2Icon = React.forwardRef<SVGSVGElement, Chart2IconProps>(
  (
    {
      size,
      color,
...
Chart2Icon.displayName = 'Chart2Icon';
