...
interface CallRinging02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-ringing02)
 * @see {@link https://clicons.dev/icon/call-ringing02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallRinging02Icon = React.forwardRef<SVGSVGElement, CallRinging02IconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M17.5 11.002L20 11M13 6.50195V4M17.9497 6.05025L16.181 7.819',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
CallRinging02Icon.displayName = 'CallRinging02Icon';
export default CallRinging02Icon;
