...
interface RemoveCircleHalfDotIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/remove-circle-half-dot}
 */
const RemoveCircleHalfDotIcon = React.forwardRef<SVGSVGElement, RemoveCircleHalfDotIconProps>(
...
RemoveCircleHalfDotIcon.displayName = 'RemoveCircleHalfDotIcon';
