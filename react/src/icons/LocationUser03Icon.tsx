...
interface LocationUser03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/location-user03)
 * @see {@link https://clicons.dev/icon/location-user03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const LocationUser03Icon = React.forwardRef<SVGSVGElement, LocationUser03IconProps>(
  (
    {
      size,
      color,
...
LocationUser03Icon.displayName = 'LocationUser03Icon';
