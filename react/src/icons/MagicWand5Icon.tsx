...
interface MagicWand5IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MagicWand5Icon = React.forwardRef<SVGSVGElement, MagicWand5IconProps>(
  (
    {
      size,
      color,
...
MagicWand5Icon.displayName = 'MagicWand5Icon';
export default MagicWand5Icon;
