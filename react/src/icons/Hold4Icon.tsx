...
interface Hold4IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/hold4)
 * @see {@link https://clicons.dev/icon/hold4} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Hold4Icon = React.forwardRef<SVGSVGElement, Hold4IconProps>(
  (
    {
      size,
      color,
...
Hold4Icon.displayName = 'Hold4Icon';
export default Hold4Icon;
