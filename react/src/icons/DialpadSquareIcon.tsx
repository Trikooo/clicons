...
interface DialpadSquareIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name DialpadSquareIcon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/dialpad-square)
 * @see {@link https://clicons.dev/icon/dialpad-square}
 */
const DialpadSquareIcon = React.forwardRef<SVGSVGElement, DialpadSquareIconProps>(
