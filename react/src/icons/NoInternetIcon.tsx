...
interface NoInternetIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/no-internet)
 * @see {@link https://clicons.dev/icon/no-internet} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const NoInternetIcon = React.forwardRef<SVGSVGElement, NoInternetIconProps>(
  (
    {
      size,
      color,
