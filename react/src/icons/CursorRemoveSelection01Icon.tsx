...
interface CursorRemoveSelection01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/cursor-remove-selection01)
 * @see {@link https://clicons.dev/icon/cursor-remove-selection01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CursorRemoveSelection01Icon = React.forwardRef<SVGSVGElement, CursorRemoveSelection01IconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M12 6.5H18", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "1" }]];
...
CursorRemoveSelection01Icon.displayName = 'CursorRemoveSelection01Icon';
export default CursorRemoveSelection01Icon;
