...
interface Agreement2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Agreement2Icon = React.forwardRef<SVGSVGElement, Agreement2IconProps>(
  (
    {
      size,
      color,
...
Agreement2Icon.displayName = 'Agreement2Icon';
export default Agreement2Icon;
