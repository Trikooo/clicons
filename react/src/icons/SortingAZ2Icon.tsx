...
interface SortingAZ2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/sorting-az2}
 */
const SortingAZ2Icon = React.forwardRef<SVGSVGElement, SortingAZ2IconProps>(
...
SortingAZ2Icon.displayName = 'SortingAZ2Icon';
