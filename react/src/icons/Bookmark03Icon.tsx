...
interface Bookmark03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/bookmark03)
 * @see {@link https://clicons.dev/icon/bookmark03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Bookmark03Icon = React.forwardRef<SVGSVGElement, Bookmark03IconProps>(
  (
    {
      size,
      color,
...
Bookmark03Icon.displayName = 'Bookmark03Icon';
