...
interface UserMinus2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/user-minus2}
 */
const UserMinus2Icon = React.forwardRef<SVGSVGElement, UserMinus2IconProps>(
...
UserMinus2Icon.displayName = 'UserMinus2Icon';
