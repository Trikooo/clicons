...
interface NewJobIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const NewJobIcon = React.forwardRef<SVGSVGElement, NewJobIconProps>(
  (
    {
      size,
      color,
...
NewJobIcon.displayName = 'NewJobIcon';
export default NewJobIcon;
