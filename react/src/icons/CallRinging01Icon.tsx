...
interface CallRinging01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-ringing01)
 * @see {@link https://clicons.dev/icon/call-ringing01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallRinging01Icon = React.forwardRef<SVGSVGElement, CallRinging01IconProps>(
  (
    {
      size,
      color,
...
CallRinging01Icon.displayName = 'CallRinging01Icon';
export default CallRinging01Icon;
