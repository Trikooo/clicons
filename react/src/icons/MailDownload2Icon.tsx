...
interface MailDownload2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MailDownload2Icon = React.forwardRef<SVGSVGElement, MailDownload2IconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M17 19C17.4915 19.5057 18.7998 21.5 19.5 21.5M22 19C21.5085 19.5057 20.2002 21.5 19.5 21.5M19.5 21.5V13.5',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
MailDownload2Icon.displayName = 'MailDownload2Icon';
export default MailDownload2Icon;
