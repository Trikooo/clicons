...
interface CallMinus02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-minus02)
 * @see {@link https://clicons.dev/icon/call-minus02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallMinus02Icon = React.forwardRef<SVGSVGElement, CallMinus02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M21 6H14", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
CallMinus02Icon.displayName = 'CallMinus02Icon';
export default CallMinus02Icon;
