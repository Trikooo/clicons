...
interface TiktokIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/tiktok)
 * @see {@link https://clicons.dev/icon/tiktok} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TiktokIcon = React.forwardRef<SVGSVGElement, TiktokIconProps>(
  (
    {
      size,
      color,
