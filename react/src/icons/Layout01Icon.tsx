...
interface Layout01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/layout01)
 * @see {@link https://clicons.dev/icon/layout01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Layout01Icon = React.forwardRef<SVGSVGElement, Layout01IconProps>(
  (
    {
      size,
      color,
...
Layout01Icon.displayName = 'Layout01Icon';
