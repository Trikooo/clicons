...
interface Menu05IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/menu05)
 * @see {@link https://clicons.dev/icon/menu05} - Icon preview
...
const Menu05Icon = React.forwardRef<SVGSVGElement, Menu05IconProps>(
  (
    ...
    const iconData = [["path", { d: "M4 5L14 5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
