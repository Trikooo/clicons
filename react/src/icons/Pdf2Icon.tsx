...
interface Pdf2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pdf2)
 * @see {@link https://clicons.dev/icon/pdf2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Pdf2Icon = React.forwardRef<SVGSVGElement, Pdf2IconProps>(
  (
    {
      size,
      color,
