...
interface DashboardSquareEditIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/dashboard-square-edit)
 * @see {@link https://clicons.dev/icon/dashboard-square-edit} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const DashboardSquareEditIcon = React.forwardRef<SVGSVGElement, DashboardSquareEditIconProps>(
  (
    {
      size,
      color,
...
DashboardSquareEditIcon.displayName = 'DashboardSquareEditIcon';
export default DashboardSquareEditIcon;
