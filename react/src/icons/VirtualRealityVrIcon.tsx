...
interface VirtualRealityVrIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name VirtualRealityVrIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/virtual-reality-vr)
 * @see {@link https://clicons.dev/icon/virtual-reality-vr} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const VirtualRealityVrIcon = React.forwardRef<SVGSVGElement, VirtualRealityVrIconProps>(
  (
    {
      size,
      color,
...
VirtualRealityVrIcon.displayName = 'VirtualRealityVrIcon';
export default VirtualRealityVrIcon;
