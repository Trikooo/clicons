...
interface PreferenceVerticalIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const PreferenceVerticalIcon = React.forwardRef<SVGSVGElement, PreferenceVerticalIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M4 11L4 21", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
PreferenceVerticalIcon.displayName = 'PreferenceVerticalIcon';
export default PreferenceVerticalIcon;
