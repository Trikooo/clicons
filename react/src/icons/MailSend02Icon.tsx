...
interface MailSend02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mail-send02)
 * @see {@link https://clicons.dev/icon/mail-send02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MailSend02Icon = React.forwardRef<SVGSVGElement, MailSend02IconProps>(
  (
    {
      size,
      color,
...
MailSend02Icon.displayName = 'MailSend02Icon';
