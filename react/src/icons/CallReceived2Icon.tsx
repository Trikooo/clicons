...
interface CallReceived2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name CallReceived2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/call-received2)
 * @see {@link https://clicons.dev/icon/call-received2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallReceived2Icon = React.forwardRef<SVGSVGElement, CallReceived2IconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M20 11V8.5C20 6.84315 18.6569 5.5 17 5.5H14M15.5 3L13 5.5L15.5 8',
      stroke: 'currentColor',
      strokeLinecap: 'round',
...
CallReceived2Icon.displayName = 'CallReceived2Icon';
export default CallReceived2Icon;
