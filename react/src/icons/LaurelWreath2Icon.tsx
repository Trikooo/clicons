...
interface LaurelWreath2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name LaurelWreath2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/laurel-wreath2)
 * @see {@link https://clicons.dev/icon/laurel-wreath2}
 */
const LaurelWreath2Icon = React.forwardRef<SVGSVGElement, LaurelWreath2IconProps>(
...
LaurelWreath2Icon.displayName = 'LaurelWreath2Icon';
