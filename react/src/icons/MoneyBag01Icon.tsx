...
interface MoneyBag01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/money-bag01)
 * @see {@link https://clicons.dev/icon/money-bag01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MoneyBag01Icon = React.forwardRef<SVGSVGElement, MoneyBag01IconProps>(
  (
    {
      size,
      color,
...
MoneyBag01Icon.displayName = 'MoneyBag01Icon';
export default MoneyBag01Icon;
