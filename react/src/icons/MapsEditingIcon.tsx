...
interface MapsEditingIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/maps-editing)
 * @see {@link https://clicons.dev/icon/maps-editing} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MapsEditingIcon = React.forwardRef<SVGSVGElement, MapsEditingIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M8 2.5L8 17.5", stroke: "currentColor", strokeLinejoin: "round", strokeWidth: "1.5", key: "2" }],
  ["path", { d: "M15 5.5V13.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "3" }]];
...
MapsEditingIcon.displayName = 'MapsEditingIcon';
