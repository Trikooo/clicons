...
interface ZoomCircleIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/zoom-circle)
 * @see {@link https://clicons.dev/icon/zoom-circle} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ZoomCircleIcon = React.forwardRef<SVGSVGElement, ZoomCircleIconProps>(
  (
    {
      size,
      color,
...
ZoomCircleIcon.displayName = 'ZoomCircleIcon';
export default ZoomCircleIcon;
