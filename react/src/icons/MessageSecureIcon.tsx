...
interface MessageSecureIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MessageSecureIcon = React.forwardRef<SVGSVGElement, MessageSecureIconProps>(
  (
    {
      size,
      color,
...
MessageSecureIcon.displayName = 'MessageSecureIcon';
export default MessageSecureIcon;
