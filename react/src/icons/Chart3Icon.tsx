...
interface Chart3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/chart3)
 * @see {@link https://clicons.dev/icon/chart3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Chart3Icon = React.forwardRef<SVGSVGElement, Chart3IconProps>(
  (
    {
      size,
      color,
...
Chart3Icon.displayName = 'Chart3Icon';
