...
interface ArtificialIntelligence4IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name ArtificialIntelligence4Icon
 ...
 */
const ArtificialIntelligence4Icon = React.forwardRef<SVGSVGElement, ArtificialIntelligence4IconProps>(
  (
    {
      size,
      color,
...
ArtificialIntelligence4Icon.displayName = 'ArtificialIntelligence4Icon';
export default ArtificialIntelligence4Icon;
