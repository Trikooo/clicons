...
interface Uv01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/uv01)
 * @see {@link https://clicons.dev/icon/uv01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Uv01Icon = React.forwardRef<SVGSVGElement, Uv01IconProps>(
  (
    {
      size,
      color,
