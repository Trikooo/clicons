...
interface CardExchange01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/card-exchange01)
 * @see {@link https://clicons.dev/icon/card-exchange01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CardExchange01Icon = React.forwardRef<SVGSVGElement, CardExchange01IconProps>(
  (
    {
      size,
      color,
...
CardExchange01Icon.displayName = 'CardExchange01Icon';
