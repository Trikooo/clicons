...
interface SunCloudSnowIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name SunCloudSnowIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/sun-cloud-snow)
 * @see {@link https://clicons.dev/icon/sun-cloud-snow} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SunCloudSnowIcon = React.forwardRef<SVGSVGElement, SunCloudSnowIconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M11.9977 17.9973L12.0022 18.005M15.9954 15.9998L15.9999 16.0076M7.99991 15.9998L8.0044 16.0076M15.9954 19.9947L15.9999 20.0024M7.99991 19.9947L8.0044 20.0024M11.9977 21.9921L12.0022 21.9998',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '2'
...
SunCloudSnowIcon.displayName = 'SunCloudSnowIcon';
export default SunCloudSnowIcon;
