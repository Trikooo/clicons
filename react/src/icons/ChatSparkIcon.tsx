...
const ChatSparkIcon = React.forwardRef<SVGSVGElement, ChatSparkIconProps>(
  ...
  [
    'path',
    {
      d: 'M11.9649 6.52864C11.9727 6.49045 12.0273 6.49045 12.0351 6.52864C12.4402 8.51077 13.9892 10.0598 15.9714 10.4649C16.0095 10.4727 16.0095 10.5273 15.9714 10.5351C13.9892 10.9402 12.4402 12.4892 12.0351 14.4714C12.0273 14.5095 11.9727 14.5095 11.9649 14.4714C11.5598 12.4892 10.0108 10.9402 8.02864 10.5351C7.99045 10.5273 7.99045 10.4727 8.02864 10.4649C10.0108 10.0598 11.5598 8.51077 11.9649 6.52864Z',
      stroke: 'currentColor',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
    }
