...
const PotionIcon = React.forwardRef<SVGSVGElement, PotionIconProps>(
  (
    ...
    const iconData = [["path", { d: "M19 15C19 18.866 15.866 22 12 22C8.13401 22 5 18.866 5 15C5 11.134 8.13401 8 12 8C15.866 8 19 11.134 19 15Z", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
