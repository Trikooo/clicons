...
interface SteakIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const SteakIcon = React.forwardRef<SVGSVGElement, SteakIconProps>(
  (
    {
      size,
      color,
...
SteakIcon.displayName = 'SteakIcon';
