...
interface Pdf02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pdf02)
 * @see {@link https://clicons.dev/icon/pdf02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Pdf02Icon = React.forwardRef<SVGSVGElement, Pdf02IconProps>(
  (
    {
      size,
      color,
...
Pdf02Icon.displayName = 'Pdf02Icon';
