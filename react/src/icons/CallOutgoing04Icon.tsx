...
interface CallOutgoing04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-outgoing04)
 * @see {@link https://clicons.dev/icon/call-outgoing04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallOutgoing04Icon = React.forwardRef<SVGSVGElement, CallOutgoing04IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M21 7V3H17M15 9L20.5941 3.40586", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
CallOutgoing04Icon.displayName = 'CallOutgoing04Icon';
export default CallOutgoing04Icon;
