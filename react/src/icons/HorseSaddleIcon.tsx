...
interface HorseSaddleIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name HorseSaddleIcon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/horse-saddle)
 * @see {@link https://clicons.dev/icon/horse-saddle}
 */
const HorseSaddleIcon = React.forwardRef<SVGSVGElement, HorseSaddleIconProps>(
  ...
  [
    'path',
    {
      d: 'M6.5 9.5C6.5 11.1569 7.84315 12.5 9.5 12.5C11.1569 12.5 12.5 11.1569 12.5 9.5V9'
    }
  ]
];
...
HorseSaddleIcon.displayName = 'HorseSaddleIcon';
