...
interface SummationSquareIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/summation-square)
 * @see {@link https://clicons.dev/icon/summation-square} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SummationSquareIcon = React.forwardRef<SVGSVGElement, SummationSquareIconProps>(
  (
    {
      size,
      color,
...
SummationSquareIcon.displayName = 'SummationSquareIcon';
