...
interface Touch07IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/touch07)
 * @see {@link https://clicons.dev/icon/touch07} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Touch07Icon = React.forwardRef<SVGSVGElement, Touch07IconProps>(
  (
    {
      size,
      color,
...
Touch07Icon.displayName = 'Touch07Icon';
