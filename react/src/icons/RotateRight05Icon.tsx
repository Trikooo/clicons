...
interface RotateRight05IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/rotate-right05)
 * @see {@link https://clicons.dev/icon/rotate-right05} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const RotateRight05Icon = React.forwardRef<SVGSVGElement, RotateRight05IconProps>(
  (
    {
      size,
      color,
...
RotateRight05Icon.displayName = 'RotateRight05Icon';
