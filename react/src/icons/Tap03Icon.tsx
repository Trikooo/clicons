...
interface Tap03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/tap03)
 * @see {@link https://clicons.dev/icon/tap03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Tap03Icon = React.forwardRef<SVGSVGElement, Tap03IconProps>(
  (
    {
      size,
      color,
...
Tap03Icon.displayName = 'Tap03Icon';
