...
interface Csv2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/csv2}
 */
const Csv2Icon = React.forwardRef<SVGSVGElement, Csv2IconProps>(
