 ...
 * @see {@link https://clicons.dev/icon/more-or-less-square}
 */
const MoreOrLessSquareIcon = React.forwardRef<SVGSVGElement, MoreOrLessSquareIconProps>(
  ...
  [
    'path',
    {
      d: 'M17.0039 9H8.99994C8.01346 9 7.14269 9.01038 7.01994 8.676C6.92417 8.41502 7.52394 7.596 8.00394 6.996'
    }
  ],
  [
    'path',
    {
      d: 'M7.00973 15L15.0137 15C16.0002 15 16.871 14.9896 16.9937 15.324C17.0895 15.585 16.4897 16.404 16.0097 17.004'
    }
  ]
];
