...
interface IceSkatingIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const IceSkatingIcon = React.forwardRef<SVGSVGElement, IceSkatingIconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M20.0293 17L20.6302 17.8C21.6792 19.1963 22.2036 19.8944 21.9268 20.4472C21.6499 21 20.7758 21 19.0276 21H2',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeWidth: '1.5'
    }
