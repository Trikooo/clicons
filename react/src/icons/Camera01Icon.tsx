...
interface Camera01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/camera01)
 * @see {@link https://clicons.dev/icon/camera01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Camera01Icon = React.forwardRef<SVGSVGElement, Camera01IconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M19.0002 9.5V9.51", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", key: "2" }]];
