...
interface ShippingTruck01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/shipping-truck01)
 * @see {@link https://clicons.dev/icon/shipping-truck01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ShippingTruck01Icon = React.forwardRef<SVGSVGElement, ShippingTruck01IconProps>(
  (
    {
      size,
      color,
...
ShippingTruck01Icon.displayName = 'ShippingTruck01Icon';
export default ShippingTruck01Icon;
