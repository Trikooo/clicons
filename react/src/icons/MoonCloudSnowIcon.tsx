...
interface MoonCloudSnowIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/moon-cloud-snow)
 * @see {@link https://clicons.dev/icon/moon-cloud-snow} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MoonCloudSnowIcon = React.forwardRef<SVGSVGElement, MoonCloudSnowIconProps>(
  (
    {
      size,
      color,
...
MoonCloudSnowIcon.displayName = 'MoonCloudSnowIcon';
