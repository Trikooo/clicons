...
interface MailVoice01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mail-voice01)
 * @see {@link https://clicons.dev/icon/mail-voice01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MailVoice01Icon = React.forwardRef<SVGSVGElement, MailVoice01IconProps>(
  (
    {
      size,
      color,
...
MailVoice01Icon.displayName = 'MailVoice01Icon';
