...
interface Books02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/books02)
 * @see {@link https://clicons.dev/icon/books02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Books02Icon = React.forwardRef<SVGSVGElement, Books02IconProps>(
  (
    {
      size,
      color,
...
Books02Icon.displayName = 'Books02Icon';
