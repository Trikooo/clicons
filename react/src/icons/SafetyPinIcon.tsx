...
interface SafetyPinIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/safety-pin)
 * @see {@link https://clicons.dev/icon/safety-pin} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SafetyPinIcon = React.forwardRef<SVGSVGElement, SafetyPinIconProps>(
  (
    {
      size,
      color,
...
SafetyPinIcon.displayName = 'SafetyPinIcon';
export default SafetyPinIcon;
