...
interface FolderAudioIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/folder-audio)
 * @see {@link https://clicons.dev/icon/folder-audio} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FolderAudioIcon = React.forwardRef<SVGSVGElement, FolderAudioIconProps>(
  (
    {
      size,
      color,
...
FolderAudioIcon.displayName = 'FolderAudioIcon';
