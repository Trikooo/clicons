...
interface Attachment01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/attachment01)
 * @see {@link https://clicons.dev/icon/attachment01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Attachment01Icon = React.forwardRef<SVGSVGElement, Attachment01IconProps>(
  (
    {
      size,
      color,
...
export default Attachment01Icon;
