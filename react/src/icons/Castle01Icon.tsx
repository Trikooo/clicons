...
interface Castle01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/castle01)
 * @see {@link https://clicons.dev/icon/castle01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Castle01Icon = React.forwardRef<SVGSVGElement, Castle01IconProps>(
  (
    {
      size,
      color,
...
Castle01Icon.displayName = 'Castle01Icon';
