...
interface ArrowRight4IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/arrow-right4)
 * @see {@link https://clicons.dev/icon/arrow-right4} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ArrowRight4Icon = React.forwardRef<SVGSVGElement, ArrowRight4IconProps>(
  (
    {
      size,
      color,
...
ArrowRight4Icon.displayName = 'ArrowRight4Icon';
