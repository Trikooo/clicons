...
interface ComputerDeskIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const ComputerDeskIcon = React.forwardRef<SVGSVGElement, ComputerDeskIconProps>(
  (
    {
      size,
      color,
...
ComputerDeskIcon.displayName = 'ComputerDeskIcon';
