...
interface MoreHorizontalCircleIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name MoreHorizontalCircleIcon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/more-horizontal-circle)
 * @see {@link https://clicons.dev/icon/more-horizontal-circle}
 */
const MoreHorizontalCircleIcon = React.forwardRef<SVGSVGElement, MoreHorizontalCircleIconProps>(
...
MoreHorizontalCircleIcon.displayName = 'MoreHorizontalCircleIcon';
