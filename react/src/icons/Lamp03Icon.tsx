...
interface Lamp03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/lamp03)
 * @see {@link https://clicons.dev/icon/lamp03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Lamp03Icon = React.forwardRef<SVGSVGElement, Lamp03IconProps>(
  (
    {
      size,
      color,
...
Lamp03Icon.displayName = 'Lamp03Icon';
