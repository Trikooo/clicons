...
interface ChatFeedback01IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name ChatFeedback01Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/chat-feedback01)
 * @see {@link https://clicons.dev/icon/chat-feedback01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ChatFeedback01Icon = React.forwardRef<SVGSVGElement, ChatFeedback01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M7.5 8.5H16.5M7.5 12.5H13", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
ChatFeedback01Icon.displayName = 'ChatFeedback01Icon';
export default ChatFeedback01Icon;
