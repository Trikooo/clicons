...
interface Clock3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/clock3)
 * @see {@link https://clicons.dev/icon/clock3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Clock3Icon = React.forwardRef<SVGSVGElement, Clock3IconProps>(
  (
    {
      size,
      color,
