...
interface Archive2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Archive2Icon = React.forwardRef<SVGSVGElement, Archive2IconProps>(
  (
    {
      size,
      color,
...
Archive2Icon.displayName = 'Archive2Icon';
