...
interface SwipeLeft9IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/swipe-left9)
 * @see {@link https://clicons.dev/icon/swipe-left9} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SwipeLeft9Icon = React.forwardRef<SVGSVGElement, SwipeLeft9IconProps>(
  (
    {
      size,
      color,
...
SwipeLeft9Icon.displayName = 'SwipeLeft9Icon';
export default SwipeLeft9Icon;
