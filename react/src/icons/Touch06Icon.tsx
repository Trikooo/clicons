...
interface Touch06IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/touch06)
 * @see {@link https://clicons.dev/icon/touch06} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Touch06Icon = React.forwardRef<SVGSVGElement, Touch06IconProps>(
  (
    {
      size,
      color,
...
Touch06Icon.displayName = 'Touch06Icon';
