...
interface Chat01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/chat01)
 * @see {@link https://clicons.dev/icon/chat01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Chat01Icon = React.forwardRef<SVGSVGElement, Chat01IconProps>(
  (
    {
      size,
      color,
