...
interface DispleasedIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const DispleasedIcon = React.forwardRef<SVGSVGElement, DispleasedIconProps>(
  (
    {
      size,
      color,
...
DispleasedIcon.displayName = 'DispleasedIcon';
