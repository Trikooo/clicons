...
interface Billiard2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/billiard2}
 */
const Billiard2Icon = React.forwardRef<SVGSVGElement, Billiard2IconProps>(
...
Billiard2Icon.displayName = 'Billiard2Icon';
