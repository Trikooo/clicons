...
interface EvilIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const EvilIcon = React.forwardRef<SVGSVGElement, EvilIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M9 16C9.83563 16.6278 10.8744 16.9998 12 16.9998C13.1256 16.9998 14.1644 16.6278 15 16", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "2" }]];
