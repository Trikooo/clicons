...
const DeliveryView02Icon = React.forwardRef<SVGSVGElement, DeliveryView02IconProps>(
  (
    ...
    const iconData = [["path", { d: "M10.5 21.5C6.72876 21.5 4.84315 21.5 3.67157 20.3284C2.5 19.1569 2.5 17.2712 2.5 13.5V6.5H21.5V14.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
