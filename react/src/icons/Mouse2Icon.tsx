...
interface Mouse2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mouse2)
 * @see {@link https://clicons.dev/icon/mouse2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Mouse2Icon = React.forwardRef<SVGSVGElement, Mouse2IconProps>(
  (
    {
      size,
      color,
