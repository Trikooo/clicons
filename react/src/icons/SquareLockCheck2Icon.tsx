...
interface SquareLockCheck2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name SquareLockCheck2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/square-lock-check2)
 * @see {@link https://clicons.dev/icon/square-lock-check2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SquareLockCheck2Icon = React.forwardRef<SVGSVGElement, SquareLockCheck2IconProps>(
  (
    {
      size,
      color,
...
SquareLockCheck2Icon.displayName = 'SquareLockCheck2Icon';
export default SquareLockCheck2Icon;
