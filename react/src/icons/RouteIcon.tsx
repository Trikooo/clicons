...
interface RouteIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/route}
 */
const RouteIcon = React.forwardRef<SVGSVGElement, RouteIconProps>(
