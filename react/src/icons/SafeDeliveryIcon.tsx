...
interface SafeDeliveryIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name SafeDeliveryIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/safe-delivery)
 * @see {@link https://clicons.dev/icon/safe-delivery} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SafeDeliveryIcon = React.forwardRef<SVGSVGElement, SafeDeliveryIconProps>(
  (
    {
      size,
      color,
...
SafeDeliveryIcon.displayName = 'SafeDeliveryIcon';
