...
interface Camera2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/camera2}
 */
const Camera2Icon = React.forwardRef<SVGSVGElement, Camera2IconProps>(
