...
interface SixCircleIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const SixCircleIcon = React.forwardRef<SVGSVGElement, SixCircleIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M11 12H13C14.1046 12 15 12.8954 15 14V15C15 16.1046 14.1046 17 13 17H11C9.89543 17 9 16.1046 9 15V14C9 12.8954 9.89543 12 11 12Z", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
SixCircleIcon.displayName = 'SixCircleIcon';
