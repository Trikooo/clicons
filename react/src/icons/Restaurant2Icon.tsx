...
interface Restaurant2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/restaurant2}
 */
const Restaurant2Icon = React.forwardRef<SVGSVGElement, Restaurant2IconProps>(
...
Restaurant2Icon.displayName = 'Restaurant2Icon';
