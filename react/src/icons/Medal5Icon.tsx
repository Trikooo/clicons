...
interface Medal5IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Medal5Icon = React.forwardRef<SVGSVGElement, Medal5IconProps>(
  (
    {
      size,
      color,
...
Medal5Icon.displayName = 'Medal5Icon';
export default Medal5Icon;
