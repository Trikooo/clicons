...
interface ChartUpIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/chart-up)
 * @see {@link https://clicons.dev/icon/chart-up} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ChartUpIcon = React.forwardRef<SVGSVGElement, ChartUpIconProps>(
  (
    {
      size,
      color,
