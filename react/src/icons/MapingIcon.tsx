...
interface MapingIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MapingIcon = React.forwardRef<SVGSVGElement, MapingIconProps>(
  (
    {
      size,
      color,
...
MapingIcon.displayName = 'MapingIcon';
export default MapingIcon;
