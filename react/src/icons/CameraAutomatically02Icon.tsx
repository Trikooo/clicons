...
interface CameraAutomatically02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/camera-automatically02)
 * @see {@link https://clicons.dev/icon/camera-automatically02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CameraAutomatically02Icon = React.forwardRef<SVGSVGElement, CameraAutomatically02IconProps>(
  (
    {
      size,
      color,
...
CameraAutomatically02Icon.displayName = 'CameraAutomatically02Icon';
