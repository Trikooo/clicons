...
interface SunCloudSlowWind2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name SunCloudSlowWind2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/sun-cloud-slow-wind2)
 * @see {@link https://clicons.dev/icon/sun-cloud-slow-wind2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SunCloudSlowWind2Icon = React.forwardRef<SVGSVGElement, SunCloudSlowWind2IconProps>(
  (
    {
      size,
      color,
...
SunCloudSlowWind2Icon.displayName = 'SunCloudSlowWind2Icon';
export default SunCloudSlowWind2Icon;
