...
interface SwipeLeft4IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/swipe-left4}
 */
const SwipeLeft4Icon = React.forwardRef<SVGSVGElement, SwipeLeft4IconProps>(
...
SwipeLeft4Icon.displayName = 'SwipeLeft4Icon';
