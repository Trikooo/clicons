...
interface StoreRemoveIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const StoreRemoveIcon = React.forwardRef<SVGSVGElement, StoreRemoveIconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M3.50003 9.99988V14.9999C3.50003 17.8283 3.50003 19.2425 4.37871 20.1212C5.25739 20.9999 6.6716 20.9999 9.50003 20.9999H12M20.5 12.9999V9.99988',
      stroke: 'currentColor',
      strokeLinecap: 'round',
...
StoreRemoveIcon.displayName = 'StoreRemoveIcon';
export default StoreRemoveIcon;
