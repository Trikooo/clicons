...
const FlipPhoneIcon = React.forwardRef<SVGSVGElement, FlipPhoneIconProps>(
  (
    ...
    const iconData = [["path", { d: "M14.5 4H5.5V15.5C5.5 19.0899 8.41015 22 12 22C15.5899 22 18.5 19.0899 18.5 15.5V8C18.5 6.11438 18.5 5.17157 17.9142 4.58579C17.3284 4 16.3856 4 14.5 4Z", stroke: "currentColor", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
