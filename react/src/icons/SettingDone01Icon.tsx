...
interface SettingDone01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/setting-done01)
 * @see {@link https://clicons.dev/icon/setting-done01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SettingDone01Icon = React.forwardRef<SVGSVGElement, SettingDone01IconProps>(
  (
    {
      size,
      color,
...
SettingDone01Icon.displayName = 'SettingDone01Icon';
