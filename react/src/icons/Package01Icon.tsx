...
interface Package01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/package01)
 * @see {@link https://clicons.dev/icon/package01} - Icon preview
