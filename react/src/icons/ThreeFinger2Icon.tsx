...
interface ThreeFinger2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name ThreeFinger2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/three-finger2)
 * @see {@link https://clicons.dev/icon/three-finger2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ThreeFinger2Icon = React.forwardRef<SVGSVGElement, ThreeFinger2IconProps>(
  (
    {
      size,
      color,
...
ThreeFinger2Icon.displayName = 'ThreeFinger2Icon';
export default ThreeFinger2Icon;
