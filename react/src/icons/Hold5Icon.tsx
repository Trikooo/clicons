...
interface Hold5IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/hold5)
 * @see {@link https://clicons.dev/icon/hold5} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Hold5Icon = React.forwardRef<SVGSVGElement, Hold5IconProps>(
  (
    {
      size,
      color,
...
Hold5Icon.displayName = 'Hold5Icon';
export default Hold5Icon;
