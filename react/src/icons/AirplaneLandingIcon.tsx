...
interface AirplaneLandingIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const AirplaneLandingIcon = React.forwardRef<SVGSVGElement, AirplaneLandingIconProps>(
  (
    {
      size,
      color,
