...
interface ShoppingBag02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/shopping-bag02)
 * @see {@link https://clicons.dev/icon/shopping-bag02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ShoppingBag02Icon = React.forwardRef<SVGSVGElement, ShoppingBag02IconProps>(
  (
    {
      size,
      color,
