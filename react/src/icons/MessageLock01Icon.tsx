...
interface MessageLock01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/message-lock01)
 * @see {@link https://clicons.dev/icon/message-lock01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MessageLock01Icon = React.forwardRef<SVGSVGElement, MessageLock01IconProps>(
  (
    {
      size,
      color,
...
MessageLock01Icon.displayName = 'MessageLock01Icon';
