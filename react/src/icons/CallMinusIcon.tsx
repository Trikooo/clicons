...
interface CallMinusIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-minus)
 * @see {@link https://clicons.dev/icon/call-minus} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallMinusIcon = React.forwardRef<SVGSVGElement, CallMinusIconProps>(
  (
    {
      size,
      color,
...
CallMinusIcon.displayName = 'CallMinusIcon';
export default CallMinusIcon;
