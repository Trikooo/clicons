...
interface Touch7IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/touch7}
 */
const Touch7Icon = React.forwardRef<SVGSVGElement, Touch7IconProps>(
...
Touch7Icon.displayName = 'Touch7Icon';
