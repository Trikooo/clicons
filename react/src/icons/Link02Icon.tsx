...
interface Link02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/link02)
 * @see {@link https://clicons.dev/icon/link02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Link02Icon = React.forwardRef<SVGSVGElement, Link02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M9.5 14.5L14.5 9.49995", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
