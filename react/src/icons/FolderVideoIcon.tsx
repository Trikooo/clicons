...
interface FolderVideoIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/folder-video)
 * @see {@link https://clicons.dev/icon/folder-video} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FolderVideoIcon = React.forwardRef<SVGSVGElement, FolderVideoIconProps>(
  (
    {
      size,
      color,
...
FolderVideoIcon.displayName = 'FolderVideoIcon';
