...
const GitMergeIcon = React.forwardRef<SVGSVGElement, GitMergeIconProps>(
  (
    ...
    const iconData = [["path", { d: "M7 20C8.10457 20 9 19.1046 9 18C9 16.8954 8.10457 16 7 16C5.89543 16 5 16.8954 5 18C5 19.1046 5.89543 20 7 20Z", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
