...
interface DentalBracesIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/dental-braces}
 */
const DentalBracesIcon = React.forwardRef<SVGSVGElement, DentalBracesIconProps>(
  ...
  [
    'path',
    {
      d: 'M10.387 9.38704C9.87099 9.9031 9.87099 12.0969 10.387 12.613C10.9031 13.129 13.0969 13.129 13.613 12.613C14.129 12.0969 14.129 9.9031 13.613 9.38704C13.0969 8.87099 10.9031 8.87099 10.387 9.38704Z'
    }
  ],
  [
    'path',
...
DentalBracesIcon.displayName = 'DentalBracesIcon';
