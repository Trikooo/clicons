...
interface MessageUpload2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MessageUpload2Icon = React.forwardRef<SVGSVGElement, MessageUpload2IconProps>(
  (
    {
      size,
      color,
...
MessageUpload2Icon.displayName = 'MessageUpload2Icon';
export default MessageUpload2Icon;
