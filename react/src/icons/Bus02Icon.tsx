...
interface Bus02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/bus02)
 * @see {@link https://clicons.dev/icon/bus02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Bus02Icon = React.forwardRef<SVGSVGElement, Bus02IconProps>(
  (
    {
      size,
      color,
...
Bus02Icon.displayName = 'Bus02Icon';
