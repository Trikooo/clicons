...
interface TongueWinkRightIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/tongue-wink-right}
 */
const TongueWinkRightIcon = React.forwardRef<SVGSVGElement, TongueWinkRightIconProps>(
...
TongueWinkRightIcon.displayName = 'TongueWinkRightIcon';
