...
interface Link03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/link03)
 * @see {@link https://clicons.dev/icon/link03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Link03Icon = React.forwardRef<SVGSVGElement, Link03IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M9.521 14.4356L14.434 9.52258", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
