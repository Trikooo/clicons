...
interface Briefcase6IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/briefcase6}
 */
const Briefcase6Icon = React.forwardRef<SVGSVGElement, Briefcase6IconProps>(
...
Briefcase6Icon.displayName = 'Briefcase6Icon';
