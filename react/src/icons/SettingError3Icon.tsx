...
interface SettingError3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const SettingError3Icon = React.forwardRef<SVGSVGElement, SettingError3IconProps>(
  (
    {
      size,
      color,
...
SettingError3Icon.displayName = 'SettingError3Icon';
export default SettingError3Icon;
