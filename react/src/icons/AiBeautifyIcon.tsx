...
interface AiBeautifyIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/ai-beautify)
 * @see {@link https://clicons.dev/icon/ai-beautify} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AiBeautifyIcon = React.forwardRef<SVGSVGElement, AiBeautifyIconProps>(
  (
    {
      size,
      color,
...
AiBeautifyIcon.displayName = 'AiBeautifyIcon';
export default AiBeautifyIcon;
