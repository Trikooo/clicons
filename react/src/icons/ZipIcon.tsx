...
interface ZipIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/zip)
 * @see {@link https://clicons.dev/icon/zip} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ZipIcon = React.forwardRef<SVGSVGElement, ZipIconProps>(
  (
    {
      size,
      color,
