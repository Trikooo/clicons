...
interface Blockchain6IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name Blockchain6Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/blockchain6)
 * @see {@link https://clicons.dev/icon/blockchain6}
 */
const Blockchain6Icon = React.forwardRef<SVGSVGElement, Blockchain6IconProps>(
...
Blockchain6Icon.displayName = 'Blockchain6Icon';
