...
interface AiIdeaIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/ai-idea)
 * @see {@link https://clicons.dev/icon/ai-idea} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AiIdeaIcon = React.forwardRef<SVGSVGElement, AiIdeaIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M13.5 19V20C13.5 20.9428 13.5 21.4142 13.2071 21.7071C12.9142 22 12.4428 22 11.5 22C10.5572 22 10.0858 22 9.79289 21.7071C9.5 21.4142 9.5 20.9428 9.5 20V19", stroke: "currentColor", strokeLinejoin: "round", strokeWidth: "1.5", key: "2" }]];
...
AiIdeaIcon.displayName = 'AiIdeaIcon';
export default AiIdeaIcon;
