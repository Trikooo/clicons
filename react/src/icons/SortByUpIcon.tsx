...
interface SortByUpIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/sort-by-up)
 * @see {@link https://clicons.dev/icon/sort-by-up} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SortByUpIcon = React.forwardRef<SVGSVGElement, SortByUpIconProps>(
  (
    {
      size,
      color,
...
SortByUpIcon.displayName = 'SortByUpIcon';
export default SortByUpIcon;
