...
interface MouseLeftClickIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MouseLeftClickIcon = React.forwardRef<SVGSVGElement, MouseLeftClickIconProps>(
  (
    {
      size,
      color,
...
MouseLeftClickIcon.displayName = 'MouseLeftClickIcon';
