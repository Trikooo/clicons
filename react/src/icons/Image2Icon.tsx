...
interface Image2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/image2}
 */
const Image2Icon = React.forwardRef<SVGSVGElement, Image2IconProps>(
