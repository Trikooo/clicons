...
interface MouseScrollIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/mouse-scroll}
 */
const MouseScrollIcon = React.forwardRef<SVGSVGElement, MouseScrollIconProps>(
...
MouseScrollIcon.displayName = 'MouseScrollIcon';
