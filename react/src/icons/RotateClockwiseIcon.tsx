 ...
 * @see {@link https://clicons.dev/icon/rotate-clockwise} - Icon preview
...
const RotateClockwiseIcon = React.forwardRef<SVGSVGElement, RotateClockwiseIconProps>(
  (
    ...
    const iconData = [["path", { d: "M4 2V5.13219C4 5.42605 4.36724 5.55908 4.55527 5.33333C6.3854 3.2875 9.04499 2 12.0051 2C17.5251 2 22 6.47715 22 12C22 15.9582 19.7015 19.3793 16.367 21", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
