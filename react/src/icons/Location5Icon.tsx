...
interface Location5IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Location5Icon = React.forwardRef<SVGSVGElement, Location5IconProps>(
  (
    {
      size,
      color,
...
Location5Icon.displayName = 'Location5Icon';
export default Location5Icon;
