...
interface CrownIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/crown)
 * @see {@link https://clicons.dev/icon/crown} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CrownIcon = React.forwardRef<SVGSVGElement, CrownIconProps>(
  (
    {
      size,
      color,
