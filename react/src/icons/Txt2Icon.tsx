...
interface Txt2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/txt2)
 * @see {@link https://clicons.dev/icon/txt2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Txt2Icon = React.forwardRef<SVGSVGElement, Txt2IconProps>(
  (
    {
      size,
      color,
...
Txt2Icon.displayName = 'Txt2Icon';
export default Txt2Icon;
