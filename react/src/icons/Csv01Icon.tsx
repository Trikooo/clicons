...
interface Csv01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/csv01)
 * @see {@link https://clicons.dev/icon/csv01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Csv01Icon = React.forwardRef<SVGSVGElement, Csv01IconProps>(
  (
    {
      size,
      color,
...
Csv01Icon.displayName = 'Csv01Icon';
