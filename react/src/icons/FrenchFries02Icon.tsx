...
interface FrenchFries02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/french-fries02)
 * @see {@link https://clicons.dev/icon/french-fries02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FrenchFries02Icon = React.forwardRef<SVGSVGElement, FrenchFries02IconProps>(
  (
    {
      size,
      color,
...
FrenchFries02Icon.displayName = 'FrenchFries02Icon';
