...
interface ArtificialIntelligence08IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name ArtificialIntelligence08Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/artificial-intelligence08)
 * @see {@link https://clicons.dev/icon/artificial-intelligence08} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ArtificialIntelligence08Icon = React.forwardRef<SVGSVGElement, ArtificialIntelligence08IconProps>(
  (
    {
      size,
      color,
...
ArtificialIntelligence08Icon.displayName = 'ArtificialIntelligence08Icon';
export default ArtificialIntelligence08Icon;
