...
interface MessageDone01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/message-done01)
 * @see {@link https://clicons.dev/icon/message-done01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MessageDone01Icon = React.forwardRef<SVGSVGElement, MessageDone01IconProps>(
  (
    {
      size,
      color,
...
MessageDone01Icon.displayName = 'MessageDone01Icon';
