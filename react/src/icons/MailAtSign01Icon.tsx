...
interface MailAtSign01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mail-at-sign01)
 * @see {@link https://clicons.dev/icon/mail-at-sign01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MailAtSign01Icon = React.forwardRef<SVGSVGElement, MailAtSign01IconProps>(
  (
    {
      size,
      color,
...
MailAtSign01Icon.displayName = 'MailAtSign01Icon';
