...
interface BitcoinInvoiceIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/bitcoin-invoice)
 * @see {@link https://clicons.dev/icon/bitcoin-invoice} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BitcoinInvoiceIcon = React.forwardRef<SVGSVGElement, BitcoinInvoiceIconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M8.125 13.5L8.125 7.5M10 7.5V6M10 15V13.5M8.125 10.5H11.875M11.875 10.5C12.4963 10.5 13 11.0037 13 11.625V12.375C13 12.9963 12.4963 13.5 11.875 13.5H7M11.875 10.5C12.4963 10.5 13 9.99632 13 9.375V8.625C13 8.00368 12.4963 7.5 11.875 7.5H7',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
BitcoinInvoiceIcon.displayName = 'BitcoinInvoiceIcon';
