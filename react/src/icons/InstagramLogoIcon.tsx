...
interface InstagramLogoIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
}
 ...
 * @preview ![img](https://clicons.dev/icon/instagram-logo)
 * @see {@link https://clicons.dev/icon/instagram-logo}
 */
const InstagramLogoIcon = React.forwardRef<SVGSVGElement, InstagramLogoIconProps>(
