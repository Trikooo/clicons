...
interface PercentSquareIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/percent-square}
 */
const PercentSquareIcon = React.forwardRef<SVGSVGElement, PercentSquareIconProps>(
