...
interface Setting06IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/setting06)
 * @see {@link https://clicons.dev/icon/setting06} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Setting06Icon = React.forwardRef<SVGSVGElement, Setting06IconProps>(
  (
    {
      size,
      color,
...
Setting06Icon.displayName = 'Setting06Icon';
