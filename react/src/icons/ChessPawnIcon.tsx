 ...
 * @see {@link https://clicons.dev/icon/chess-pawn} - Icon preview
...
const ChessPawnIcon = React.forwardRef<SVGSVGElement, ChessPawnIconProps>(
  (
    ...
    const iconData = [["path", { d: "M9.5 10C9.5 12.6667 9 15.3333 7 18M14.5 10C14.5 12.6667 15 15.3333 17 18", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
