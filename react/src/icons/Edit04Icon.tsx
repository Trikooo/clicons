...
interface Edit04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/edit04)
 * @see {@link https://clicons.dev/icon/edit04} - Icon preview
