...
interface CallRinging4IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name CallRinging4Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/call-ringing4)
 * @see {@link https://clicons.dev/icon/call-ringing4}
 */
const CallRinging4Icon = React.forwardRef<SVGSVGElement, CallRinging4IconProps>(
...
CallRinging4Icon.displayName = 'CallRinging4Icon';
