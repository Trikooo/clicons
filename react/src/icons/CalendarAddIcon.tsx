...
interface CalendarAddIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/calendar-add}
 */
const CalendarAddIcon = React.forwardRef<SVGSVGElement, CalendarAddIconProps>(
