...
interface WalletAdd01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/wallet-add01)
 * @see {@link https://clicons.dev/icon/wallet-add01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const WalletAdd01Icon = React.forwardRef<SVGSVGElement, WalletAdd01IconProps>(
  (
    {
      size,
      color,
...
WalletAdd01Icon.displayName = 'WalletAdd01Icon';
