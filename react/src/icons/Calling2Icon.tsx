...
interface Calling2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/calling2}
 */
const Calling2Icon = React.forwardRef<SVGSVGElement, Calling2IconProps>(
...
Calling2Icon.displayName = 'Calling2Icon';
