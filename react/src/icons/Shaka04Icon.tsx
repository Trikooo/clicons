...
interface Shaka04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/shaka04)
 * @see {@link https://clicons.dev/icon/shaka04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Shaka04Icon = React.forwardRef<SVGSVGElement, Shaka04IconProps>(
  (
    {
      size,
      color,
...
Shaka04Icon.displayName = 'Shaka04Icon';
