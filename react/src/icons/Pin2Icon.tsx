...
interface Pin2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pin2)
 * @see {@link https://clicons.dev/icon/pin2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Pin2Icon = React.forwardRef<SVGSVGElement, Pin2IconProps>(
  (
    {
      size,
      color,
