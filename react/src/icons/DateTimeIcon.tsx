...
interface DateTimeIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/date-time}
 */
const DateTimeIcon = React.forwardRef<SVGSVGElement, DateTimeIconProps>(
