...
interface Alert01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/alert01)
 * @see {@link https://clicons.dev/icon/alert01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Alert01Icon = React.forwardRef<SVGSVGElement, Alert01IconProps>(
  (
    {
      size,
      color,
