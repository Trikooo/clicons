...
interface MessageCancelIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MessageCancelIcon = React.forwardRef<SVGSVGElement, MessageCancelIconProps>(
  (
    {
      size,
      color,
