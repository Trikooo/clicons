...
interface CalendarLock01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/calendar-lock01)
 * @see {@link https://clicons.dev/icon/calendar-lock01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CalendarLock01Icon = React.forwardRef<SVGSVGElement, CalendarLock01IconProps>(
  (
    {
      size,
      color,
...
CalendarLock01Icon.displayName = 'CalendarLock01Icon';
