...
interface FolderShared2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name FolderShared2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/folder-shared2)
 * @see {@link https://clicons.dev/icon/folder-shared2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FolderShared2Icon = React.forwardRef<SVGSVGElement, FolderShared2IconProps>(
  (
    {
      size,
      color,
...
FolderShared2Icon.displayName = 'FolderShared2Icon';
export default FolderShared2Icon;
