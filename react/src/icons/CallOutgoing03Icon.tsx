...
interface CallOutgoing03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-outgoing03)
 * @see {@link https://clicons.dev/icon/call-outgoing03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallOutgoing03Icon = React.forwardRef<SVGSVGElement, CallOutgoing03IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M18.5 3L21 5.5L18.5 8M14 5.5H20.3912", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
CallOutgoing03Icon.displayName = 'CallOutgoing03Icon';
export default CallOutgoing03Icon;
