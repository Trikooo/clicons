...
interface BitcoinStoreIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/bitcoin-store)
 * @see {@link https://clicons.dev/icon/bitcoin-store} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BitcoinStoreIcon = React.forwardRef<SVGSVGElement, BitcoinStoreIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M3.02002 10.4814V14.9886C3.02002 17.8215 3.02002 19.2379 3.89903 20.118C4.77805 20.9981 6.1928 20.9981 9.02231 20.9981H13.0238", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "2" }]];
...
BitcoinStoreIcon.displayName = 'BitcoinStoreIcon';
