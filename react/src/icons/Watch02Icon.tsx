...
interface Watch02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/watch02)
 * @see {@link https://clicons.dev/icon/watch02} - Icon preview
