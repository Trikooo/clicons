...
interface SunCloudHailstone2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const SunCloudHailstone2Icon = React.forwardRef<SVGSVGElement, SunCloudHailstone2IconProps>(
  (
    {
      size,
      color,
...
SunCloudHailstone2Icon.displayName = 'SunCloudHailstone2Icon';
export default SunCloudHailstone2Icon;
