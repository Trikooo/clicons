...
interface ShoppingBasketSecureIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name ShoppingBasketSecureIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/shopping-basket-secure)
 * @see {@link https://clicons.dev/icon/shopping-basket-secure} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ShoppingBasketSecureIcon = React.forwardRef<SVGSVGElement, ShoppingBasketSecureIconProps>(
  (
    {
      size,
      color,
...
ShoppingBasketSecureIcon.displayName = 'ShoppingBasketSecureIcon';
export default ShoppingBasketSecureIcon;
