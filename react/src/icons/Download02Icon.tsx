...
const Download02Icon = React.forwardRef<SVGSVGElement, Download02IconProps>(
  (
    ...
    const iconData = [["path", { d: "M16.0001 12C16.0001 12 13.0542 16 12.0001 16C10.946 16 8.00012 12 8.00012 12M12.0001 15.5L12.0001 3", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
