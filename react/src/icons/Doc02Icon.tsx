...
interface Doc02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/doc02)
 * @see {@link https://clicons.dev/icon/doc02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Doc02Icon = React.forwardRef<SVGSVGElement, Doc02IconProps>(
  (
    {
      size,
      color,
...
Doc02Icon.displayName = 'Doc02Icon';
