...
interface Clubs02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/clubs02)
 * @see {@link https://clicons.dev/icon/clubs02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Clubs02Icon = React.forwardRef<SVGSVGElement, Clubs02IconProps>(
  (
    {
      size,
      color,
...
Clubs02Icon.displayName = 'Clubs02Icon';
