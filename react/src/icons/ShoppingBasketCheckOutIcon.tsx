...
interface ShoppingBasketCheckOutIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name ShoppingBasketCheckOutIcon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/shopping-basket-check-out)
 * @see {@link https://clicons.dev/icon/shopping-basket-check-out}
 */
const ShoppingBasketCheckOutIcon = React.forwardRef<SVGSVGElement, ShoppingBasketCheckOutIconProps>(
...
ShoppingBasketCheckOutIcon.displayName = 'ShoppingBasketCheckOutIcon';
