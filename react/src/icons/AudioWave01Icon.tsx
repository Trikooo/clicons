...
interface AudioWave01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/audio-wave01)
 * @see {@link https://clicons.dev/icon/audio-wave01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AudioWave01Icon = React.forwardRef<SVGSVGElement, AudioWave01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M9 3V21", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
export default AudioWave01Icon;
