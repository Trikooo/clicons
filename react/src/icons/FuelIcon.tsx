...
const FuelIcon = React.forwardRef<SVGSVGElement, FuelIconProps>(
  (
    ...
    const iconData = [["path", { d: "M5 6V5.5C5 4.55719 5 4.08579 5.29289 3.79289C5.58579 3.5 6.05719 3.5 7 3.5C7.94281 3.5 8.41421 3.5 8.70711 3.79289C9 4.08579 9 4.55719 9 5.5V6", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
