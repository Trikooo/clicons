...
interface InsertRowDownIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const InsertRowDownIcon = React.forwardRef<SVGSVGElement, InsertRowDownIconProps>(
  (
    {
      size,
      color,
...
InsertRowDownIcon.displayName = 'InsertRowDownIcon';
export default InsertRowDownIcon;
