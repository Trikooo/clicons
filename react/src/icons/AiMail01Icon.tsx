...
interface AiMail01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/ai-mail01)
 * @see {@link https://clicons.dev/icon/ai-mail01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AiMail01Icon = React.forwardRef<SVGSVGElement, AiMail01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M7 8L9.94202 9.73943C11.6572 10.7535 12.3428 10.7535 14.058 9.73943L17 8", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
AiMail01Icon.displayName = 'AiMail01Icon';
export default AiMail01Icon;
