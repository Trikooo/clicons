...
interface MessageNotification2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name MessageNotification2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/message-notification2)
 * @see {@link https://clicons.dev/icon/message-notification2}
 */
const MessageNotification2Icon = React.forwardRef<SVGSVGElement, MessageNotification2IconProps>(
...
MessageNotification2Icon.displayName = 'MessageNotification2Icon';
