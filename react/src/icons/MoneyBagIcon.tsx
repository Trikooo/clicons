...
interface MoneyBagIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/money-bag)
 * @see {@link https://clicons.dev/icon/money-bag} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MoneyBagIcon = React.forwardRef<SVGSVGElement, MoneyBagIconProps>(
  (
    {
      size,
      color,
