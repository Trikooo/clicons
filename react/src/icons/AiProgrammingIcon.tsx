...
interface AiProgrammingIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const AiProgrammingIcon = React.forwardRef<SVGSVGElement, AiProgrammingIconProps>(
  (
    {
      size,
      color,
...
AiProgrammingIcon.displayName = 'AiProgrammingIcon';
