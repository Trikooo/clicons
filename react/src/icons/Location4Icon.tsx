...
interface Location4IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/location4}
 */
const Location4Icon = React.forwardRef<SVGSVGElement, Location4IconProps>(
...
Location4Icon.displayName = 'Location4Icon';
