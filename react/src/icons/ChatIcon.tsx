...
interface ChatIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/chat)
 * @see {@link https://clicons.dev/icon/chat} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ChatIcon = React.forwardRef<SVGSVGElement, ChatIconProps>(
  (
    {
      size,
      color,
