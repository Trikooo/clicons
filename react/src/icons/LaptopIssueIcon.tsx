...
interface LaptopIssueIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const LaptopIssueIcon = React.forwardRef<SVGSVGElement, LaptopIssueIconProps>(
  (
    {
      size,
      color,
...
LaptopIssueIcon.displayName = 'LaptopIssueIcon';
