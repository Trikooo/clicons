...
interface Heading02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/heading02)
 * @see {@link https://clicons.dev/icon/heading02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Heading02Icon = React.forwardRef<SVGSVGElement, Heading02IconProps>(
  (
    {
      size,
      color,
