...
interface Target2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/target2)
 * @see {@link https://clicons.dev/icon/target2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Target2Icon = React.forwardRef<SVGSVGElement, Target2IconProps>(
  (
    {
      size,
      color,
...
Target2Icon.displayName = 'Target2Icon';
export default Target2Icon;
