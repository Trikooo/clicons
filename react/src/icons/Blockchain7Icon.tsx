...
interface Blockchain7IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name Blockchain7Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/blockchain7)
 * @see {@link https://clicons.dev/icon/blockchain7}
 */
const Blockchain7Icon = React.forwardRef<SVGSVGElement, Blockchain7IconProps>(
...
Blockchain7Icon.displayName = 'Blockchain7Icon';
