...
interface Unlink6IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/unlink6}
 */
const Unlink6Icon = React.forwardRef<SVGSVGElement, Unlink6IconProps>(
...
Unlink6Icon.displayName = 'Unlink6Icon';
