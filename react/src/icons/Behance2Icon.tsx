...
interface Behance2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/behance2}
 */
const Behance2Icon = React.forwardRef<SVGSVGElement, Behance2IconProps>(
...
Behance2Icon.displayName = 'Behance2Icon';
