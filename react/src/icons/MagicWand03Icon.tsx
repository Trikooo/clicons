...
interface MagicWand03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/magic-wand03)
 * @see {@link https://clicons.dev/icon/magic-wand03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MagicWand03Icon = React.forwardRef<SVGSVGElement, MagicWand03IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M15 15L16.5 16.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
MagicWand03Icon.displayName = 'MagicWand03Icon';
