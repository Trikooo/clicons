...
interface TaskDoneIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/task-done}
 */
const TaskDoneIcon = React.forwardRef<SVGSVGElement, TaskDoneIconProps>(
...
TaskDoneIcon.displayName = 'TaskDoneIcon';
