...
interface DistributionIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/distribution)
 * @see {@link https://clicons.dev/icon/distribution} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const DistributionIcon = React.forwardRef<SVGSVGElement, DistributionIconProps>(
  (
    {
      size,
      color,
