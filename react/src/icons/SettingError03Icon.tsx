...
interface SettingError03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/setting-error03)
 * @see {@link https://clicons.dev/icon/setting-error03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SettingError03Icon = React.forwardRef<SVGSVGElement, SettingError03IconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M14.384 9.43749C13.7591 8.85581 12.9211 8.5 12 8.5C10.067 8.5 8.5 10.067 8.5 12C8.5 12.9211 8.85581 13.7591 9.43749 14.384", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "1" }],
...
SettingError03Icon.displayName = 'SettingError03Icon';
export default SettingError03Icon;
