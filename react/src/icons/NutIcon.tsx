...
interface NutIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/nut)
 * @see {@link https://clicons.dev/icon/nut} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const NutIcon = React.forwardRef<SVGSVGElement, NutIconProps>(
  (
    {
      size,
      color,
