...
interface MessageOutgoing2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MessageOutgoing2Icon = React.forwardRef<SVGSVGElement, MessageOutgoing2IconProps>(
  (
    {
      size,
      color,
...
MessageOutgoing2Icon.displayName = 'MessageOutgoing2Icon';
export default MessageOutgoing2Icon;
