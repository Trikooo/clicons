...
interface Home2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/home2}
 */
const Home2Icon = React.forwardRef<SVGSVGElement, Home2IconProps>(
