...
interface LongitudeIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/longitude}
 */
const LongitudeIcon = React.forwardRef<SVGSVGElement, LongitudeIconProps>(
