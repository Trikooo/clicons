...
interface ChatFavouriteIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name ChatFavouriteIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/chat-favourite)
 * @see {@link https://clicons.dev/icon/chat-favourite} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ChatFavouriteIcon = React.forwardRef<SVGSVGElement, ChatFavouriteIconProps>(
  (
    {
      size,
      color,
...
ChatFavouriteIcon.displayName = 'ChatFavouriteIcon';
export default ChatFavouriteIcon;
