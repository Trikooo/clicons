...
interface Tired01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/tired01)
 * @see {@link https://clicons.dev/icon/tired01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Tired01Icon = React.forwardRef<SVGSVGElement, Tired01IconProps>(
  (
    {
      size,
      color,
...
Tired01Icon.displayName = 'Tired01Icon';
