...
interface SwipeLeft2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/swipe-left2)
 * @see {@link https://clicons.dev/icon/swipe-left2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SwipeLeft2Icon = React.forwardRef<SVGSVGElement, SwipeLeft2IconProps>(
  (
    {
      size,
      color,
