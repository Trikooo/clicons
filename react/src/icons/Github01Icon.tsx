...
interface Github01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/github01)
 * @see {@link https://clicons.dev/icon/github01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Github01Icon = React.forwardRef<SVGSVGElement, Github01IconProps>(
  (
    {
      size,
      color,
...
Github01Icon.displayName = 'Github01Icon';
