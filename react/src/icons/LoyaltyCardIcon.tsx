 ...
 * @see {@link https://clicons.dev/icon/loyalty-card} - Icon preview
...
const LoyaltyCardIcon = React.forwardRef<SVGSVGElement, LoyaltyCardIconProps>(
  (
    ...
    const iconData = [["path", { d: "M2 12C2 7.99306 2 5.98959 3.17157 4.7448C4.34315 3.5 6.22876 3.5 10 3.5H14C17.7712 3.5 19.6569 3.5 20.8284 4.7448C22 5.98959 22 7.99306 22 12C22 16.0069 22 18.0104 20.8284 19.2552C19.6569 20.5 17.7712 20.5 14 20.5H10C6.22876 20.5 4.34315 20.5 3.17157 19.2552C2 18.0104 2 16.0069 2 12Z", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
