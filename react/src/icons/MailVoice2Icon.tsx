...
interface MailVoice2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/mail-voice2}
 */
const MailVoice2Icon = React.forwardRef<SVGSVGElement, MailVoice2IconProps>(
...
MailVoice2Icon.displayName = 'MailVoice2Icon';
