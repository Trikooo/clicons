...
interface ShoppingBasketDone2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const ShoppingBasketDone2Icon = React.forwardRef<SVGSVGElement, ShoppingBasketDone2IconProps>(
  (
    {
      size,
      color,
...
ShoppingBasketDone2Icon.displayName = 'ShoppingBasketDone2Icon';
export default ShoppingBasketDone2Icon;
