...
interface CursorProgress01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/cursor-progress01)
 * @see {@link https://clicons.dev/icon/cursor-progress01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CursorProgress01Icon = React.forwardRef<SVGSVGElement, CursorProgress01IconProps>(
  (
    {
      size,
      color,
...
CursorProgress01Icon.displayName = 'CursorProgress01Icon';
