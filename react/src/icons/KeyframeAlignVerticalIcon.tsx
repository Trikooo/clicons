...
interface KeyframeAlignVerticalIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const KeyframeAlignVerticalIcon = React.forwardRef<SVGSVGElement, KeyframeAlignVerticalIconProps>(
  (
    {
      size,
      color,
