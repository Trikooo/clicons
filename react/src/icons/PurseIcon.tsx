...
const PurseIcon = React.forwardRef<SVGSVGElement, PurseIconProps>(
  (
    ...
    const iconData = [["path", { d: "M16 14C16 14.8284 16.6716 15.5 17.5 15.5C18.3284 15.5 19 14.8284 19 14C19 13.1716 18.3284 12.5 17.5 12.5C16.6716 12.5 16 13.1716 16 14Z", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
