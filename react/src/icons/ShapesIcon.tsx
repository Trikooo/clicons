...
interface ShapesIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/shapes)
 * @see {@link https://clicons.dev/icon/shapes} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ShapesIcon = React.forwardRef<SVGSVGElement, ShapesIconProps>(
  (
    {
      size,
      color,
