...
interface DashboardSquareIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name DashboardSquareIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/dashboard-square)
 * @see {@link https://clicons.dev/icon/dashboard-square} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const DashboardSquareIcon = React.forwardRef<SVGSVGElement, DashboardSquareIconProps>(
  (
    {
      size,
      color,
...
DashboardSquareIcon.displayName = 'DashboardSquareIcon';
export default DashboardSquareIcon;
