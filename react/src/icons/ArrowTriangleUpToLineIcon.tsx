...
interface ArrowTriangleUpToLineIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name ArrowTriangleUpToLineIcon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/arrow-triangle-up-to-line)
 * @see {@link https://clicons.dev/icon/arrow-triangle-up-to-line}
 */
const ArrowTriangleUpToLineIcon = React.forwardRef<SVGSVGElement, ArrowTriangleUpToLineIconProps>(
...
ArrowTriangleUpToLineIcon.displayName = 'ArrowTriangleUpToLineIcon';
export default ArrowTriangleUpToLineIcon;
