...
interface Agreement03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/agreement03)
 * @see {@link https://clicons.dev/icon/agreement03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Agreement03Icon = React.forwardRef<SVGSVGElement, Agreement03IconProps>(
  (
    {
      size,
      color,
...
Agreement03Icon.displayName = 'Agreement03Icon';
