...
interface PresentationBarChart02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/presentation-bar-chart02)
 * @see {@link https://clicons.dev/icon/presentation-bar-chart02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PresentationBarChart02Icon = React.forwardRef<SVGSVGElement, PresentationBarChart02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M12 18V22", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
PresentationBarChart02Icon.displayName = 'PresentationBarChart02Icon';
