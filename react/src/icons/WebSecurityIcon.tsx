...
interface WebSecurityIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/web-security}
 */
const WebSecurityIcon = React.forwardRef<SVGSVGElement, WebSecurityIconProps>(
...
WebSecurityIcon.displayName = 'WebSecurityIcon';
