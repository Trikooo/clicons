...
interface Location8IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Location8Icon = React.forwardRef<SVGSVGElement, Location8IconProps>(
  (
    {
      size,
      color,
...
Location8Icon.displayName = 'Location8Icon';
export default Location8Icon;
