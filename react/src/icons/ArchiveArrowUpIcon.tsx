...
interface ArchiveArrowUpIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const ArchiveArrowUpIcon = React.forwardRef<SVGSVGElement, ArchiveArrowUpIconProps>(
  (
    {
      size,
      color,
