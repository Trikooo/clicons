...
const NuclearPowerIcon = React.forwardRef<SVGSVGElement, NuclearPowerIconProps>(
  (
    ...
    const iconData = [["path", { d: "M14 12.5C14 13.6046 13.1046 14.5 12 14.5C10.8954 14.5 10 13.6046 10 12.5C10 11.3954 10.8954 10.5 12 10.5C13.1046 10.5 14 11.3954 14 12.5Z", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
...
NuclearPowerIcon.displayName = 'NuclearPowerIcon';
