...
interface Motorbike02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/motorbike02)
 * @see {@link https://clicons.dev/icon/motorbike02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Motorbike02Icon = React.forwardRef<SVGSVGElement, Motorbike02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["circle", { cx: "19.5", cy: "16.5", r: "2.5", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
  ["circle", { cx: "4.5", cy: "16.5", r: "2.5", stroke: "currentColor", strokeWidth: "1.5", key: "1" }],
...
Motorbike02Icon.displayName = 'Motorbike02Icon';
