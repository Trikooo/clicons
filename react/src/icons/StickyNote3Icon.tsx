...
interface StickyNote3IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name StickyNote3Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/sticky-note3)
 * @see {@link https://clicons.dev/icon/sticky-note3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const StickyNote3Icon = React.forwardRef<SVGSVGElement, StickyNote3IconProps>(
  (
    {
      size,
      color,
...
StickyNote3Icon.displayName = 'StickyNote3Icon';
export default StickyNote3Icon;
