...
interface Unlink4IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/unlink4}
 */
const Unlink4Icon = React.forwardRef<SVGSVGElement, Unlink4IconProps>(
...
Unlink4Icon.displayName = 'Unlink4Icon';
