...
interface Link01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/link01)
 * @see {@link https://clicons.dev/icon/link01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Link01Icon = React.forwardRef<SVGSVGElement, Link01IconProps>(
  (
    {
      size,
      color,
