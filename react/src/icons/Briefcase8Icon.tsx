...
interface Briefcase8IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/briefcase8)
 * @see {@link https://clicons.dev/icon/briefcase8} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Briefcase8Icon = React.forwardRef<SVGSVGElement, Briefcase8IconProps>(
  (
    {
      size,
      color,
...
Briefcase8Icon.displayName = 'Briefcase8Icon';
export default Briefcase8Icon;
