...
interface EnergyRectangleIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/energy-rectangle)
 * @see {@link https://clicons.dev/icon/energy-rectangle} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const EnergyRectangleIcon = React.forwardRef<SVGSVGElement, EnergyRectangleIconProps>(
  (
    {
      size,
      color,
...
EnergyRectangleIcon.displayName = 'EnergyRectangleIcon';
