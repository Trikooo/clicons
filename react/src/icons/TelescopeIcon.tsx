...
interface TelescopeIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/telescope)
 * @see {@link https://clicons.dev/icon/telescope} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TelescopeIcon = React.forwardRef<SVGSVGElement, TelescopeIconProps>(
  (
    {
      size,
      color,
