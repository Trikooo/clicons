...
interface Sushi2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/sushi2}
 */
const Sushi2Icon = React.forwardRef<SVGSVGElement, Sushi2IconProps>(
...
Sushi2Icon.displayName = 'Sushi2Icon';
