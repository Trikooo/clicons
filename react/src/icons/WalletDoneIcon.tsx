...
interface WalletDoneIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const WalletDoneIcon = React.forwardRef<SVGSVGElement, WalletDoneIconProps>(
  (
    {
      size,
      color,
...
WalletDoneIcon.displayName = 'WalletDoneIcon';
export default WalletDoneIcon;
