...
interface StoreAdd02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/store-add02)
 * @see {@link https://clicons.dev/icon/store-add02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const StoreAdd02Icon = React.forwardRef<SVGSVGElement, StoreAdd02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M3 10.5V15C3 17.8284 3 19.2426 3.87868 20.1213C4.75736 21 6.17157 21 9 21H12.5M21 10.5V12.5", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
...
StoreAdd02Icon.displayName = 'StoreAdd02Icon';
