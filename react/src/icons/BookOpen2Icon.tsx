...
interface BookOpen2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/book-open2}
 */
const BookOpen2Icon = React.forwardRef<SVGSVGElement, BookOpen2IconProps>(
