...
interface Clock03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/clock03)
 * @see {@link https://clicons.dev/icon/clock03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Clock03Icon = React.forwardRef<SVGSVGElement, Clock03IconProps>(
  (
    {
      size,
      color,
...
Clock03Icon.displayName = 'Clock03Icon';
