...
interface FilmRoll01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/film-roll01)
 * @see {@link https://clicons.dev/icon/film-roll01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FilmRoll01Icon = React.forwardRef<SVGSVGElement, FilmRoll01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M4 4.5H13V22H4V4.5Z", stroke: "currentColor", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
FilmRoll01Icon.displayName = 'FilmRoll01Icon';
