...
interface Loading02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/loading02)
 * @see {@link https://clicons.dev/icon/loading02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Loading02Icon = React.forwardRef<SVGSVGElement, Loading02IconProps>(
  (
    {
      size,
      color,
