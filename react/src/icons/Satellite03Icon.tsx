...
interface Satellite03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/satellite03)
 * @see {@link https://clicons.dev/icon/satellite03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Satellite03Icon = React.forwardRef<SVGSVGElement, Satellite03IconProps>(
  (
    {
      size,
      color,
...
Satellite03Icon.displayName = 'Satellite03Icon';
