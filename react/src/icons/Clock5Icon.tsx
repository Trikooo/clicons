...
interface Clock5IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/clock5}
 */
const Clock5Icon = React.forwardRef<SVGSVGElement, Clock5IconProps>(
...
Clock5Icon.displayName = 'Clock5Icon';
