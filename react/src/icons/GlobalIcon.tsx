...
interface GlobalIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/global)
 * @see {@link https://clicons.dev/icon/global} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const GlobalIcon = React.forwardRef<SVGSVGElement, GlobalIconProps>(
  (
    {
      size,
      color,
...
GlobalIcon.displayName = 'GlobalIcon';
