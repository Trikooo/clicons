...
interface BatteryChargingIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const BatteryChargingIcon = React.forwardRef<SVGSVGElement, BatteryChargingIconProps>(
  (
    {
      size,
      color,
