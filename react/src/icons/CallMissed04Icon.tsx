...
interface CallMissed04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-missed04)
 * @see {@link https://clicons.dev/icon/call-missed04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallMissed04Icon = React.forwardRef<SVGSVGElement, CallMissed04IconProps>(
  (
    {
      size,
      color,
...
CallMissed04Icon.displayName = 'CallMissed04Icon';
export default CallMissed04Icon;
