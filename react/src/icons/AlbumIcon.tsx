...
interface AlbumIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/album)
 * @see {@link https://clicons.dev/icon/album} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AlbumIcon = React.forwardRef<SVGSVGElement, AlbumIconProps>(
  (
    {
      size,
      color,
