...
interface TwoFinger2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/two-finger2)
 * @see {@link https://clicons.dev/icon/two-finger2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TwoFinger2Icon = React.forwardRef<SVGSVGElement, TwoFinger2IconProps>(
  (
    {
      size,
      color,
...
TwoFinger2Icon.displayName = 'TwoFinger2Icon';
export default TwoFinger2Icon;
