...
interface Chatting01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/chatting01)
 * @see {@link https://clicons.dev/icon/chatting01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Chatting01Icon = React.forwardRef<SVGSVGElement, Chatting01IconProps>(
  (
    {
      size,
      color,
...
Chatting01Icon.displayName = 'Chatting01Icon';
