...
interface PineTreeIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const PineTreeIcon = React.forwardRef<SVGSVGElement, PineTreeIconProps>(
  (
    {
      size,
      color,
