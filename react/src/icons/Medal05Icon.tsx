...
interface Medal05IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/medal05)
 * @see {@link https://clicons.dev/icon/medal05} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Medal05Icon = React.forwardRef<SVGSVGElement, Medal05IconProps>(
  (
    {
      size,
      color,
...
Medal05Icon.displayName = 'Medal05Icon';
