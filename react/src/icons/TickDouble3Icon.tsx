...
interface TickDouble3IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name TickDouble3Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/tick-double3)
 * @see {@link https://clicons.dev/icon/tick-double3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TickDouble3Icon = React.forwardRef<SVGSVGElement, TickDouble3IconProps>(
  (
    {
      size,
      color,
...
TickDouble3Icon.displayName = 'TickDouble3Icon';
export default TickDouble3Icon;
