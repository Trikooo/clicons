...
const BitcoinLocationIcon = React.forwardRef<SVGSVGElement, BitcoinLocationIconProps>(
  (
    ...
    const iconData = [["path", { d: "M18 18.2678C19.2447 18.6638 20 19.184 20 19.7537C20 20.9943 16.4183 22 12 22C7.58172 22 4 20.9943 4 19.7537C4 19.184 4.75527 18.6638 6 18.2678", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
