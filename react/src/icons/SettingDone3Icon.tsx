...
interface SettingDone3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name SettingDone3Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/setting-done3)
 * @see {@link https://clicons.dev/icon/setting-done3}
 */
const SettingDone3Icon = React.forwardRef<SVGSVGElement, SettingDone3IconProps>(
...
SettingDone3Icon.displayName = 'SettingDone3Icon';
