...
interface BookDownloadIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const BookDownloadIcon = React.forwardRef<SVGSVGElement, BookDownloadIconProps>(
  (
    {
      size,
      color,
...
BookDownloadIcon.displayName = 'BookDownloadIcon';
