...
interface Invoice02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/invoice02)
 * @see {@link https://clicons.dev/icon/invoice02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Invoice02Icon = React.forwardRef<SVGSVGElement, Invoice02IconProps>(
  (
    {
      size,
      color,
...
Invoice02Icon.displayName = 'Invoice02Icon';
