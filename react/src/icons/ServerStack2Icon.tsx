...
interface ServerStack2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const ServerStack2Icon = React.forwardRef<SVGSVGElement, ServerStack2IconProps>(
  (
    {
      size,
      color,
...
ServerStack2Icon.displayName = 'ServerStack2Icon';
export default ServerStack2Icon;
