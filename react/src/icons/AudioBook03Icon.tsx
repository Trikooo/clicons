...
interface AudioBook03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/audio-book03)
 * @see {@link https://clicons.dev/icon/audio-book03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AudioBook03Icon = React.forwardRef<SVGSVGElement, AudioBook03IconProps>(
  (
    {
      size,
      color,
...
AudioBook03Icon.displayName = 'AudioBook03Icon';
