...
interface Cards02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/cards02)
 * @see {@link https://clicons.dev/icon/cards02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Cards02Icon = React.forwardRef<SVGSVGElement, Cards02IconProps>(
  (
    {
      size,
      color,
...
Cards02Icon.displayName = 'Cards02Icon';
