...
interface DeliverySent02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/delivery-sent02)
 * @see {@link https://clicons.dev/icon/delivery-sent02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const DeliverySent02Icon = React.forwardRef<SVGSVGElement, DeliverySent02IconProps>(
  (
    {
      size,
      color,
...
DeliverySent02Icon.displayName = 'DeliverySent02Icon';
export default DeliverySent02Icon;
