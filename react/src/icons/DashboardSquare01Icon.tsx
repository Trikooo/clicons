...
interface DashboardSquare01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/dashboard-square01)
 * @see {@link https://clicons.dev/icon/dashboard-square01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const DashboardSquare01Icon = React.forwardRef<SVGSVGElement, DashboardSquare01IconProps>(
  (
    {
      size,
      color,
