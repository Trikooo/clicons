...
interface NewTwitterRectangleIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/new-twitter-rectangle}
 */
const NewTwitterRectangleIcon = React.forwardRef<SVGSVGElement, NewTwitterRectangleIconProps>(
...
NewTwitterRectangleIcon.displayName = 'NewTwitterRectangleIcon';
