...
interface EarthIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/earth)
 * @see {@link https://clicons.dev/icon/earth} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const EarthIcon = React.forwardRef<SVGSVGElement, EarthIconProps>(
  (
    {
      size,
      color,
