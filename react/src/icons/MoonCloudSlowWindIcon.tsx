...
interface MoonCloudSlowWindIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/moon-cloud-slow-wind}
 */
const MoonCloudSlowWindIcon = React.forwardRef<SVGSVGElement, MoonCloudSlowWindIconProps>(
...
MoonCloudSlowWindIcon.displayName = 'MoonCloudSlowWindIcon';
