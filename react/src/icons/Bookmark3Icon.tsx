...
interface Bookmark3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/bookmark3)
 * @see {@link https://clicons.dev/icon/bookmark3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Bookmark3Icon = React.forwardRef<SVGSVGElement, Bookmark3IconProps>(
  (
    {
      size,
      color,
...
Bookmark3Icon.displayName = 'Bookmark3Icon';
export default Bookmark3Icon;
