...
interface MailDownload02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mail-download02)
 * @see {@link https://clicons.dev/icon/mail-download02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MailDownload02Icon = React.forwardRef<SVGSVGElement, MailDownload02IconProps>(
  (
    {
      size,
      color,
...
MailDownload02Icon.displayName = 'MailDownload02Icon';
