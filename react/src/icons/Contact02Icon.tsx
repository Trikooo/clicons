...
interface Contact02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/contact02)
 * @see {@link https://clicons.dev/icon/contact02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Contact02Icon = React.forwardRef<SVGSVGElement, Contact02IconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M5 6L2.5 6M5 12L2.5 12M5 18H2.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "2" }]];
...
Contact02Icon.displayName = 'Contact02Icon';
