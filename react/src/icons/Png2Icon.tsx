...
interface Png2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/png2}
 */
const Png2Icon = React.forwardRef<SVGSVGElement, Png2IconProps>(
