...
interface Location3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Location3Icon = React.forwardRef<SVGSVGElement, Location3IconProps>(
  (
    {
      size,
      color,
...
Location3Icon.displayName = 'Location3Icon';
