...
interface Shaka3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/shaka3}
 */
const Shaka3Icon = React.forwardRef<SVGSVGElement, Shaka3IconProps>(
...
Shaka3Icon.displayName = 'Shaka3Icon';
