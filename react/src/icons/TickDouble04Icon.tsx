...
interface TickDouble04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/tick-double04)
 * @see {@link https://clicons.dev/icon/tick-double04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TickDouble04Icon = React.forwardRef<SVGSVGElement, TickDouble04IconProps>(
  (
    {
      size,
      color,
...
TickDouble04Icon.displayName = 'TickDouble04Icon';
export default TickDouble04Icon;
