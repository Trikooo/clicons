...
interface Sword3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/sword3}
 */
const Sword3Icon = React.forwardRef<SVGSVGElement, Sword3IconProps>(
...
Sword3Icon.displayName = 'Sword3Icon';
