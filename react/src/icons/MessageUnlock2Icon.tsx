...
interface MessageUnlock2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name MessageUnlock2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/message-unlock2)
 * @see {@link https://clicons.dev/icon/message-unlock2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MessageUnlock2Icon = React.forwardRef<SVGSVGElement, MessageUnlock2IconProps>(
  (
    {
      size,
      color,
...
MessageUnlock2Icon.displayName = 'MessageUnlock2Icon';
export default MessageUnlock2Icon;
