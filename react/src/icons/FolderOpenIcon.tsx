...
interface FolderOpenIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/folder-open)
 * @see {@link https://clicons.dev/icon/folder-open} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FolderOpenIcon = React.forwardRef<SVGSVGElement, FolderOpenIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M11.5 4.51456C12.4151 3.28409 13.6662 2.55594 15.5125 2.50161C16.1155 2.48386 16.7152 2.61395 17.2682 2.85544C18.5748 3.42601 19.4185 4.15644 20 5.5L21.5 3", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "2" }]];
