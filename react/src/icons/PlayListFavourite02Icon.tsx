...
interface PlayListFavourite02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/play-list-favourite02)
 * @see {@link https://clicons.dev/icon/play-list-favourite02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PlayListFavourite02Icon = React.forwardRef<SVGSVGElement, PlayListFavourite02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M21.5 12.5V11.05C21.5 7.01949 21.5 5.00424 20.2479 3.75212C18.9958 2.5 16.9805 2.5 12.95 2.5H11.05C7.01949 2.5 5.00424 2.5 3.75212 3.75212C2.5 5.00424 2.5 7.01949 2.5 11.05V12.95C2.5 16.9805 2.5 18.9958 3.75212 20.2479C5.00424 21.5 7.01949 21.5 11.05 21.5H12.5", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
...
PlayListFavourite02Icon.displayName = 'PlayListFavourite02Icon';
