...
interface Layout3RowIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/layout3-row}
 */
const Layout3RowIcon = React.forwardRef<SVGSVGElement, Layout3RowIconProps>(
...
Layout3RowIcon.displayName = 'Layout3RowIcon';
