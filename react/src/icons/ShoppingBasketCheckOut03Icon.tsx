...
interface ShoppingBasketCheckOut03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/shopping-basket-check-out03)
 * @see {@link https://clicons.dev/icon/shopping-basket-check-out03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ShoppingBasketCheckOut03Icon = React.forwardRef<SVGSVGElement, ShoppingBasketCheckOut03IconProps>(
  (
    {
      size,
      color,
...
ShoppingBasketCheckOut03Icon.displayName = 'ShoppingBasketCheckOut03Icon';
export default ShoppingBasketCheckOut03Icon;
