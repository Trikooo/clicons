...
interface AlbumNotFoundIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const AlbumNotFoundIcon = React.forwardRef<SVGSVGElement, AlbumNotFoundIconProps>(
  (
    {
      size,
      color,
...
AlbumNotFoundIcon.displayName = 'AlbumNotFoundIcon';
export default AlbumNotFoundIcon;
