...
interface PointingRight05IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pointing-right05)
 * @see {@link https://clicons.dev/icon/pointing-right05} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PointingRight05Icon = React.forwardRef<SVGSVGElement, PointingRight05IconProps>(
  (
    {
      size,
      color,
...
PointingRight05Icon.displayName = 'PointingRight05Icon';
