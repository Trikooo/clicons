...
interface MedicineBottleIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name MedicineBottleIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/medicine-bottle)
 * @see {@link https://clicons.dev/icon/medicine-bottle} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MedicineBottleIcon = React.forwardRef<SVGSVGElement, MedicineBottleIconProps>(
  (
    {
      size,
      color,
...
MedicineBottleIcon.displayName = 'MedicineBottleIcon';
