...
interface AppleNewsIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/apple-news)
 * @see {@link https://clicons.dev/icon/apple-news} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AppleNewsIcon = React.forwardRef<SVGSVGElement, AppleNewsIconProps>(
  (
    {
      size,
      color,
...
AppleNewsIcon.displayName = 'AppleNewsIcon';
