...
interface MailRemove02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mail-remove02)
 * @see {@link https://clicons.dev/icon/mail-remove02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MailRemove02Icon = React.forwardRef<SVGSVGElement, MailRemove02IconProps>(
  (
    {
      size,
      color,
...
MailRemove02Icon.displayName = 'MailRemove02Icon';
