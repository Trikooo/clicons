...
interface ShieldKeyIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const ShieldKeyIcon = React.forwardRef<SVGSVGElement, ShieldKeyIconProps>(
  (
    {
      size,
      color,
