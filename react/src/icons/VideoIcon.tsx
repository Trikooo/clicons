...
interface VideoIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/video)
 * @see {@link https://clicons.dev/icon/video} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const VideoIcon = React.forwardRef<SVGSVGElement, VideoIconProps>(
  (
    {
      size,
      color,
