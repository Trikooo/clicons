...
interface LocationOffline2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name LocationOffline2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/location-offline2)
 * @see {@link https://clicons.dev/icon/location-offline2}
 */
const LocationOffline2Icon = React.forwardRef<SVGSVGElement, LocationOffline2IconProps>(
...
LocationOffline2Icon.displayName = 'LocationOffline2Icon';
