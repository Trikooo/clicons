...
interface Package03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/package03)
 * @see {@link https://clicons.dev/icon/package03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Package03Icon = React.forwardRef<SVGSVGElement, Package03IconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M21 6V18C21 18.7042 19.9348 19.1132 17.8043 19.9313L13.6094 21.5422C12.8147 21.8474 12.4173 22 12 22C11.5827 22 11.1853 21.8474 10.3906 21.5422L6.19573 19.9313C4.06524 19.1132 3 18.7042 3 18V6',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
Package03Icon.displayName = 'Package03Icon';
export default Package03Icon;
