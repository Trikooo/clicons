...
interface Atm2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/atm2}
 */
const Atm2Icon = React.forwardRef<SVGSVGElement, Atm2IconProps>(
