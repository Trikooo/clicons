...
interface Contact2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/contact2}
 */
const Contact2Icon = React.forwardRef<SVGSVGElement, Contact2IconProps>(
...
Contact2Icon.displayName = 'Contact2Icon';
