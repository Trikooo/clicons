...
interface ArrowRight5IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/arrow-right5)
 * @see {@link https://clicons.dev/icon/arrow-right5} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ArrowRight5Icon = React.forwardRef<SVGSVGElement, ArrowRight5IconProps>(
  (
    {
      size,
      color,
...
ArrowRight5Icon.displayName = 'ArrowRight5Icon';
export default ArrowRight5Icon;
