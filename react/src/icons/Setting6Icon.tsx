...
interface Setting6IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/setting6}
 */
const Setting6Icon = React.forwardRef<SVGSVGElement, Setting6IconProps>(
...
Setting6Icon.displayName = 'Setting6Icon';
