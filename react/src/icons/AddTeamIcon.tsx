...
interface AddTeamIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const AddTeamIcon = React.forwardRef<SVGSVGElement, AddTeamIconProps>(
  (
    {
      size,
      color,
...
AddTeamIcon.displayName = 'AddTeamIcon';
