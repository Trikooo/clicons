 ...
 * @see {@link https://clicons.dev/icon/stroke-left}
 */
const StrokeLeftIcon = React.forwardRef<SVGSVGElement, StrokeLeftIconProps>(
  ...
  [
    'path',
    {
      d: 'M7 5H15C17.8284 5 19.2426 5 20.1213 5.87868C21 6.75736 21 8.17157 21 11V13C21 15.8284 21 17.2426 20.1213 18.1213C19.2426 19 17.8284 19 15 19H7'
    }
  ],
  [
    'path',
