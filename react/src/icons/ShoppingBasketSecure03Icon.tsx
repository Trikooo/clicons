...
interface ShoppingBasketSecure03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/shopping-basket-secure03)
 * @see {@link https://clicons.dev/icon/shopping-basket-secure03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ShoppingBasketSecure03Icon = React.forwardRef<SVGSVGElement, ShoppingBasketSecure03IconProps>(
  (
    {
      size,
      color,
...
ShoppingBasketSecure03Icon.displayName = 'ShoppingBasketSecure03Icon';
