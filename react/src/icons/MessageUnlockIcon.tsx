...
interface MessageUnlockIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name MessageUnlockIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/message-unlock)
 * @see {@link https://clicons.dev/icon/message-unlock} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MessageUnlockIcon = React.forwardRef<SVGSVGElement, MessageUnlockIconProps>(
  (
    {
      size,
      color,
...
MessageUnlockIcon.displayName = 'MessageUnlockIcon';
