...
interface Layout3ColumnIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/layout3-column}
 */
const Layout3ColumnIcon = React.forwardRef<SVGSVGElement, Layout3ColumnIconProps>(
...
Layout3ColumnIcon.displayName = 'Layout3ColumnIcon';
