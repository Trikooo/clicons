...
interface Trolley2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Trolley2Icon = React.forwardRef<SVGSVGElement, Trolley2IconProps>(
  (
    {
      size,
      color,
...
Trolley2Icon.displayName = 'Trolley2Icon';
export default Trolley2Icon;
