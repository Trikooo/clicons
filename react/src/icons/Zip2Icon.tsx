...
interface Zip2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Zip2Icon = React.forwardRef<SVGSVGElement, Zip2IconProps>(
  (
    {
      size,
      color,
...
Zip2Icon.displayName = 'Zip2Icon';
export default Zip2Icon;
