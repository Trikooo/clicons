...
interface Bitcoin03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/bitcoin03)
 * @see {@link https://clicons.dev/icon/bitcoin03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Bitcoin03Icon = React.forwardRef<SVGSVGElement, Bitcoin03IconProps>(
  (
    {
      size,
      color,
...
Bitcoin03Icon.displayName = 'Bitcoin03Icon';
