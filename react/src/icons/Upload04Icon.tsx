...
interface Upload04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/upload04)
 * @see {@link https://clicons.dev/icon/upload04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Upload04Icon = React.forwardRef<SVGSVGElement, Upload04IconProps>(
  (
    {
      size,
      color,
