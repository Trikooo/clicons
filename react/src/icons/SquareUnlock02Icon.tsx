...
interface SquareUnlock02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/square-unlock02)
 * @see {@link https://clicons.dev/icon/square-unlock02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SquareUnlock02Icon = React.forwardRef<SVGSVGElement, SquareUnlock02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M12 16.5V14.5", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
...
SquareUnlock02Icon.displayName = 'SquareUnlock02Icon';
