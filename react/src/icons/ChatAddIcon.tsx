...
interface ChatAddIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const ChatAddIcon = React.forwardRef<SVGSVGElement, ChatAddIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M15.5 10.5H8.5M12 7V14", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "1" }]];
