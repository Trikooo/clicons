...
interface CustomerServiceIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/customer-service)
 * @see {@link https://clicons.dev/icon/customer-service} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CustomerServiceIcon = React.forwardRef<SVGSVGElement, CustomerServiceIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M10 4.30518C10.089 4.20518 10.1815 4.10717 10.2774 4.01129C12.9591 1.32957 17.307 1.32957 19.9887 4.01129C22.6704 6.693 22.6704 11.0409 19.9887 13.7226C19.8928 13.8185 19.7948 13.911 19.6948 14", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "2" }]];
