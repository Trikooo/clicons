...
interface TouchLocked03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/touch-locked03)
 * @see {@link https://clicons.dev/icon/touch-locked03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TouchLocked03Icon = React.forwardRef<SVGSVGElement, TouchLocked03IconProps>(
  (
    {
      size,
      color,
...
TouchLocked03Icon.displayName = 'TouchLocked03Icon';
