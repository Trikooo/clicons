...
interface TicketStarIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/ticket-star)
 * @see {@link https://clicons.dev/icon/ticket-star} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TicketStarIcon = React.forwardRef<SVGSVGElement, TicketStarIconProps>(
  (
    {
      size,
      color,
...
TicketStarIcon.displayName = 'TicketStarIcon';
