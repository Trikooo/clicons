...
interface HoldLocked02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/hold-locked02)
 * @see {@link https://clicons.dev/icon/hold-locked02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const HoldLocked02Icon = React.forwardRef<SVGSVGElement, HoldLocked02IconProps>(
  (
    {
      size,
      color,
...
HoldLocked02Icon.displayName = 'HoldLocked02Icon';
