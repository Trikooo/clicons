...
interface DiceFaces3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const DiceFaces3Icon = React.forwardRef<SVGSVGElement, DiceFaces3IconProps>(
  (
    {
      size,
      color,
...
DiceFaces3Icon.displayName = 'DiceFaces3Icon';
export default DiceFaces3Icon;
