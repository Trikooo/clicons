...
interface DashedLine2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name DashedLine2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/dashed-line2)
 * @see {@link https://clicons.dev/icon/dashed-line2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const DashedLine2Icon = React.forwardRef<SVGSVGElement, DashedLine2IconProps>(
  (
    {
      size,
      color,
...
DashedLine2Icon.displayName = 'DashedLine2Icon';
export default DashedLine2Icon;
