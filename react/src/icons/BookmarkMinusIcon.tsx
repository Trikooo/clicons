...
interface BookmarkMinusIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const BookmarkMinusIcon = React.forwardRef<SVGSVGElement, BookmarkMinusIconProps>(
  (
    {
      size,
      color,
