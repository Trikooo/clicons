...
interface Chemistry02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/chemistry02)
 * @see {@link https://clicons.dev/icon/chemistry02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Chemistry02Icon = React.forwardRef<SVGSVGElement, Chemistry02IconProps>(
  (
    {
      size,
      color,
...
Chemistry02Icon.displayName = 'Chemistry02Icon';
