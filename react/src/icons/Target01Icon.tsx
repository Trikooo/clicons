...
interface Target01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/target01)
 * @see {@link https://clicons.dev/icon/target01} - Icon preview
