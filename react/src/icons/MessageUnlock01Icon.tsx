...
interface MessageUnlock01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/message-unlock01)
 * @see {@link https://clicons.dev/icon/message-unlock01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MessageUnlock01Icon = React.forwardRef<SVGSVGElement, MessageUnlock01IconProps>(
  (
    {
      size,
      color,
...
MessageUnlock01Icon.displayName = 'MessageUnlock01Icon';
export default MessageUnlock01Icon;
