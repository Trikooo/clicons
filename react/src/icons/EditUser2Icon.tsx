...
interface EditUser2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const EditUser2Icon = React.forwardRef<SVGSVGElement, EditUser2IconProps>(
  (
    {
      size,
      color,
...
EditUser2Icon.displayName = 'EditUser2Icon';
export default EditUser2Icon;
