...
interface MessageSearchIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/message-search}
 */
const MessageSearchIcon = React.forwardRef<SVGSVGElement, MessageSearchIconProps>(
...
MessageSearchIcon.displayName = 'MessageSearchIcon';
