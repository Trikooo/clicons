...
interface SevenZ02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/seven-z02)
 * @see {@link https://clicons.dev/icon/seven-z02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SevenZ02Icon = React.forwardRef<SVGSVGElement, SevenZ02IconProps>(
  (
    {
      size,
      color,
...
SevenZ02Icon.displayName = 'SevenZ02Icon';
