...
interface MessageAdd2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MessageAdd2Icon = React.forwardRef<SVGSVGElement, MessageAdd2IconProps>(
  (
    {
      size,
      color,
...
MessageAdd2Icon.displayName = 'MessageAdd2Icon';
export default MessageAdd2Icon;
