...
interface ImageRemove02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/image-remove02)
 * @see {@link https://clicons.dev/icon/image-remove02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ImageRemove02Icon = React.forwardRef<SVGSVGElement, ImageRemove02IconProps>(
  (
    {
      size,
      color,
...
ImageRemove02Icon.displayName = 'ImageRemove02Icon';
