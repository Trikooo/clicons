...
interface Sun2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/sun2}
 */
const Sun2Icon = React.forwardRef<SVGSVGElement, Sun2IconProps>(
