...
interface Blockchain3IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name Blockchain3Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/blockchain3)
 * @see {@link https://clicons.dev/icon/blockchain3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Blockchain3Icon = React.forwardRef<SVGSVGElement, Blockchain3IconProps>(
  (
    {
      size,
      color,
...
Blockchain3Icon.displayName = 'Blockchain3Icon';
export default Blockchain3Icon;
