...
interface Album01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/album01)
 * @see {@link https://clicons.dev/icon/album01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Album01Icon = React.forwardRef<SVGSVGElement, Album01IconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M5 18C8.42061 13.2487 12.2647 6.9475 18 11.6734", stroke: "currentColor", strokeWidth: "1.5", key: "2" }]];
...
Album01Icon.displayName = 'Album01Icon';
