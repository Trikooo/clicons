...
interface SquareArrowDiagonalIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name SquareArrowDiagonalIcon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/square-arrow-diagonal)
 * @see {@link https://clicons.dev/icon/square-arrow-diagonal}
 */
const SquareArrowDiagonalIcon = React.forwardRef<SVGSVGElement, SquareArrowDiagonalIconProps>(
...
SquareArrowDiagonalIcon.displayName = 'SquareArrowDiagonalIcon';
