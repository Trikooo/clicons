...
interface Configuration2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name Configuration2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/configuration2)
 * @see {@link https://clicons.dev/icon/configuration2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Configuration2Icon = React.forwardRef<SVGSVGElement, Configuration2IconProps>(
  (
    {
      size,
      color,
...
Configuration2Icon.displayName = 'Configuration2Icon';
export default Configuration2Icon;
