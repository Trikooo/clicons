...
interface MedicineIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/medicine}
 */
const MedicineIcon = React.forwardRef<SVGSVGElement, MedicineIconProps>(
