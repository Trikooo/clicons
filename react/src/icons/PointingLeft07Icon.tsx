...
interface PointingLeft07IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pointing-left07)
 * @see {@link https://clicons.dev/icon/pointing-left07} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PointingLeft07Icon = React.forwardRef<SVGSVGElement, PointingLeft07IconProps>(
  (
    {
      size,
      color,
...
PointingLeft07Icon.displayName = 'PointingLeft07Icon';
