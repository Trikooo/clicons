...
interface MoneyBag02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/money-bag02)
 * @see {@link https://clicons.dev/icon/money-bag02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MoneyBag02Icon = React.forwardRef<SVGSVGElement, MoneyBag02IconProps>(
  (
    {
      size,
      color,
...
MoneyBag02Icon.displayName = 'MoneyBag02Icon';
