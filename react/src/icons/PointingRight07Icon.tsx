...
interface PointingRight07IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pointing-right07)
 * @see {@link https://clicons.dev/icon/pointing-right07} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PointingRight07Icon = React.forwardRef<SVGSVGElement, PointingRight07IconProps>(
  (
    {
      size,
      color,
...
PointingRight07Icon.displayName = 'PointingRight07Icon';
