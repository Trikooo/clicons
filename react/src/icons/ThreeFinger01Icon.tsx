...
interface ThreeFinger01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/three-finger01)
 * @see {@link https://clicons.dev/icon/three-finger01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ThreeFinger01Icon = React.forwardRef<SVGSVGElement, ThreeFinger01IconProps>(
  (
    {
      size,
      color,
...
ThreeFinger01Icon.displayName = 'ThreeFinger01Icon';
