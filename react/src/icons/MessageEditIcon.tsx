...
interface MessageEditIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name MessageEditIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/message-edit)
 * @see {@link https://clicons.dev/icon/message-edit} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MessageEditIcon = React.forwardRef<SVGSVGElement, MessageEditIconProps>(
  (
    {
      size,
      color,
...
MessageEditIcon.displayName = 'MessageEditIcon';
