...
interface Maximize01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/maximize01)
 * @see {@link https://clicons.dev/icon/maximize01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Maximize01Icon = React.forwardRef<SVGSVGElement, Maximize01IconProps>(
  (
    {
      size,
      color,
