...
interface BlockedIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/blocked)
 * @see {@link https://clicons.dev/icon/blocked} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BlockedIcon = React.forwardRef<SVGSVGElement, BlockedIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M9.52514 13.4744C10.1585 14.1078 11.0335 14.4995 12 14.4995C13.933 14.4995 15.5 12.9324 15.5 10.9995C15.5 10.033 15.1083 9.15801 14.4749 8.52464M9.52514 13.4744C8.89175 12.841 8.5 11.966 8.5 10.9995C8.5 9.06651 10.067 7.49951 12 7.49951C12.9665 7.49951 13.8415 7.89126 14.4749 8.52464M9.52514 13.4744L14.4749 8.52464", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "1" }]];
