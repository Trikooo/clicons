...
interface SunCloudLittleSnow2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name SunCloudLittleSnow2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/sun-cloud-little-snow2)
 * @see {@link https://clicons.dev/icon/sun-cloud-little-snow2}
 */
const SunCloudLittleSnow2Icon = React.forwardRef<SVGSVGElement, SunCloudLittleSnow2IconProps>(
...
SunCloudLittleSnow2Icon.displayName = 'SunCloudLittleSnow2Icon';
