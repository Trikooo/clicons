...
interface Backpack2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/backpack2}
 */
const Backpack2Icon = React.forwardRef<SVGSVGElement, Backpack2IconProps>(
...
Backpack2Icon.displayName = 'Backpack2Icon';
