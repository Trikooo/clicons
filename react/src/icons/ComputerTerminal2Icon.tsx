...
interface ComputerTerminal2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name ComputerTerminal2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/computer-terminal2)
 * @see {@link https://clicons.dev/icon/computer-terminal2}
 */
const ComputerTerminal2Icon = React.forwardRef<SVGSVGElement, ComputerTerminal2IconProps>(
...
ComputerTerminal2Icon.displayName = 'ComputerTerminal2Icon';
