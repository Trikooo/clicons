...
interface LaurelWreathFirstIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const LaurelWreathFirstIcon = React.forwardRef<SVGSVGElement, LaurelWreathFirstIconProps>(
  (
    {
      size,
      color,
...
LaurelWreathFirstIcon.displayName = 'LaurelWreathFirstIcon';
export default LaurelWreathFirstIcon;
