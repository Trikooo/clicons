...
interface Layout6IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Layout6Icon = React.forwardRef<SVGSVGElement, Layout6IconProps>(
  (
    {
      size,
      color,
...
Layout6Icon.displayName = 'Layout6Icon';
export default Layout6Icon;
