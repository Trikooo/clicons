...
interface Home8IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/home8}
 */
const Home8Icon = React.forwardRef<SVGSVGElement, Home8IconProps>(
...
Home8Icon.displayName = 'Home8Icon';
