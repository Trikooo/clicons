...
interface SquareArrowMoveDownRightIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/square-arrow-move-down-right)
 * @see {@link https://clicons.dev/icon/square-arrow-move-down-right} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SquareArrowMoveDownRightIcon = React.forwardRef<SVGSVGElement, SquareArrowMoveDownRightIconProps>(
  (
    {
      size,
      color,
...
SquareArrowMoveDownRightIcon.displayName = 'SquareArrowMoveDownRightIcon';
