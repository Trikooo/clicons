...
interface CellsIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/cells)
 * @see {@link https://clicons.dev/icon/cells} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CellsIcon = React.forwardRef<SVGSVGElement, CellsIconProps>(
  (
    {
      size,
      color,
...
CellsIcon.displayName = 'CellsIcon';
