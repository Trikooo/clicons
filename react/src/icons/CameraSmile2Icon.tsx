...
interface CameraSmile2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const CameraSmile2Icon = React.forwardRef<SVGSVGElement, CameraSmile2IconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M11 14.5C11.7981 15.7144 13.0688 16.5 14.5 16.5C15.9312 16.5 17.2019 15.7144 18 14.5',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
CameraSmile2Icon.displayName = 'CameraSmile2Icon';
export default CameraSmile2Icon;
