...
interface ShippingTruck02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/shipping-truck02)
 * @see {@link https://clicons.dev/icon/shipping-truck02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ShippingTruck02Icon = React.forwardRef<SVGSVGElement, ShippingTruck02IconProps>(
  (
    {
      size,
      color,
...
ShippingTruck02Icon.displayName = 'ShippingTruck02Icon';
export default ShippingTruck02Icon;
