...
interface VirtualRealityVr02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/virtual-reality-vr02)
 * @see {@link https://clicons.dev/icon/virtual-reality-vr02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const VirtualRealityVr02Icon = React.forwardRef<SVGSVGElement, VirtualRealityVr02IconProps>(
  (
    {
      size,
      color,
...
VirtualRealityVr02Icon.displayName = 'VirtualRealityVr02Icon';
