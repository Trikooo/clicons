...
interface SmartWatch01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/smart-watch01)
 * @see {@link https://clicons.dev/icon/smart-watch01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SmartWatch01Icon = React.forwardRef<SVGSVGElement, SmartWatch01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["circle", { cx: "12", cy: "12", r: "6", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
...
SmartWatch01Icon.displayName = 'SmartWatch01Icon';
