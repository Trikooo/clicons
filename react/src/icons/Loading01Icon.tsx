...
interface Loading01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/loading01)
 * @see {@link https://clicons.dev/icon/loading01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Loading01Icon = React.forwardRef<SVGSVGElement, Loading01IconProps>(
  (
    {
      size,
      color,
