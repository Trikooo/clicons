...
interface Mic2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/mic2}
 */
const Mic2Icon = React.forwardRef<SVGSVGElement, Mic2IconProps>(
