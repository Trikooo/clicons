...
interface SunCloudHailstoneIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const SunCloudHailstoneIcon = React.forwardRef<SVGSVGElement, SunCloudHailstoneIconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M11.9978 15L12.0022 15.0078M14.9966 17.9967L15.0011 18.0044M8.99888 17.9967L9.00337 18.0044M17.9955 20.9933L18 21.0011M6 20.9933L6.00449 21.0011M11.9978 21.9922L12.0022 22',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '2'
...
SunCloudHailstoneIcon.displayName = 'SunCloudHailstoneIcon';
export default SunCloudHailstoneIcon;
