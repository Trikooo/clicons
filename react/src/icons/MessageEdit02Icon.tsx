...
interface MessageEdit02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/message-edit02)
 * @see {@link https://clicons.dev/icon/message-edit02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MessageEdit02Icon = React.forwardRef<SVGSVGElement, MessageEdit02IconProps>(
  (
    {
      size,
      color,
...
MessageEdit02Icon.displayName = 'MessageEdit02Icon';
export default MessageEdit02Icon;
