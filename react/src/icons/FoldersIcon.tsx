 ...
 * @preview ![img](https://clicons.dev/icon/folders)
 * @see {@link https://clicons.dev/icon/folders} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FoldersIcon = React.forwardRef<SVGSVGElement, FoldersIconProps>(
  (
    {
      size,
      color,
