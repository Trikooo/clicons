...
interface Summation2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/summation2)
 * @see {@link https://clicons.dev/icon/summation2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Summation2Icon = React.forwardRef<SVGSVGElement, Summation2IconProps>(
  (
    {
      size,
      color,
...
Summation2Icon.displayName = 'Summation2Icon';
export default Summation2Icon;
