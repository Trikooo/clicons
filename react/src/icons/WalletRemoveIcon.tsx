...
interface WalletRemoveIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const WalletRemoveIcon = React.forwardRef<SVGSVGElement, WalletRemoveIconProps>(
  (
    {
      size,
      color,
...
WalletRemoveIcon.displayName = 'WalletRemoveIcon';
