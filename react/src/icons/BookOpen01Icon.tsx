...
interface BookOpen01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/book-open01)
 * @see {@link https://clicons.dev/icon/book-open01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BookOpen01Icon = React.forwardRef<SVGSVGElement, BookOpen01IconProps>(
  (
    {
      size,
      color,
