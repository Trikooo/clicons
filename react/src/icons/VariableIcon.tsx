...
interface VariableIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/variable)
 * @see {@link https://clicons.dev/icon/variable} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const VariableIcon = React.forwardRef<SVGSVGElement, VariableIconProps>(
  (
    {
      size,
      color,
