...
interface ComputerProgramming02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/computer-programming02)
 * @see {@link https://clicons.dev/icon/computer-programming02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ComputerProgramming02Icon = React.forwardRef<SVGSVGElement, ComputerProgramming02IconProps>(
  (
    {
      size,
      color,
...
ComputerProgramming02Icon.displayName = 'ComputerProgramming02Icon';
