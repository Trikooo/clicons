...
interface AppleReminderIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/apple-reminder)
 * @see {@link https://clicons.dev/icon/apple-reminder} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AppleReminderIcon = React.forwardRef<SVGSVGElement, AppleReminderIconProps>(
  (
    {
      size,
      color,
