...
interface BodyWeightIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/body-weight)
 * @see {@link https://clicons.dev/icon/body-weight} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BodyWeightIcon = React.forwardRef<SVGSVGElement, BodyWeightIconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M19.191 2.99805C18.6141 4.30938 18.0839 6.55739 18.0839 7.58772M4.81544 2.99805C5.39237 4.30938 5.92253 6.55739 5.92253 7.58772M5.39913 15.5107C4.96029 16.8915 3.80051 19.6218 4.00426 21.0026M18.6142 15.5107C19.0531 16.8915 20.2129 19.6218 20.0091 21.0026',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
BodyWeightIcon.displayName = 'BodyWeightIcon';
