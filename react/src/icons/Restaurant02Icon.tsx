...
interface Restaurant02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/restaurant02)
 * @see {@link https://clicons.dev/icon/restaurant02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Restaurant02Icon = React.forwardRef<SVGSVGElement, Restaurant02IconProps>(
  (
    {
      size,
      color,
...
Restaurant02Icon.displayName = 'Restaurant02Icon';
export default Restaurant02Icon;
