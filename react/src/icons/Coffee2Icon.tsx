...
interface Coffee2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Coffee2Icon = React.forwardRef<SVGSVGElement, Coffee2IconProps>(
  (
    {
      size,
      color,
...
Coffee2Icon.displayName = 'Coffee2Icon';
