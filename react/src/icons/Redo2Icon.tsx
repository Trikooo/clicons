...
interface Redo2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/redo2}
 */
const Redo2Icon = React.forwardRef<SVGSVGElement, Redo2IconProps>(
