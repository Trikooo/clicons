...
interface MailDownloadIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MailDownloadIcon = React.forwardRef<SVGSVGElement, MailDownloadIconProps>(
  (
    {
      size,
      color,
