...
interface CallAddIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const CallAddIcon = React.forwardRef<SVGSVGElement, CallAddIconProps>(
  (
    {
      size,
      color,
