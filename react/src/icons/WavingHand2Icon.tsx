...
interface WavingHand2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name WavingHand2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/waving-hand2)
 * @see {@link https://clicons.dev/icon/waving-hand2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const WavingHand2Icon = React.forwardRef<SVGSVGElement, WavingHand2IconProps>(
  (
    {
      size,
      color,
...
WavingHand2Icon.displayName = 'WavingHand2Icon';
export default WavingHand2Icon;
