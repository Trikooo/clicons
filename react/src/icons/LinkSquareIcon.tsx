...
interface LinkSquareIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/link-square}
 */
const LinkSquareIcon = React.forwardRef<SVGSVGElement, LinkSquareIconProps>(
...
LinkSquareIcon.displayName = 'LinkSquareIcon';
