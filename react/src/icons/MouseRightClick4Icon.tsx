...
interface MouseRightClick4IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name MouseRightClick4Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/mouse-right-click4)
 * @see {@link https://clicons.dev/icon/mouse-right-click4} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MouseRightClick4Icon = React.forwardRef<SVGSVGElement, MouseRightClick4IconProps>(
  (
    {
      size,
      color,
...
MouseRightClick4Icon.displayName = 'MouseRightClick4Icon';
export default MouseRightClick4Icon;
