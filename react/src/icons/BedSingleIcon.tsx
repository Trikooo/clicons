...
interface BedSingleIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/bed-single)
 * @see {@link https://clicons.dev/icon/bed-single} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BedSingleIcon = React.forwardRef<SVGSVGElement, BedSingleIconProps>(
  (
    {
      size,
      color,
