...
interface Album2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Album2Icon = React.forwardRef<SVGSVGElement, Album2IconProps>(
  (
    {
      size,
      color,
...
Album2Icon.displayName = 'Album2Icon';
export default Album2Icon;
