...
interface Medal02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/medal02)
 * @see {@link https://clicons.dev/icon/medal02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Medal02Icon = React.forwardRef<SVGSVGElement, Medal02IconProps>(
  (
    {
      size,
      color,
...
Medal02Icon.displayName = 'Medal02Icon';
