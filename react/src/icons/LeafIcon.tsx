...
interface LeafIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/leaf)
 * @see {@link https://clicons.dev/icon/leaf} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const LeafIcon = React.forwardRef<SVGSVGElement, LeafIconProps>(
  (
    {
      size,
      color,
