...
interface CheckmarkCircle02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/checkmark-circle02)
 * @see {@link https://clicons.dev/icon/checkmark-circle02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CheckmarkCircle02Icon = React.forwardRef<SVGSVGElement, CheckmarkCircle02IconProps>(
  (
    {
      size,
      color,
