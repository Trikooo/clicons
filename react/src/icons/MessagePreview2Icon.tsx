...
interface MessagePreview2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MessagePreview2Icon = React.forwardRef<SVGSVGElement, MessagePreview2IconProps>(
  (
    {
      size,
      color,
...
MessagePreview2Icon.displayName = 'MessagePreview2Icon';
export default MessagePreview2Icon;
