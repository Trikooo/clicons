...
interface StoreVerified2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name StoreVerified2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/store-verified2)
 * @see {@link https://clicons.dev/icon/store-verified2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const StoreVerified2Icon = React.forwardRef<SVGSVGElement, StoreVerified2IconProps>(
  (
    {
      size,
      color,
...
StoreVerified2Icon.displayName = 'StoreVerified2Icon';
export default StoreVerified2Icon;
