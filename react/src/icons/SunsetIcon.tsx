...
interface SunsetIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/sunset)
 * @see {@link https://clicons.dev/icon/sunset} - Icon preview
...
const SunsetIcon = React.forwardRef<SVGSVGElement, SunsetIconProps>(
  (
    ...
    const iconData = [["path", { d: "M9.5 7.5C9.99153 8.0057 11.2998 10 12 10M14.5 7.5C14.0085 8.0057 12.7002 10 12 10M12 10V4", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
