...
interface WorkflowCircle04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/workflow-circle04)
 * @see {@link https://clicons.dev/icon/workflow-circle04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const WorkflowCircle04Icon = React.forwardRef<SVGSVGElement, WorkflowCircle04IconProps>(
  (
    {
      size,
      color,
...
WorkflowCircle04Icon.displayName = 'WorkflowCircle04Icon';
