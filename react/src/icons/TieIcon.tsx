...
interface TieIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/tie}
 */
const TieIcon = React.forwardRef<SVGSVGElement, TieIconProps>(
