...
interface Passport01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/passport01)
 * @see {@link https://clicons.dev/icon/passport01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Passport01Icon = React.forwardRef<SVGSVGElement, Passport01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M12.9503 22C15.595 22 16.9173 22 17.8667 21.2437C18.8161 20.4874 19.1189 19.1927 19.7247 16.6033L21.642 8.40697C21.9773 6.97363 22.1449 6.25696 21.8405 5.7379C21.2878 4.79529 19.8789 5.00001 18.9593 5.00001", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
Passport01Icon.displayName = 'Passport01Icon';
