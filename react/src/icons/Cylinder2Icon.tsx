...
interface Cylinder2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/cylinder2}
 */
const Cylinder2Icon = React.forwardRef<SVGSVGElement, Cylinder2IconProps>(
...
Cylinder2Icon.displayName = 'Cylinder2Icon';
