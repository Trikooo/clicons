...
interface Underpants01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/underpants01)
 * @see {@link https://clicons.dev/icon/underpants01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Underpants01Icon = React.forwardRef<SVGSVGElement, Underpants01IconProps>(
  (
    {
      size,
      color,
...
Underpants01Icon.displayName = 'Underpants01Icon';
