...
interface ChatUnlockIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/chat-unlock)
 * @see {@link https://clicons.dev/icon/chat-unlock} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ChatUnlockIcon = React.forwardRef<SVGSVGElement, ChatUnlockIconProps>(
  (
    {
      size,
      color,
...
ChatUnlockIcon.displayName = 'ChatUnlockIcon';
export default ChatUnlockIcon;
