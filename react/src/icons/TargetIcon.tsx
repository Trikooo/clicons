...
interface TargetIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/target)
 * @see {@link https://clicons.dev/icon/target} - Icon preview
