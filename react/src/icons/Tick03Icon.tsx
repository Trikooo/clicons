...
interface Tick03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/tick03)
 * @see {@link https://clicons.dev/icon/tick03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Tick03Icon = React.forwardRef<SVGSVGElement, Tick03IconProps>(
  (
    {
      size,
      color,
...
Tick03Icon.displayName = 'Tick03Icon';
