...
interface FileImportIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/file-import)
 * @see {@link https://clicons.dev/icon/file-import} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FileImportIcon = React.forwardRef<SVGSVGElement, FileImportIconProps>(
  (
    {
      size,
      color,
