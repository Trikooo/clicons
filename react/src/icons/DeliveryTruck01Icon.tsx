...
interface DeliveryTruck01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/delivery-truck01)
 * @see {@link https://clicons.dev/icon/delivery-truck01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const DeliveryTruck01Icon = React.forwardRef<SVGSVGElement, DeliveryTruck01IconProps>(
  (
    {
      size,
      color,
...
DeliveryTruck01Icon.displayName = 'DeliveryTruck01Icon';
export default DeliveryTruck01Icon;
