...
interface ChartBreakoutSquareIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/chart-breakout-square}
 */
const ChartBreakoutSquareIcon = React.forwardRef<SVGSVGElement, ChartBreakoutSquareIconProps>(
  ...
  [
    'path',
    {
      d: 'M11.8517 8.00684H15.0738C15.4527 8.00684 15.7598 8.32175 15.7598 8.71022V12.0354M2.75977 13.9583C5.03301 14.2241 10.7373 13.5137 14.8914 8.88963'
    }
  ]
];
