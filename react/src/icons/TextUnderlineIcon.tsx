...
interface TextUnderlineIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const TextUnderlineIcon = React.forwardRef<SVGSVGElement, TextUnderlineIconProps>(
  (
    {
      size,
      color,
