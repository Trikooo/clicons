...
interface BatteryMedium01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/battery-medium01)
 * @see {@link https://clicons.dev/icon/battery-medium01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BatteryMedium01Icon = React.forwardRef<SVGSVGElement, BatteryMedium01IconProps>(
  (
    {
      size,
      color,
...
BatteryMedium01Icon.displayName = 'BatteryMedium01Icon';
export default BatteryMedium01Icon;
