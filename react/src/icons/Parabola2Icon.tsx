...
interface Parabola2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/parabola2}
 */
const Parabola2Icon = React.forwardRef<SVGSVGElement, Parabola2IconProps>(
...
Parabola2Icon.displayName = 'Parabola2Icon';
