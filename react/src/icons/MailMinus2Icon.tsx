...
interface MailMinus2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/mail-minus2}
 */
const MailMinus2Icon = React.forwardRef<SVGSVGElement, MailMinus2IconProps>(
...
MailMinus2Icon.displayName = 'MailMinus2Icon';
