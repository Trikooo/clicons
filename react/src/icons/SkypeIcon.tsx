...
const SkypeIcon = React.forwardRef<SVGSVGElement, SkypeIconProps>(
  (
    ...
    const iconData = [["path", { d: "M15 10C15 8.89543 13.6569 8 12 8C10.3431 8 9 8.89543 9 10C9 11.1046 10.3431 12 12 12C13.6569 12 15 12.8954 15 14C15 15.1046 13.6569 16 12 16C10.3431 16 9 15.1046 9 14", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
