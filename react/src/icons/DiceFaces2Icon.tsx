...
interface DiceFaces2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const DiceFaces2Icon = React.forwardRef<SVGSVGElement, DiceFaces2IconProps>(
  (
    {
      size,
      color,
...
DiceFaces2Icon.displayName = 'DiceFaces2Icon';
export default DiceFaces2Icon;
