...
interface SwipeUp3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const SwipeUp3Icon = React.forwardRef<SVGSVGElement, SwipeUp3IconProps>(
  (
    {
      size,
      color,
...
SwipeUp3Icon.displayName = 'SwipeUp3Icon';
export default SwipeUp3Icon;
