...
interface SunCloudSlowWind01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/sun-cloud-slow-wind01)
 * @see {@link https://clicons.dev/icon/sun-cloud-slow-wind01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SunCloudSlowWind01Icon = React.forwardRef<SVGSVGElement, SunCloudSlowWind01IconProps>(
  (
    {
      size,
      color,
...
SunCloudSlowWind01Icon.displayName = 'SunCloudSlowWind01Icon';
