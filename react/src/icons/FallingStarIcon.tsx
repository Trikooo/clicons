...
interface FallingStarIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/falling-star)
 * @see {@link https://clicons.dev/icon/falling-star} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FallingStarIcon = React.forwardRef<SVGSVGElement, FallingStarIconProps>(
  (
    {
      size,
      color,
...
FallingStarIcon.displayName = 'FallingStarIcon';
