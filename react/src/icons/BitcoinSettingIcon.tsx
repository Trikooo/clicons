...
interface BitcoinSettingIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/bitcoin-setting)
 * @see {@link https://clicons.dev/icon/bitcoin-setting} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BitcoinSettingIcon = React.forwardRef<SVGSVGElement, BitcoinSettingIconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M10.125 15L10.125 9M12 9V7.5M12 16.5V15M10.125 12H13.875M13.875 12C14.4963 12 15 12.5037 15 13.125V13.875C15 14.4963 14.4963 15 13.875 15H9M13.875 12C14.4963 12 15 11.4963 15 10.875V10.125C15 9.50368 14.4963 9 13.875 9H9',
      stroke: 'currentColor',
      strokeLinecap: 'round',
...
BitcoinSettingIcon.displayName = 'BitcoinSettingIcon';
