...
interface NotificationOff01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/notification-off01)
 * @see {@link https://clicons.dev/icon/notification-off01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const NotificationOff01Icon = React.forwardRef<SVGSVGElement, NotificationOff01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M15.5 18C15.5 19.933 13.933 21.5 12 21.5C10.067 21.5 8.5 19.933 8.5 18", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
