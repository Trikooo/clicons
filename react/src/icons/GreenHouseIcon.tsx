...
interface GreenHouseIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const GreenHouseIcon = React.forwardRef<SVGSVGElement, GreenHouseIconProps>(
  (
    {
      size,
      color,
...
GreenHouseIcon.displayName = 'GreenHouseIcon';
