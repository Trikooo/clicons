...
interface MailDownload01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mail-download01)
 * @see {@link https://clicons.dev/icon/mail-download01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MailDownload01Icon = React.forwardRef<SVGSVGElement, MailDownload01IconProps>(
  (
    {
      size,
      color,
...
MailDownload01Icon.displayName = 'MailDownload01Icon';
export default MailDownload01Icon;
