...
interface FolderAttachmentIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const FolderAttachmentIcon = React.forwardRef<SVGSVGElement, FolderAttachmentIconProps>(
  (
    {
      size,
      color,
...
FolderAttachmentIcon.displayName = 'FolderAttachmentIcon';
