...
interface MoneyReceiveIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name MoneyReceiveIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/money-receive)
 * @see {@link https://clicons.dev/icon/money-receive} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MoneyReceiveIcon = React.forwardRef<SVGSVGElement, MoneyReceiveIconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M14.5 5.50195C14.5 5.50195 12.7002 8.00195 12 8.00195C11.2998 8.00195 9.5 5.50195 9.5 5.50195M12 7.50195V2.50195',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
MoneyReceiveIcon.displayName = 'MoneyReceiveIcon';
