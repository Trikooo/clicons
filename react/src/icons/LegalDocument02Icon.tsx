...
interface LegalDocument02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/legal-document02)
 * @see {@link https://clicons.dev/icon/legal-document02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const LegalDocument02Icon = React.forwardRef<SVGSVGElement, LegalDocument02IconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M8 18H16", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "1" }],
...
LegalDocument02Icon.displayName = 'LegalDocument02Icon';
