...
interface FilterVerticalIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const FilterVerticalIcon = React.forwardRef<SVGSVGElement, FilterVerticalIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M7 21L7 18", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
