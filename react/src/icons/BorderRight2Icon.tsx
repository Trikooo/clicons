...
interface BorderRight2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const BorderRight2Icon = React.forwardRef<SVGSVGElement, BorderRight2IconProps>(
  (
    {
      size,
      color,
...
BorderRight2Icon.displayName = 'BorderRight2Icon';
export default BorderRight2Icon;
