...
interface BitcoinMailIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const BitcoinMailIcon = React.forwardRef<SVGSVGElement, BitcoinMailIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M4.99997 12V6C4.99997 4.11438 4.99997 3.17157 5.58576 2.58579C6.17154 2 7.11435 2 8.99997 2H15C16.8856 2 17.8284 2 18.4142 2.58579C19 3.17157 19 4.11438 19 6V12", stroke: "currentColor", strokeWidth: "1.5", key: "2" }],
...
BitcoinMailIcon.displayName = 'BitcoinMailIcon';
