...
interface CheckmarkCircle3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name CheckmarkCircle3Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/checkmark-circle3)
 * @see {@link https://clicons.dev/icon/checkmark-circle3}
 */
const CheckmarkCircle3Icon = React.forwardRef<SVGSVGElement, CheckmarkCircle3IconProps>(
...
CheckmarkCircle3Icon.displayName = 'CheckmarkCircle3Icon';
