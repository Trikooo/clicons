...
interface HealtcareIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const HealtcareIcon = React.forwardRef<SVGSVGElement, HealtcareIconProps>(
  (
    {
      size,
      color,
...
HealtcareIcon.displayName = 'HealtcareIcon';
