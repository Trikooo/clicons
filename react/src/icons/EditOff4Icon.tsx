...
interface EditOff4IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/edit-off4}
 */
const EditOff4Icon = React.forwardRef<SVGSVGElement, EditOff4IconProps>(
...
EditOff4Icon.displayName = 'EditOff4Icon';
