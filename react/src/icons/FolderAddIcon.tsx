...
interface FolderAddIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/folder-add)
 * @see {@link https://clicons.dev/icon/folder-add} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FolderAddIcon = React.forwardRef<SVGSVGElement, FolderAddIconProps>(
  (
    {
      size,
      color,
