...
interface WorkflowCircle03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/workflow-circle03)
 * @see {@link https://clicons.dev/icon/workflow-circle03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const WorkflowCircle03Icon = React.forwardRef<SVGSVGElement, WorkflowCircle03IconProps>(
  (
    {
      size,
      color,
...
WorkflowCircle03Icon.displayName = 'WorkflowCircle03Icon';
