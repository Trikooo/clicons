...
interface RotateLeft01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/rotate-left01)
 * @see {@link https://clicons.dev/icon/rotate-left01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const RotateLeft01Icon = React.forwardRef<SVGSVGElement, RotateLeft01IconProps>(
  (
    {
      size,
      color,
...
RotateLeft01Icon.displayName = 'RotateLeft01Icon';
