...
interface Calling02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/calling02)
 * @see {@link https://clicons.dev/icon/calling02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Calling02Icon = React.forwardRef<SVGSVGElement, Calling02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M13 3C17.4183 3 21 6.58172 21 11M13.5 6.5C15.7091 6.5 17.5 8.29086 17.5 10.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
Calling02Icon.displayName = 'Calling02Icon';
export default Calling02Icon;
