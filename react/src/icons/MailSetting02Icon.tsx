...
interface MailSetting02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mail-setting02)
 * @see {@link https://clicons.dev/icon/mail-setting02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MailSetting02Icon = React.forwardRef<SVGSVGElement, MailSetting02IconProps>(
  (
    {
      size,
      color,
...
MailSetting02Icon.displayName = 'MailSetting02Icon';
