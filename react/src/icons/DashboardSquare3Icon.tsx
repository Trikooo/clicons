...
interface DashboardSquare3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name DashboardSquare3Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/dashboard-square3)
 * @see {@link https://clicons.dev/icon/dashboard-square3}
 */
const DashboardSquare3Icon = React.forwardRef<SVGSVGElement, DashboardSquare3IconProps>(
...
DashboardSquare3Icon.displayName = 'DashboardSquare3Icon';
