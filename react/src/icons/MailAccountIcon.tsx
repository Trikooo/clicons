...
interface MailAccountIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MailAccountIcon = React.forwardRef<SVGSVGElement, MailAccountIconProps>(
  (
    {
      size,
      color,
...
MailAccountIcon.displayName = 'MailAccountIcon';
export default MailAccountIcon;
