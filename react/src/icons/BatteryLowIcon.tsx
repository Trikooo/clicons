...
interface BatteryLowIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/battery-low)
 * @see {@link https://clicons.dev/icon/battery-low} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BatteryLowIcon = React.forwardRef<SVGSVGElement, BatteryLowIconProps>(
  (
    {
      size,
      color,
