...
interface AmpouleIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/ampoule)
 * @see {@link https://clicons.dev/icon/ampoule} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AmpouleIcon = React.forwardRef<SVGSVGElement, AmpouleIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M21 16H14", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "3" }]];
...
AmpouleIcon.displayName = 'AmpouleIcon';
