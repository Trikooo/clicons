...
interface SunCloudSlowWind02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/sun-cloud-slow-wind02)
 * @see {@link https://clicons.dev/icon/sun-cloud-slow-wind02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SunCloudSlowWind02Icon = React.forwardRef<SVGSVGElement, SunCloudSlowWind02IconProps>(
  (
    {
      size,
      color,
...
SunCloudSlowWind02Icon.displayName = 'SunCloudSlowWind02Icon';
