...
interface SaleTag02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/sale-tag02)
 * @see {@link https://clicons.dev/icon/sale-tag02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SaleTag02Icon = React.forwardRef<SVGSVGElement, SaleTag02IconProps>(
  (
    {
      size,
      color,
