...
interface XingIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/xing)
 * @see {@link https://clicons.dev/icon/xing} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const XingIcon = React.forwardRef<SVGSVGElement, XingIconProps>(
  (
    {
      size,
      color,
