...
interface SquareArrowUpRight2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name SquareArrowUpRight2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/square-arrow-up-right2)
 * @see {@link https://clicons.dev/icon/square-arrow-up-right2}
 */
const SquareArrowUpRight2Icon = React.forwardRef<SVGSVGElement, SquareArrowUpRight2IconProps>(
...
SquareArrowUpRight2Icon.displayName = 'SquareArrowUpRight2Icon';
