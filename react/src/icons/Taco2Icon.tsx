...
interface Taco2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/taco2)
 * @see {@link https://clicons.dev/icon/taco2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Taco2Icon = React.forwardRef<SVGSVGElement, Taco2IconProps>(
  (
    {
      size,
      color,
...
Taco2Icon.displayName = 'Taco2Icon';
export default Taco2Icon;
