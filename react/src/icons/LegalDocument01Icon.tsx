...
interface LegalDocument01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/legal-document01)
 * @see {@link https://clicons.dev/icon/legal-document01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const LegalDocument01Icon = React.forwardRef<SVGSVGElement, LegalDocument01IconProps>(
  (
    {
      size,
      color,
...
LegalDocument01Icon.displayName = 'LegalDocument01Icon';
