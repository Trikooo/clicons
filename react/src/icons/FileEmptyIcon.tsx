...
interface FileEmptyIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/file-empty}
 */
const FileEmptyIcon = React.forwardRef<SVGSVGElement, FileEmptyIconProps>(
...
FileEmptyIcon.displayName = 'FileEmptyIcon';
