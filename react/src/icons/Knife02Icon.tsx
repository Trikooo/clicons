...
interface Knife02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/knife02)
 * @see {@link https://clicons.dev/icon/knife02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Knife02Icon = React.forwardRef<SVGSVGElement, Knife02IconProps>(
  (
    {
      size,
      color,
...
Knife02Icon.displayName = 'Knife02Icon';
