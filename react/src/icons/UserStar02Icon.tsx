...
interface UserStar02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/user-star02)
 * @see {@link https://clicons.dev/icon/user-star02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const UserStar02Icon = React.forwardRef<SVGSVGElement, UserStar02IconProps>(
  (
    {
      size,
      color,
...
UserStar02Icon.displayName = 'UserStar02Icon';
