...
interface Note3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/note3}
 */
const Note3Icon = React.forwardRef<SVGSVGElement, Note3IconProps>(
...
Note3Icon.displayName = 'Note3Icon';
