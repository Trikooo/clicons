...
interface Calendar02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/calendar02)
 * @see {@link https://clicons.dev/icon/calendar02} - Icon preview
