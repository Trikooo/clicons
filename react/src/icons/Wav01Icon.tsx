...
interface Wav01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/wav01)
 * @see {@link https://clicons.dev/icon/wav01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Wav01Icon = React.forwardRef<SVGSVGElement, Wav01IconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M4 16V22L6.5 19L9 22V16M11.25 22L13 16H13.5L15.25 22M12.25 20H14.25M16 16L17.75 22H18.25L20 16',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
Wav01Icon.displayName = 'Wav01Icon';
export default Wav01Icon;
