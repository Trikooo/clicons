...
interface CameraSmile02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/camera-smile02)
 * @see {@link https://clicons.dev/icon/camera-smile02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CameraSmile02Icon = React.forwardRef<SVGSVGElement, CameraSmile02IconProps>(
  (
    {
      size,
      color,
...
CameraSmile02Icon.displayName = 'CameraSmile02Icon';
