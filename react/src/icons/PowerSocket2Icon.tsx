...
interface PowerSocket2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name PowerSocket2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/power-socket2)
 * @see {@link https://clicons.dev/icon/power-socket2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PowerSocket2Icon = React.forwardRef<SVGSVGElement, PowerSocket2IconProps>(
  (
    {
      size,
      color,
...
PowerSocket2Icon.displayName = 'PowerSocket2Icon';
export default PowerSocket2Icon;
