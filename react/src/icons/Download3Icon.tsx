...
interface Download3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Download3Icon = React.forwardRef<SVGSVGElement, Download3IconProps>(
  (
    {
      size,
      color,
...
Download3Icon.displayName = 'Download3Icon';
export default Download3Icon;
