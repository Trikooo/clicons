...
interface Film2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/film2}
 */
const Film2Icon = React.forwardRef<SVGSVGElement, Film2IconProps>(
...
Film2Icon.displayName = 'Film2Icon';
