...
interface WorkflowSquare3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name WorkflowSquare3Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/workflow-square3)
 * @see {@link https://clicons.dev/icon/workflow-square3}
 */
const WorkflowSquare3Icon = React.forwardRef<SVGSVGElement, WorkflowSquare3IconProps>(
...
WorkflowSquare3Icon.displayName = 'WorkflowSquare3Icon';
