...
interface FolderRemoveIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/folder-remove)
 * @see {@link https://clicons.dev/icon/folder-remove} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FolderRemoveIcon = React.forwardRef<SVGSVGElement, FolderRemoveIconProps>(
  (
    {
      size,
      color,
