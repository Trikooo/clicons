...
interface NoteIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/note)
 * @see {@link https://clicons.dev/icon/note} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const NoteIcon = React.forwardRef<SVGSVGElement, NoteIconProps>(
  (
    {
      size,
      color,
