...
interface MailValidation02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mail-validation02)
 * @see {@link https://clicons.dev/icon/mail-validation02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MailValidation02Icon = React.forwardRef<SVGSVGElement, MailValidation02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M2 4.5L8.91302 8.41697C11.4616 9.86101 12.5384 9.86101 15.087 8.41697L22 4.5", stroke: "currentColor", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
MailValidation02Icon.displayName = 'MailValidation02Icon';
export default MailValidation02Icon;
