...
interface DiscoverCircleIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const DiscoverCircleIcon = React.forwardRef<SVGSVGElement, DiscoverCircleIconProps>(
  (
    {
      size,
      color,
...
DiscoverCircleIcon.displayName = 'DiscoverCircleIcon';
