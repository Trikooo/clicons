...
interface TimeSetting3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name TimeSetting3Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/time-setting3)
 * @see {@link https://clicons.dev/icon/time-setting3}
 */
const TimeSetting3Icon = React.forwardRef<SVGSVGElement, TimeSetting3IconProps>(
...
TimeSetting3Icon.displayName = 'TimeSetting3Icon';
