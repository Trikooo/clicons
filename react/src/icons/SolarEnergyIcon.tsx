...
interface SolarEnergyIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/solar-energy)
 * @see {@link https://clicons.dev/icon/solar-energy} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SolarEnergyIcon = React.forwardRef<SVGSVGElement, SolarEnergyIconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M15 12C15 13.6569 13.6569 15 12 15M15 12C15 10.3431 13.6569 9 12 9M15 12H16.5M12 15C10.3431 15 9 13.6569 9 12M12 15V16.5M9 12C9 10.3431 10.3431 9 12 9M9 12L7.5 12M12 9V7.5M14.1213 9.87869L15.182 8.81803M9.87868 14.1213L8.81802 15.182M14.1213 14.1213L15.182 15.182M9.87868 9.87869L8.81802 8.81803',
      stroke: 'currentColor',
      strokeLinecap: 'round',
