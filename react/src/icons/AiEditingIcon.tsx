...
interface AiEditingIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/ai-editing)
 * @see {@link https://clicons.dev/icon/ai-editing} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AiEditingIcon = React.forwardRef<SVGSVGElement, AiEditingIconProps>(
  (
    {
      size,
      color,
...
AiEditingIcon.displayName = 'AiEditingIcon';
export default AiEditingIcon;
