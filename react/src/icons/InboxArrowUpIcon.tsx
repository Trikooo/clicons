...
interface InboxArrowUpIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @preview ![img](https://clicons.dev/icon/inbox-arrow-up)
 * @see {@link https://clicons.dev/icon/inbox-arrow-up}
 */
const InboxArrowUpIcon = React.forwardRef<SVGSVGElement, InboxArrowUpIconProps>(
