...
interface LocationStar02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/location-star02)
 * @see {@link https://clicons.dev/icon/location-star02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const LocationStar02Icon = React.forwardRef<SVGSVGElement, LocationStar02IconProps>(
  (
    {
      size,
      color,
...
LocationStar02Icon.displayName = 'LocationStar02Icon';
