...
interface ChatSecureIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/chat-secure}
 */
const ChatSecureIcon = React.forwardRef<SVGSVGElement, ChatSecureIconProps>(
...
ChatSecureIcon.displayName = 'ChatSecureIcon';
