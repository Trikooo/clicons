...
const ChatSecureIcon = React.forwardRef<SVGSVGElement, ChatSecureIconProps>(
  ...
  [
    'path',
    {
      d: 'M14.609 7.09814C13.8731 6.72153 12.9726 6.5 12 6.5C11.0274 6.5 10.1269 6.72153 9.39101 7.09814C9.03013 7.28282 8.84969 7.37517 8.67484 7.66551C8.5 7.95586 8.5 8.23699 8.5 8.79925V10.1948C8.5 12.4682 10.2665 13.7321 11.2895 14.2735C11.5748 14.4245 11.7175 14.5 12 14.5C12.2825 14.5 12.4252 14.4245 12.7105 14.2735C13.7335 13.7321 15.5 12.4682 15.5 10.1948L15.5 8.79926C15.5 8.23699 15.5 7.95586 15.3252 7.66551C15.1503 7.37517 14.9699 7.28282 14.609 7.09814Z',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
