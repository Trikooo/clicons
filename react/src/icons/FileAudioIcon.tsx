...
interface FileAudioIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/file-audio)
 * @see {@link https://clicons.dev/icon/file-audio} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FileAudioIcon = React.forwardRef<SVGSVGElement, FileAudioIconProps>(
  (
    {
      size,
      color,
