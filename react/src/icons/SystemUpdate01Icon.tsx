...
interface SystemUpdate01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/system-update01)
 * @see {@link https://clicons.dev/icon/system-update01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SystemUpdate01Icon = React.forwardRef<SVGSVGElement, SystemUpdate01IconProps>(
  (
    {
      size,
      color,
...
SystemUpdate01Icon.displayName = 'SystemUpdate01Icon';
export default SystemUpdate01Icon;
