...
interface CursorMagicSelection2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name CursorMagicSelection2Icon
 ...
 */
const CursorMagicSelection2Icon = React.forwardRef<SVGSVGElement, CursorMagicSelection2IconProps>(
  (
    {
      size,
      color,
...
CursorMagicSelection2Icon.displayName = 'CursorMagicSelection2Icon';
export default CursorMagicSelection2Icon;
