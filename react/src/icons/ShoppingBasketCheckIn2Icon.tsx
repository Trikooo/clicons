...
interface ShoppingBasketCheckIn2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name ShoppingBasketCheckIn2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/shopping-basket-check-in2)
 * @see {@link https://clicons.dev/icon/shopping-basket-check-in2}
 */
const ShoppingBasketCheckIn2Icon = React.forwardRef<SVGSVGElement, ShoppingBasketCheckIn2IconProps>(
...
ShoppingBasketCheckIn2Icon.displayName = 'ShoppingBasketCheckIn2Icon';
export default ShoppingBasketCheckIn2Icon;
