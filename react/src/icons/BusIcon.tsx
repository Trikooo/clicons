...
interface BusIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/bus}
 */
const BusIcon = React.forwardRef<SVGSVGElement, BusIconProps>(
