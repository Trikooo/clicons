...
interface TouchLocked04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/touch-locked04)
 * @see {@link https://clicons.dev/icon/touch-locked04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TouchLocked04Icon = React.forwardRef<SVGSVGElement, TouchLocked04IconProps>(
  (
    {
      size,
      color,
...
TouchLocked04Icon.displayName = 'TouchLocked04Icon';
