...
const DashboardSpeed01Icon = React.forwardRef<SVGSVGElement, DashboardSpeed01IconProps>(
  (
    ...
    const iconData = [["path", { d: "M13.5 13L17 9M14 15C14 16.1046 13.1046 17 12 17C10.8954 17 10 16.1046 10 15C10 13.8954 10.8954 13 12 13C13.1046 13 14 13.8954 14 15Z", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
