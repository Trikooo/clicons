...
interface PenConnectUsbIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pen-connect-usb)
 * @see {@link https://clicons.dev/icon/pen-connect-usb} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PenConnectUsbIcon = React.forwardRef<SVGSVGElement, PenConnectUsbIconProps>(
  (
    {
      size,
      color,
...
PenConnectUsbIcon.displayName = 'PenConnectUsbIcon';
export default PenConnectUsbIcon;
