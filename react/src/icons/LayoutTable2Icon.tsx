...
interface LayoutTable2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name LayoutTable2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/layout-table2)
 * @see {@link https://clicons.dev/icon/layout-table2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const LayoutTable2Icon = React.forwardRef<SVGSVGElement, LayoutTable2IconProps>(
  (
    {
      size,
      color,
...
LayoutTable2Icon.displayName = 'LayoutTable2Icon';
export default LayoutTable2Icon;
