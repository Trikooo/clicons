...
interface SquareArrowReload02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/square-arrow-reload02)
 * @see {@link https://clicons.dev/icon/square-arrow-reload02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SquareArrowReload02Icon = React.forwardRef<SVGSVGElement, SquareArrowReload02IconProps>(
  (
    {
      size,
      color,
...
SquareArrowReload02Icon.displayName = 'SquareArrowReload02Icon';
export default SquareArrowReload02Icon;
