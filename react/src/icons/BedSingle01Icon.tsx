...
interface BedSingle01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/bed-single01)
 * @see {@link https://clicons.dev/icon/bed-single01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BedSingle01Icon = React.forwardRef<SVGSVGElement, BedSingle01IconProps>(
  (
    {
      size,
      color,
...
BedSingle01Icon.displayName = 'BedSingle01Icon';
