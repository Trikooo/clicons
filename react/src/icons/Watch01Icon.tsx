...
interface Watch01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/watch01)
 * @see {@link https://clicons.dev/icon/watch01} - Icon preview
...
const Watch01Icon = React.forwardRef<SVGSVGElement, Watch01IconProps>(
  (
    ...
    const iconData = [["circle", { cx: "12", cy: "12", r: "7", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
