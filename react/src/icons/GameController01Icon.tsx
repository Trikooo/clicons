...
interface GameController01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/game-controller01)
 * @see {@link https://clicons.dev/icon/game-controller01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const GameController01Icon = React.forwardRef<SVGSVGElement, GameController01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M11 13H13", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
GameController01Icon.displayName = 'GameController01Icon';
