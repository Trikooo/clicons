...
interface ChatSpark01IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name ChatSpark01Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/chat-spark01)
 * @see {@link https://clicons.dev/icon/chat-spark01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ChatSpark01Icon = React.forwardRef<SVGSVGElement, ChatSpark01IconProps>(
  (
    {
      size,
      color,
...
ChatSpark01Icon.displayName = 'ChatSpark01Icon';
export default ChatSpark01Icon;
