...
interface CallUnlocked2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name CallUnlocked2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/call-unlocked2)
 * @see {@link https://clicons.dev/icon/call-unlocked2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallUnlocked2Icon = React.forwardRef<SVGSVGElement, CallUnlocked2IconProps>(
  (
    {
      size,
      color,
...
CallUnlocked2Icon.displayName = 'CallUnlocked2Icon';
export default CallUnlocked2Icon;
