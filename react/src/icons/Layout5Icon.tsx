...
interface Layout5IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/layout5}
 */
const Layout5Icon = React.forwardRef<SVGSVGElement, Layout5IconProps>(
...
Layout5Icon.displayName = 'Layout5Icon';
