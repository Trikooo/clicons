...
const EcoPowerIcon = React.forwardRef<SVGSVGElement, EcoPowerIconProps>(
  (
    ...
    const iconData = [["path", { d: "M9 20C5.22895 19.1318 3 15.6772 3 12.5102C3 8.74448 6.37016 5.02317 8.73565 2.875C10.0204 1.70833 11.9797 1.70833 13.2643 2.875C14.7712 4.24338 16.5749 6.25009 17.7511 8.5", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
