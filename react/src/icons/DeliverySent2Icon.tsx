...
interface DeliverySent2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name DeliverySent2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/delivery-sent2)
 * @see {@link https://clicons.dev/icon/delivery-sent2}
 */
const DeliverySent2Icon = React.forwardRef<SVGSVGElement, DeliverySent2IconProps>(
...
DeliverySent2Icon.displayName = 'DeliverySent2Icon';
