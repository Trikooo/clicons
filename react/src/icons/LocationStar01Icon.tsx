...
interface LocationStar01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/location-star01)
 * @see {@link https://clicons.dev/icon/location-star01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const LocationStar01Icon = React.forwardRef<SVGSVGElement, LocationStar01IconProps>(
  (
    {
      size,
      color,
...
LocationStar01Icon.displayName = 'LocationStar01Icon';
