...
interface AirplaneTakeOff02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/airplane-take-off02)
 * @see {@link https://clicons.dev/icon/airplane-take-off02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AirplaneTakeOff02Icon = React.forwardRef<SVGSVGElement, AirplaneTakeOff02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M6.01172 20H22", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
AirplaneTakeOff02Icon.displayName = 'AirplaneTakeOff02Icon';
