...
interface Ticket3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Ticket3Icon = React.forwardRef<SVGSVGElement, Ticket3IconProps>(
  (
    {
      size,
      color,
...
Ticket3Icon.displayName = 'Ticket3Icon';
export default Ticket3Icon;
