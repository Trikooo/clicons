...
interface Clapping2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/clapping2)
 * @see {@link https://clicons.dev/icon/clapping2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Clapping2Icon = React.forwardRef<SVGSVGElement, Clapping2IconProps>(
  (
    {
      size,
      color,
...
Clapping2Icon.displayName = 'Clapping2Icon';
export default Clapping2Icon;
