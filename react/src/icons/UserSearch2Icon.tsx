...
interface UserSearch2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name UserSearch2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/user-search2)
 * @see {@link https://clicons.dev/icon/user-search2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const UserSearch2Icon = React.forwardRef<SVGSVGElement, UserSearch2IconProps>(
  (
    {
      size,
      color,
...
UserSearch2Icon.displayName = 'UserSearch2Icon';
export default UserSearch2Icon;
