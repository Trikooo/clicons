...
interface Mouse02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mouse02)
 * @see {@link https://clicons.dev/icon/mouse02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Mouse02Icon = React.forwardRef<SVGSVGElement, Mouse02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M12 2L12 6M12 10L12 12", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
Mouse02Icon.displayName = 'Mouse02Icon';
