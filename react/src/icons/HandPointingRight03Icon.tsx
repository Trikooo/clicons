...
interface HandPointingRight03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/hand-pointing-right03)
 * @see {@link https://clicons.dev/icon/hand-pointing-right03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const HandPointingRight03Icon = React.forwardRef<SVGSVGElement, HandPointingRight03IconProps>(
  (
    {
      size,
      color,
...
HandPointingRight03Icon.displayName = 'HandPointingRight03Icon';
