...
interface ChevronUpIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @preview ![img](https://clicons.dev/icon/chevron-up)
 * @see {@link https://clicons.dev/icon/chevron-up}
 */
