...
interface AiInnovation3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const AiInnovation3Icon = React.forwardRef<SVGSVGElement, AiInnovation3IconProps>(
  (
    {
      size,
      color,
...
AiInnovation3Icon.displayName = 'AiInnovation3Icon';
export default AiInnovation3Icon;
