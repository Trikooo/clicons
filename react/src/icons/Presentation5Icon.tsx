...
interface Presentation5IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name Presentation5Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/presentation5)
 * @see {@link https://clicons.dev/icon/presentation5} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Presentation5Icon = React.forwardRef<SVGSVGElement, Presentation5IconProps>(
  (
    {
      size,
      color,
...
Presentation5Icon.displayName = 'Presentation5Icon';
export default Presentation5Icon;
