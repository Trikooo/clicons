...
const FlowCircleIcon = React.forwardRef<SVGSVGElement, FlowCircleIconProps>(
  (
    ...
    const iconData = [["path", { d: "M18 4.5C18 5.88071 16.8807 7 15.5 7C14.1193 7 13 5.88071 13 4.5C13 3.11929 14.1193 2 15.5 2C16.8807 2 18 3.11929 18 4.5Z", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
