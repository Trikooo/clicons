...
interface GitForkIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/git-fork)
 * @see {@link https://clicons.dev/icon/git-fork} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const GitForkIcon = React.forwardRef<SVGSVGElement, GitForkIconProps>(
  (
    {
      size,
      color,
