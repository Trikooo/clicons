...
interface ComputerChartUpIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name ComputerChartUpIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/computer-chart-up)
 * @see {@link https://clicons.dev/icon/computer-chart-up} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ComputerChartUpIcon = React.forwardRef<SVGSVGElement, ComputerChartUpIconProps>(
  (
    {
      size,
      color,
...
ComputerChartUpIcon.displayName = 'ComputerChartUpIcon';
export default ComputerChartUpIcon;
