...
interface GifIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/gif}
 */
const GifIcon = React.forwardRef<SVGSVGElement, GifIconProps>(
