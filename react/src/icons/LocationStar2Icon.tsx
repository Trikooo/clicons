...
interface LocationStar2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name LocationStar2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/location-star2)
 * @see {@link https://clicons.dev/icon/location-star2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const LocationStar2Icon = React.forwardRef<SVGSVGElement, LocationStar2IconProps>(
  (
    {
      size,
      color,
...
LocationStar2Icon.displayName = 'LocationStar2Icon';
export default LocationStar2Icon;
