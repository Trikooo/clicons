...
interface MessageUnlock02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/message-unlock02)
 * @see {@link https://clicons.dev/icon/message-unlock02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MessageUnlock02Icon = React.forwardRef<SVGSVGElement, MessageUnlock02IconProps>(
  (
    {
      size,
      color,
...
MessageUnlock02Icon.displayName = 'MessageUnlock02Icon';
