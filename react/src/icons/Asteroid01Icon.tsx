...
interface Asteroid01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/asteroid01)
 * @see {@link https://clicons.dev/icon/asteroid01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Asteroid01Icon = React.forwardRef<SVGSVGElement, Asteroid01IconProps>(
  (
    {
      size,
      color,
...
Asteroid01Icon.displayName = 'Asteroid01Icon';
