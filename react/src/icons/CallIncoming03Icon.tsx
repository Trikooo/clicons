...
interface CallIncoming03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-incoming03)
 * @see {@link https://clicons.dev/icon/call-incoming03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallIncoming03Icon = React.forwardRef<SVGSVGElement, CallIncoming03IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M16.5 3L14 5.5L16.5 8M21 5.5H14.6088", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
CallIncoming03Icon.displayName = 'CallIncoming03Icon';
export default CallIncoming03Icon;
