...
interface BorderNone02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/border-none02)
 * @see {@link https://clicons.dev/icon/border-none02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BorderNone02Icon = React.forwardRef<SVGSVGElement, BorderNone02IconProps>(
  (
    {
      size,
      color,
...
BorderNone02Icon.displayName = 'BorderNone02Icon';
export default BorderNone02Icon;
