...
interface Flag2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/flag2}
 */
const Flag2Icon = React.forwardRef<SVGSVGElement, Flag2IconProps>(
