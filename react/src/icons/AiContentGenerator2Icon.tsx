...
interface AiContentGenerator2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name AiContentGenerator2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/ai-content-generator2)
 * @see {@link https://clicons.dev/icon/ai-content-generator2}
 */
const AiContentGenerator2Icon = React.forwardRef<SVGSVGElement, AiContentGenerator2IconProps>(
...
AiContentGenerator2Icon.displayName = 'AiContentGenerator2Icon';
