 ...
 * @see {@link https://clicons.dev/icon/folder-library} - Icon preview
...
const FolderLibraryIcon = React.forwardRef<SVGSVGElement, FolderLibraryIconProps>(
  (
    ...
    const iconData = [["path", { d: "M16.2627 10.5H7.73725C5.15571 10.5 3.86494 10.5 3.27143 11.3526C2.67793 12.2052 3.11904 13.4258 4.00126 15.867L5.08545 18.867C5.54545 20.1398 5.77545 20.7763 6.2889 21.1381C6.80235 21.5 7.47538 21.5 8.82143 21.5H15.1786C16.5246 21.5 17.1976 21.5 17.7111 21.1381C18.2245 20.7763 18.4545 20.1398 18.9146 18.867L19.9987 15.867C20.881 13.4258 21.3221 12.2052 20.7286 11.3526C20.1351 10.5 18.8443 10.5 16.2627 10.5Z", stroke: "currentColor", strokeLinecap: "square", strokeWidth: "1.5", key: "0" }],
