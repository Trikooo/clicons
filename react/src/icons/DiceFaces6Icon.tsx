...
interface DiceFaces6IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const DiceFaces6Icon = React.forwardRef<SVGSVGElement, DiceFaces6IconProps>(
  (
    {
      size,
      color,
...
DiceFaces6Icon.displayName = 'DiceFaces6Icon';
export default DiceFaces6Icon;
