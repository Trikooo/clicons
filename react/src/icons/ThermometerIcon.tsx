...
interface ThermometerIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/thermometer)
 * @see {@link https://clicons.dev/icon/thermometer} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ThermometerIcon = React.forwardRef<SVGSVGElement, ThermometerIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M17.2634 6.7373L14.1055 9.8952", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "2" }]];
