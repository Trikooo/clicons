...
interface UserRemove2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name UserRemove2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/user-remove2)
 * @see {@link https://clicons.dev/icon/user-remove2}
 */
const UserRemove2Icon = React.forwardRef<SVGSVGElement, UserRemove2IconProps>(
