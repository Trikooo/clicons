...
interface SailboatOffshoreIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/sailboat-offshore)
 * @see {@link https://clicons.dev/icon/sailboat-offshore} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SailboatOffshoreIcon = React.forwardRef<SVGSVGElement, SailboatOffshoreIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M14 14L14 3", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "2" }],
...
SailboatOffshoreIcon.displayName = 'SailboatOffshoreIcon';
