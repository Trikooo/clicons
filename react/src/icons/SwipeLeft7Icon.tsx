...
interface SwipeLeft7IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/swipe-left7)
 * @see {@link https://clicons.dev/icon/swipe-left7} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SwipeLeft7Icon = React.forwardRef<SVGSVGElement, SwipeLeft7IconProps>(
  (
    {
      size,
      color,
...
SwipeLeft7Icon.displayName = 'SwipeLeft7Icon';
export default SwipeLeft7Icon;
