...
interface RotateRight03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/rotate-right03)
 * @see {@link https://clicons.dev/icon/rotate-right03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const RotateRight03Icon = React.forwardRef<SVGSVGElement, RotateRight03IconProps>(
  (
    {
      size,
      color,
...
RotateRight03Icon.displayName = 'RotateRight03Icon';
