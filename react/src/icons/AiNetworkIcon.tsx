...
interface AiNetworkIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const AiNetworkIcon = React.forwardRef<SVGSVGElement, AiNetworkIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M12.499 14.5L11.0384 9.97891C10.9465 9.69466 10.6648 9.5 10.3452 9.5C10.0256 9.5 9.74382 9.69466 9.65199 9.97891L8.19133 14.5M14.9989 9.5V14.5M8.72979 13H11.9606", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "5" }]];
...
AiNetworkIcon.displayName = 'AiNetworkIcon';
