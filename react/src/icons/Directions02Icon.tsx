...
interface Directions02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/directions02)
 * @see {@link https://clicons.dev/icon/directions02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Directions02Icon = React.forwardRef<SVGSVGElement, Directions02IconProps>(
  (
    {
      size,
      color,
...
Directions02Icon.displayName = 'Directions02Icon';
