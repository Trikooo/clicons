...
interface PauseIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pause)
 * @see {@link https://clicons.dev/icon/pause} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PauseIcon = React.forwardRef<SVGSVGElement, PauseIconProps>(
  (
    {
      size,
      color,
