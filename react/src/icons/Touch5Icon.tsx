...
interface Touch5IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/touch5)
 * @see {@link https://clicons.dev/icon/touch5} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Touch5Icon = React.forwardRef<SVGSVGElement, Touch5IconProps>(
  (
    {
      size,
      color,
...
Touch5Icon.displayName = 'Touch5Icon';
export default Touch5Icon;
