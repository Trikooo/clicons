...
interface ImageDelete2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name ImageDelete2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/image-delete2)
 * @see {@link https://clicons.dev/icon/image-delete2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ImageDelete2Icon = React.forwardRef<SVGSVGElement, ImageDelete2IconProps>(
  (
    {
      size,
      color,
...
ImageDelete2Icon.displayName = 'ImageDelete2Icon';
export default ImageDelete2Icon;
