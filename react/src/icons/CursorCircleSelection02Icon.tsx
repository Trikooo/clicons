...
interface CursorCircleSelection02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/cursor-circle-selection02)
 * @see {@link https://clicons.dev/icon/cursor-circle-selection02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CursorCircleSelection02Icon = React.forwardRef<SVGSVGElement, CursorCircleSelection02IconProps>(
  (
    {
      size,
      color,
...
CursorCircleSelection02Icon.displayName = 'CursorCircleSelection02Icon';
