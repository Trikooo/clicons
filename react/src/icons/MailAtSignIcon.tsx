...
interface MailAtSignIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MailAtSignIcon = React.forwardRef<SVGSVGElement, MailAtSignIconProps>(
  (
    {
      size,
      color,
...
MailAtSignIcon.displayName = 'MailAtSignIcon';
