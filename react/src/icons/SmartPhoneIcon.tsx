...
interface SmartPhoneIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/smart-phone}
 */
const SmartPhoneIcon = React.forwardRef<SVGSVGElement, SmartPhoneIconProps>(
