...
interface Playlist02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/playlist02)
 * @see {@link https://clicons.dev/icon/playlist02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Playlist02Icon = React.forwardRef<SVGSVGElement, Playlist02IconProps>(
  (
    {
      size,
      color,
...
Playlist02Icon.displayName = 'Playlist02Icon';
