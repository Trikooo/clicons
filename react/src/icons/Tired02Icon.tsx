...
interface Tired02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/tired02)
 * @see {@link https://clicons.dev/icon/tired02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Tired02Icon = React.forwardRef<SVGSVGElement, Tired02IconProps>(
  (
    {
      size,
      color,
...
Tired02Icon.displayName = 'Tired02Icon';
