...
interface Dress7IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/dress7}
 */
const Dress7Icon = React.forwardRef<SVGSVGElement, Dress7IconProps>(
...
Dress7Icon.displayName = 'Dress7Icon';
