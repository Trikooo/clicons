...
interface BatteryCharging01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/battery-charging01)
 * @see {@link https://clicons.dev/icon/battery-charging01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BatteryCharging01Icon = React.forwardRef<SVGSVGElement, BatteryCharging01IconProps>(
  (
    {
      size,
      color,
