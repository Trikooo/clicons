...
interface DeliveryTruckIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/delivery-truck}
 */
const DeliveryTruckIcon = React.forwardRef<SVGSVGElement, DeliveryTruckIconProps>(
