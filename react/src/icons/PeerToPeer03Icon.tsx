...
interface PeerToPeer03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/peer-to-peer03)
 * @see {@link https://clicons.dev/icon/peer-to-peer03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PeerToPeer03Icon = React.forwardRef<SVGSVGElement, PeerToPeer03IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M5.5166 3C4.68817 3 4.0166 3.67157 4.0166 4.5C4.0166 5.32843 4.68817 6 5.5166 6C6.34503 6 7.0166 5.32843 7.0166 4.5C7.0166 3.67157 6.34503 3 5.5166 3Z", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
  ["path", { d: "M18.5166 3C17.6882 3 17.0166 3.67157 17.0166 4.5C17.0166 5.32843 17.6882 6 18.5166 6C19.345 6 20.0166 5.32843 20.0166 4.5C20.0166 3.67157 19.345 3 18.5166 3Z", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "1" }],
  ["path", { d: "M10.0166 6H10.5166", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "2" }],
  ["path", { d: "M13.5166 6H14.0166", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "3" }],
...
PeerToPeer03Icon.displayName = 'PeerToPeer03Icon';
