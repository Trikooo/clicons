...
interface WardrobeIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/wardrobe)
 * @see {@link https://clicons.dev/icon/wardrobe} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const WardrobeIcon = React.forwardRef<SVGSVGElement, WardrobeIconProps>(
  (
    {
      size,
      color,
...
WardrobeIcon.displayName = 'WardrobeIcon';
