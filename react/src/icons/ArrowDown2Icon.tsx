...
interface ArrowDown2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/arrow-down2}
 */
const ArrowDown2Icon = React.forwardRef<SVGSVGElement, ArrowDown2IconProps>(
