...
interface CallRinging2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name CallRinging2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/call-ringing2)
 * @see {@link https://clicons.dev/icon/call-ringing2}
 */
const CallRinging2Icon = React.forwardRef<SVGSVGElement, CallRinging2IconProps>(
...
CallRinging2Icon.displayName = 'CallRinging2Icon';
