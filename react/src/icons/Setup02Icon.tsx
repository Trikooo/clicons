...
interface Setup02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/setup02)
 * @see {@link https://clicons.dev/icon/setup02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Setup02Icon = React.forwardRef<SVGSVGElement, Setup02IconProps>(
  (
    {
      size,
      color,
...
Setup02Icon.displayName = 'Setup02Icon';
