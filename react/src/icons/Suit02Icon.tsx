...
interface Suit02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/suit02)
 * @see {@link https://clicons.dev/icon/suit02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Suit02Icon = React.forwardRef<SVGSVGElement, Suit02IconProps>(
  (
    {
      size,
      color,
...
Suit02Icon.displayName = 'Suit02Icon';
