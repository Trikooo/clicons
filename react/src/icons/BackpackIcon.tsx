...
interface BackpackIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/backpack}
 */
const BackpackIcon = React.forwardRef<SVGSVGElement, BackpackIconProps>(
