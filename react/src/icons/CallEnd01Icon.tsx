...
interface CallEnd01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-end01)
 * @see {@link https://clicons.dev/icon/call-end01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallEnd01Icon = React.forwardRef<SVGSVGElement, CallEnd01IconProps>(
  (
    {
      size,
      color,
...
CallEnd01Icon.displayName = 'CallEnd01Icon';
export default CallEnd01Icon;
