...
interface CameraOff02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/camera-off02)
 * @see {@link https://clicons.dev/icon/camera-off02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CameraOff02Icon = React.forwardRef<SVGSVGElement, CameraOff02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M5 9H6", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
CameraOff02Icon.displayName = 'CameraOff02Icon';
