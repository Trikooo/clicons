...
interface AirplaneLanding02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/airplane-landing02)
 * @see {@link https://clicons.dev/icon/airplane-landing02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AirplaneLanding02Icon = React.forwardRef<SVGSVGElement, AirplaneLanding02IconProps>(
  (
    {
      size,
      color,
...
AirplaneLanding02Icon.displayName = 'AirplaneLanding02Icon';
