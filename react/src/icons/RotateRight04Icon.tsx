...
interface RotateRight04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/rotate-right04)
 * @see {@link https://clicons.dev/icon/rotate-right04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const RotateRight04Icon = React.forwardRef<SVGSVGElement, RotateRight04IconProps>(
  (
    {
      size,
      color,
...
RotateRight04Icon.displayName = 'RotateRight04Icon';
