...
interface CallPaused02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-paused02)
 * @see {@link https://clicons.dev/icon/call-paused02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallPaused02Icon = React.forwardRef<SVGSVGElement, CallPaused02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M19 3V9M15 3V9", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
CallPaused02Icon.displayName = 'CallPaused02Icon';
export default CallPaused02Icon;
