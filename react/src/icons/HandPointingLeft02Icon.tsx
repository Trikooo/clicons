...
interface HandPointingLeft02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/hand-pointing-left02)
 * @see {@link https://clicons.dev/icon/hand-pointing-left02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const HandPointingLeft02Icon = React.forwardRef<SVGSVGElement, HandPointingLeft02IconProps>(
  (
    {
      size,
      color,
...
HandPointingLeft02Icon.displayName = 'HandPointingLeft02Icon';
