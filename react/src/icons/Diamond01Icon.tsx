...
interface Diamond01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/diamond01)
 * @see {@link https://clicons.dev/icon/diamond01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Diamond01Icon = React.forwardRef<SVGSVGElement, Diamond01IconProps>(
  (
    {
      size,
      color,
