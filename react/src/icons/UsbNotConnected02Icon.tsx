...
interface UsbNotConnected02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/usb-not-connected02)
 * @see {@link https://clicons.dev/icon/usb-not-connected02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const UsbNotConnected02Icon = React.forwardRef<SVGSVGElement, UsbNotConnected02IconProps>(
  (
    {
      size,
      color,
...
UsbNotConnected02Icon.displayName = 'UsbNotConnected02Icon';
