...
interface Sorting01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/sorting01)
 * @see {@link https://clicons.dev/icon/sorting01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Sorting01Icon = React.forwardRef<SVGSVGElement, Sorting01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M11.0001 8L19.0001 8.00006", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
