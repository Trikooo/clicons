...
interface WebflowIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/webflow}
 */
const WebflowIcon = React.forwardRef<SVGSVGElement, WebflowIconProps>(
