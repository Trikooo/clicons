...
interface Tv01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/tv01)
 * @see {@link https://clicons.dev/icon/tv01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Tv01Icon = React.forwardRef<SVGSVGElement, Tv01IconProps>(
  (
    {
      size,
      color,
