...
interface MouseLeftClick5IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name MouseLeftClick5Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/mouse-left-click5)
 * @see {@link https://clicons.dev/icon/mouse-left-click5}
 */
const MouseLeftClick5Icon = React.forwardRef<SVGSVGElement, MouseLeftClick5IconProps>(
...
MouseLeftClick5Icon.displayName = 'MouseLeftClick5Icon';
