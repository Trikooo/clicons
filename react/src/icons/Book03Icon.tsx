...
interface Book03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/book03)
 * @see {@link https://clicons.dev/icon/book03} - Icon preview
...
const Book03Icon = React.forwardRef<SVGSVGElement, Book03IconProps>(
  (
    ...
    const iconData = [["path", { d: "M8 2V18", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
