...
interface Radar02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/radar02)
 * @see {@link https://clicons.dev/icon/radar02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Radar02Icon = React.forwardRef<SVGSVGElement, Radar02IconProps>(
  (
    {
      size,
      color,
...
Radar02Icon.displayName = 'Radar02Icon';
