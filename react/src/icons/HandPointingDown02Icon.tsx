...
interface HandPointingDown02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/hand-pointing-down02)
 * @see {@link https://clicons.dev/icon/hand-pointing-down02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const HandPointingDown02Icon = React.forwardRef<SVGSVGElement, HandPointingDown02IconProps>(
  (
    {
      size,
      color,
...
HandPointingDown02Icon.displayName = 'HandPointingDown02Icon';
