...
interface AllahIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/allah)
 * @see {@link https://clicons.dev/icon/allah} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AllahIcon = React.forwardRef<SVGSVGElement, AllahIconProps>(
  (
    {
      size,
      color,
...
AllahIcon.displayName = 'AllahIcon';
export default AllahIcon;
