...
const AllahIcon = React.forwardRef<SVGSVGElement, AllahIconProps>(
  ...
  [
    'path',
    {
      d: 'M17 10V16M14.5 10V14.5C14.5 15.3284 13.8284 16 13 16C12.1716 16 11.5 15.3284 11.5 14.5M11.5 8V14.5M11.5 14.5V10M11.5 14.5C11.5 15.3284 10.8284 16 10 16C9.17157 16 8.5 15.3284 8.5 14.5V10C8.5 10 6 10.5 6 13',
      stroke: 'currentColor',
      strokeLinecap: 'round',
