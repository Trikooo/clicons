...
interface BorderHorizontalIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const BorderHorizontalIcon = React.forwardRef<SVGSVGElement, BorderHorizontalIconProps>(
  (
    {
      size,
      color,
