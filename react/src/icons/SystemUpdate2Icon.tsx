...
interface SystemUpdate2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name SystemUpdate2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/system-update2)
 * @see {@link https://clicons.dev/icon/system-update2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SystemUpdate2Icon = React.forwardRef<SVGSVGElement, SystemUpdate2IconProps>(
  (
    {
      size,
      color,
...
SystemUpdate2Icon.displayName = 'SystemUpdate2Icon';
export default SystemUpdate2Icon;
