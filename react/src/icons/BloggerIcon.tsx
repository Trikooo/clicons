...
interface BloggerIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/blogger}
 */
const BloggerIcon = React.forwardRef<SVGSVGElement, BloggerIconProps>(
