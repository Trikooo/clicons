...
interface SolarSystemIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/solar-system)
 * @see {@link https://clicons.dev/icon/solar-system} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SolarSystemIcon = React.forwardRef<SVGSVGElement, SolarSystemIconProps>(
  (
    {
      size,
      color,
...
SolarSystemIcon.displayName = 'SolarSystemIcon';
