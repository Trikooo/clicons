...
interface Undo2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/undo2)
 * @see {@link https://clicons.dev/icon/undo2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Undo2Icon = React.forwardRef<SVGSVGElement, Undo2IconProps>(
  (
    {
      size,
      color,
