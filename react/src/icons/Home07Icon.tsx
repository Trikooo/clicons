...
interface Home07IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/home07)
 * @see {@link https://clicons.dev/icon/home07} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Home07Icon = React.forwardRef<SVGSVGElement, Home07IconProps>(
  (
    {
      size,
      color,
...
Home07Icon.displayName = 'Home07Icon';
