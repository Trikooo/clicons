...
interface RssUnlockedIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const RssUnlockedIcon = React.forwardRef<SVGSVGElement, RssUnlockedIconProps>(
  (
    {
      size,
      color,
...
RssUnlockedIcon.displayName = 'RssUnlockedIcon';
