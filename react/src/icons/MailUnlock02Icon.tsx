...
interface MailUnlock02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mail-unlock02)
 * @see {@link https://clicons.dev/icon/mail-unlock02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MailUnlock02Icon = React.forwardRef<SVGSVGElement, MailUnlock02IconProps>(
  (
    {
      size,
      color,
...
MailUnlock02Icon.displayName = 'MailUnlock02Icon';
export default MailUnlock02Icon;
