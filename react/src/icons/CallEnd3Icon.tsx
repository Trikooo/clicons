...
interface CallEnd3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-end3)
 * @see {@link https://clicons.dev/icon/call-end3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallEnd3Icon = React.forwardRef<SVGSVGElement, CallEnd3IconProps>(
  (
    {
      size,
      color,
...
CallEnd3Icon.displayName = 'CallEnd3Icon';
export default CallEnd3Icon;
