...
interface SafeIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/safe)
 * @see {@link https://clicons.dev/icon/safe} - Icon preview
