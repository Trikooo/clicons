...
const MirroringScreenIcon = React.forwardRef<SVGSVGElement, MirroringScreenIconProps>(
  (
    ...
    const iconData = [["path", { d: "M4 21C4 19.8954 3.10457 19 2 19M8 21C8 17.6863 5.31371 15 2 15M12 21C12 15.4772 7.52285 11 2 11", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
