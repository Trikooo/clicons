...
interface SimcardIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/simcard)
 * @see {@link https://clicons.dev/icon/simcard} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SimcardIcon = React.forwardRef<SVGSVGElement, SimcardIconProps>(
  (
    {
      size,
      color,
