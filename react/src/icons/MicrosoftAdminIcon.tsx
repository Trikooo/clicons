...
interface MicrosoftAdminIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/microsoft-admin)
 * @see {@link https://clicons.dev/icon/microsoft-admin} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MicrosoftAdminIcon = React.forwardRef<SVGSVGElement, MicrosoftAdminIconProps>(
  (
    {
      size,
      color,
...
MicrosoftAdminIcon.displayName = 'MicrosoftAdminIcon';
export default MicrosoftAdminIcon;
