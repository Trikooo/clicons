...
interface MailAdd2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/mail-add2}
 */
const MailAdd2Icon = React.forwardRef<SVGSVGElement, MailAdd2IconProps>(
...
MailAdd2Icon.displayName = 'MailAdd2Icon';
