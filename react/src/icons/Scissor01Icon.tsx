...
interface Scissor01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/scissor01)
 * @see {@link https://clicons.dev/icon/scissor01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Scissor01Icon = React.forwardRef<SVGSVGElement, Scissor01IconProps>(
  (
    {
      size,
      color,
