...
interface MessageIncoming2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MessageIncoming2Icon = React.forwardRef<SVGSVGElement, MessageIncoming2IconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M14 4.49997L22 4.49997M14 4.49997C14 3.79974 15.9943 2.4915 16.5 1.99997M14 4.49997C14 5.2002 15.9943 6.50844 16.5 6.99997',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
MessageIncoming2Icon.displayName = 'MessageIncoming2Icon';
export default MessageIncoming2Icon;
