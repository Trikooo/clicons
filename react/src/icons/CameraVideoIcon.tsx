 ...
 * @see {@link https://clicons.dev/icon/camera-video} - Icon preview
...
const CameraVideoIcon = React.forwardRef<SVGSVGElement, CameraVideoIconProps>(
  (
    ...
    const iconData = [["path", { d: "M4.5 21.5L8.5 17.5M10.5 17.5L14.5 21.5M9.5 17.5L9.5 22.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
