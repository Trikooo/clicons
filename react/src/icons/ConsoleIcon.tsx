 ...
 * @see {@link https://clicons.dev/icon/console}
 */
const ConsoleIcon = React.forwardRef<SVGSVGElement, ConsoleIconProps>(
  ...
  [
    'path',
    {
      d: 'M20 9.13119C19.1303 5.05749 15.4752 2 11.0982 2C6.0734 2 2 6.02944 2 11C2 15.9706 6.0734 20 11.0982 20C11.5749 20 12.0431 19.9637 12.5 19.8938'
    }
  ],
  [
    'path',
