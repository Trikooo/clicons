...
interface ArrowTriangleUpIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @preview ![img](https://clicons.dev/icon/arrow-triangle-up)
 * @see {@link https://clicons.dev/icon/arrow-triangle-up}
 */
const ArrowTriangleUpIcon = React.forwardRef<SVGSVGElement, ArrowTriangleUpIconProps>(
