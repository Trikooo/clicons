...
interface Setup01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/setup01)
 * @see {@link https://clicons.dev/icon/setup01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Setup01Icon = React.forwardRef<SVGSVGElement, Setup01IconProps>(
  (
    {
      size,
      color,
...
Setup01Icon.displayName = 'Setup01Icon';
export default Setup01Icon;
