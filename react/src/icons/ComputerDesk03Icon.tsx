...
interface ComputerDesk03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/computer-desk03)
 * @see {@link https://clicons.dev/icon/computer-desk03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ComputerDesk03Icon = React.forwardRef<SVGSVGElement, ComputerDesk03IconProps>(
  (
    {
      size,
      color,
...
ComputerDesk03Icon.displayName = 'ComputerDesk03Icon';
