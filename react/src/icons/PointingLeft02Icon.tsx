...
interface PointingLeft02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pointing-left02)
 * @see {@link https://clicons.dev/icon/pointing-left02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PointingLeft02Icon = React.forwardRef<SVGSVGElement, PointingLeft02IconProps>(
  (
    {
      size,
      color,
...
PointingLeft02Icon.displayName = 'PointingLeft02Icon';
