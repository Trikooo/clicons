...
interface Link06IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/link06)
 * @see {@link https://clicons.dev/icon/link06} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Link06Icon = React.forwardRef<SVGSVGElement, Link06IconProps>(
  (
    {
      size,
      color,
...
Link06Icon.displayName = 'Link06Icon';
export default Link06Icon;
