...
interface Discount01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/discount01)
 * @see {@link https://clicons.dev/icon/discount01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Discount01Icon = React.forwardRef<SVGSVGElement, Discount01IconProps>(
  (
    {
      size,
      color,
...
Discount01Icon.displayName = 'Discount01Icon';
