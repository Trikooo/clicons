...
interface BookIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/book)
 * @see {@link https://clicons.dev/icon/book} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BookIcon = React.forwardRef<SVGSVGElement, BookIconProps>(
  (
    {
      size,
      color,
