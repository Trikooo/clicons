...
interface Mail02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mail02)
 * @see {@link https://clicons.dev/icon/mail02} - Icon preview
...
const Mail02Icon = React.forwardRef<SVGSVGElement, Mail02IconProps>(
  (
    ...
    const iconData = [["path", { d: "M7 8.5L9.94202 10.2394C11.6572 11.2535 12.3428 11.2535 14.058 10.2394L17 8.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
