...
interface LookRightIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const LookRightIcon = React.forwardRef<SVGSVGElement, LookRightIconProps>(
  (
    {
      size,
      color,
...
LookRightIcon.displayName = 'LookRightIcon';
