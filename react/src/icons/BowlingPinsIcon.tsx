 ...
 * @see {@link https://clicons.dev/icon/bowling-pins} - Icon preview
...
const BowlingPinsIcon = React.forwardRef<SVGSVGElement, BowlingPinsIconProps>(
  (
    ...
    const iconData = [["path", { d: "M12.5 10.544C13.2611 10.1947 14.1078 10 15 10C18.3137 10 21 12.6863 21 16C21 19.3137 18.3137 22 15 22C14.4821 22 13.9794 21.9344 13.5 21.811", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
