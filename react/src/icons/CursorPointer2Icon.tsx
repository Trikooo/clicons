...
interface CursorPointer2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name CursorPointer2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/cursor-pointer2)
 * @see {@link https://clicons.dev/icon/cursor-pointer2}
 */
const CursorPointer2Icon = React.forwardRef<SVGSVGElement, CursorPointer2IconProps>(
...
CursorPointer2Icon.displayName = 'CursorPointer2Icon';
