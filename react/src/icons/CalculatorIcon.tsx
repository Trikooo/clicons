...
interface CalculatorIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const CalculatorIcon = React.forwardRef<SVGSVGElement, CalculatorIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M5.5 3V8M8 5.5L3 5.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
