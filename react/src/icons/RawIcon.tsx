...
interface RawIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const RawIcon = React.forwardRef<SVGSVGElement, RawIconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M4 22V19.5M4 19.5V16L6.25 16C7.2165 16 8 16.7835 8 17.75C8 18.7165 7.2165 19.5 6.25 19.5M4 19.5H6.25M6.25 19.5L7.5 22',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
