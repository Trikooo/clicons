...
interface Touch05IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/touch05)
 * @see {@link https://clicons.dev/icon/touch05} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Touch05Icon = React.forwardRef<SVGSVGElement, Touch05IconProps>(
  (
    {
      size,
      color,
...
Touch05Icon.displayName = 'Touch05Icon';
