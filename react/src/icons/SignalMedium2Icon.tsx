...
interface SignalMedium2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name SignalMedium2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/signal-medium2)
 * @see {@link https://clicons.dev/icon/signal-medium2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SignalMedium2Icon = React.forwardRef<SVGSVGElement, SignalMedium2IconProps>(
  (
    {
      size,
      color,
...
SignalMedium2Icon.displayName = 'SignalMedium2Icon';
export default SignalMedium2Icon;
