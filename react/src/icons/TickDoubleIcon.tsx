...
interface TickDoubleIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/tick-double}
 */
const TickDoubleIcon = React.forwardRef<SVGSVGElement, TickDoubleIconProps>(
...
TickDoubleIcon.displayName = 'TickDoubleIcon';
