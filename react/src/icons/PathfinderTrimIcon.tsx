...
interface PathfinderTrimIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pathfinder-trim)
 * @see {@link https://clicons.dev/icon/pathfinder-trim} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PathfinderTrimIcon = React.forwardRef<SVGSVGElement, PathfinderTrimIconProps>(
  (
    {
      size,
      color,
...
PathfinderTrimIcon.displayName = 'PathfinderTrimIcon';
