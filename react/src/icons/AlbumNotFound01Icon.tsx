...
interface AlbumNotFound01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/album-not-found01)
 * @see {@link https://clicons.dev/icon/album-not-found01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AlbumNotFound01Icon = React.forwardRef<SVGSVGElement, AlbumNotFound01IconProps>(
  (
    {
      size,
      color,
...
AlbumNotFound01Icon.displayName = 'AlbumNotFound01Icon';
