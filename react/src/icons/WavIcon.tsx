...
interface WavIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/wav}
 */
const WavIcon = React.forwardRef<SVGSVGElement, WavIconProps>(
