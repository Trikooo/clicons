...
interface Comet2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Comet2Icon = React.forwardRef<SVGSVGElement, Comet2IconProps>(
  (
    {
      size,
      color,
...
Comet2Icon.displayName = 'Comet2Icon';
export default Comet2Icon;
