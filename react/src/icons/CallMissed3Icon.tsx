...
interface CallMissed3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name CallMissed3Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/call-missed3)
 * @see {@link https://clicons.dev/icon/call-missed3}
 */
const CallMissed3Icon = React.forwardRef<SVGSVGElement, CallMissed3IconProps>(
...
CallMissed3Icon.displayName = 'CallMissed3Icon';
