...
interface Medal03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/medal03)
 * @see {@link https://clicons.dev/icon/medal03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Medal03Icon = React.forwardRef<SVGSVGElement, Medal03IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M10.5292 13.6376C11.2478 13.2125 11.6071 13 12 13C12.3929 13 12.7522 13.2125 13.4708 13.6376L14.4708 14.2292C15.2167 14.6704 15.5896 14.891 15.7948 15.26C16 15.6289 16 16.0789 16 16.979V18.021C16 18.9211 16 19.3711 15.7948 19.74C15.5896 20.109 15.2167 20.3296 14.4708 20.7708L13.4708 21.3624C12.7522 21.7875 12.3929 22 12 22C11.6071 22 11.2478 21.7875 10.5292 21.3624L9.52922 20.7708C8.78332 20.3296 8.41037 20.109 8.20519 19.74C8 19.3711 8 18.9211 8 18.021V16.979C8 16.0789 8 15.6289 8.20519 15.26C8.41037 14.891 8.78332 14.6704 9.52922 14.2292L10.5292 13.6376Z", stroke: "currentColor", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
  ...
  ["path", { d: "M12 2V7", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "2" }]];
...
Medal03Icon.displayName = 'Medal03Icon';
