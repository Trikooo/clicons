...
interface LibrariesIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/libraries)
 * @see {@link https://clicons.dev/icon/libraries} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const LibrariesIcon = React.forwardRef<SVGSVGElement, LibrariesIconProps>(
  (
    {
      size,
      color,
