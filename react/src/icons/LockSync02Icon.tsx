...
const LockSync02Icon = React.forwardRef<SVGSVGElement, LockSync02IconProps>(
  (
    ...
    const iconData = [["path", { d: "M20 11H22C21.497 5.94668 17.2229 2 12.0247 2C6.48823 2 2 6.47715 2 12C2 17.5228 6.48823 22 12.0247 22C16.1355 22 19.6684 19.5318 21.2154 16", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
