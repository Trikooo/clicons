...
interface CallOutgoing3IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name CallOutgoing3Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/call-outgoing3)
 * @see {@link https://clicons.dev/icon/call-outgoing3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallOutgoing3Icon = React.forwardRef<SVGSVGElement, CallOutgoing3IconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M18.5 3L21 5.5L18.5 8M14 5.5H20.3912',
      stroke: 'currentColor',
      strokeLinecap: 'round',
...
CallOutgoing3Icon.displayName = 'CallOutgoing3Icon';
export default CallOutgoing3Icon;
