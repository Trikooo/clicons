...
interface ArrowUpLeft2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name ArrowUpLeft2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/arrow-up-left2)
 * @see {@link https://clicons.dev/icon/arrow-up-left2}
 */
const ArrowUpLeft2Icon = React.forwardRef<SVGSVGElement, ArrowUpLeft2IconProps>(
...
ArrowUpLeft2Icon.displayName = 'ArrowUpLeft2Icon';
