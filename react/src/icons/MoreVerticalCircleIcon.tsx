...
interface MoreVerticalCircleIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name MoreVerticalCircleIcon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/more-vertical-circle)
 * @see {@link https://clicons.dev/icon/more-vertical-circle}
 */
const MoreVerticalCircleIcon = React.forwardRef<SVGSVGElement, MoreVerticalCircleIconProps>(
