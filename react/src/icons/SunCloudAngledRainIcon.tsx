...
interface SunCloudAngledRainIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const SunCloudAngledRainIcon = React.forwardRef<SVGSVGElement, SunCloudAngledRainIconProps>(
  (
    {
      size,
      color,
...
SunCloudAngledRainIcon.displayName = 'SunCloudAngledRainIcon';
export default SunCloudAngledRainIcon;
