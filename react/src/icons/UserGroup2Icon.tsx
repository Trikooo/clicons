...
interface UserGroup2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/user-group2}
 */
const UserGroup2Icon = React.forwardRef<SVGSVGElement, UserGroup2IconProps>(
...
UserGroup2Icon.displayName = 'UserGroup2Icon';
