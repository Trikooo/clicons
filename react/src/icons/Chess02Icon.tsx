...
interface Chess02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/chess02)
 * @see {@link https://clicons.dev/icon/chess02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Chess02Icon = React.forwardRef<SVGSVGElement, Chess02IconProps>(
  (
    {
      size,
      color,
...
Chess02Icon.displayName = 'Chess02Icon';
