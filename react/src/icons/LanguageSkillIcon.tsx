...
interface LanguageSkillIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/language-skill)
 * @see {@link https://clicons.dev/icon/language-skill} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const LanguageSkillIcon = React.forwardRef<SVGSVGElement, LanguageSkillIconProps>(
  (
    {
      size,
      color,
...
LanguageSkillIcon.displayName = 'LanguageSkillIcon';
