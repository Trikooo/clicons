 ...
 * @see {@link https://clicons.dev/icon/halal-lab}
 */
const HalalLabIcon = React.forwardRef<SVGSVGElement, HalalLabIconProps>(
  ...
  [
    'path',
    {
      d: 'M7 3H3V21H7C7 18.2386 9.23858 16 12 16C14.7614 16 17 18.2386 17 21H21C21 16.0294 16.9706 12 12 12C10.1499 12 8.4301 12.5583 7 13.5155V3Z'
    }
  ],
  [
    'path',
