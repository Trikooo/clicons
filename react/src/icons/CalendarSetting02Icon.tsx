...
interface CalendarSetting02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/calendar-setting02)
 * @see {@link https://clicons.dev/icon/calendar-setting02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CalendarSetting02Icon = React.forwardRef<SVGSVGElement, CalendarSetting02IconProps>(
  (
    {
      size,
      color,
...
CalendarSetting02Icon.displayName = 'CalendarSetting02Icon';
