...
interface Atm02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/atm02)
 * @see {@link https://clicons.dev/icon/atm02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Atm02Icon = React.forwardRef<SVGSVGElement, Atm02IconProps>(
  (
    {
      size,
      color,
...
Atm02Icon.displayName = 'Atm02Icon';
export default Atm02Icon;
