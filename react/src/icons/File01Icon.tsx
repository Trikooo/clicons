...
interface File01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/file01)
 * @see {@link https://clicons.dev/icon/file01} - Icon preview
...
const File01Icon = React.forwardRef<SVGSVGElement, File01IconProps>(
  (
    ...
    const iconData = [["path", { d: "M8 7L16 7", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
