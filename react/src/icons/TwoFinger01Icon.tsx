...
interface TwoFinger01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/two-finger01)
 * @see {@link https://clicons.dev/icon/two-finger01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TwoFinger01Icon = React.forwardRef<SVGSVGElement, TwoFinger01IconProps>(
  (
    {
      size,
      color,
...
TwoFinger01Icon.displayName = 'TwoFinger01Icon';
