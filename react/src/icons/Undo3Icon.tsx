...
interface Undo3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/undo3}
 */
const Undo3Icon = React.forwardRef<SVGSVGElement, Undo3IconProps>(
...
Undo3Icon.displayName = 'Undo3Icon';
