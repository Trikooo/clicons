...
interface CameraNightMode01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/camera-night-mode01)
 * @see {@link https://clicons.dev/icon/camera-night-mode01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CameraNightMode01Icon = React.forwardRef<SVGSVGElement, CameraNightMode01IconProps>(
  (
    {
      size,
      color,
...
CameraNightMode01Icon.displayName = 'CameraNightMode01Icon';
export default CameraNightMode01Icon;
