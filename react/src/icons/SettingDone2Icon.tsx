...
interface SettingDone2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const SettingDone2Icon = React.forwardRef<SVGSVGElement, SettingDone2IconProps>(
  (
    {
      size,
      color,
...
SettingDone2Icon.displayName = 'SettingDone2Icon';
export default SettingDone2Icon;
