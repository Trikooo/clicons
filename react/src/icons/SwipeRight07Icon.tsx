...
interface SwipeRight07IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/swipe-right07)
 * @see {@link https://clicons.dev/icon/swipe-right07} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SwipeRight07Icon = React.forwardRef<SVGSVGElement, SwipeRight07IconProps>(
  (
    {
      size,
      color,
...
SwipeRight07Icon.displayName = 'SwipeRight07Icon';
