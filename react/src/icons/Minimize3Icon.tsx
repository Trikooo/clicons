...
interface Minimize3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/minimize3}
 */
const Minimize3Icon = React.forwardRef<SVGSVGElement, Minimize3IconProps>(
...
Minimize3Icon.displayName = 'Minimize3Icon';
