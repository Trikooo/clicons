...
interface ThreeDScaleIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/three-d-scale)
 * @see {@link https://clicons.dev/icon/three-d-scale} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ThreeDScaleIcon = React.forwardRef<SVGSVGElement, ThreeDScaleIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M12 13L17 17.5M12 13L7 17.5M12 13V8", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
...
ThreeDScaleIcon.displayName = 'ThreeDScaleIcon';
