...
interface CursorLoading01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/cursor-loading01)
 * @see {@link https://clicons.dev/icon/cursor-loading01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CursorLoading01Icon = React.forwardRef<SVGSVGElement, CursorLoading01IconProps>(
  (
    {
      size,
      color,
...
CursorLoading01Icon.displayName = 'CursorLoading01Icon';
