...
interface Doc01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/doc01)
 * @see {@link https://clicons.dev/icon/doc01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Doc01Icon = React.forwardRef<SVGSVGElement, Doc01IconProps>(
  (
    {
      size,
      color,
...
Doc01Icon.displayName = 'Doc01Icon';
