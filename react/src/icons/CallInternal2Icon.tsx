...
interface CallInternal2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name CallInternal2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/call-internal2)
 * @see {@link https://clicons.dev/icon/call-internal2}
 */
const CallInternal2Icon = React.forwardRef<SVGSVGElement, CallInternal2IconProps>(
...
CallInternal2Icon.displayName = 'CallInternal2Icon';
