...
interface ChatUser01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/chat-user01)
 * @see {@link https://clicons.dev/icon/chat-user01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ChatUser01Icon = React.forwardRef<SVGSVGElement, ChatUser01IconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M16 8.49951C16 6.84266 17.3431 5.49951 19 5.49951M19 5.49951C20.6569 5.49951 22 6.84266 22 8.49951M19 5.49951C19.9665 5.49951 20.75 4.7165 20.75 3.75C20.75 2.7835 19.9665 2 19 2C18.0335 2 17.25 2.7835 17.25 3.75C17.25 4.7165 18.0335 5.49951 19 5.49951Z',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
ChatUser01Icon.displayName = 'ChatUser01Icon';
export default ChatUser01Icon;
