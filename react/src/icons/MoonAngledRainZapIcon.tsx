...
interface MoonAngledRainZapIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/moon-angled-rain-zap}
 */
const MoonAngledRainZapIcon = React.forwardRef<SVGSVGElement, MoonAngledRainZapIconProps>(
  ...
  [
    'path',
    {
      d: 'M10 5.14839C9.91652 4.71721 9.76249 4.29241 9.53351 3.89062C8.98606 2.93002 8.11203 2.27953 7.13552 2C7.28642 3.2303 6.71543 4.48952 5.58897 5.14839C4.46251 5.80725 3.10057 5.6786 2.1243 4.93106C1.87501 5.92756 1.99406 7.01964 2.54151 7.98024C3.20804 9.1498 4.35869 9.85965 5.58897 10'
    }
  ]
];
...
MoonAngledRainZapIcon.displayName = 'MoonAngledRainZapIcon';
