...
interface SwipeDown05IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/swipe-down05)
 * @see {@link https://clicons.dev/icon/swipe-down05} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SwipeDown05Icon = React.forwardRef<SVGSVGElement, SwipeDown05IconProps>(
  (
    {
      size,
      color,
...
SwipeDown05Icon.displayName = 'SwipeDown05Icon';
export default SwipeDown05Icon;
