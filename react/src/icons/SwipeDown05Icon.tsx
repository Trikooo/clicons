...
const SwipeDown05Icon = React.forwardRef<SVGSVGElement, SwipeDown05IconProps>(
  ...
  [
    'path',
    {
      d: 'M18.5 8L18.5 2M18.5 8C17.7998 8 16.4915 6.0057 16 5.5M18.5 8C19.2002 8 20.5085 6.0057 21 5.5',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
