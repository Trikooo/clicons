...
interface SystemUpdate02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/system-update02)
 * @see {@link https://clicons.dev/icon/system-update02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SystemUpdate02Icon = React.forwardRef<SVGSVGElement, SystemUpdate02IconProps>(
  (
    {
      size,
      color,
...
SystemUpdate02Icon.displayName = 'SystemUpdate02Icon';
export default SystemUpdate02Icon;
