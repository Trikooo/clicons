...
interface Stamp01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/stamp01)
 * @see {@link https://clicons.dev/icon/stamp01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Stamp01Icon = React.forwardRef<SVGSVGElement, Stamp01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M4.98572 19.1814C5.00154 20.4212 5.08263 20.9434 5.49849 21.4149C6.0151 22.0007 6.84657 22.0007 8.50951 22.0007H15.4619C17.1248 22.0007 17.9563 22.0007 18.4729 21.4149C18.8888 20.9434 18.9699 20.4212 18.9857 19.1814", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
Stamp01Icon.displayName = 'Stamp01Icon';
