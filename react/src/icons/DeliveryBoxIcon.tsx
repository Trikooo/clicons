...
interface DeliveryBoxIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name DeliveryBoxIcon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/delivery-box)
 * @see {@link https://clicons.dev/icon/delivery-box}
 */
const DeliveryBoxIcon = React.forwardRef<SVGSVGElement, DeliveryBoxIconProps>(
