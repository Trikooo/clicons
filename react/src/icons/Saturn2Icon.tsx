...
interface Saturn2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/saturn2}
 */
const Saturn2Icon = React.forwardRef<SVGSVGElement, Saturn2IconProps>(
...
Saturn2Icon.displayName = 'Saturn2Icon';
