...
interface Home5IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Home5Icon = React.forwardRef<SVGSVGElement, Home5IconProps>(
  (
    {
      size,
      color,
...
Home5Icon.displayName = 'Home5Icon';
export default Home5Icon;
