...
interface ReverseWithdrawalIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name ReverseWithdrawalIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/reverse-withdrawal)
 * @see {@link https://clicons.dev/icon/reverse-withdrawal} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ReverseWithdrawalIcon = React.forwardRef<SVGSVGElement, ReverseWithdrawalIconProps>(
  (
    {
      size,
      color,
...
ReverseWithdrawalIcon.displayName = 'ReverseWithdrawalIcon';
export default ReverseWithdrawalIcon;
