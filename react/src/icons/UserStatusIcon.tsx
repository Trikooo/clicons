...
interface UserStatusIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/user-status)
 * @see {@link https://clicons.dev/icon/user-status} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const UserStatusIcon = React.forwardRef<SVGSVGElement, UserStatusIconProps>(
  (
    {
      size,
      color,
