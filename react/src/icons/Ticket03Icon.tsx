...
interface Ticket03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/ticket03)
 * @see {@link https://clicons.dev/icon/ticket03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Ticket03Icon = React.forwardRef<SVGSVGElement, Ticket03IconProps>(
  (
    {
      size,
      color,
...
Ticket03Icon.displayName = 'Ticket03Icon';
