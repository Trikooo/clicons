 ...
 * @see {@link https://clicons.dev/icon/protection-mask} - Icon preview
...
const ProtectionMaskIcon = React.forwardRef<SVGSVGElement, ProtectionMaskIconProps>(
  (
    ...
    const iconData = [["path", { d: "M4.27574 22V18.4493C4.27574 17.172 3.93486 16.5167 3.26456 15.4113C2.46115 14.0864 2 12.5402 2 10.8889C2 5.97969 6.07554 2 11.103 2C15.4666 2 19.1132 4.99817 20 9", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
