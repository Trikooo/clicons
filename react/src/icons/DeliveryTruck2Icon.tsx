...
interface DeliveryTruck2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const DeliveryTruck2Icon = React.forwardRef<SVGSVGElement, DeliveryTruck2IconProps>(
  (
    {
      size,
      color,
...
DeliveryTruck2Icon.displayName = 'DeliveryTruck2Icon';
export default DeliveryTruck2Icon;
