...
interface Attachment2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name Attachment2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/attachment2)
 * @see {@link https://clicons.dev/icon/attachment2}
 */
const Attachment2Icon = React.forwardRef<SVGSVGElement, Attachment2IconProps>(
