...
interface ChocolateIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/chocolate)
 * @see {@link https://clicons.dev/icon/chocolate} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ChocolateIcon = React.forwardRef<SVGSVGElement, ChocolateIconProps>(
  (
    {
      size,
      color,
