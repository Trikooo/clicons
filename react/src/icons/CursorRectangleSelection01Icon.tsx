...
interface CursorRectangleSelection01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/cursor-rectangle-selection01)
 * @see {@link https://clicons.dev/icon/cursor-rectangle-selection01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CursorRectangleSelection01Icon = React.forwardRef<SVGSVGElement, CursorRectangleSelection01IconProps>(
  (
    {
      size,
      color,
...
CursorRectangleSelection01Icon.displayName = 'CursorRectangleSelection01Icon';
