...
interface Configuration02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/configuration02)
 * @see {@link https://clicons.dev/icon/configuration02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Configuration02Icon = React.forwardRef<SVGSVGElement, Configuration02IconProps>(
  (
    {
      size,
      color,
...
Configuration02Icon.displayName = 'Configuration02Icon';
