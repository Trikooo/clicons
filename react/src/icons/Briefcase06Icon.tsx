...
interface Briefcase06IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/briefcase06)
 * @see {@link https://clicons.dev/icon/briefcase06} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Briefcase06Icon = React.forwardRef<SVGSVGElement, Briefcase06IconProps>(
  (
    {
      size,
      color,
...
Briefcase06Icon.displayName = 'Briefcase06Icon';
export default Briefcase06Icon;
