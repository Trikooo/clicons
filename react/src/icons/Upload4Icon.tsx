...
interface Upload4IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/upload4)
 * @see {@link https://clicons.dev/icon/upload4} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Upload4Icon = React.forwardRef<SVGSVGElement, Upload4IconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M16.5 7.49996C16.5 7.49996 13.1858 3.00001 12 3C10.8141 2.99999 7.5 7.5 7.5 7.5M12 4V15',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
Upload4Icon.displayName = 'Upload4Icon';
export default Upload4Icon;
