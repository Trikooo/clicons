...
interface BorderNoneIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/border-none)
 * @see {@link https://clicons.dev/icon/border-none} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BorderNoneIcon = React.forwardRef<SVGSVGElement, BorderNoneIconProps>(
  (
    {
      size,
      color,
