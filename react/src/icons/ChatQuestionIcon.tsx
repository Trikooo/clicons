...
const ChatQuestionIcon = React.forwardRef<SVGSVGElement, ChatQuestionIconProps>(
  ...
  [
    'path',
    {
      d: 'M9.5 8.5C9.5 7.11929 10.6193 6 12 6C13.3807 6 14.5 7.11929 14.5 8.5C14.5 9.53529 13.8707 10.4236 12.9737 10.8033C12.4651 11.0186 12 11.4477 12 12',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
