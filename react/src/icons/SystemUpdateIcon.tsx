...
interface SystemUpdateIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/system-update)
 * @see {@link https://clicons.dev/icon/system-update} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SystemUpdateIcon = React.forwardRef<SVGSVGElement, SystemUpdateIconProps>(
  (
    {
      size,
      color,
