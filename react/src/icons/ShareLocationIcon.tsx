...
interface ShareLocationIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const ShareLocationIcon = React.forwardRef<SVGSVGElement, ShareLocationIconProps>(
  (
    {
      size,
      color,
