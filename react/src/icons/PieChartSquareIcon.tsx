...
interface PieChartSquareIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pie-chart-square)
 * @see {@link https://clicons.dev/icon/pie-chart-square} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PieChartSquareIcon = React.forwardRef<SVGSVGElement, PieChartSquareIconProps>(
  (
    {
      size,
      color,
...
PieChartSquareIcon.displayName = 'PieChartSquareIcon';
