...
interface Chess2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/chess2}
 */
const Chess2Icon = React.forwardRef<SVGSVGElement, Chess2IconProps>(
...
Chess2Icon.displayName = 'Chess2Icon';
