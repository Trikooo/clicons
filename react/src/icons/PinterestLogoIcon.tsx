...
interface PinterestLogoIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
}
 ...
 * @preview ![img](https://clicons.dev/icon/pinterest-logo)
 * @see {@link https://clicons.dev/icon/pinterest-logo}
 */
const PinterestLogoIcon = React.forwardRef<SVGSVGElement, PinterestLogoIconProps>(
...
PinterestLogoIcon.displayName = 'PinterestLogoIcon';
