...
interface SecurityKeyUsbIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/security-key-usb}
 */
const SecurityKeyUsbIcon = React.forwardRef<SVGSVGElement, SecurityKeyUsbIconProps>(
...
SecurityKeyUsbIcon.displayName = 'SecurityKeyUsbIcon';
