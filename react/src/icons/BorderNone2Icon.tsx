...
interface BorderNone2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name BorderNone2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/border-none2)
 * @see {@link https://clicons.dev/icon/border-none2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BorderNone2Icon = React.forwardRef<SVGSVGElement, BorderNone2IconProps>(
  (
    {
      size,
      color,
...
BorderNone2Icon.displayName = 'BorderNone2Icon';
export default BorderNone2Icon;
