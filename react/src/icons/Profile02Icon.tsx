...
interface Profile02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/profile02)
 * @see {@link https://clicons.dev/icon/profile02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Profile02Icon = React.forwardRef<SVGSVGElement, Profile02IconProps>(
  (
    {
      size,
      color,
...
Profile02Icon.displayName = 'Profile02Icon';
