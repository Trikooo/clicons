...
interface DashboardSquare2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name DashboardSquare2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/dashboard-square2)
 * @see {@link https://clicons.dev/icon/dashboard-square2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const DashboardSquare2Icon = React.forwardRef<SVGSVGElement, DashboardSquare2IconProps>(
  (
    {
      size,
      color,
...
DashboardSquare2Icon.displayName = 'DashboardSquare2Icon';
export default DashboardSquare2Icon;
