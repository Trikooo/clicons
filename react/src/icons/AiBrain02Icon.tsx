...
interface AiBrain02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/ai-brain02)
 * @see {@link https://clicons.dev/icon/ai-brain02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AiBrain02Icon = React.forwardRef<SVGSVGElement, AiBrain02IconProps>(
  (
    {
      size,
      color,
...
AiBrain02Icon.displayName = 'AiBrain02Icon';
