...
interface ArrowLeft4IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/arrow-left4)
 * @see {@link https://clicons.dev/icon/arrow-left4} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ArrowLeft4Icon = React.forwardRef<SVGSVGElement, ArrowLeft4IconProps>(
  (
    {
      size,
      color,
...
ArrowLeft4Icon.displayName = 'ArrowLeft4Icon';
