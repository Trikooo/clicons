...
interface Home9IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Home9Icon = React.forwardRef<SVGSVGElement, Home9IconProps>(
  (
    {
      size,
      color,
...
Home9Icon.displayName = 'Home9Icon';
export default Home9Icon;
