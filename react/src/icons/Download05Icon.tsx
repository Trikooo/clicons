...
interface Download05IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/download05)
 * @see {@link https://clicons.dev/icon/download05} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Download05Icon = React.forwardRef<SVGSVGElement, Download05IconProps>(
  (
    {
      size,
      color,
...
Download05Icon.displayName = 'Download05Icon';
