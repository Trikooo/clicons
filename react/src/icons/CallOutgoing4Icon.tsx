...
interface CallOutgoing4IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name CallOutgoing4Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/call-outgoing4)
 * @see {@link https://clicons.dev/icon/call-outgoing4} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallOutgoing4Icon = React.forwardRef<SVGSVGElement, CallOutgoing4IconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M21 7V3H17M15 9L20.5941 3.40586',
      stroke: 'currentColor',
      strokeLinecap: 'round',
...
CallOutgoing4Icon.displayName = 'CallOutgoing4Icon';
export default CallOutgoing4Icon;
