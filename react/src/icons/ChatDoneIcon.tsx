...
interface ChatDoneIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/chat-done)
 * @see {@link https://clicons.dev/icon/chat-done} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ChatDoneIcon = React.forwardRef<SVGSVGElement, ChatDoneIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M9 11.3333C9 11.3333 10 11.3333 11 13C11 13 13.1765 8.83333 16 8", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "1" }]];
...
ChatDoneIcon.displayName = 'ChatDoneIcon';
export default ChatDoneIcon;
