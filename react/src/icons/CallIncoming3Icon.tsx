...
interface CallIncoming3IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name CallIncoming3Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/call-incoming3)
 * @see {@link https://clicons.dev/icon/call-incoming3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallIncoming3Icon = React.forwardRef<SVGSVGElement, CallIncoming3IconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M16.5 3L14 5.5L16.5 8M21 5.5H14.6088',
      stroke: 'currentColor',
      strokeLinecap: 'round',
...
CallIncoming3Icon.displayName = 'CallIncoming3Icon';
export default CallIncoming3Icon;
