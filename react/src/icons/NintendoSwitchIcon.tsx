...
interface NintendoSwitchIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/nintendo-switch}
 */
const NintendoSwitchIcon = React.forwardRef<SVGSVGElement, NintendoSwitchIconProps>(
...
NintendoSwitchIcon.displayName = 'NintendoSwitchIcon';
