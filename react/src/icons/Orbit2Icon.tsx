...
interface Orbit2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/orbit2}
 */
const Orbit2Icon = React.forwardRef<SVGSVGElement, Orbit2IconProps>(
...
Orbit2Icon.displayName = 'Orbit2Icon';
