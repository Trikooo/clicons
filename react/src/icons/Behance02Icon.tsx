...
interface Behance02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/behance02)
 * @see {@link https://clicons.dev/icon/behance02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Behance02Icon = React.forwardRef<SVGSVGElement, Behance02IconProps>(
  (
    {
      size,
      color,
...
Behance02Icon.displayName = 'Behance02Icon';
