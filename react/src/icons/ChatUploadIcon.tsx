...
interface ChatUploadIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/chat-upload)
 * @see {@link https://clicons.dev/icon/chat-upload} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ChatUploadIcon = React.forwardRef<SVGSVGElement, ChatUploadIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M15 9.99998C15 9.99998 12.7906 7.00001 12 7C11.2094 6.99999 9.00002 10 9.00002 10M12 7.5V14", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "1" }]];
...
ChatUploadIcon.displayName = 'ChatUploadIcon';
