...
interface Mortarboard02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mortarboard02)
 * @see {@link https://clicons.dev/icon/mortarboard02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Mortarboard02Icon = React.forwardRef<SVGSVGElement, Mortarboard02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M2 8C2 9.34178 10.0949 13 11.9861 13C13.8772 13 21.9722 9.34178 21.9722 8C21.9722 6.65822 13.8772 3 11.9861 3C10.0949 3 2 6.65822 2 8Z", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
Mortarboard02Icon.displayName = 'Mortarboard02Icon';
export default Mortarboard02Icon;
