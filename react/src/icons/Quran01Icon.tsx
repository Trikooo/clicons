...
interface Quran01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/quran01)
 * @see {@link https://clicons.dev/icon/quran01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Quran01Icon = React.forwardRef<SVGSVGElement, Quran01IconProps>(
  (
    {
      size,
      color,
...
Quran01Icon.displayName = 'Quran01Icon';
