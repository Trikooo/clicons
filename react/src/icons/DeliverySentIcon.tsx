...
interface DeliverySentIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const DeliverySentIcon = React.forwardRef<SVGSVGElement, DeliverySentIconProps>(
  (
    {
      size,
      color,
...
DeliverySentIcon.displayName = 'DeliverySentIcon';
export default DeliverySentIcon;
