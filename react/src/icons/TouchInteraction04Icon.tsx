...
interface TouchInteraction04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/touch-interaction04)
 * @see {@link https://clicons.dev/icon/touch-interaction04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TouchInteraction04Icon = React.forwardRef<SVGSVGElement, TouchInteraction04IconProps>(
  (
    {
      size,
      color,
...
TouchInteraction04Icon.displayName = 'TouchInteraction04Icon';
