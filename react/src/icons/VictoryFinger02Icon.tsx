...
interface VictoryFinger02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/victory-finger02)
 * @see {@link https://clicons.dev/icon/victory-finger02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const VictoryFinger02Icon = React.forwardRef<SVGSVGElement, VictoryFinger02IconProps>(
  (
    {
      size,
      color,
...
VictoryFinger02Icon.displayName = 'VictoryFinger02Icon';
