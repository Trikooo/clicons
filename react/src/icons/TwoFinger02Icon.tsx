...
interface TwoFinger02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/two-finger02)
 * @see {@link https://clicons.dev/icon/two-finger02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TwoFinger02Icon = React.forwardRef<SVGSVGElement, TwoFinger02IconProps>(
  (
    {
      size,
      color,
...
TwoFinger02Icon.displayName = 'TwoFinger02Icon';
