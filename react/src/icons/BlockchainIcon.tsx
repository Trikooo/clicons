...
interface BlockchainIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/blockchain}
 */
const BlockchainIcon = React.forwardRef<SVGSVGElement, BlockchainIconProps>(
