...
interface LocationUser3IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name LocationUser3Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/location-user3)
 * @see {@link https://clicons.dev/icon/location-user3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const LocationUser3Icon = React.forwardRef<SVGSVGElement, LocationUser3IconProps>(
  (
    {
      size,
      color,
...
LocationUser3Icon.displayName = 'LocationUser3Icon';
export default LocationUser3Icon;
