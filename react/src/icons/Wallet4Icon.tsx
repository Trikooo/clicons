...
interface Wallet4IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/wallet4)
 * @see {@link https://clicons.dev/icon/wallet4} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Wallet4Icon = React.forwardRef<SVGSVGElement, Wallet4IconProps>(
  (
    {
      size,
      color,
...
Wallet4Icon.displayName = 'Wallet4Icon';
export default Wallet4Icon;
