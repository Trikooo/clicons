...
interface SidebarRight01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/sidebar-right01)
 * @see {@link https://clicons.dev/icon/sidebar-right01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SidebarRight01Icon = React.forwardRef<SVGSVGElement, SidebarRight01IconProps>(
  (
    {
      size,
      color,
...
SidebarRight01Icon.displayName = 'SidebarRight01Icon';
