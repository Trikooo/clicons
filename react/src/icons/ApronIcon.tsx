...
const ApronIcon = React.forwardRef<SVGSVGElement, ApronIconProps>(
  (
    ...
    const iconData = [["path", { d: "M19 11V16C19 18.8284 19 20.2426 18.1213 21.1213C17.2426 22 15.8284 22 13 22H11C8.17157 22 6.75736 22 5.87868 21.1213C5 20.2426 5 18.8284 5 16V11M8 8H16", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
