...
interface PointingRight03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pointing-right03)
 * @see {@link https://clicons.dev/icon/pointing-right03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PointingRight03Icon = React.forwardRef<SVGSVGElement, PointingRight03IconProps>(
  (
    {
      size,
      color,
...
PointingRight03Icon.displayName = 'PointingRight03Icon';
