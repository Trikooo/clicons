...
interface StarAwardIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const StarAwardIcon = React.forwardRef<SVGSVGElement, StarAwardIconProps>(
  (
    {
      size,
      color,
...
StarAwardIcon.displayName = 'StarAwardIcon';
