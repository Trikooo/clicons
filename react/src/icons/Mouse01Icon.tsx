...
interface Mouse01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mouse01)
 * @see {@link https://clicons.dev/icon/mouse01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Mouse01Icon = React.forwardRef<SVGSVGElement, Mouse01IconProps>(
  (
    {
      size,
      color,
...
Mouse01Icon.displayName = 'Mouse01Icon';
export default Mouse01Icon;
