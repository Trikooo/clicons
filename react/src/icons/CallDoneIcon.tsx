...
interface CallDoneIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-done)
 * @see {@link https://clicons.dev/icon/call-done} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallDoneIcon = React.forwardRef<SVGSVGElement, CallDoneIconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M13 9C13 9 14.1429 9 15.2857 11C15.2857 11 17.7731 6 21 5',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
CallDoneIcon.displayName = 'CallDoneIcon';
export default CallDoneIcon;
