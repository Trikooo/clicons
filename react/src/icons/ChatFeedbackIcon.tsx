...
interface ChatFeedbackIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/chat-feedback)
 * @see {@link https://clicons.dev/icon/chat-feedback} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ChatFeedbackIcon = React.forwardRef<SVGSVGElement, ChatFeedbackIconProps>(
  (
    {
      size,
      color,
...
ChatFeedbackIcon.displayName = 'ChatFeedbackIcon';
