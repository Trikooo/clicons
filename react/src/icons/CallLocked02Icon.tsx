...
interface CallLocked02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-locked02)
 * @see {@link https://clicons.dev/icon/call-locked02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallLocked02Icon = React.forwardRef<SVGSVGElement, CallLocked02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M15.5 6.5V5C15.5 3.89543 16.3954 3 17.5 3C18.6046 3 19.5 3.89543 19.5 5V6.5M15.5 6.5H19.5M15.5 6.5C15.0341 6.5 14.8011 6.5 14.6173 6.57612C14.3723 6.67761 14.1776 6.87229 14.0761 7.11732C14 7.30109 14 7.53406 14 8V9C14 9.94281 14 10.4142 14.2929 10.7071C14.5858 11 15.0572 11 16 11H19C19.9428 11 20.4142 11 20.7071 10.7071C21 10.4142 21 9.94281 21 9V8C21 7.53406 21 7.30109 20.9239 7.11732C20.8224 6.87229 20.6277 6.67761 20.3827 6.57612C20.1989 6.5 19.9659 6.5 19.5 6.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
CallLocked02Icon.displayName = 'CallLocked02Icon';
export default CallLocked02Icon;
