...
interface ImageDelete01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/image-delete01)
 * @see {@link https://clicons.dev/icon/image-delete01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ImageDelete01Icon = React.forwardRef<SVGSVGElement, ImageDelete01IconProps>(
  (
    {
      size,
      color,
...
ImageDelete01Icon.displayName = 'ImageDelete01Icon';
