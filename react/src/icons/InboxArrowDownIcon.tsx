...
interface InboxArrowDownIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @preview ![img](https://clicons.dev/icon/inbox-arrow-down)
 * @see {@link https://clicons.dev/icon/inbox-arrow-down}
 */
const InboxArrowDownIcon = React.forwardRef<SVGSVGElement, InboxArrowDownIconProps>(
  ...
  [
    'path',
    {
      d: 'M15 7.00002C15 7.00002 12.7905 9.99999 12 10C11.2094 10 9 7 9 7'
    }
  ],
  [
    'path',
