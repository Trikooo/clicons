...
interface CursorProgress03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/cursor-progress03)
 * @see {@link https://clicons.dev/icon/cursor-progress03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CursorProgress03Icon = React.forwardRef<SVGSVGElement, CursorProgress03IconProps>(
  (
    {
      size,
      color,
...
CursorProgress03Icon.displayName = 'CursorProgress03Icon';
