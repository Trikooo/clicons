...
interface ShoppingBasketCheckOut2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name ShoppingBasketCheckOut2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/shopping-basket-check-out2)
 * @see {@link https://clicons.dev/icon/shopping-basket-check-out2}
 */
const ShoppingBasketCheckOut2Icon = React.forwardRef<SVGSVGElement, ShoppingBasketCheckOut2IconProps>(
...
ShoppingBasketCheckOut2Icon.displayName = 'ShoppingBasketCheckOut2Icon';
