...
interface DashboardCircleIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const DashboardCircleIcon = React.forwardRef<SVGSVGElement, DashboardCircleIconProps>(
  (
    {
      size,
      color,
...
DashboardCircleIcon.displayName = 'DashboardCircleIcon';
