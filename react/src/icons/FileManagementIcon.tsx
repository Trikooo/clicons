...
interface FileManagementIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/file-management)
 * @see {@link https://clicons.dev/icon/file-management} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FileManagementIcon = React.forwardRef<SVGSVGElement, FileManagementIconProps>(
  (
    {
      size,
      color,
...
FileManagementIcon.displayName = 'FileManagementIcon';
