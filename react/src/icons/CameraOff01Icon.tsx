...
interface CameraOff01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/camera-off01)
 * @see {@link https://clicons.dev/icon/camera-off01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CameraOff01Icon = React.forwardRef<SVGSVGElement, CameraOff01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M9.71586 9.71484C8.6787 10.4376 8 11.639 8 12.999C8 15.2081 9.79086 16.999 12 16.999C13.36 16.999 14.5614 16.3203 15.2841 15.2831", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
