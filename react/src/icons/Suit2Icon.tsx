...
interface Suit2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/suit2)
 * @see {@link https://clicons.dev/icon/suit2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Suit2Icon = React.forwardRef<SVGSVGElement, Suit2IconProps>(
  (
    {
      size,
      color,
...
Suit2Icon.displayName = 'Suit2Icon';
export default Suit2Icon;
