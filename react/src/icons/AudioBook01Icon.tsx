...
interface AudioBook01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/audio-book01)
 * @see {@link https://clicons.dev/icon/audio-book01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AudioBook01Icon = React.forwardRef<SVGSVGElement, AudioBook01IconProps>(
  (
    {
      size,
      color,
...
AudioBook01Icon.displayName = 'AudioBook01Icon';
