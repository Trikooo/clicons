...
interface CallIncoming04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-incoming04)
 * @see {@link https://clicons.dev/icon/call-incoming04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallIncoming04Icon = React.forwardRef<SVGSVGElement, CallIncoming04IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M15 5V9H19M21 3L15.4059 8.59414", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
CallIncoming04Icon.displayName = 'CallIncoming04Icon';
export default CallIncoming04Icon;
