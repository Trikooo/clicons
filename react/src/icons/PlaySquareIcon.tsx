...
interface PlaySquareIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/play-square)
 * @see {@link https://clicons.dev/icon/play-square} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PlaySquareIcon = React.forwardRef<SVGSVGElement, PlaySquareIconProps>(
  (
    {
      size,
      color,
