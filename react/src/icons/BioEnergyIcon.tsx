...
interface BioEnergyIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/bio-energy)
 * @see {@link https://clicons.dev/icon/bio-energy} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const BioEnergyIcon = React.forwardRef<SVGSVGElement, BioEnergyIconProps>(
  (
    {
      size,
      color,
...
BioEnergyIcon.displayName = 'BioEnergyIcon';
