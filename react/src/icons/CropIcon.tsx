...
interface CropIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/crop}
 */
const CropIcon = React.forwardRef<SVGSVGElement, CropIconProps>(
