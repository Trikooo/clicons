...
interface WechatIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const WechatIcon = React.forwardRef<SVGSVGElement, WechatIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M7 7H7.00897M12.991 7H13", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", key: "0" }],
