...
interface SunCloudAngledRain2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name SunCloudAngledRain2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/sun-cloud-angled-rain2)
 * @see {@link https://clicons.dev/icon/sun-cloud-angled-rain2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SunCloudAngledRain2Icon = React.forwardRef<SVGSVGElement, SunCloudAngledRain2IconProps>(
  (
    {
      size,
      color,
...
SunCloudAngledRain2Icon.displayName = 'SunCloudAngledRain2Icon';
export default SunCloudAngledRain2Icon;
