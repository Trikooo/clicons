...
interface MailAccount2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MailAccount2Icon = React.forwardRef<SVGSVGElement, MailAccount2IconProps>(
  (
    {
      size,
      color,
...
MailAccount2Icon.displayName = 'MailAccount2Icon';
export default MailAccount2Icon;
