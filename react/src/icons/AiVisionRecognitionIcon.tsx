...
const AiVisionRecognitionIcon = React.forwardRef<SVGSVGElement, AiVisionRecognitionIconProps>(
  (
    ...
    const iconData = [["path", { d: "M22 12C22 12 19 19 12 19C5 19 2 12 2 12C2 12 5 5 12 5C18.5 5 22 12 22 12Z", stroke: "currentColor", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
