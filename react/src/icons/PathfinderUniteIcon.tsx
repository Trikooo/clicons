...
interface PathfinderUniteIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pathfinder-unite)
 * @see {@link https://clicons.dev/icon/pathfinder-unite} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PathfinderUniteIcon = React.forwardRef<SVGSVGElement, PathfinderUniteIconProps>(
  (
    {
      size,
      color,
...
PathfinderUniteIcon.displayName = 'PathfinderUniteIcon';
export default PathfinderUniteIcon;
