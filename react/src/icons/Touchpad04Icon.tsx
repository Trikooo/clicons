...
interface Touchpad04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/touchpad04)
 * @see {@link https://clicons.dev/icon/touchpad04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Touchpad04Icon = React.forwardRef<SVGSVGElement, Touchpad04IconProps>(
  (
    {
      size,
      color,
...
Touchpad04Icon.displayName = 'Touchpad04Icon';
