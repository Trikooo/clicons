 ...
 * @see {@link https://clicons.dev/icon/wordpress} - Icon preview
...
const WordpressIcon = React.forwardRef<SVGSVGElement, WordpressIconProps>(
  (
    ...
    const iconData = [["path", { d: "M2 6H3M3 6L7.457 17.4921C8.10731 19.1689 8.43246 20.0073 8.9816 20C9.53074 19.9926 9.83482 19.1459 10.443 17.4524L10.5 17.2935M3 6H6.5M6.5 6H7.457M6.5 6L10.5 17.2935M10.5 17.2935L12.816 11", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
