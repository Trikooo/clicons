...
const WorkoutStretchingIcon = React.forwardRef<SVGSVGElement, WorkoutStretchingIconProps>(
  (
    ...
    const iconData = [["path", { d: "M16 5.5C16 6.32843 15.3284 7 14.5 7C13.6716 7 13 6.32843 13 5.5C13 4.67157 13.6716 4 14.5 4C15.3284 4 16 4.67157 16 5.5Z", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
