...
interface UserMultiple3IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name UserMultiple3Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/user-multiple3)
 * @see {@link https://clicons.dev/icon/user-multiple3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const UserMultiple3Icon = React.forwardRef<SVGSVGElement, UserMultiple3IconProps>(
  (
    {
      size,
      color,
...
UserMultiple3Icon.displayName = 'UserMultiple3Icon';
export default UserMultiple3Icon;
