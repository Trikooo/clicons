...
interface TwoFinger05IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/two-finger05)
 * @see {@link https://clicons.dev/icon/two-finger05} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TwoFinger05Icon = React.forwardRef<SVGSVGElement, TwoFinger05IconProps>(
  (
    {
      size,
      color,
...
TwoFinger05Icon.displayName = 'TwoFinger05Icon';
