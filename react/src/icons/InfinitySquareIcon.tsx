...
interface InfinitySquareIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/infinity-square)
 * @see {@link https://clicons.dev/icon/infinity-square} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const InfinitySquareIcon = React.forwardRef<SVGSVGElement, InfinitySquareIconProps>(
  (
    {
      size,
      color,
...
InfinitySquareIcon.displayName = 'InfinitySquareIcon';
