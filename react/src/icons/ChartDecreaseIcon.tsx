...
interface ChartDecreaseIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/chart-decrease}
 */
const ChartDecreaseIcon = React.forwardRef<SVGSVGElement, ChartDecreaseIconProps>(
...
ChartDecreaseIcon.displayName = 'ChartDecreaseIcon';
