...
interface CursorCircleSelectionIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name CursorCircleSelectionIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/cursor-circle-selection)
 * @see {@link https://clicons.dev/icon/cursor-circle-selection} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CursorCircleSelectionIcon = React.forwardRef<SVGSVGElement, CursorCircleSelectionIconProps>(
  (
    {
      size,
      color,
...
CursorCircleSelectionIcon.displayName = 'CursorCircleSelectionIcon';
export default CursorCircleSelectionIcon;
