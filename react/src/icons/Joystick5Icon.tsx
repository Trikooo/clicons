...
interface Joystick5IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/joystick5}
 */
const Joystick5Icon = React.forwardRef<SVGSVGElement, Joystick5IconProps>(
...
Joystick5Icon.displayName = 'Joystick5Icon';
