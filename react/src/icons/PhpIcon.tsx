...
interface PhpIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/php)
 * @see {@link https://clicons.dev/icon/php} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PhpIcon = React.forwardRef<SVGSVGElement, PhpIconProps>(
  (
    {
      size,
      color,
