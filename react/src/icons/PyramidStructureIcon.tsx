...
interface PyramidStructureIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name PyramidStructureIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/pyramid-structure)
 * @see {@link https://clicons.dev/icon/pyramid-structure} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PyramidStructureIcon = React.forwardRef<SVGSVGElement, PyramidStructureIconProps>(
  (
    {
      size,
      color,
...
PyramidStructureIcon.displayName = 'PyramidStructureIcon';
export default PyramidStructureIcon;
