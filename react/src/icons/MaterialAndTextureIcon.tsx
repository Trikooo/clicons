...
interface MaterialAndTextureIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name MaterialAndTextureIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/material-and-texture)
 * @see {@link https://clicons.dev/icon/material-and-texture} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MaterialAndTextureIcon = React.forwardRef<SVGSVGElement, MaterialAndTextureIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M19 10.5L8.76086 14.8882M5 13.5L10.5 11", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "2" }],
...
MaterialAndTextureIcon.displayName = 'MaterialAndTextureIcon';
export default MaterialAndTextureIcon;
