...
const ArrangeByNumbers19Icon = React.forwardRef<SVGSVGElement, ArrangeByNumbers19IconProps>(
  (
    ...
    const iconData = [["path", { d: "M7 10.0002V3.94897C7 3.37446 7 3.0872 6.76959 3.01571C6.26306 2.85855 5.5 3.99988 5.5 3.99988M7 10.0002H5.5M7 10.0002H8.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
