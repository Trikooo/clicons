...
interface RoadLocation01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/road-location01)
 * @see {@link https://clicons.dev/icon/road-location01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const RoadLocation01Icon = React.forwardRef<SVGSVGElement, RoadLocation01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M18.5 15L16.5 15M13 15L11 15M7.5 15L5.5 15", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
RoadLocation01Icon.displayName = 'RoadLocation01Icon';
