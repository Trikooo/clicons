...
interface CursorMove02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/cursor-move02)
 * @see {@link https://clicons.dev/icon/cursor-move02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CursorMove02Icon = React.forwardRef<SVGSVGElement, CursorMove02IconProps>(
  (
    {
      size,
      color,
...
CursorMove02Icon.displayName = 'CursorMove02Icon';
