...
interface Search02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/search02)
 * @see {@link https://clicons.dev/icon/search02} - Icon preview
