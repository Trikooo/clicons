...
interface ComputerTerminalIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const ComputerTerminalIcon = React.forwardRef<SVGSVGElement, ComputerTerminalIconProps>(
  (
    {
      size,
      color,
...
ComputerTerminalIcon.displayName = 'ComputerTerminalIcon';
export default ComputerTerminalIcon;
