...
interface Agreement01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/agreement01)
 * @see {@link https://clicons.dev/icon/agreement01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Agreement01Icon = React.forwardRef<SVGSVGElement, Agreement01IconProps>(
  (
    {
      size,
      color,
...
Agreement01Icon.displayName = 'Agreement01Icon';
