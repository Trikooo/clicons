...
interface PhoneOff02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/phone-off02)
 * @see {@link https://clicons.dev/icon/phone-off02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PhoneOff02Icon = React.forwardRef<SVGSVGElement, PhoneOff02IconProps>(
  (
    {
      size,
      color,
...
PhoneOff02Icon.displayName = 'PhoneOff02Icon';
