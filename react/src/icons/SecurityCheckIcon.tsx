...
interface SecurityCheckIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const SecurityCheckIcon = React.forwardRef<SVGSVGElement, SecurityCheckIconProps>(
  (
    {
      size,
      color,
...
SecurityCheckIcon.displayName = 'SecurityCheckIcon';
