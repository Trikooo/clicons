...
interface ImageDownload2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name ImageDownload2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/image-download2)
 * @see {@link https://clicons.dev/icon/image-download2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ImageDownload2Icon = React.forwardRef<SVGSVGElement, ImageDownload2IconProps>(
  (
    {
      size,
      color,
...
ImageDownload2Icon.displayName = 'ImageDownload2Icon';
export default ImageDownload2Icon;
