...
const CaduceusIcon = React.forwardRef<SVGSVGElement, CaduceusIconProps>(
  (
    ...
    const iconData = [["path", { d: "M13.5 3.5C13.5 4.32843 12.8284 5 12 5C11.1716 5 10.5 4.32843 10.5 3.5C10.5 2.67157 11.1716 2 12 2C12.8284 2 13.5 2.67157 13.5 3.5Z", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
