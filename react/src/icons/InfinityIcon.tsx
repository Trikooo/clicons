...
interface InfinityIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/infinity}
 */
const InfinityIcon = React.forwardRef<SVGSVGElement, InfinityIconProps>(
