...
interface PenTool01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pen-tool01)
 * @see {@link https://clicons.dev/icon/pen-tool01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PenTool01Icon = React.forwardRef<SVGSVGElement, PenTool01IconProps>(
  (
    {
      size,
      color,
