...
interface Mouse08IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/mouse08)
 * @see {@link https://clicons.dev/icon/mouse08} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Mouse08Icon = React.forwardRef<SVGSVGElement, Mouse08IconProps>(
  (
    {
      size,
      color,
...
Mouse08Icon.displayName = 'Mouse08Icon';
