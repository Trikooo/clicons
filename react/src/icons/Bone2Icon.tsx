...
interface Bone2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/bone2}
 */
const Bone2Icon = React.forwardRef<SVGSVGElement, Bone2IconProps>(
...
Bone2Icon.displayName = 'Bone2Icon';
