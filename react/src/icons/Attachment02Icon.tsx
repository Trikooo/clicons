...
interface Attachment02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/attachment02)
 * @see {@link https://clicons.dev/icon/attachment02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Attachment02Icon = React.forwardRef<SVGSVGElement, Attachment02IconProps>(
  (
    {
      size,
      color,
