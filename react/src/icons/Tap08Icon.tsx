...
interface Tap08IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/tap08)
 * @see {@link https://clicons.dev/icon/tap08} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Tap08Icon = React.forwardRef<SVGSVGElement, Tap08IconProps>(
  (
    {
      size,
      color,
...
Tap08Icon.displayName = 'Tap08Icon';
