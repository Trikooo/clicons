...
interface MessageAdd01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/message-add01)
 * @see {@link https://clicons.dev/icon/message-add01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MessageAdd01Icon = React.forwardRef<SVGSVGElement, MessageAdd01IconProps>(
  (
    {
      size,
      color,
...
MessageAdd01Icon.displayName = 'MessageAdd01Icon';
