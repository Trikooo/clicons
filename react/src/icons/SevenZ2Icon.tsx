...
interface SevenZ2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/seven-z2}
 */
const SevenZ2Icon = React.forwardRef<SVGSVGElement, SevenZ2IconProps>(
...
SevenZ2Icon.displayName = 'SevenZ2Icon';
