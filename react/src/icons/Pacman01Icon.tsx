...
interface Pacman01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pacman01)
 * @see {@link https://clicons.dev/icon/pacman01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Pacman01Icon = React.forwardRef<SVGSVGElement, Pacman01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M22 12H21.991M18.009 12H18", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", key: "0" }],
...
Pacman01Icon.displayName = 'Pacman01Icon';
