...
interface CallRinging04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-ringing04)
 * @see {@link https://clicons.dev/icon/call-ringing04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallRinging04Icon = React.forwardRef<SVGSVGElement, CallRinging04IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M14 3V6M19 5L17 7M21 10H18", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
CallRinging04Icon.displayName = 'CallRinging04Icon';
export default CallRinging04Icon;
