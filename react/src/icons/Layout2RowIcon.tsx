...
interface Layout2RowIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/layout2-row}
 */
const Layout2RowIcon = React.forwardRef<SVGSVGElement, Layout2RowIconProps>(
...
Layout2RowIcon.displayName = 'Layout2RowIcon';
