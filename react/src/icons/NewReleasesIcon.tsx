...
interface NewReleasesIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const NewReleasesIcon = React.forwardRef<SVGSVGElement, NewReleasesIconProps>(
  (
    {
      size,
      color,
