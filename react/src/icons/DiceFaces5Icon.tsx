...
interface DiceFaces5IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const DiceFaces5Icon = React.forwardRef<SVGSVGElement, DiceFaces5IconProps>(
  (
    {
      size,
      color,
...
DiceFaces5Icon.displayName = 'DiceFaces5Icon';
export default DiceFaces5Icon;
