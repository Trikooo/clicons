...
interface Flag01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/flag01)
 * @see {@link https://clicons.dev/icon/flag01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Flag01Icon = React.forwardRef<SVGSVGElement, Flag01IconProps>(
  (
    {
      size,
      color,
