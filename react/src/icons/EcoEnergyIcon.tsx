...
interface EcoEnergyIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/eco-energy)
 * @see {@link https://clicons.dev/icon/eco-energy} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const EcoEnergyIcon = React.forwardRef<SVGSVGElement, EcoEnergyIconProps>(
  (
    {
      size,
      color,
...
EcoEnergyIcon.displayName = 'EcoEnergyIcon';
