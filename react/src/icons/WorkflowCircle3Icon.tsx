...
interface WorkflowCircle3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const WorkflowCircle3Icon = React.forwardRef<SVGSVGElement, WorkflowCircle3IconProps>(
  (
    {
      size,
      color,
...
WorkflowCircle3Icon.displayName = 'WorkflowCircle3Icon';
export default WorkflowCircle3Icon;
