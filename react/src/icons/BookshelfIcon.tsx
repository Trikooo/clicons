...
interface BookshelfIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/bookshelf}
 */
const BookshelfIcon = React.forwardRef<SVGSVGElement, BookshelfIconProps>(
