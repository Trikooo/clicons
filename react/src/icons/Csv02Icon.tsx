...
interface Csv02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/csv02)
 * @see {@link https://clicons.dev/icon/csv02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Csv02Icon = React.forwardRef<SVGSVGElement, Csv02IconProps>(
  (
    {
      size,
      color,
...
Csv02Icon.displayName = 'Csv02Icon';
