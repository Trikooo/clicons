...
interface ZeroSquareIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const ZeroSquareIcon = React.forwardRef<SVGSVGElement, ZeroSquareIconProps>(
  (
    {
      size,
      color,
...
ZeroSquareIcon.displayName = 'ZeroSquareIcon';
export default ZeroSquareIcon;
