...
interface Redo3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/redo3}
 */
const Redo3Icon = React.forwardRef<SVGSVGElement, Redo3IconProps>(
...
Redo3Icon.displayName = 'Redo3Icon';
