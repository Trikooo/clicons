...
interface GiveBloodIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const GiveBloodIcon = React.forwardRef<SVGSVGElement, GiveBloodIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M9 7.54707C9 5.55959 10.6851 3.59556 11.8678 2.46181C12.5102 1.84606 13.4898 1.84606 14.1322 2.46181C15.3149 3.59556 17 5.55959 17 7.54707C17 9.4957 15.4853 11.5 13 11.5C10.5147 11.5 9 9.4957 9 7.54707Z", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
...
GiveBloodIcon.displayName = 'GiveBloodIcon';
