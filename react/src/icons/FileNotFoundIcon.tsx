...
interface FileNotFoundIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/file-not-found)
 * @see {@link https://clicons.dev/icon/file-not-found} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FileNotFoundIcon = React.forwardRef<SVGSVGElement, FileNotFoundIconProps>(
  (
    {
      size,
      color,
...
FileNotFoundIcon.displayName = 'FileNotFoundIcon';
