...
interface PowerServiceIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/power-service)
 * @see {@link https://clicons.dev/icon/power-service} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const PowerServiceIcon = React.forwardRef<SVGSVGElement, PowerServiceIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M12.5 8L10 12H14L11.5 16", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
PowerServiceIcon.displayName = 'PowerServiceIcon';
