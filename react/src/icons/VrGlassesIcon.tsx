...
interface VrGlassesIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/vr-glasses}
 */
const VrGlassesIcon = React.forwardRef<SVGSVGElement, VrGlassesIconProps>(
...
VrGlassesIcon.displayName = 'VrGlassesIcon';
