...
interface Progress04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/progress04)
 * @see {@link https://clicons.dev/icon/progress04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Progress04Icon = React.forwardRef<SVGSVGElement, Progress04IconProps>(
  (
    {
      size,
      color,
...
Progress04Icon.displayName = 'Progress04Icon';
