...
interface CallInternal02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-internal02)
 * @see {@link https://clicons.dev/icon/call-internal02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallInternal02Icon = React.forwardRef<SVGSVGElement, CallInternal02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M14 6.5H20M19 4.5L21 6.5L19 8.5M15 4.5L13 6.5L15 8.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
CallInternal02Icon.displayName = 'CallInternal02Icon';
export default CallInternal02Icon;
