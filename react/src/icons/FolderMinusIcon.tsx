...
interface FolderMinusIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/folder-minus)
 * @see {@link https://clicons.dev/icon/folder-minus} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const FolderMinusIcon = React.forwardRef<SVGSVGElement, FolderMinusIconProps>(
  (
    {
      size,
      color,
