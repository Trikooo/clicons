...
interface UserRemoveIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/user-remove}
 */
const UserRemoveIcon = React.forwardRef<SVGSVGElement, UserRemoveIconProps>(
