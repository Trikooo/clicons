...
interface Gps01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/gps01)
 * @see {@link https://clicons.dev/icon/gps01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Gps01Icon = React.forwardRef<SVGSVGElement, Gps01IconProps>(
  (
    {
      size,
      color,
...
Gps01Icon.displayName = 'Gps01Icon';
export default Gps01Icon;
