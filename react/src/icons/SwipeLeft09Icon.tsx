...
interface SwipeLeft09IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/swipe-left09)
 * @see {@link https://clicons.dev/icon/swipe-left09} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SwipeLeft09Icon = React.forwardRef<SVGSVGElement, SwipeLeft09IconProps>(
  (
    {
      size,
      color,
...
SwipeLeft09Icon.displayName = 'SwipeLeft09Icon';
export default SwipeLeft09Icon;
