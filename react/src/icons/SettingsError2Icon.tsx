...
interface SettingsError2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name SettingsError2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/settings-error2)
 * @see {@link https://clicons.dev/icon/settings-error2}
 */
const SettingsError2Icon = React.forwardRef<SVGSVGElement, SettingsError2IconProps>(
...
SettingsError2Icon.displayName = 'SettingsError2Icon';
