...
interface SwipeDown5IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/swipe-down5}
 */
const SwipeDown5Icon = React.forwardRef<SVGSVGElement, SwipeDown5IconProps>(
...
SwipeDown5Icon.displayName = 'SwipeDown5Icon';
