...
interface Package02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/package02)
 * @see {@link https://clicons.dev/icon/package02} - Icon preview
