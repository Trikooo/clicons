...
interface ResourcesAddIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const ResourcesAddIcon = React.forwardRef<SVGSVGElement, ResourcesAddIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M18 2V10M22 6L14 6", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "3" }]];
...
ResourcesAddIcon.displayName = 'ResourcesAddIcon';
