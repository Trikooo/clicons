...
interface TicketIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/ticket)
 * @see {@link https://clicons.dev/icon/ticket} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TicketIcon = React.forwardRef<SVGSVGElement, TicketIconProps>(
  (
    {
      size,
      color,
