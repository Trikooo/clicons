...
interface Pin02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/pin02)
 * @see {@link https://clicons.dev/icon/pin02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Pin02Icon = React.forwardRef<SVGSVGElement, Pin02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M12 16V21", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
