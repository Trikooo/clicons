...
interface Location03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/location03)
 * @see {@link https://clicons.dev/icon/location03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Location03Icon = React.forwardRef<SVGSVGElement, Location03IconProps>(
  (
    {
      size,
      color,
...
Location03Icon.displayName = 'Location03Icon';
