...
interface UserCircle2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/user-circle2)
 * @see {@link https://clicons.dev/icon/user-circle2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const UserCircle2Icon = React.forwardRef<SVGSVGElement, UserCircle2IconProps>(
  (
    {
      size,
      color,
...
UserCircle2Icon.displayName = 'UserCircle2Icon';
