...
interface Link4IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/link4}
 */
const Link4Icon = React.forwardRef<SVGSVGElement, Link4IconProps>(
...
Link4Icon.displayName = 'Link4Icon';
