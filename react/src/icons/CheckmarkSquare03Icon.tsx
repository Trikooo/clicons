...
interface CheckmarkSquare03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/checkmark-square03)
 * @see {@link https://clicons.dev/icon/checkmark-square03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CheckmarkSquare03Icon = React.forwardRef<SVGSVGElement, CheckmarkSquare03IconProps>(
  (
    {
      size,
      color,
...
CheckmarkSquare03Icon.displayName = 'CheckmarkSquare03Icon';
