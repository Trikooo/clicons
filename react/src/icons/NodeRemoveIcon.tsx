...
const NodeRemoveIcon = React.forwardRef<SVGSVGElement, NodeRemoveIconProps>(
  (
    ...
    const iconData = [["path", { d: "M13.5 19.5H12.5C9.67157 19.5 8.25736 19.5 7.37868 18.6213C6.5 17.7426 6.5 16.3284 6.5 13.5V11.5M6.5 9V11.5M6.5 11.5H13.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
