...
interface Stamp02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/stamp02)
 * @see {@link https://clicons.dev/icon/stamp02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Stamp02Icon = React.forwardRef<SVGSVGElement, Stamp02IconProps>(
  (
    {
      size,
      color,
...
Stamp02Icon.displayName = 'Stamp02Icon';
