...
interface TableLamp2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/table-lamp2)
 * @see {@link https://clicons.dev/icon/table-lamp2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TableLamp2Icon = React.forwardRef<SVGSVGElement, TableLamp2IconProps>(
  (
    {
      size,
      color,
...
TableLamp2Icon.displayName = 'TableLamp2Icon';
export default TableLamp2Icon;
