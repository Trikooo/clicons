...
interface SettingError4IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const SettingError4Icon = React.forwardRef<SVGSVGElement, SettingError4IconProps>(
  (
    {
      size,
      color,
...
SettingError4Icon.displayName = 'SettingError4Icon';
export default SettingError4Icon;
