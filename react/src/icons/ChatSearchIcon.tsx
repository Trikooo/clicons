...
interface ChatSearchIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/chat-search)
 * @see {@link https://clicons.dev/icon/chat-search} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ChatSearchIcon = React.forwardRef<SVGSVGElement, ChatSearchIconProps>(
  (
    {
      size,
      color,
...
ChatSearchIcon.displayName = 'ChatSearchIcon';
