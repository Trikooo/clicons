...
const ChatSearchIcon = React.forwardRef<SVGSVGElement, ChatSearchIconProps>(
  ...
  [
    'path',
    {
      d: 'M16 13.9998L14.375 12.3748M15 9.99976C15 8.3429 13.6569 6.99976 12 6.99976C10.3431 6.99976 9 8.3429 9 9.99976C9 11.6566 10.3431 12.9998 12 12.9998C12.8284 12.9998 13.5784 12.664 14.1213 12.1211C14.6642 11.5782 15 10.8282 15 9.99976Z',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
