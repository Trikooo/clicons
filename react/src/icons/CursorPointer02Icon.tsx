...
interface CursorPointer02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/cursor-pointer02)
 * @see {@link https://clicons.dev/icon/cursor-pointer02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CursorPointer02Icon = React.forwardRef<SVGSVGElement, CursorPointer02IconProps>(
  (
    {
      size,
      color,
...
CursorPointer02Icon.displayName = 'CursorPointer02Icon';
