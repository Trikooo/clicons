...
interface AlbumNotFound2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const AlbumNotFound2Icon = React.forwardRef<SVGSVGElement, AlbumNotFound2IconProps>(
  (
    {
      size,
      color,
...
AlbumNotFound2Icon.displayName = 'AlbumNotFound2Icon';
export default AlbumNotFound2Icon;
