...
interface Mouse10IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Mouse10Icon = React.forwardRef<SVGSVGElement, Mouse10IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M12 6V2", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
Mouse10Icon.displayName = 'Mouse10Icon';
