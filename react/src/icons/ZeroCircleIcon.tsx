...
interface ZeroCircleIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/zero-circle)
 * @see {@link https://clicons.dev/icon/zero-circle} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ZeroCircleIcon = React.forwardRef<SVGSVGElement, ZeroCircleIconProps>(
  (
    {
      size,
      color,
...
ZeroCircleIcon.displayName = 'ZeroCircleIcon';
export default ZeroCircleIcon;
