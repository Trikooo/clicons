...
interface RotateLeft03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/rotate-left03)
 * @see {@link https://clicons.dev/icon/rotate-left03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const RotateLeft03Icon = React.forwardRef<SVGSVGElement, RotateLeft03IconProps>(
  (
    {
      size,
      color,
...
RotateLeft03Icon.displayName = 'RotateLeft03Icon';
