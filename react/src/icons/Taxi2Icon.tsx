...
interface Taxi2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Taxi2Icon = React.forwardRef<SVGSVGElement, Taxi2IconProps>(
  (
    {
      size,
      color,
...
Taxi2Icon.displayName = 'Taxi2Icon';
export default Taxi2Icon;
