...
interface MusicNoteSquare2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name MusicNoteSquare2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/music-note-square2)
 * @see {@link https://clicons.dev/icon/music-note-square2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MusicNoteSquare2Icon = React.forwardRef<SVGSVGElement, MusicNoteSquare2IconProps>(
  (
    {
      size,
      color,
...
MusicNoteSquare2Icon.displayName = 'MusicNoteSquare2Icon';
export default MusicNoteSquare2Icon;
