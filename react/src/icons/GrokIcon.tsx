...
interface GrokIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/grok)
 * @see {@link https://clicons.dev/icon/grok} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const GrokIcon = React.forwardRef<SVGSVGElement, GrokIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M8 17.5L16 7.5", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "1" }]];
