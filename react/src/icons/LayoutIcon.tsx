...
interface LayoutIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/layout}
 */
const LayoutIcon = React.forwardRef<SVGSVGElement, LayoutIconProps>(
