...
interface ViewOffIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/view-off)
 * @see {@link https://clicons.dev/icon/view-off} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ViewOffIcon = React.forwardRef<SVGSVGElement, ViewOffIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M22 8C22 8 18 14 12 14C6 14 2 8 2 8", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
