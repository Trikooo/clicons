...
interface Minimize01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/minimize01)
 * @see {@link https://clicons.dev/icon/minimize01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Minimize01Icon = React.forwardRef<SVGSVGElement, Minimize01IconProps>(
  (
    {
      size,
      color,
