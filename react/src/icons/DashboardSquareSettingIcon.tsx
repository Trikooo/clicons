...
interface DashboardSquareSettingIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/dashboard-square-setting)
 * @see {@link https://clicons.dev/icon/dashboard-square-setting} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const DashboardSquareSettingIcon = React.forwardRef<SVGSVGElement, DashboardSquareSettingIconProps>(
  (
    {
      size,
      color,
...
DashboardSquareSettingIcon.displayName = 'DashboardSquareSettingIcon';
