...
interface Mouse5IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Mouse5Icon = React.forwardRef<SVGSVGElement, Mouse5IconProps>(
  (
    {
      size,
      color,
...
Mouse5Icon.displayName = 'Mouse5Icon';
export default Mouse5Icon;
