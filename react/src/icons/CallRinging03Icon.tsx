...
interface CallRinging03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-ringing03)
 * @see {@link https://clicons.dev/icon/call-ringing03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallRinging03Icon = React.forwardRef<SVGSVGElement, CallRinging03IconProps>(
  (
    {
      size,
      color,
...
CallRinging03Icon.displayName = 'CallRinging03Icon';
export default CallRinging03Icon;
