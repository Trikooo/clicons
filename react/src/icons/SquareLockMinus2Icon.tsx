...
interface SquareLockMinus2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const SquareLockMinus2Icon = React.forwardRef<SVGSVGElement, SquareLockMinus2IconProps>(
  (
    {
      size,
      color,
...
SquareLockMinus2Icon.displayName = 'SquareLockMinus2Icon';
export default SquareLockMinus2Icon;
