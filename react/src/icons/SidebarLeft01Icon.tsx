...
interface SidebarLeft01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/sidebar-left01)
 * @see {@link https://clicons.dev/icon/sidebar-left01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SidebarLeft01Icon = React.forwardRef<SVGSVGElement, SidebarLeft01IconProps>(
  (
    {
      size,
      color,
...
SidebarLeft01Icon.displayName = 'SidebarLeft01Icon';
