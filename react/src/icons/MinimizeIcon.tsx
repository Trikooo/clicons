...
interface MinimizeIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/minimize)
 * @see {@link https://clicons.dev/icon/minimize} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MinimizeIcon = React.forwardRef<SVGSVGElement, MinimizeIconProps>(
  (
    {
      size,
      color,
