...
interface LocationUser2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name LocationUser2Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/location-user2)
 * @see {@link https://clicons.dev/icon/location-user2}
 */
const LocationUser2Icon = React.forwardRef<SVGSVGElement, LocationUser2IconProps>(
...
LocationUser2Icon.displayName = 'LocationUser2Icon';
