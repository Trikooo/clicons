...
interface ArchiveOff03IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name ArchiveOff03Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/archive-off03)
 * @see {@link https://clicons.dev/icon/archive-off03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ArchiveOff03Icon = React.forwardRef<SVGSVGElement, ArchiveOff03IconProps>(
  (
    {
      size,
      color,
...
ArchiveOff03Icon.displayName = 'ArchiveOff03Icon';
export default ArchiveOff03Icon;
