...
interface Package3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/package3}
 */
const Package3Icon = React.forwardRef<SVGSVGElement, Package3IconProps>(
...
Package3Icon.displayName = 'Package3Icon';
