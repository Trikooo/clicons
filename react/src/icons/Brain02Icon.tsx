...
interface Brain02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/brain02)
 * @see {@link https://clicons.dev/icon/brain02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Brain02Icon = React.forwardRef<SVGSVGElement, Brain02IconProps>(
  (
    {
      size,
      color,
...
Brain02Icon.displayName = 'Brain02Icon';
