...
interface CursorCircleSelection01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/cursor-circle-selection01)
 * @see {@link https://clicons.dev/icon/cursor-circle-selection01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CursorCircleSelection01Icon = React.forwardRef<SVGSVGElement, CursorCircleSelection01IconProps>(
  (
    {
      size,
      color,
...
CursorCircleSelection01Icon.displayName = 'CursorCircleSelection01Icon';
