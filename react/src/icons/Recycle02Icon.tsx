...
interface Recycle02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/recycle02)
 * @see {@link https://clicons.dev/icon/recycle02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Recycle02Icon = React.forwardRef<SVGSVGElement, Recycle02IconProps>(
  (
    {
      size,
      color,
...
Recycle02Icon.displayName = 'Recycle02Icon';
