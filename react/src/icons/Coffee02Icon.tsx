...
interface Coffee02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/coffee02)
 * @see {@link https://clicons.dev/icon/coffee02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Coffee02Icon = React.forwardRef<SVGSVGElement, Coffee02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M18.2505 10.5H19.6403C21.4918 10.5 22.0421 10.7655 21.9975 12.0838C21.9237 14.2674 20.939 16.8047 17 17.5", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
