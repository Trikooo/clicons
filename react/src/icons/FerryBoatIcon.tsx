...
interface FerryBoatIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/ferry-boat}
 */
const FerryBoatIcon = React.forwardRef<SVGSVGElement, FerryBoatIconProps>(
...
FerryBoatIcon.displayName = 'FerryBoatIcon';
