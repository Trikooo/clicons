...
interface EditUser02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/edit-user02)
 * @see {@link https://clicons.dev/icon/edit-user02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const EditUser02Icon = React.forwardRef<SVGSVGElement, EditUser02IconProps>(
  (
    {
      size,
      color,
...
EditUser02Icon.displayName = 'EditUser02Icon';
