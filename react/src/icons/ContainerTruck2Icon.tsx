...
interface ContainerTruck2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const ContainerTruck2Icon = React.forwardRef<SVGSVGElement, ContainerTruck2IconProps>(
  (
    {
      size,
      color,
...
ContainerTruck2Icon.displayName = 'ContainerTruck2Icon';
export default ContainerTruck2Icon;
