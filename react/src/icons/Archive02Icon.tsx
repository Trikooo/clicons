...
interface Archive02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/archive02)
 * @see {@link https://clicons.dev/icon/archive02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Archive02Icon = React.forwardRef<SVGSVGElement, Archive02IconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M16 15L15.7 15.4C15.1111 16.1851 14.8167 16.5777 14.3944 16.7889C13.9721 17 13.4814 17 12.5 17H11.5C10.5186 17 10.0279 17 9.60557 16.7889C9.18328 16.5777 8.88885 16.1851 8.3 15.4L8 15", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "3" }]];
