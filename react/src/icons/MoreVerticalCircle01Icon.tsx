...
const MoreVerticalCircle01Icon = React.forwardRef<SVGSVGElement, MoreVerticalCircle01IconProps>(
  (
    ...
    const iconData = [["path", { d: "M13.5 4.5C13.5 3.67157 12.8284 3 12 3C11.1716 3 10.5 3.67157 10.5 4.5C10.5 5.32843 11.1716 6 12 6C12.8284 6 13.5 5.32843 13.5 4.5Z", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
