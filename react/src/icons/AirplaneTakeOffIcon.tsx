...
interface AirplaneTakeOffIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const AirplaneTakeOffIcon = React.forwardRef<SVGSVGElement, AirplaneTakeOffIconProps>(
  (
    {
      size,
      color,
