...
interface Link6IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/link6)
 * @see {@link https://clicons.dev/icon/link6} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Link6Icon = React.forwardRef<SVGSVGElement, Link6IconProps>(
  (
    {
      size,
      color,
...
Link6Icon.displayName = 'Link6Icon';
export default Link6Icon;
