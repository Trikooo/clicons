...
const TransmissionIcon = React.forwardRef<SVGSVGElement, TransmissionIconProps>(
  (
    ...
    const iconData = [["path", { d: "M5.6 22C5.6 21.1163 4.88366 20.4 4 20.4M8.8 22C8.8 19.349 6.65097 17.2 4 17.2M12 22C12 17.5817 8.41828 14 4 14", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
