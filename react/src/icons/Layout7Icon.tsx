...
interface Layout7IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Layout7Icon = React.forwardRef<SVGSVGElement, Layout7IconProps>(
  (
    {
      size,
      color,
...
Layout7Icon.displayName = 'Layout7Icon';
export default Layout7Icon;
