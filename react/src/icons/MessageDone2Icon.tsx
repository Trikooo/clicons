...
interface MessageDone2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MessageDone2Icon = React.forwardRef<SVGSVGElement, MessageDone2IconProps>(
  (
    {
      size,
      color,
...
MessageDone2Icon.displayName = 'MessageDone2Icon';
export default MessageDone2Icon;
