...
interface Layout3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/layout3}
 */
const Layout3Icon = React.forwardRef<SVGSVGElement, Layout3IconProps>(
...
Layout3Icon.displayName = 'Layout3Icon';
