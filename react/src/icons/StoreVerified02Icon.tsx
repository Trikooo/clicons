...
interface StoreVerified02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/store-verified02)
 * @see {@link https://clicons.dev/icon/store-verified02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const StoreVerified02Icon = React.forwardRef<SVGSVGElement, StoreVerified02IconProps>(
  (
    {
      size,
      color,
...
StoreVerified02Icon.displayName = 'StoreVerified02Icon';
export default StoreVerified02Icon;
