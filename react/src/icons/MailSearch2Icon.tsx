...
interface MailSearch2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MailSearch2Icon = React.forwardRef<SVGSVGElement, MailSearch2IconProps>(
  (
    {
      size,
      color,
...
MailSearch2Icon.displayName = 'MailSearch2Icon';
export default MailSearch2Icon;
