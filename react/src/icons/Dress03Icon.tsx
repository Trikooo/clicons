...
interface Dress03IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/dress03)
 * @see {@link https://clicons.dev/icon/dress03} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Dress03Icon = React.forwardRef<SVGSVGElement, Dress03IconProps>(
  (
    {
      size,
      color,
...
Dress03Icon.displayName = 'Dress03Icon';
