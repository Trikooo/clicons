...
interface UserSettings01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/user-settings01)
 * @see {@link https://clicons.dev/icon/user-settings01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const UserSettings01Icon = React.forwardRef<SVGSVGElement, UserSettings01IconProps>(
  (
    {
      size,
      color,
