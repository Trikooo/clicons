...
interface GroupItemsIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const GroupItemsIcon = React.forwardRef<SVGSVGElement, GroupItemsIconProps>(
  (
    {
      size,
      color,
...
GroupItemsIcon.displayName = 'GroupItemsIcon';
