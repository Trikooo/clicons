...
interface Shield2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/shield2}
 */
const Shield2Icon = React.forwardRef<SVGSVGElement, Shield2IconProps>(
...
Shield2Icon.displayName = 'Shield2Icon';
