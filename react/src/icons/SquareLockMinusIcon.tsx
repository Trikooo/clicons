...
interface SquareLockMinusIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const SquareLockMinusIcon = React.forwardRef<SVGSVGElement, SquareLockMinusIconProps>(
  (
    {
      size,
      color,
...
SquareLockMinusIcon.displayName = 'SquareLockMinusIcon';
export default SquareLockMinusIcon;
