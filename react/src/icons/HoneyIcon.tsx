...
interface HoneyIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/honey)
 * @see {@link https://clicons.dev/icon/honey} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const HoneyIcon = React.forwardRef<SVGSVGElement, HoneyIconProps>(
  (
    {
      size,
      color,
