...
interface QuoteDownSquareIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/quote-down-square}
 */
const QuoteDownSquareIcon = React.forwardRef<SVGSVGElement, QuoteDownSquareIconProps>(
