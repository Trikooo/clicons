...
interface JavaScriptIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/java-script}
 */
const JavaScriptIcon = React.forwardRef<SVGSVGElement, JavaScriptIconProps>(
