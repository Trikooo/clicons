...
interface CallOutgoingIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name CallOutgoingIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/call-outgoing)
 * @see {@link https://clicons.dev/icon/call-outgoing} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallOutgoingIcon = React.forwardRef<SVGSVGElement, CallOutgoingIconProps>(
  (
    {
      size,
      color,
