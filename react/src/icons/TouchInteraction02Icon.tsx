...
interface TouchInteraction02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/touch-interaction02)
 * @see {@link https://clicons.dev/icon/touch-interaction02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TouchInteraction02Icon = React.forwardRef<SVGSVGElement, TouchInteraction02IconProps>(
  (
    {
      size,
      color,
...
TouchInteraction02Icon.displayName = 'TouchInteraction02Icon';
