...
interface ConnectIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const ConnectIcon = React.forwardRef<SVGSVGElement, ConnectIconProps>(
  (
    {
      size,
      color,
