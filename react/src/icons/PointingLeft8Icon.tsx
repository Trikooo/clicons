...
interface PointingLeft8IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name PointingLeft8Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/pointing-left8)
 * @see {@link https://clicons.dev/icon/pointing-left8}
 */
const PointingLeft8Icon = React.forwardRef<SVGSVGElement, PointingLeft8IconProps>(
...
PointingLeft8Icon.displayName = 'PointingLeft8Icon';
