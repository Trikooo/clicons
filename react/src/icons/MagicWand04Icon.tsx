...
interface MagicWand04IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name MagicWand04Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/magic-wand04)
 * @see {@link https://clicons.dev/icon/magic-wand04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MagicWand04Icon = React.forwardRef<SVGSVGElement, MagicWand04IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M10.9381 11.0774L3.41101 18.6045C2.863 19.1525 2.863 20.041 3.41101 20.589C3.95902 21.137 4.84752 21.137 5.39553 20.589L12.9226 13.0619M10.9381 11.0774L12.9226 13.0619M10.9381 11.0774L11.6823 10.3332M12.9226 13.0619L13.6668 12.3177M11.6823 10.3332L11.7248 10.2906C12.1124 9.90313 12.7406 9.90313 13.1281 10.2906L13.7094 10.8719C14.0969 11.2594 14.0969 11.8876 13.7094 12.2751L13.6668 12.3177M11.6823 10.3332L13.6668 12.3177", stroke: "currentColor", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
MagicWand04Icon.displayName = 'MagicWand04Icon';
