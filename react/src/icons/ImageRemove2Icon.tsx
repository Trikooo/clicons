...
interface ImageRemove2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name ImageRemove2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/image-remove2)
 * @see {@link https://clicons.dev/icon/image-remove2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const ImageRemove2Icon = React.forwardRef<SVGSVGElement, ImageRemove2IconProps>(
  (
    {
      size,
      color,
...
export default ImageRemove2Icon;
