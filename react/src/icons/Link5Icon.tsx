...
interface Link5IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/link5}
 */
const Link5Icon = React.forwardRef<SVGSVGElement, Link5IconProps>(
...
Link5Icon.displayName = 'Link5Icon';
