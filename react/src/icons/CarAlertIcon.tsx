...
interface CarAlertIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const CarAlertIcon = React.forwardRef<SVGSVGElement, CarAlertIconProps>(
  (
    {
      size,
      color,
...
CarAlertIcon.displayName = 'CarAlertIcon';
export default CarAlertIcon;
