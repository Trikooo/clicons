...
interface LaurelWreathRight2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const LaurelWreathRight2Icon = React.forwardRef<SVGSVGElement, LaurelWreathRight2IconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M14.1914 18.0136C14.1914 18.0136 16.1692 18.4083 17.4973 17.4151C18.8254 16.422 19.0009 14.4172 19.0009 14.4172C19.0009 14.4172 17.0232 14.0226 15.6951 15.0157C14.3669 16.0089 14.1914 18.0136 14.1914 18.0136ZM14.1914 18.0136H10.9932C9.89237 18.0136 9 18.906 9 20.0068C9 21.1076 9.89237 22 10.9932 22H13',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
LaurelWreathRight2Icon.displayName = 'LaurelWreathRight2Icon';
export default LaurelWreathRight2Icon;
