...
interface MedicineBottle01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/medicine-bottle01)
 * @see {@link https://clicons.dev/icon/medicine-bottle01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MedicineBottle01Icon = React.forwardRef<SVGSVGElement, MedicineBottle01IconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M12 13V18M9.5 15.5L14.5 15.5", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "2" }]];
...
MedicineBottle01Icon.displayName = 'MedicineBottle01Icon';
export default MedicineBottle01Icon;
