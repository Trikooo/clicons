...
const BitcoinReceiptIcon = React.forwardRef<SVGSVGElement, BitcoinReceiptIconProps>(
  (
    ...
    const iconData = [["path", { d: "M10.125 13.5L10.125 7.5M12 7.5V6M12 15V13.5M10.125 10.5H13.875M13.875 10.5C14.4963 10.5 15 11.0037 15 11.625V12.375C15 12.9963 14.4963 13.5 13.875 13.5H9M13.875 10.5C14.4963 10.5 15 9.99632 15 9.375V8.625C15 8.00368 14.4963 7.5 13.875 7.5H9", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
