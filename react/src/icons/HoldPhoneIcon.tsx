...
interface HoldPhoneIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/hold-phone)
 * @see {@link https://clicons.dev/icon/hold-phone} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const HoldPhoneIcon = React.forwardRef<SVGSVGElement, HoldPhoneIconProps>(
  (
    {
      size,
      color,
  ...
  ["path", { d: "M9.99981 15H10.0088", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", key: "3" }]];
...
HoldPhoneIcon.displayName = 'HoldPhoneIcon';
