...
interface GridViewIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/grid-view)
 * @see {@link https://clicons.dev/icon/grid-view} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const GridViewIcon = React.forwardRef<SVGSVGElement, GridViewIconProps>(
  (
    {
      size,
      color,
