...
interface MailReceiveIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MailReceiveIcon = React.forwardRef<SVGSVGElement, MailReceiveIconProps>(
  (
    {
      size,
      color,
...
MailReceiveIcon.displayName = 'MailReceiveIcon';
export default MailReceiveIcon;
