...
interface GoForward60SecIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/go-forward60-sec}
 */
const GoForward60SecIcon = React.forwardRef<SVGSVGElement, GoForward60SecIconProps>(
...
GoForward60SecIcon.displayName = 'GoForward60SecIcon';
