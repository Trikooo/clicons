...
interface Notebook2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/notebook2}
 */
const Notebook2Icon = React.forwardRef<SVGSVGElement, Notebook2IconProps>(
...
Notebook2Icon.displayName = 'Notebook2Icon';
