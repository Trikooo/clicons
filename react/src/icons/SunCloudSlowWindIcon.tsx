...
interface SunCloudSlowWindIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name SunCloudSlowWindIcon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/sun-cloud-slow-wind)
 * @see {@link https://clicons.dev/icon/sun-cloud-slow-wind}
 */
const SunCloudSlowWindIcon = React.forwardRef<SVGSVGElement, SunCloudSlowWindIconProps>(
...
SunCloudSlowWindIcon.displayName = 'SunCloudSlowWindIcon';
