...
interface MailUnlockIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/mail-unlock}
 */
const MailUnlockIcon = React.forwardRef<SVGSVGElement, MailUnlockIconProps>(
...
MailUnlockIcon.displayName = 'MailUnlockIcon';
