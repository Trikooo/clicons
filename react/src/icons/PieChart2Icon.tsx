...
interface PieChart2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const PieChart2Icon = React.forwardRef<SVGSVGElement, PieChart2IconProps>(
  (
    {
      size,
      color,
...
PieChart2Icon.displayName = 'PieChart2Icon';
