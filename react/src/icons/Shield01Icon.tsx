...
interface Shield01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/shield01)
 * @see {@link https://clicons.dev/icon/shield01} - Icon preview
