...
interface TwoSquareIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const TwoSquareIcon = React.forwardRef<SVGSVGElement, TwoSquareIconProps>(
  (
    {
      size,
      color,
...
TwoSquareIcon.displayName = 'TwoSquareIcon';
