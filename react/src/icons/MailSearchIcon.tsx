...
interface MailSearchIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MailSearchIcon = React.forwardRef<SVGSVGElement, MailSearchIconProps>(
  (
    {
      size,
      color,
