...
interface AccountSetting3IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name AccountSetting3Icon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/account-setting3)
 * @see {@link https://clicons.dev/icon/account-setting3}
 */
const AccountSetting3Icon = React.forwardRef<SVGSVGElement, AccountSetting3IconProps>(
...
AccountSetting3Icon.displayName = 'AccountSetting3Icon';
