...
interface HierarchySquare7IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const HierarchySquare7Icon = React.forwardRef<SVGSVGElement, HierarchySquare7IconProps>(
  (
    {
      size,
      color,
...
HierarchySquare7Icon.displayName = 'HierarchySquare7Icon';
export default HierarchySquare7Icon;
