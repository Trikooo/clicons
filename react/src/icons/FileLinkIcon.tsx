...
interface FileLinkIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/file-link}
 */
const FileLinkIcon = React.forwardRef<SVGSVGElement, FileLinkIconProps>(
