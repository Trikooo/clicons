...
interface Hamburger02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/hamburger02)
 * @see {@link https://clicons.dev/icon/hamburger02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Hamburger02Icon = React.forwardRef<SVGSVGElement, Hamburger02IconProps>(
  (
    {
      size,
      color,
...
Hamburger02Icon.displayName = 'Hamburger02Icon';
