...
const ComputerProtectionIcon = React.forwardRef<SVGSVGElement, ComputerProtectionIconProps>(
  ...
  ["path", { d: "M22 5.5V3C20 3 18.5 2 18.5 2C18.5 2 17 3 15 3V5.5C15 9 18.5 10 18.5 10C18.5 10 22 9 22 5.5Z", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "4" }]];
