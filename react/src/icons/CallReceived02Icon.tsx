...
interface CallReceived02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/call-received02)
 * @see {@link https://clicons.dev/icon/call-received02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallReceived02Icon = React.forwardRef<SVGSVGElement, CallReceived02IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M20 11V8.5C20 6.84315 18.6569 5.5 17 5.5H14M15.5 3L13 5.5L15.5 8", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
CallReceived02Icon.displayName = 'CallReceived02Icon';
export default CallReceived02Icon;
