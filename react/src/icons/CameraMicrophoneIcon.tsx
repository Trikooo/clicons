...
interface CameraMicrophoneIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name CameraMicrophoneIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/camera-microphone)
 * @see {@link https://clicons.dev/icon/camera-microphone} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CameraMicrophoneIcon = React.forwardRef<SVGSVGElement, CameraMicrophoneIconProps>(
  (
    {
      size,
      color,
...
CameraMicrophoneIcon.displayName = 'CameraMicrophoneIcon';
export default CameraMicrophoneIcon;
