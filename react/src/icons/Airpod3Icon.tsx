...
interface Airpod3IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/airpod3)
 * @see {@link https://clicons.dev/icon/airpod3} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Airpod3Icon = React.forwardRef<SVGSVGElement, Airpod3IconProps>(
  (
    {
      size,
      color,
...
Airpod3Icon.displayName = 'Airpod3Icon';
export default Airpod3Icon;
