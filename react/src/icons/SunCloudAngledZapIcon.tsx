...
interface SunCloudAngledZapIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name SunCloudAngledZapIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/sun-cloud-angled-zap)
 * @see {@link https://clicons.dev/icon/sun-cloud-angled-zap} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SunCloudAngledZapIcon = React.forwardRef<SVGSVGElement, SunCloudAngledZapIconProps>(
  (
    {
      size,
      color,
...
SunCloudAngledZapIcon.displayName = 'SunCloudAngledZapIcon';
export default SunCloudAngledZapIcon;
