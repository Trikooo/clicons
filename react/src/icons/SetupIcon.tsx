...
interface SetupIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/setup)
 * @see {@link https://clicons.dev/icon/setup} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const SetupIcon = React.forwardRef<SVGSVGElement, SetupIconProps>(
  (
    {
      size,
      color,
