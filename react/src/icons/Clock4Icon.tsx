...
interface Clock4IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/clock4}
 */
const Clock4Icon = React.forwardRef<SVGSVGElement, Clock4IconProps>(
