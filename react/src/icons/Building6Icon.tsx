...
interface Building6IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/building6}
 */
const Building6Icon = React.forwardRef<SVGSVGElement, Building6IconProps>(
...
Building6Icon.displayName = 'Building6Icon';
