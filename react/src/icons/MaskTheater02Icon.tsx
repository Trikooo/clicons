...
interface MaskTheater02IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name MaskTheater02Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/mask-theater02)
 * @see {@link https://clicons.dev/icon/mask-theater02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MaskTheater02Icon = React.forwardRef<SVGSVGElement, MaskTheater02IconProps>(
  (
    {
      size,
      color,
...
MaskTheater02Icon.displayName = 'MaskTheater02Icon';
export default MaskTheater02Icon;
