...
interface SharedWifiIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/shared-wifi}
 */
const SharedWifiIcon = React.forwardRef<SVGSVGElement, SharedWifiIconProps>(
...
SharedWifiIcon.displayName = 'SharedWifiIcon';
