...
interface MagicWandIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/magic-wand)
 * @see {@link https://clicons.dev/icon/magic-wand} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const MagicWandIcon = React.forwardRef<SVGSVGElement, MagicWandIconProps>(
  (
    {
      size,
      color,
