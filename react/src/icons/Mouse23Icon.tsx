...
interface Mouse23IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Mouse23Icon = React.forwardRef<SVGSVGElement, Mouse23IconProps>(
  (
    {
      size,
      color,
...
Mouse23Icon.displayName = 'Mouse23Icon';
