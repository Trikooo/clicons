...
interface Medal04IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/medal04)
 * @see {@link https://clicons.dev/icon/medal04} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Medal04Icon = React.forwardRef<SVGSVGElement, Medal04IconProps>(
  (
    {
      size,
      color,
...
Medal04Icon.displayName = 'Medal04Icon';
