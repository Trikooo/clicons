...
interface OneSquareIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/one-square)
 * @see {@link https://clicons.dev/icon/one-square} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const OneSquareIcon = React.forwardRef<SVGSVGElement, OneSquareIconProps>(
  (
    {
      size,
      color,
...
OneSquareIcon.displayName = 'OneSquareIcon';
export default OneSquareIcon;
