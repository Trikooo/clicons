...
interface Dollar2IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/dollar2}
 */
const Dollar2Icon = React.forwardRef<SVGSVGElement, Dollar2IconProps>(
