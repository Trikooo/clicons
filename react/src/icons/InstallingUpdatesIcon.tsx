...
interface InstallingUpdatesIconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name InstallingUpdatesIcon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/installing-updates)
 * @see {@link https://clicons.dev/icon/installing-updates} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const InstallingUpdatesIcon = React.forwardRef<SVGSVGElement, InstallingUpdatesIconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M15 10.75C15 12.4069 13.6569 13.75 12 13.75C10.3431 13.75 9 12.4069 9 10.75C9 9.09315 10.3431 7.75 12 7.75C13.6569 7.75 15 9.09315 15 10.75Z',
      stroke: 'currentColor',
      strokeWidth: '1.5'
    }
  ],
...
InstallingUpdatesIcon.displayName = 'InstallingUpdatesIcon';
export default InstallingUpdatesIcon;
