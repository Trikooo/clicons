...
interface AiBrain01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/ai-brain01)
 * @see {@link https://clicons.dev/icon/ai-brain01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AiBrain01Icon = React.forwardRef<SVGSVGElement, AiBrain01IconProps>(
  (
    {
      size,
      color,
...
AiBrain01Icon.displayName = 'AiBrain01Icon';
