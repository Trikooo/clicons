...
interface CallPaused2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name CallPaused2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/call-paused2)
 * @see {@link https://clicons.dev/icon/call-paused2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const CallPaused2Icon = React.forwardRef<SVGSVGElement, CallPaused2IconProps>(
  (
    {
      size,
      color,
...
CallPaused2Icon.displayName = 'CallPaused2Icon';
export default CallPaused2Icon;
