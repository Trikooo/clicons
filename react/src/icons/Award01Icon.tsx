...
interface Award01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/award01)
 * @see {@link https://clicons.dev/icon/award01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Award01Icon = React.forwardRef<SVGSVGElement, Award01IconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M12 12V18", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "1.5", key: "0" }],
