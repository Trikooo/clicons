...
interface Books01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/books01)
 * @see {@link https://clicons.dev/icon/books01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Books01Icon = React.forwardRef<SVGSVGElement, Books01IconProps>(
  (
    {
      size,
      color,
...
Books01Icon.displayName = 'Books01Icon';
