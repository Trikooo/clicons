 ...
 * @preview ![img](https://clicons.dev/icon/twitter)
 * @see {@link https://clicons.dev/icon/twitter} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const TwitterIcon = React.forwardRef<SVGSVGElement, TwitterIconProps>(
  (
    {
      size,
      color,
