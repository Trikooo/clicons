...
interface AirplaneTakeOff2IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name AirplaneTakeOff2Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/airplane-take-off2)
 * @see {@link https://clicons.dev/icon/airplane-take-off2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const AirplaneTakeOff2Icon = React.forwardRef<SVGSVGElement, AirplaneTakeOff2IconProps>(
  (
    {
      size,
      color,
...
AirplaneTakeOff2Icon.displayName = 'AirplaneTakeOff2Icon';
export default AirplaneTakeOff2Icon;
