...
interface CrownPlusIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const CrownPlusIcon = React.forwardRef<SVGSVGElement, CrownPlusIconProps>(
  (
    {
      size,
      color,
...
CrownPlusIcon.displayName = 'CrownPlusIcon';
