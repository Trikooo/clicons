...
interface BitcoinWalletIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const BitcoinWalletIcon = React.forwardRef<SVGSVGElement, BitcoinWalletIconProps>(
  (
    {
      size,
      color,
    ...
    const iconData = [["path", { d: "M16 13C16 13.8284 16.6716 14.5 17.5 14.5C18.3284 14.5 19 13.8284 19 13C19 12.1716 18.3284 11.5 17.5 11.5C16.6716 11.5 16 12.1716 16 13Z", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
...
BitcoinWalletIcon.displayName = 'BitcoinWalletIcon';
