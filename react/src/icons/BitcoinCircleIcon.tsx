...
interface BitcoinCircleIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const BitcoinCircleIcon = React.forwardRef<SVGSVGElement, BitcoinCircleIconProps>(
  (
    {
      size,
      color,
