...
interface Setup2IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/setup2)
 * @see {@link https://clicons.dev/icon/setup2} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Setup2Icon = React.forwardRef<SVGSVGElement, Setup2IconProps>(
  (
    {
      size,
      color,
...
Setup2Icon.displayName = 'Setup2Icon';
export default Setup2Icon;
