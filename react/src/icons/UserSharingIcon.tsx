...
interface UserSharingIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/user-sharing)
 * @see {@link https://clicons.dev/icon/user-sharing} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const UserSharingIcon = React.forwardRef<SVGSVGElement, UserSharingIconProps>(
  (
    {
      size,
      color,
...
UserSharingIcon.displayName = 'UserSharingIcon';
