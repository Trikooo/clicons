...
interface ChatLockIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/chat-lock}
 */
const ChatLockIcon = React.forwardRef<SVGSVGElement, ChatLockIconProps>(
...
ChatLockIcon.displayName = 'ChatLockIcon';
