...
interface MathIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/math}
 */
const MathIcon = React.forwardRef<SVGSVGElement, MathIconProps>(
