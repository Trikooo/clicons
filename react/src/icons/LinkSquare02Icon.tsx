...
interface LinkSquare02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/link-square02)
 * @see {@link https://clicons.dev/icon/link-square02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const LinkSquare02Icon = React.forwardRef<SVGSVGElement, LinkSquare02IconProps>(
  (
    {
      size,
      color,
