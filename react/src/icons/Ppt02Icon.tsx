...
interface Ppt02IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/ppt02)
 * @see {@link https://clicons.dev/icon/ppt02} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Ppt02Icon = React.forwardRef<SVGSVGElement, Ppt02IconProps>(
  (
    {
      size,
      color,
...
Ppt02Icon.displayName = 'Ppt02Icon';
