...
interface Directions01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/directions01)
 * @see {@link https://clicons.dev/icon/directions01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Directions01Icon = React.forwardRef<SVGSVGElement, Directions01IconProps>(
  (
    {
      size,
      color,
...
Directions01Icon.displayName = 'Directions01Icon';
