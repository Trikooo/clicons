...
interface Dress07IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/dress07)
 * @see {@link https://clicons.dev/icon/dress07} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Dress07Icon = React.forwardRef<SVGSVGElement, Dress07IconProps>(
  (
    {
      size,
      color,
  ...
  [
    'path',
    {
      d: 'M6 7C7.5 9 6.95594 11.1815 6.59802 13.2178C6.22004 15.3682 5.58295 16.6762 5.21963 18.4412C4.97017 19.6531 4.84545 20.2591 5.33363 20.7716C6.71183 22.2184 16.9342 22.5901 18.6664 20.7716C19.1546 20.2591 19.0298 19.6531 18.7804 18.4412C18.4171 16.6762 17.78 15.3682 17.402 13.2178C17.0441 11.1815 16.5 9 18 7',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      strokeWidth: '1.5'
...
Dress07Icon.displayName = 'Dress07Icon';
export default Dress07Icon;
