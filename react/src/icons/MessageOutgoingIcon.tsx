...
interface MessageOutgoingIconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const MessageOutgoingIcon = React.forwardRef<SVGSVGElement, MessageOutgoingIconProps>(
  (
    {
      size,
      color,
...
MessageOutgoingIcon.displayName = 'MessageOutgoingIcon';
