 ...
 * @see {@link https://clicons.dev/icon/text-bold} - Icon preview
...
const TextBoldIcon = React.forwardRef<SVGSVGElement, TextBoldIconProps>(
  (
    ...
    const iconData = [["path", { d: "M5 6C5 4.58579 5 3.87868 5.43934 3.43934C5.87868 3 6.58579 3 8 3H12.5789C15.0206 3 17 5.01472 17 7.5C17 9.98528 15.0206 12 12.5789 12H5V6Z", stroke: "currentColor", fillRule: "evenodd", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
