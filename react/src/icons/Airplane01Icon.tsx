...
interface Airplane01IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 * @preview ![img](https://clicons.dev/icon/airplane01)
 * @see {@link https://clicons.dev/icon/airplane01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const Airplane01Icon = React.forwardRef<SVGSVGElement, Airplane01IconProps>(
  (
    {
      size,
      color,
...
Airplane01Icon.displayName = 'Airplane01Icon';
