...
interface ImageDeleteIconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
...
/**
 * @name ImageDeleteIcon
 * @description SVG icon component from Clicons.
 * @preview ![img](https://clicons.dev/icon/image-delete)
 * @see {@link https://clicons.dev/icon/image-delete}
 */
const ImageDeleteIcon = React.forwardRef<SVGSVGElement, ImageDeleteIconProps>(
...
ImageDeleteIcon.displayName = 'ImageDeleteIcon';
