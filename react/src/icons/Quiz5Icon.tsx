...
interface Quiz5IconProps extends React.SVGAttributes<SVGSVGElement> {
 ...
 */
const Quiz5Icon = React.forwardRef<SVGSVGElement, Quiz5IconProps>(
  (
    {
      size,
      color,
...
Quiz5Icon.displayName = 'Quiz5Icon';
export default Quiz5Icon;
