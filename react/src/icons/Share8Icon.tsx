...
interface Share8IconProps extends React.SVGAttributes<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
 ...
 * @see {@link https://clicons.dev/icon/share8}
 */
const Share8Icon = React.forwardRef<SVGSVGElement, Share8IconProps>(
...
Share8Icon.displayName = 'Share8Icon';
