...
interface StarAward01IconProps extends React.SVGAttributes<SVGSVGElement> {
...
/**
 * @name StarAward01Icon
 * @description SVG icon component from Clicons, renders SVG Element with children.
 * @preview ![img](https://clicons.dev/icon/star-award01)
 * @see {@link https://clicons.dev/icon/star-award01} - Icon preview
 * @see {@link https://clicons.dev} - Clicons documentation
 */
const StarAward01Icon = React.forwardRef<SVGSVGElement, StarAward01IconProps>(
  (
    {
      size,
      color,
...
StarAward01Icon.displayName = 'StarAward01Icon';
export default StarAward01Icon;
