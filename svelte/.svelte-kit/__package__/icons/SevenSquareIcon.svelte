<script lang="ts">
  ...
  /**
   * @component SevenSquareIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/seven-square)
   * @see {@link https://clicons.dev/icon/seven-square} - Icon preview
...
>
  ...
  <path d="M9.49707 7H15.0811C15.3108 7 15.4971 7.18625 15.4971 7.41599C15.4971 7.47144 15.486 7.52632 15.4645 7.57742L11.4971 17" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
