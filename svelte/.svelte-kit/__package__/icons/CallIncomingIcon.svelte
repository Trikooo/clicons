<script lang="ts">
  ...
  /**
   * @component CallIncomingIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/call-incoming)
   * @see {@link https://clicons.dev/icon/call-incoming} - Icon preview
...
>
  ...
  <path d="M16 10C15.3932 9.41016 13 7.84027 13 7C13 6.15973 15.3932 4.58984 16 4M13.5 7H21" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
