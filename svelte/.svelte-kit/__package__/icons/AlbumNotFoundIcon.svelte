<script lang="ts">
  ...
  /**
   * @component AlbumNotFoundIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/album-not-found)
   * @see {@link https://clicons.dev/icon/album-not-found} - Icon preview
...
>
  ...
  <path d="M5 17C6.8176 14.6361 8.72306 12.4166 11 11M18 11.5443C16.7483 10.5786 15.5868 10.1046 14.5 10" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
