<script lang="ts">
  ...
  /**
   * @component StarAward2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/star-award2)
   * @see {@link https://clicons.dev/icon/star-award2} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M19 9C19 12.866 15.866 16 12 16C8.13401 16 5 12.866 5 9C5 5.13401 8.13401 2 12 2C15.866 2 19 5.13401 19 9Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
