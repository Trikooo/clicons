<script lang="ts">
  ...
  /**
   * @component MinimizeScreenIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/minimize-screen)
   * @see {@link https://clicons.dev/icon/minimize-screen} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M11.4333 16.0659L8.6912 15.9658C8.28365 15.951 7.96094 15.6163 7.96094 15.2084L7.96094 12.5936M13.4609 10.5659L8.41716 15.5843" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
