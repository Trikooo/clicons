<script lang="ts">
  ...
  /**
   * @component GeometricShapesIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/geometric-shapes)
   * @see {@link https://clicons.dev/icon/geometric-shapes} - Icon preview
...
>
  ...
  <circle cx="17.5" cy="18" r="4" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M9.49994 14.5L2.5 21.5M2.50006 14.5L9.5 21.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
