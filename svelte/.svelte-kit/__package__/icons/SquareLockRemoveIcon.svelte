<script lang="ts">
  ...
  /**
   * @component SquareLockRemoveIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/square-lock-remove)
   * @see {@link https://clicons.dev/icon/square-lock-remove} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M14 22L17.5 18.5M17.5 18.5L21 15M17.5 18.5L14 15M17.5 18.5L21 22" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
