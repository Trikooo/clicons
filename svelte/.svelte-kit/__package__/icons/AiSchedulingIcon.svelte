<script lang="ts">
  ...
  /**
   * @component AiSchedulingIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/ai-scheduling)
   * @see {@link https://clicons.dev/icon/ai-scheduling} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M18 2V5M6 2V5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
