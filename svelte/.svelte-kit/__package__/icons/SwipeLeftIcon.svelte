<script lang="ts">
  ...
  /**
   * @component SwipeLeftIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/swipe-left)
   * @see {@link https://clicons.dev/icon/swipe-left} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M15.0039 4.49902H21.0029M15.0039 4.49902C15.0039 3.79906 16.9979 2.49134 17.5035 2M15.0039 4.49902C15.0039 5.19898 16.9979 6.5067 17.5035 6.99804" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
