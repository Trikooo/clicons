<script lang="ts">
  ...
  /**
   * @component RenewableEnergyIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/renewable-energy)
   * @see {@link https://clicons.dev/icon/renewable-energy} - Icon preview
...
>
  ...
  <path d="M13.5 2L11 6H15L12.5 10" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M7.49981 12H7.50879" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
</svg>
