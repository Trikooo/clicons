<script lang="ts">
  ...
  /**
   * @component Medal4Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/medal4)
   * @see {@link https://clicons.dev/icon/medal4} - Icon preview
...
>
  ...
  <path d="M12 2V7" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
