...
>
  ...
  <path d="M18 2L18 8M18 2C17.2998 2 15.9915 3.9943 15.5 4.5M18 2C18.7002 2 20.0085 3.9943 20.5 4.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
