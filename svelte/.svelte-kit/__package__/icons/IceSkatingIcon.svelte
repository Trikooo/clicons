<script lang="ts">
  ...
  /**
   * @component IceSkatingIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/ice-skating)
   * @see {@link https://clicons.dev/icon/ice-skating} - Icon preview
...
>
  ...
  <path d="M13.5 9.5L13 10" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M12.5 7L11 7.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M20.0293 17L20.6302 17.8C21.6792 19.1963 22.2036 19.8944 21.9268 20.4472C21.6499 21 20.7758 21 19.0276 21H2" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  <path d="M15 17V21M6 17V21" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
</svg>
