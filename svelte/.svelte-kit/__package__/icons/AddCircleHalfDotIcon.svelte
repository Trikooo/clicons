<script lang="ts">
  ...
  /**
   * @component AddCircleHalfDotIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/add-circle-half-dot)
   * @see {@link https://clicons.dev/icon/add-circle-half-dot} - Icon preview
...
>
  ...
  <path d="M12 8.00012V16.0001M16 12.0001L8 12.0001" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
