<script lang="ts">
  ...
  /**
   * @component Layout6Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/layout6)
   * @see {@link https://clicons.dev/icon/layout6} - Icon preview
...
>
  ...
  <path d="M21.5 8L9 8" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
  <path d="M21.5 16L9 16" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
</svg>
