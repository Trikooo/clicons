<script lang="ts">
  ...
  /**
   * @component Mouse11Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/mouse11)
   * @see {@link https://clicons.dev/icon/mouse11} - Icon preview
...
>
  ...
  <path d="M12.5 22C18.5 22 20 17.49 20 12C20 6.50998 18.5 2 12.5 2C6.49993 2 5 6.50996 5 12C5 17.49 6.49993 22 12.5 22Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
