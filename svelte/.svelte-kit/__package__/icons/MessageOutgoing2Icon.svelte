<script lang="ts">
  ...
  /**
   * @component MessageOutgoing2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/message-outgoing2)
   * @see {@link https://clicons.dev/icon/message-outgoing2} - Icon preview
...
>
  ...
  <path d="M22 4.49997L14 4.49997M22 4.49997C22 3.79974 20.0057 2.4915 19.5 1.99997M22 4.49997C22 5.2002 20.0057 6.50844 19.5 6.99997" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
