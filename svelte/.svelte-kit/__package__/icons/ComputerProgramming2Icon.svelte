<script lang="ts">
  ...
  /**
   * @component ComputerProgramming2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/computer-programming2)
   * @see {@link https://clicons.dev/icon/computer-programming2} - Icon preview
...
>
  ...
  <path d="M8 10H15" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
