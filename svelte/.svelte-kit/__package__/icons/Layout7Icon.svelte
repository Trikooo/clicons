<script lang="ts">
  ...
  /**
   * @component Layout7Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/layout7)
   * @see {@link https://clicons.dev/icon/layout7} - Icon preview
...
>
  ...
  <path d="M8 15L21.5 15" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
  <path d="M8 21.5L8 9" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
</svg>
