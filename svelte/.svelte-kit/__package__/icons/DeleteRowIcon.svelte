<script lang="ts">
  ...
  /**
   * @component DeleteRowIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/delete-row)
   * @see {@link https://clicons.dev/icon/delete-row} - Icon preview
...
>
  ...
  <path d="M9 21.5L12 18.5M12 18.5L15 15.5M12 18.5L9 15.5M12 18.5L15 21.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M2.5 9L21.5 9" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
  <path d="M8.5 2.5L8.5 9M15.5 2.5L15.5 9" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
</svg>
