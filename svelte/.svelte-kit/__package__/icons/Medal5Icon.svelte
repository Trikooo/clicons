<script lang="ts">
  ...
  /**
   * @component Medal5Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/medal5)
   * @see {@link https://clicons.dev/icon/medal5} - Icon preview
