<script lang="ts">
  ...
  /**
   * @component BubbleChatDelayIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/bubble-chat-delay)
   * @see {@link https://clicons.dev/icon/bubble-chat-delay} - Icon preview
...
>
  ...
  <path d="M12 7V12L15 14" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
