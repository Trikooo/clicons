<script lang="ts">
  ...
  /**
   * @component CallAddIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/call-add)
   * @see {@link https://clicons.dev/icon/call-add} - Icon preview
...
>
  ...
  <path d="M16.5 4V11M20 7.5H13" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
