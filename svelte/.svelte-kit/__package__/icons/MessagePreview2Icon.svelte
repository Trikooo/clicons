<script lang="ts">
  ...
  /**
   * @component MessagePreview2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/message-preview2)
   * @see {@link https://clicons.dev/icon/message-preview2} - Icon preview
...
>
  ...
  <path d="M17.5 5H17.509" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
