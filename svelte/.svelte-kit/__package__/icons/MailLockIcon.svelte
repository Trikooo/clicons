<script lang="ts">
  ...
  /**
   * @component MailLockIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/mail-lock)
   * @see {@link https://clicons.dev/icon/mail-lock} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M2 5L8.91302 8.91697C11.4616 10.361 12.5384 10.361 15.087 8.91697L22 5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinejoin="round" strokeWidth="1.5" />
