...
>
  ...
  <path d="M12.009 11L12 11M12.009 14.5H12M12.009 18H12" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
