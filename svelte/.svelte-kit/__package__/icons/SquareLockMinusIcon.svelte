<script lang="ts">
  ...
  /**
   * @component SquareLockMinusIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/square-lock-minus)
   * @see {@link https://clicons.dev/icon/square-lock-minus} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M13 17L21 17" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
