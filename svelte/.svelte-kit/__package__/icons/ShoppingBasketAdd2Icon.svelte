<script lang="ts">
  ...
  /**
   * @component ShoppingBasketAdd2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/shopping-basket-add2)
   * @see {@link https://clicons.dev/icon/shopping-basket-add2} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M13 18H21M17 22L17 14" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  ...
  <path d="M4.5 17.5H10" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
