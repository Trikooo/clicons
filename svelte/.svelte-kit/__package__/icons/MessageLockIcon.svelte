<script lang="ts">
  ...
  /**
   * @component MessageLockIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/message-lock)
   * @see {@link https://clicons.dev/icon/message-lock} - Icon preview
...
>
  ...
  <path d="M8.5 14.9999H15.5M8.5 9.99988H12" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
