<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/square-arrow-right} - Icon preview
...
>
  ...
  <path d="M10 7C10 7 14 10.6824 14 12C14 13.3176 10 17 10 17" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
