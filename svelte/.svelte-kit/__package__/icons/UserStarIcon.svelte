<script lang="ts">
  ...
  /**
   * @component UserStarIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/user-star)
   * @see {@link https://clicons.dev/icon/user-star} - Icon preview
...
>
  ...
  <path d="M3 20C3 16.134 6.13401 13 10 13C11.275 13 12.4704 13.3409 13.5 13.9365" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
