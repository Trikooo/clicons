<script lang="ts">
  ...
  /**
   * @component SquareLockCheckIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/square-lock-check)
   * @see {@link https://clicons.dev/icon/square-lock-check} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M14 20C14 20 15 20 16 22C16 22 19.1765 17 22 16" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  ...
  <path d="M5.5 9V6.5C5.5 4.01472 7.51472 2 10 2C12.4853 2 14.5 4.01472 14.5 6.5V9" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
