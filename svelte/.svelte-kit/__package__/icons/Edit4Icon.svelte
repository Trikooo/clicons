<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/edit4)
   * @see {@link https://clicons.dev/icon/edit4} - Icon preview
...
>
  ...
  <path d="M12 21H18" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M14.5 5.5L18.5 9.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
