...
>
  ...
  <path d="M5.5 12H7.5L9 9.5L10.5 14L12.5 8L14.5 16L16.5 12H18.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
