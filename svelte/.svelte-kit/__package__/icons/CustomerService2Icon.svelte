<script lang="ts">
  ...
  /**
   * @component CustomerService2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/customer-service2)
   * @see {@link https://clicons.dev/icon/customer-service2} - Icon preview
...
>
  ...
  <path d="M9.5 21C10.8807 22.3333 13.1193 22.3333 14.5 21" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  ...
  <path d="M2 16V12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12L22.0001 16" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
