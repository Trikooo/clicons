<script lang="ts">
  ...
  /**
   * @component Navigation5Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/navigation5)
   * @see {@link https://clicons.dev/icon/navigation5} - Icon preview
...
>
  ...
  <path d="M12 12V12.01" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
</svg>
