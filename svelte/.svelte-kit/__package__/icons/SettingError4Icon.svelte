<script lang="ts">
  ...
  /**
   * @component SettingError4Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/setting-error4)
   * @see {@link https://clicons.dev/icon/setting-error4} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M17 15V17M17.009 19H17M22 17C22 19.7614 19.7614 22 17 22C14.2386 22 12 19.7614 12 17C12 14.2386 14.2386 12 17 12C19.7614 12 22 14.2386 22 17Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
