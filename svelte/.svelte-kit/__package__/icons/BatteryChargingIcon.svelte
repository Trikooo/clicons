<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/battery-charging)
   * @see {@link https://clicons.dev/icon/battery-charging} - Icon preview
...
>
  ...
  <path d="M10.8282 9L9.08572 11.1749C8.89899 11.4079 9.03283 11.7433 9.33733 11.8053L11.1627 12.1773C11.4873 12.2434 11.6111 12.6147 11.3842 12.8413L9.22216 15" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
