<script lang="ts">
  ...
  /**
   * @component Stamp2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/stamp2)
   * @see {@link https://clicons.dev/icon/stamp2} - Icon preview
...
>
  ...
  <path d="M7.0883 17.7351C7.52832 16.4151 7.74832 15.755 8.2721 15.3775C8.79587 15 9.49159 15 10.883 15H13.117C14.5084 15 15.2041 15 15.7279 15.3775C16.2517 15.755 16.4717 16.4151 16.9117 17.7351L17 18H7L7.0883 17.7351Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
