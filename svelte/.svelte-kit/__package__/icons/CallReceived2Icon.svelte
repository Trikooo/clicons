...
<svg
  ...
  {...restProps}
>
  <path d="M20 11V8.5C20 6.84315 18.6569 5.5 17 5.5H14M15.5 3L13 5.5L15.5 8" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
