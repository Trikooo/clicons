<script lang="ts">
  ...
  /**
   * @component CallMissed2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/call-missed2)
   * @see {@link https://clicons.dev/icon/call-missed2} - Icon preview
...
>
  ...
  <path d="M7.2368 9C7.14942 7.99573 6.74189 5.76249 7.25219 5.25219C7.76249 4.74189 9.99573 5.14942 11 5.2368M7.5 5.5L11.1464 9.14645C11.3728 9.37282 11.6799 9.5 12 9.5C12.3201 9.5 12.6272 9.37282 12.8536 9.14645L17 5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
