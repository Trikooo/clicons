<script lang="ts">
  ...
  /**
   * @component DeviceAccessIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/device-access)
   * @see {@link https://clicons.dev/icon/device-access} - Icon preview
...
>
  ...
  <path d="M10 19V19.01" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
</svg>
