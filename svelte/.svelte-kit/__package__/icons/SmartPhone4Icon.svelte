<script lang="ts">
  ...
  /**
   * @component SmartPhone4Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/smart-phone4)
   * @see {@link https://clicons.dev/icon/smart-phone4} - Icon preview
...
>
  ...
  <path d="M11.5 2H7.5L8 3H11L11.5 2Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
