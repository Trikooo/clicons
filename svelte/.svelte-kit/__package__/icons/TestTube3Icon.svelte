<script lang="ts">
  ...
  /**
   * @component TestTube3Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/test-tube3)
   * @see {@link https://clicons.dev/icon/test-tube3} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M8.0155 2.00177H15.975" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M5.53308 11.1499C5.53308 11.1499 8.53308 10.224 11.0331 13.0015M18.5331 11.6128C18.5331 11.6128 17.9215 12.592 17.0331 13.0017" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  <path d="M10.0331 18.0037L10.0418 18.0013" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
  <path d="M14.0331 14.0037L14.0418 14.0013" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
