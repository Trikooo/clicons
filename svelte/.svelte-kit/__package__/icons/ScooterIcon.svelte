<script lang="ts">
  ...
  /**
   * @component ScooterIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/scooter)
   * @see {@link https://clicons.dev/icon/scooter} - Icon preview
...
>
  ...
  <path d="M5 7H9" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M10 17C10 18.6569 8.65685 20 7 20C5.34315 20 4 18.6569 4 17" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
  <circle cx="20" cy="16" r="2" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
