<script lang="ts">
  ...
  /**
   * @component HotAirBalloonIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/hot-air-balloon)
   * @see {@link https://clicons.dev/icon/hot-air-balloon} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M20 8.93333C20 14 14.4615 18 12 18C9.53846 18 4 14 4 8.93333C4 5.10416 7.58172 2 12 2C16.4183 2 20 5.10416 20 8.93333Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
  <path d="M15 8.93333C15 14 12.9231 18 12 18C11.0769 18 9 14 9 8.93333C9 5.10416 10.3431 2 12 2C13.6569 2 15 5.10416 15 8.93333Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
