<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/shopping-cart)
   * @see {@link https://clicons.dev/icon/shopping-cart} - Icon preview
...
>
  ...
  <path d="M16 10V13M11 10V13" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
