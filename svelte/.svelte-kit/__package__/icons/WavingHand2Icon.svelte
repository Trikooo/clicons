...
>
  ...
  <path d="M21.3307 14C21.877 15.6354 21.0574 17.4263 19.5 18" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
