<script lang="ts">
  ...
  /**
   * @component Typescript2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/typescript2)
   * @see {@link https://clicons.dev/icon/typescript2} - Icon preview
...
>
  ...
  <path d="M6 16H8.5M11 16H8.5M8.5 16V22" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M18.0002 16H15C14.4477 16 14 16.4477 14 17V18C14 18.5523 14.4477 19 15 19H17.0002C17.5525 19 18.0002 19.4477 18.0002 20V21C18.0002 21.5523 17.5525 22 17.0002 22H14" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
