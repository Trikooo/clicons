<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/bookmark-remove)
   * @see {@link https://clicons.dev/icon/bookmark-remove} - Icon preview
...
>
  ...
  <path d="M3.5 7H11" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  <path d="M21 2L14 8.99954M21 9L14 2.00046" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
