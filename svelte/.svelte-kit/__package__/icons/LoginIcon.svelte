<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/login} - Icon preview
...
>
  ...
  <path d="M13 9C13 9 16 11.2095 16 12C16 12.7906 13 15 13 15M15.5 12H3" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
