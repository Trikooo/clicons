<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/home)
   * @see {@link https://clicons.dev/icon/home} - Icon preview
...
>
  ...
  <path d="M15.0002 17C14.2007 17.6224 13.1504 18 12.0002 18C10.8499 18 9.79971 17.6224 9.00018 17" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
