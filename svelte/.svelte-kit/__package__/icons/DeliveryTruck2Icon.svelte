<script lang="ts">
  ...
  /**
   * @component DeliveryTruck2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/delivery-truck2)
   * @see {@link https://clicons.dev/icon/delivery-truck2} - Icon preview
...
>
  ...
  <path d="M2 7H8M2 10H6" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
