<script lang="ts">
  ...
  /**
   * @component MessagePreviewIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/message-preview)
   * @see {@link https://clicons.dev/icon/message-preview} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M8.5 15.5H15.5M8.5 10.5H12" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
