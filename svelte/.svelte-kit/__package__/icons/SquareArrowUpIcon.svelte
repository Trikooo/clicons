<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/square-arrow-up} - Icon preview
...
>
  ...
  <path d="M17 14C17 14 13.3176 10 12 10C10.6824 9.99999 7 14 7 14" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
