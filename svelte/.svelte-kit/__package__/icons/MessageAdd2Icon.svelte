<script lang="ts">
  ...
  /**
   * @component MessageAdd2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/message-add2)
   * @see {@link https://clicons.dev/icon/message-add2} - Icon preview
...
>
  ...
  <path d="M15 5.5H22M18.5 2L18.5 9" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
