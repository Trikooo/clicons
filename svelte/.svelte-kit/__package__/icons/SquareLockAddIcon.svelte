<script lang="ts">
  ...
  /**
   * @component SquareLockAddIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/square-lock-add)
   * @see {@link https://clicons.dev/icon/square-lock-add} - Icon preview
...
>
  ...
  <path d="M17 22L17 14M13 18H21" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
