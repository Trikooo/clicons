<script lang="ts">
  ...
  /**
   * @component InsertRowDownIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/insert-row-down)
   * @see {@link https://clicons.dev/icon/insert-row-down} - Icon preview
...
>
  ...
  <path d="M12 13.5V20.5M9 18.5L12 21.5L15 18.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
