<script lang="ts">
  ...
  /**
   * @component SquareUnlock2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/square-unlock2)
   * @see {@link https://clicons.dev/icon/square-unlock2} - Icon preview
...
>
  ...
  <path d="M7.5 9V6.5C7.5 4.01472 9.51472 2 12 2C13.9593 2 15.5 3.5 16 5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
