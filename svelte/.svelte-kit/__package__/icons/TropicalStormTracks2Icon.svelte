<script lang="ts">
  ...
  /**
   * @component TropicalStormTracks2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/tropical-storm-tracks2)
   * @see {@link https://clicons.dev/icon/tropical-storm-tracks2} - Icon preview
...
>
  ...
  <circle cx="8.10593" cy="10.312" r="2.23093" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
  <path d="M19.5 7V12.5C19.5 16.6421 16.1421 20 12 20M19.5 7C20.2002 7 21.5085 8.9943 22 9.5M19.5 7C18.7998 7 17.4915 8.9943 17 9.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
