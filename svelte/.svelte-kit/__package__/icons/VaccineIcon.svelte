<script lang="ts">
  ...
  /**
   * @component VaccineIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/vaccine)
   * @see {@link https://clicons.dev/icon/vaccine} - Icon preview
...
>
  ...
  <path d="M11 6L17 12" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
