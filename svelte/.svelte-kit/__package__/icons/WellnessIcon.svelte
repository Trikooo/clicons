<script lang="ts">
  ...
  /**
   * @component WellnessIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/wellness)
   * @see {@link https://clicons.dev/icon/wellness} - Icon preview
