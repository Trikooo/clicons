<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/solar-power} - Icon preview
...
>
  ...
  <path d="M9.5 11L8 18M14.5 11L16 18" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M4 14.5H20" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  ...
  <path d="M15 22C13.9398 20.8271 14 19 14 18M9 22C10.0602 20.8271 10 19 10 18" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
