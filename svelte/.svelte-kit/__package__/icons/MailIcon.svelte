<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/mail)
   * @see {@link https://clicons.dev/icon/mail} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M2 6L8.91302 9.91697C11.4616 11.361 12.5384 11.361 15.087 9.91697L22 6" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinejoin="round" strokeWidth="1.5" />
