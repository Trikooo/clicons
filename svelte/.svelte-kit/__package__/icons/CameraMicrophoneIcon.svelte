<script lang="ts">
  ...
  /**
   * @component CameraMicrophoneIcon
...
>
  ...
  <path d="M19.0002 9.49997V9.50997" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
