<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/books} - Icon preview
...
>
  ...
  <path d="M21 15C19.8954 15 19 13.6569 19 12C19 10.3431 19.8954 9 21 9" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  <path d="M3 3C4.10457 3 5 4.34315 5 6C5 7.65685 4.10457 9 3 9" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  <path d="M3 15C4.10457 15 5 16.3431 5 18C5 19.6569 4.10457 21 3 21" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
