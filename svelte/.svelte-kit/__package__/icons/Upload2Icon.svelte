<script lang="ts">
  ...
  /**
   * @component Upload2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/upload2)
   * @see {@link https://clicons.dev/icon/upload2} - Icon preview
