<script lang="ts">
  ...
  /**
   * @component SailboatCoastalIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/sailboat-coastal)
   * @see {@link https://clicons.dev/icon/sailboat-coastal} - Icon preview
...
>
  ...
  <path d="M14 13L14 2" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  <path d="M2 21L22 21" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
