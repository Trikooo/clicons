<script lang="ts">
  ...
  /**
   * @component Layout4Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/layout4)
   * @see {@link https://clicons.dev/icon/layout4} - Icon preview
...
>
  ...
  <path d="M8.99999 21.5L8.99999 2.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
  <path d="M21.5 12L9 12" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
</svg>
