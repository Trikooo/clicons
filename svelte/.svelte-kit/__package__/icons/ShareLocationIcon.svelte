<script lang="ts">
  ...
  /**
   * @component ShareLocationIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/share-location)
   * @see {@link https://clicons.dev/icon/share-location} - Icon preview
...
>
  ...
  <path d="M11.9961 11.5H12.0024" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
</svg>
