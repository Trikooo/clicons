<script lang="ts">
  ...
  /**
   * @component CurtainsIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/curtains)
   * @see {@link https://clicons.dev/icon/curtains} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M22 3L2 3" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M5 14C5.5985 13.2925 6.76719 11.3937 7 9" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M19 14C18.4015 13.2925 17.2328 11.3937 17 9" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
