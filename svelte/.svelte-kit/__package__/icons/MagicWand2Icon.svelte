<script lang="ts">
  ...
  /**
   * @component MagicWand2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/magic-wand2)
   * @see {@link https://clicons.dev/icon/magic-wand2} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M17.5 17.5L21.5 21.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
