<script lang="ts">
  ...
  /**
   * @component KeyframeAlignVerticalIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/keyframe-align-vertical)
   * @see {@link https://clicons.dev/icon/keyframe-align-vertical} - Icon preview
