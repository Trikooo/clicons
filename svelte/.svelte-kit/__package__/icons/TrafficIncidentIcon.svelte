<script lang="ts">
  ...
  /**
   * @component TrafficIncidentIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/traffic-incident)
   * @see {@link https://clicons.dev/icon/traffic-incident} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M3 1.99774H21" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
