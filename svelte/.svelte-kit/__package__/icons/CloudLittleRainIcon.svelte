<script lang="ts">
  ...
  /**
   * @component CloudLittleRainIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/cloud-little-rain)
   * @see {@link https://clicons.dev/icon/cloud-little-rain} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M12.0011 13.5V15M9 16.5V18M15 16.5V18M6.5 19.5V21M17.5 19.5V21M12 19.5V21" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
