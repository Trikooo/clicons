<script lang="ts">
  ...
  /**
   * @component MessageDone2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/message-done2)
   * @see {@link https://clicons.dev/icon/message-done2} - Icon preview
