<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/chat-bot)
   * @see {@link https://clicons.dev/icon/chat-bot} - Icon preview
...
>
  ...
  <path d="M9 12V13M15 12V13" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M10 16.5C10 16.5 10.6667 17 12 17C13.3333 17 14 16.5 14 16.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
