<script lang="ts">
  ...
  /**
   * @component ChatDownloadIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/chat-download)
   * @see {@link https://clicons.dev/icon/chat-download} - Icon preview
...
>
  ...
  <path d="M22 6.00002C22 6.00002 19.7906 8.99999 19 9C18.2095 9.00001 16 6 16 6M19 8.5V2" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
