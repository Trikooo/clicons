<script lang="ts">
  ...
  /**
   * @component CardExchangeIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/card-exchange)
   * @see {@link https://clicons.dev/icon/card-exchange} - Icon preview
...
>
  ...
  <path d="M2 15L14 15" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  <path d="M10 7L22 7" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
