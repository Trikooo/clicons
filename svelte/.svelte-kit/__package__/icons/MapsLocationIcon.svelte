<script lang="ts">
  ...
  /**
   * @component MapsLocationIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/maps-location)
   * @see {@link https://clicons.dev/icon/maps-location} - Icon preview
...
>
  ...
  <path d="M8 2L8 17" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M15 5V9.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
