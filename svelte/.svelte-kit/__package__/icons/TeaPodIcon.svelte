<script lang="ts">
  ...
  /**
   * @component TeaPodIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/tea-pod)
   * @see {@link https://clicons.dev/icon/tea-pod} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M19.0063 10.005V6.5038C19.0063 4.01763 16.9835 2.0022 14.4881 2.0022C11.9928 2.0022 9.96997 4.01763 9.96997 6.5038V10.005" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  <path d="M14.488 9.00468V7.50415" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
