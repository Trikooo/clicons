<script lang="ts">
  ...
  /**
   * @component Mouse4Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/mouse4)
   * @see {@link https://clicons.dev/icon/mouse4} - Icon preview
...
>
  ...
  <path d="M12 2L12 8M12 12L12 14" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
