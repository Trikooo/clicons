<script lang="ts">
  ...
  /**
   * @component UsbNotConnected2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/usb-not-connected2)
   * @see {@link https://clicons.dev/icon/usb-not-connected2} - Icon preview
...
>
  ...
  <path d="M19 12.5L13 18.5M19 18.5L13 12.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  ...
  <path d="M9.5 4.5H10.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
