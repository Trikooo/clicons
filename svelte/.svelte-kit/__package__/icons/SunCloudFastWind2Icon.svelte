<script lang="ts">
  ...
  /**
   * @component SunCloudFastWind2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/sun-cloud-fast-wind2)
   * @see {@link https://clicons.dev/icon/sun-cloud-fast-wind2} - Icon preview
...
>
  ...
  <path d="M19.2479 21C19.506 21 20.2036 21 21.2479 21" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
