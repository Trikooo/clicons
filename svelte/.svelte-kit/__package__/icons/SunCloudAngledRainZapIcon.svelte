<script lang="ts">
  ...
  /**
   * @component SunCloudAngledRainZapIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/sun-cloud-angled-rain-zap)
   * @see {@link https://clicons.dev/icon/sun-cloud-angled-rain-zap} - Icon preview
...
>
  ...
  <path d="M16 18.5L15 20.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M13 18.5L12 20.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
