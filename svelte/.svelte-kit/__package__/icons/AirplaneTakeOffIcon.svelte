<script lang="ts">
  ...
  /**
   * @component AirplaneTakeOffIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/airplane-take-off)
   * @see {@link https://clicons.dev/icon/airplane-take-off} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M2.00031 20H18.0003" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
