<script lang="ts">
  ...
  /**
   * @component PresentationBarChart2Icon
...
>
  ...
  <path d="M8 13V10M12 13V7M16 13V11" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
