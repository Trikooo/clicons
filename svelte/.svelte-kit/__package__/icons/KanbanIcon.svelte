<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/kanban)
   * @see {@link https://clicons.dev/icon/kanban} - Icon preview
...
>
  ...
  <path d="M12 7V11M17 7V17M7 7V14" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
