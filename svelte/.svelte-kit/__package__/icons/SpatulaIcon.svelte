<script lang="ts">
  ...
  /**
   * @component SpatulaIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/spatula)
   * @see {@link https://clicons.dev/icon/spatula} - Icon preview
...
>
  ...
  <path d="M15.2207 10.686L17.3751 8.53168" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  <path d="M13.375 8.84143L15.5294 6.68707" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
