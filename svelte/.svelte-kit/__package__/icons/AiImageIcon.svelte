<script lang="ts">
  ...
  /**
   * @component AiImageIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/ai-image)
   * @see {@link https://clicons.dev/icon/ai-image} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <circle cx="7" cy="8" r="1.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  ...
  <path d="M4.5 21.5C8.87246 16.275 13.7741 9.38406 20.9975 14.0424" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
</svg>
