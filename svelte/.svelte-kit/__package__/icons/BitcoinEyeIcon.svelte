<script lang="ts">
  ...
  /**
   * @component BitcoinEyeIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/bitcoin-eye)
   * @see {@link https://clicons.dev/icon/bitcoin-eye} - Icon preview
...
>
  ...
  <path d="M12 9C18 9 22 15.5 22 15.5C22 15.5 18 22 12 22C6 22 2 15.5 2 15.5C2 15.5 6 9 12 9Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinejoin="round" strokeWidth="1.5" />
</svg>
