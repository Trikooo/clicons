<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/alert2} - Icon preview
...
>
  ...
  <path d="M12 9V13.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M12 16.9922V17.0022" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
</svg>
