<script lang="ts">
  ...
  /**
   * @component ComputerCheckIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/computer-check)
   * @see {@link https://clicons.dev/icon/computer-check} - Icon preview
...
>
  ...
  <path d="M8.5 10.5006C8.5 10.5006 9.5 11.0006 10.25 12.5006C10.25 12.5006 13.0294 8.33394 15.5 7.50061" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
