<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/remove)
   * @see {@link https://clicons.dev/icon/remove} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M19.002 12L5.00001 12" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
