<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/apple} - Icon preview
...
>
  ...
  <path d="M6 12C6 10.3665 6.82273 8.73298 8 8" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M12 6C12 4.66667 12.6 2 15 2" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
