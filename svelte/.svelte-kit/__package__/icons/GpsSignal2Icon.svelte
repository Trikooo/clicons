<script lang="ts">
  ...
  /**
   * @component GpsSignal2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/gps-signal2)
   * @see {@link https://clicons.dev/icon/gps-signal2} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M20.9947 3L21 3.00529M18.4971 5.49736L18.5024 5.50264M16 7.99471L16.0053 8" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
