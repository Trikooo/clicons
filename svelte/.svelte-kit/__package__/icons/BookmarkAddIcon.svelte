<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/bookmark-add)
   * @see {@link https://clicons.dev/icon/bookmark-add} - Icon preview
...
>
  ...
  <path d="M3.5 7.00005H10" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  <path d="M17 10L17 2M13 6H21" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
