<script lang="ts">
  ...
  /**
   * @component DispleasedIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/displeased)
   * @see {@link https://clicons.dev/icon/displeased} - Icon preview
...
>
  ...
  <path d="M9 15.6837C11.0949 14.3069 13.504 15.1434 15 17" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
