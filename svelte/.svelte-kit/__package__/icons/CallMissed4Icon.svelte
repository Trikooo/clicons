<script lang="ts">
  ...
  /**
   * @component CallMissed4Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/call-missed4)
   * @see {@link https://clicons.dev/icon/call-missed4} - Icon preview
...
>
  ...
  <path d="M10.75 4L7 4.00012L7 7.75M7.43048 4.4306L12 9L17 4.00012" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
