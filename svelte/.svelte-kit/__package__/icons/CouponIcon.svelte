<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/coupon)
   * @see {@link https://clicons.dev/icon/coupon} - Icon preview
...
>
  ...
  <path d="M15 8L9 14" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M15 14H14.991M9.00897 8H9" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
</svg>
