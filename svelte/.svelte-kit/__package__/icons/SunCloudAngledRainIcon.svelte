<script lang="ts">
  ...
  /**
   * @component SunCloudAngledRainIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/sun-cloud-angled-rain)
   * @see {@link https://clicons.dev/icon/sun-cloud-angled-rain} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M12.5 16L11.5 18M17 16L16 18M13.5 20L12.5 22M8 16L7 18M9 20L8 22" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
