<script lang="ts">
  ...
  /**
   * @component HospitalLocationIcon
...
>
  ...
  <path d="M10.5 7V10M10.5 13V10M14.5 7V10M14.5 13V10M14.5 10H10.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
