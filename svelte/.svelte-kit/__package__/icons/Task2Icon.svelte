<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/task2} - Icon preview
...
>
  ...
  <path d="M8 15H12M8 11H16" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
