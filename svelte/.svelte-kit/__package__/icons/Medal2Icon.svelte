<script lang="ts">
  ...
  /**
   * @component Medal2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/medal2)
   * @see {@link https://clicons.dev/icon/medal2} - Icon preview
...
>
  ...
  <path d="M8 5V6M12 5V8M16 5V6" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
