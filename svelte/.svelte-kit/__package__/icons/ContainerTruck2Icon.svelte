<script lang="ts">
  ...
  /**
   * @component ContainerTruck2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/container-truck2)
   * @see {@link https://clicons.dev/icon/container-truck2} - Icon preview
...
>
  ...
  <path d="M6.5 7V10.9998M10.5 7V10.9998" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
