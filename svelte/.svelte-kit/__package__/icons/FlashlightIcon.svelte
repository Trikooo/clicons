<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/flashlight)
   * @see {@link https://clicons.dev/icon/flashlight} - Icon preview
...
>
  ...
  <path d="M7 6H17" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M12 13V15" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
