<script lang="ts">
  ...
  /**
   * @component ImageAdd2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/image-add2)
   * @see {@link https://clicons.dev/icon/image-add2} - Icon preview
...
>
  ...
  <path d="M21.5 6H18M18 6H14.5M18 6V2.5M18 6V9.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
