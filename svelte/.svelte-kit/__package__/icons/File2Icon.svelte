<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/file2} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M8 17H16" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M8 13H12" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
