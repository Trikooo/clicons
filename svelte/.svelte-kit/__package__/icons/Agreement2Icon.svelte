<script lang="ts">
  ...
  /**
   * @component Agreement2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/agreement2)
   * @see {@link https://clicons.dev/icon/agreement2} - Icon preview
...
>
  ...
  <path d="M22 14.75H19.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  <path d="M8.5 6.75003L2 6.75003" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
