<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/folder-upload)
   * @see {@link https://clicons.dev/icon/folder-upload} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M22 16C21.4102 15.3932 19.8403 13 19 13C18.1597 13 16.5898 15.3932 16 16M19 14L19 21" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
