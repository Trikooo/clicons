<script lang="ts">
  ...
  /**
   * @component Briefcase4Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/briefcase4)
   * @see {@link https://clicons.dev/icon/briefcase4} - Icon preview
...
>
  ...
  <path d="M13.5 14C19.5735 13.5094 21.75 10 21.75 10M2.25 10C2.25 10 4.42655 13.5094 10.5 14" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M10.5 14V13C10.5 12.7239 10.7239 12.5 11 12.5H13C13.2761 12.5 13.5 12.7239 13.5 13V14C13.5 14.8284 12.8284 15.5 12 15.5C11.1716 15.5 10.5 14.8284 10.5 14Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
