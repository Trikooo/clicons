<script lang="ts">
  ...
  /**
   * @component AirpodIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/airpod)
   * @see {@link https://clicons.dev/icon/airpod} - Icon preview
...
>
  ...
  <path d="M2.5 9H7.25M21.5 9H16.75" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
  <rect x="7" y="7" width="10" height="4" rx="2" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
</svg>
