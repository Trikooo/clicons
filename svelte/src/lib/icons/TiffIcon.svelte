<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/tiff} - Icon preview
...
>
  ...
  <path d="M4 16H5.75M5.75 16H7.5M5.75 16V22M15 16H12.5V19M12.5 19V22M12.5 19H15M20 16H17.5V19M17.5 19V22M17.5 19H20M10 16V22" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
