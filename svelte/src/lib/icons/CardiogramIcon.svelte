...
>
  ...
  <path d="M2.5 15H21.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M7.00896 18H7H7.00896Z" fill={"currentColor".replace('currentColor', finalColor)} fillRule="evenodd" />
  <path d="M11 18H10.991H11Z" fill={"currentColor".replace('currentColor', finalColor)} fillRule="evenodd" />
  <path d="M7.00896 18H7M11 18H10.991" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
