<script lang="ts">
  ...
  /**
   * @component MessageProgrammingIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/message-programming)
   * @see {@link https://clicons.dev/icon/message-programming} - Icon preview
