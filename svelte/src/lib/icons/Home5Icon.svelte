<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/home5)
   * @see {@link https://clicons.dev/icon/home5} - Icon preview
...
>
  ...
  <path d="M14 15C14 13.8954 13.1046 13 12 13C10.8954 13 10 13.8954 10 15C10 16.1046 10.8954 17 12 17C13.1046 17 14 16.1046 14 15Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinejoin="round" strokeWidth="1.5" />
</svg>
