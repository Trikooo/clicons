<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/square-arrow-left} - Icon preview
...
>
  ...
  <path d="M14 7C14 7 10 10.6824 10 12C9.99999 13.3176 14 17 14 17" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
