...
>
  ...
  <path d="M17.5 11.002L20 11M13 6.50195V4M17.9497 6.05025L16.181 7.819" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
