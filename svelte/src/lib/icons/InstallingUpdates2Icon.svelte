<script lang="ts">
  ...
  /**
   * @component InstallingUpdates2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/installing-updates2)
   * @see {@link https://clicons.dev/icon/installing-updates2} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M15 10.5C15 12.1569 13.6569 13.5 12 13.5C10.3431 13.5 9 12.1569 9 10.5C9 8.84315 10.3431 7.5 12 7.5C13.6569 7.5 15 8.84315 15 10.5Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
