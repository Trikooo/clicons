<script lang="ts">
  ...
  /**
   * @component MedicineSyrupIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/medicine-syrup)
   * @see {@link https://clicons.dev/icon/medicine-syrup} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M9.5 15.75C9.5 17.4069 10.75 18 12 18C13.25 18 14.5 17.4069 14.5 15.75C14.5 14.0931 12 12 12 12C12 12 9.5 14.0931 9.5 15.75Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinejoin="round" strokeWidth="1.5" />
