<script lang="ts">
  ...
  /**
   * @component Mouse6Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/mouse6)
   * @see {@link https://clicons.dev/icon/mouse6} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M22 6.16705C21.5974 6.96357 20.7056 7.23648 20.0082 6.77661L17.9036 5.38882C16.3163 4.34208 15.5226 3.81871 14.7447 4.05676C14.2697 4.20215 13.9138 4.59687 13.5 5.29516" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  ...
  <path d="M11.6328 7.90234L10.6328 9.63439" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
