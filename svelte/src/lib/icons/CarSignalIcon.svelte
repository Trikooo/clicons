<script lang="ts">
  ...
  /**
   * @component CarSignalIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/car-signal)
   * @see {@link https://clicons.dev/icon/car-signal} - Icon preview
...
>
  ...
  <path d="M2 11L4 12.5L5.76114 12.9403C5.91978 12.9799 6.08269 13 6.24621 13H16.7538C16.9173 13 17.0802 12.9799 17.2389 12.9403L19 12.5L21 11" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M17 16V16.01" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
  <path d="M6 16V16.01" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
  <path d="M19 7C19 5.89543 18.1046 5 17 5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M22 7C22 4.23858 19.7614 2 17 2" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
