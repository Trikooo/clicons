<script lang="ts">
  ...
  /**
   * @component CallRinging3Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/call-ringing3)
   * @see {@link https://clicons.dev/icon/call-ringing3} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M12 4V7M18 7L16 9M6 7L8 9" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
