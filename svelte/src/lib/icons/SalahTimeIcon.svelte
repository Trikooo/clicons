<script lang="ts">
  ...
  /**
   * @component SalahTimeIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/salah-time)
   * @see {@link https://clicons.dev/icon/salah-time} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M15.5092 5.00159C14.2435 3.18742 11.8856 2.00044 9.50543 2.00044C5.63698 2.00044 2.50098 5.13565 2.50098 9.00311C2.50098 12.7024 5.37016 15.7493 9.00511 16.0058" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  <path d="M9.50486 7.00244V9.5034L8.00391 10.5038" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
