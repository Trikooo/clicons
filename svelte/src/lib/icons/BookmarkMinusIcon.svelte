<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/bookmark-minus)
   * @see {@link https://clicons.dev/icon/bookmark-minus} - Icon preview
...
>
  ...
  <path d="M3.5 7H10" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  <path d="M13 5H21" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
