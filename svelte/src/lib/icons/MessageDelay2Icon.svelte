<script lang="ts">
  ...
  /**
   * @component MessageDelay2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/message-delay2)
   * @see {@link https://clicons.dev/icon/message-delay2} - Icon preview
...
>
  ...
  <path d="M18 5.99999L19 4.99999M22 5.99999C22 8.20913 20.2091 9.99999 18 9.99999C15.7909 9.99999 14 8.20913 14 5.99999C14 3.79085 15.7909 1.99999 18 1.99999C20.2091 1.99999 22 3.79085 22 5.99999Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
