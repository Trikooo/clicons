<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/align-left} - Icon preview
...
>
  ...
  <path d="M4 2V22" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
