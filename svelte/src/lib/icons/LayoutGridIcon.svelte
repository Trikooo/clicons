<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/layout-grid)
   * @see {@link https://clicons.dev/icon/layout-grid} - Icon preview
...
>
  ...
  <path d="M21.5 12L2.5 12" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  <path d="M12 2.5L12 21.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
