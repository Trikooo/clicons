<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/xml)
   * @see {@link https://clicons.dev/icon/xml} - Icon preview
...
>
  ...
  <path d="M10.5 22V16L12.5 19L14.5 16V22" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M17 16V20C17 20.9428 17 21.4142 17.2929 21.7071C17.5858 22 18.0572 22 19 22H20" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
