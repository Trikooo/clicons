<script lang="ts">
  ...
  /**
   * @component Toilet2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/toilet2)
   * @see {@link https://clicons.dev/icon/toilet2} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M14.4004 14C15.3717 13.0878 16 11.6356 16 10C16 7.23858 14.2091 5 12 5C9.79086 5 8 7.23858 8 10C8 11.6356 8.62827 13.0878 9.59961 14" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
