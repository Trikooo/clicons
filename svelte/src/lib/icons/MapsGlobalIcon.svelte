<script lang="ts">
  ...
  /**
   * @component MapsGlobalIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/maps-global)
   * @see {@link https://clicons.dev/icon/maps-global} - Icon preview
...
>
  ...
  <path d="M18 7.5C18 6.67157 17.3284 6 16.5 6C15.6716 6 15 6.67157 15 7.5C15 8.32843 15.6716 9 16.5 9C17.3284 9 18 8.32843 18 7.5Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
