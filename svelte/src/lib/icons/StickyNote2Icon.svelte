<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/sticky-note2)
   * @see {@link https://clicons.dev/icon/sticky-note2} - Icon preview
...
>
  ...
  <path d="M2.5 10V16C2.5 18.8284 2.5 20.2426 3.37868 21.1213C4.25736 22 5.67157 22 8.5 22H11.5761C14.4045 22 15.8188 22 16.6974 21.1213C17.1873 20.6314 17.4041 19.9751 17.5 19" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
