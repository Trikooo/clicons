<script lang="ts">
  ...
  /**
   * @component HeadsetConnectedIcon
...
>
  ...
  <path d="M9 15.1148C9.86163 14.4098 10.8907 14 11.9959 14C13.1047 14 14.1367 14.4123 15 15.1215M13.6307 17.5C13.1386 17.1913 12.5834 17.0177 11.9959 17.0177C11.4114 17.0177 10.8588 17.1896 10.3686 17.4954" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  <path d="M12 20H12.0064" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
  ...
  <path d="M20 12V10.875C20 6.52576 16.4183 3 12 3C7.58172 3 4 6.52576 4 10.875V12" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="square" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
