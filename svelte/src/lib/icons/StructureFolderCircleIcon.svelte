<script lang="ts">
  ...
  /**
   * @component StructureFolderCircleIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/structure-folder-circle)
   * @see {@link https://clicons.dev/icon/structure-folder-circle} - Icon preview
...
>
  ...
  <path d="M19 16C18.8433 13.547 17.9687 13 15.0119 13H8.9881C6.03127 13 5.15669 13.547 5 16" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
