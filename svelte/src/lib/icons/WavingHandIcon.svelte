<script lang="ts">
  ...
  /**
   * @component WavingHandIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/waving-hand)
   * @see {@link https://clicons.dev/icon/waving-hand} - Icon preview
...
>
  ...
  <path d="M20.8307 13C21.377 14.6354 20.5574 16.4263 19 17" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
