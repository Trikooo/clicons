<script lang="ts">
  ...
  /**
   * @component Resize2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/resize2)
   * @see {@link https://clicons.dev/icon/resize2} - Icon preview
...
>
  ...
  <path d="M16 4.5L20 4.5M16 4.5C16 5.06018 17.4943 6.10678 18 6.5M16 4.5C16 3.93982 17.4943 2.89322 18 2.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M6.5 4.5L2.5 4.5M6.5 4.5C6.5 3.93982 5.0057 2.89322 4.5 2.5M6.5 4.5C6.5 5.06018 5.0057 6.10678 4.5 6.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
