<script lang="ts">
  ...
  /**
   * @component Layout2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/layout2)
   * @see {@link https://clicons.dev/icon/layout2} - Icon preview
...
>
  ...
  <path d="M21.5 9L2.5 9" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
  <path d="M16 21.5L16 9" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
</svg>
