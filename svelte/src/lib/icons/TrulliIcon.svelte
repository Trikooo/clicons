<script lang="ts">
  ...
  /**
   * @component TrulliIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/trulli)
   * @see {@link https://clicons.dev/icon/trulli} - Icon preview
...
>
  ...
  <path d="M6.00012 8.50764C9.32819 9.40699 10.8212 5.23135 13.5795 7.91038C15.0001 9.29003 16.4165 9.20495 18.0001 8.50764" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  <path d="M10.0002 21.9999V17.9999C10.0002 16.8953 10.8957 15.9999 12.0002 15.9999C13.1048 15.9999 14.0002 16.8953 14.0002 17.9999V21.9999" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
