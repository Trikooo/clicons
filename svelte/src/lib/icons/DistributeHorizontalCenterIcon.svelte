<script lang="ts">
  ...
  /**
   * @component DistributeHorizontalCenterIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/distribute-horizontal-center)
   * @see {@link https://clicons.dev/icon/distribute-horizontal-center} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M7 5L7 2M7 19L7 22" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  ...
  <path d="M17 8V2M17 16V22" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
