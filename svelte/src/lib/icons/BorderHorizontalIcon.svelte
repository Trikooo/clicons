<script lang="ts">
  ...
  /**
   * @component BorderHorizontalIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/border-horizontal)
   * @see {@link https://clicons.dev/icon/border-horizontal} - Icon preview
...
>
  ...
  <path d="M12 2.5L12 4.4M12 19.6L12 21.5M12 9.15L12 14.85" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
