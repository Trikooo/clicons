<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/audit} - Icon preview
...
>
  ...
  <path d="M7 7H15M7 11H11" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
