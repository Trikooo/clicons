<script lang="ts">
  ...
  /**
   * @component CursorInfoIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/cursor-info)
   * @see {@link https://clicons.dev/icon/cursor-info} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M15 9.99001V10M13 3.99762C13 2.89437 13.8954 2 15 2C16.1046 2 17 2.89437 17 3.99762C17 4.5747 16.755 5.09463 16.3632 5.4593C15.7572 6.02343 15 6.66601 15 7.49346" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
