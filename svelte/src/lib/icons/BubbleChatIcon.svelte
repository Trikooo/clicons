...
<svg
  ...
  {...restProps}
>
  <path d="M12.0045 12H12.0135M16 12H16.009M8.009 12H8.01797" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
