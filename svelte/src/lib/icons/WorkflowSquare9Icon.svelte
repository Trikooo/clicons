<script lang="ts">
  ...
  /**
   * @component WorkflowSquare9Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/workflow-square9)
   * @see {@link https://clicons.dev/icon/workflow-square9} - Icon preview
...
>
  ...
  <path d="M6 12H14C15.8856 12 16.8284 12 17.4142 11.4142C18 10.8284 18 9.88562 18 8" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
