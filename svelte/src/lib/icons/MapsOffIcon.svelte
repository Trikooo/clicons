<script lang="ts">
  ...
  /**
   * @component MapsOffIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/maps-off)
   * @see {@link https://clicons.dev/icon/maps-off} - Icon preview
...
>
  ...
  <path d="M14.9998 15.0093V20.9379M8.01953 8.14258L8.01953 17.9197" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
