<script lang="ts">
  ...
  /**
   * @component MessageDoneIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/message-done)
   * @see {@link https://clicons.dev/icon/message-done} - Icon preview
...
>
  ...
  <path d="M14 6C14 6 15 6 16 8C16 8 19.1765 3 22 2" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
