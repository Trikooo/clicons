...
>
  ...
  <path d="M13 9C13 9 14.1429 9 15.2857 11C15.2857 11 17.7731 6 21 5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
