...
<svg
  ...
  {...restProps}
>
  <path d="M18.5 3L21 5.5L18.5 8M14 5.5H20.3912" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
