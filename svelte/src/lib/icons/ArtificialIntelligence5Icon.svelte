<script lang="ts">
  ...
  /**
   * @component ArtificialIntelligence5Icon
...
>
  ...
  <path d="M7.4375 14.9922L9.27939 9.46653C9.37381 9.18326 9.6389 8.99219 9.9375 8.99219C10.2361 8.99219 10.5012 9.18326 10.5956 9.46653L12.4375 14.9922M8.4375 12.9922H11.4375" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M15.4375 8.99219V14.9922" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
