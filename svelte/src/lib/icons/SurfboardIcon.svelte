...
>
  ...
  <path d="M21 8C17.4091 14.1336 10.3975 8.45321 5.5 12.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
