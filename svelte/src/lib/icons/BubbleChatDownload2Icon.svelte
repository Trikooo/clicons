<script lang="ts">
  ...
  /**
   * @component BubbleChatDownload2Icon
...
>
  ...
  <path d="M15 12.5C15 12.5 12.7905 15.5 12 15.5C11.2094 15.5 9 12.5 9 12.5M12 15V8.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
