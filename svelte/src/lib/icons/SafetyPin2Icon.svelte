<script lang="ts">
  ...
  /**
   * @component SafetyPin2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/safety-pin2)
   * @see {@link https://clicons.dev/icon/safety-pin2} - Icon preview
...
>
  ...
  <circle cx="4.5" cy="19.5" r="2.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M3 17.4103L7 5M6.58974 21L17 12" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
