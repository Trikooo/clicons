<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/comment)
   * @see {@link https://clicons.dev/icon/comment} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M8 13.5H16M8 8.5H12" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
