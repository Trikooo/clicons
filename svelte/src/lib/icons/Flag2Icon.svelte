<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/flag2)
   * @see {@link https://clicons.dev/icon/flag2} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M4 7L4 21" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
