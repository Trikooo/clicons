<script lang="ts">
  ...
  /**
   * @component SquareLockMinus2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/square-lock-minus2)
   * @see {@link https://clicons.dev/icon/square-lock-minus2} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M18.3333 18H15.6667M21 18C21 20.2091 19.2091 22 17 22C14.7909 22 13 20.2091 13 18C13 15.7909 14.7909 14 17 14C19.2091 14 21 15.7909 21 18Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
