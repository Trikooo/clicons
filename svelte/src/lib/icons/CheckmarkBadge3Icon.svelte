<script lang="ts">
  ...
  /**
   * @component CheckmarkBadge3Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/checkmark-badge3)
   * @see {@link https://clicons.dev/icon/checkmark-badge3} - Icon preview
...
>
  ...
  <path d="M8 10.3077C8 10.3077 10.25 10 12 14C12 14 17.0588 4 22 2" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
