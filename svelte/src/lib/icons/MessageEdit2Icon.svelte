<script lang="ts">
  ...
  /**
   * @component MessageEdit2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/message-edit2)
   * @see {@link https://clicons.dev/icon/message-edit2} - Icon preview
...
>
  ...
  <path d="M11.9955 12.5001H12.0044M7.99997 12.5001H8.00894" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
