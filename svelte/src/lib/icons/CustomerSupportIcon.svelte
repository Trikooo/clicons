...
>
  ...
  <path d="M5 9C5 5.68629 8.13401 3 12 3C15.866 3 19 5.68629 19 9" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="square" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M19 17V17.8C19 19.5673 17.2091 21 15 21H13" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
