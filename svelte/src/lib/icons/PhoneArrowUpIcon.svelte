<script lang="ts">
  ...
  /**
   * @component PhoneArrowUpIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/phone-arrow-up)
   * @see {@link https://clicons.dev/icon/phone-arrow-up} - Icon preview
...
>
  ...
  <path d="M9 11.5C9 11.5 11.2095 8.50001 12 8.5C12.7906 8.49999 15 11.5 15 11.5M12 9V15.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
