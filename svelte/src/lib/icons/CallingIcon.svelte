<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/calling} - Icon preview
...
>
  ...
  <path d="M13 4C16.866 4 20 7.13401 20 11M13 8C14.6569 8 16 9.34315 16 11" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
