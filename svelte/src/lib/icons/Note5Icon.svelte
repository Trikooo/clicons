<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/note5} - Icon preview
...
>
  ...
  <path d="M8 14H12M8 10H16" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
