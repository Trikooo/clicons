<script lang="ts">
  ...
  /**
   * @component MoneyNotFound2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/money-not-found2)
   * @see {@link https://clicons.dev/icon/money-not-found2} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M18.5 12H18.51" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
  <path d="M5.5 12H5.51" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
