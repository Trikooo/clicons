<script lang="ts">
  ...
  /**
   * @component DiscoverCircleIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/discover-circle)
   * @see {@link https://clicons.dev/icon/discover-circle} - Icon preview
...
>
  ...
  <path d="M12 12L11.9936 12.0064" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
</svg>
