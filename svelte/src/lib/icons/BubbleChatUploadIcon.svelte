<script lang="ts">
  ...
  /**
   * @component BubbleChatUploadIcon
...
>
  ...
  <path d="M15 11.5C15 11.5 12.7905 8.50003 12 8.50002C11.2094 8.50002 9 11.5 9 11.5M12 9.00002V15.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
