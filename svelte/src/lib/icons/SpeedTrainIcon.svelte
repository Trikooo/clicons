<script lang="ts">
  ...
  /**
   * @component SpeedTrainIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/speed-train)
   * @see {@link https://clicons.dev/icon/speed-train} - Icon preview
...
>
  ...
  <path d="M21 11H17.3333C14.3878 11 12 8.76142 12 6V4" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
