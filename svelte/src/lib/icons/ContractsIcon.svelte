<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/contracts} - Icon preview
...
>
  ...
  <path d="M5 19H6L7.25 16.5L8.5 19H9.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  ...
  <path d="M6 10H12" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
