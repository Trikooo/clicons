<script lang="ts">
  ...
  /**
   * @component SunCloudMidSnowIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/sun-cloud-mid-snow)
   * @see {@link https://clicons.dev/icon/sun-cloud-mid-snow} - Icon preview
...
>
  ...
  <path d="M12 14V20M14.5 15.5L9.50013 18.5M9.5 15.5L14.4999 18.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
