...
<svg
  ...
  {...restProps}
>
  <circle cx="7.5" cy="12.5" r="2.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
  <ellipse cx="13.5" cy="12.5" rx="1.5" ry="2.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
  <ellipse cx="18" cy="12.5" rx="1" ry="2.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
