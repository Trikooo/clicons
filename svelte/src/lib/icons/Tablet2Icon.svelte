<script lang="ts">
  ...
  /**
   * @component Tablet2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/tablet2)
   * @see {@link https://clicons.dev/icon/tablet2} - Icon preview
...
>
  ...
  <path d="M10 4.5H14" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
  <path d="M11.9998 19H12.0098" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="2" />
</svg>
