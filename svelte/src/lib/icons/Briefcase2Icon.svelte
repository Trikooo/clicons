<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/briefcase2} - Icon preview
...
>
  ...
  <path d="M7.49869 11.0001V14.0001M16.4987 14.0001V11.0001" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
