<script lang="ts">
  ...
  /**
   * @component MessageMultipleIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/message-multiple)
   * @see {@link https://clicons.dev/icon/message-multiple} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M7.5 12H13.5M7.5 8H10.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
