...
<svg
  ...
  {...restProps}
>
  <path d="M12 16.5V10.1364M15.5 13.3182H8.5M15.5 7.5H8.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
