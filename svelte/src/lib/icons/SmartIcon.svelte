<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/smart)
   * @see {@link https://clicons.dev/icon/smart} - Icon preview
...
>
  ...
  <path d="M11 17.7844C13.6177 18.5609 15.9391 17.1496 17 15" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
