<script lang="ts">
  ...
  /**
   * @component SaveMoneyPoundIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/save-money-pound)
   * @see {@link https://clicons.dev/icon/save-money-pound} - Icon preview
...
>
  ...
  <path d="M16 6.37274C15.8438 5.54516 14.8863 4.76561 13.5926 5.06561C12.2384 5.37966 11.6241 6.9729 12.2384 7.96841C12.875 9 13.1795 10 12.3493 11.4148C12.1876 11.6904 12.1067 11.8282 12.1513 11.9141C12.1959 12 12.3386 12 12.624 12H16M11 9H15" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
