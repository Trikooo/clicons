<script lang="ts">
  ...
  /**
   * @component ShoppingBasketFavorite2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/shopping-basket-favorite2)
   * @see {@link https://clicons.dev/icon/shopping-basket-favorite2} - Icon preview
...
>
  ...
  <path d="M4.5 17.5H9.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
