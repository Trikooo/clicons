...
<svg
  ...
  {...restProps}
>
  <path d="M18.5 15L16.5 15M13 15L11 15M7.5 15L5.5 15" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
