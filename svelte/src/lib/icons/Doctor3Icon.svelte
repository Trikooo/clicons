<script lang="ts">
  ...
  /**
   * @component Doctor3Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/doctor3)
   * @see {@link https://clicons.dev/icon/doctor3} - Icon preview
...
>
  ...
  <path d="M16 16.0001V19.0001M17.5 17.5001L14.5 17.5001" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
