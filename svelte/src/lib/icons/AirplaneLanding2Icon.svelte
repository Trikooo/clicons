<script lang="ts">
  ...
  /**
   * @component AirplaneLanding2Icon
...
<svg
  ...
  {...restProps}
>
  <path d="M2.49811 20.0009H18.4981" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
