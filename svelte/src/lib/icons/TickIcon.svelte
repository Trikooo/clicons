<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/tick)
   * @see {@link https://clicons.dev/icon/tick} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M5 14.5C5 14.5 6.5 14.5 8.5 18C8.5 18 14.0588 8.83333 19 7" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
