...
>
  ...
  <path d="M14.4912 12H14.5002M9.5 12H9.50897" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
</svg>
