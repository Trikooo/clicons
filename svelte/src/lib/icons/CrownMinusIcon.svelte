<script lang="ts">
  ...
  /**
   * @component CrownMinusIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/crown-minus)
   * @see {@link https://clicons.dev/icon/crown-minus} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M21.5 3L16.5 3" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M5 21H19" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
