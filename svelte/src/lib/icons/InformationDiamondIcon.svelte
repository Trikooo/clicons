<script lang="ts">
  ...
  /**
   * @component InformationDiamondIcon
...
>
  ...
  <path d="M12 16L12 11.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
