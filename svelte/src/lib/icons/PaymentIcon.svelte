<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/payment)
   * @see {@link https://clicons.dev/icon/payment} - Icon preview
...
>
  ...
  <path d="M14 9C14 10.1045 13.1046 11 12 11C10.8954 11 10 10.1045 10 9C10 7.89543 10.8954 7 12 7C13.1046 7 14 7.89543 14 9Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
