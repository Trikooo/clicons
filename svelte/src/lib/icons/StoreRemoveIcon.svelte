<script lang="ts">
  ...
  /**
   * @component StoreRemoveIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/store-remove)
   * @see {@link https://clicons.dev/icon/store-remove} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M3.50003 9.99988V14.9999C3.50003 17.8283 3.50003 19.2425 4.37871 20.1212C5.25739 20.9999 6.6716 20.9999 9.50003 20.9999H12M20.5 12.9999V9.99988" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  ...
  <path d="M15.5 15.9999L20.5 20.9999M15.5 20.9999L20.5 15.9999" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
