<script lang="ts">
  ...
  /**
   * @component PropertyDeleteIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/property-delete)
   * @see {@link https://clicons.dev/icon/property-delete} - Icon preview
...
>
  ...
  <path d="M10 16H11.5M6 16H7M10 12H16M6 12H7" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M16 16L19 19M19 19L22 22M19 19L16 22M19 19L22 16" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
