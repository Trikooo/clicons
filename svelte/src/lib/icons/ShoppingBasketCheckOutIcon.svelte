...
>
  ...
  <path d="M21 19C21 19 18.7905 22 18 22C17.2094 22 15 19 15 19M18 21.5V15" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
