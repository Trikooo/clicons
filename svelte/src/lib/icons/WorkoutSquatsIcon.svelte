<script lang="ts">
  ...
  /**
   * @component WorkoutSquatsIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/workout-squats)
   * @see {@link https://clicons.dev/icon/workout-squats} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M13 4.5C13 5.32843 12.3284 6 11.5 6C10.6716 6 10 5.32843 10 4.5C10 3.67157 10.6716 3 11.5 3C12.3284 3 13 3.67157 13 4.5Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
