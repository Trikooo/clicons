<script lang="ts">
  ...
  /**
   * @component Briefcase3Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/briefcase3)
   * @see {@link https://clicons.dev/icon/briefcase3} - Icon preview
...
>
  ...
  <path d="M2 12.5H22" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
