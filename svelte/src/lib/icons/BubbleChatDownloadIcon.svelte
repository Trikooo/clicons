<script lang="ts">
  ...
  /**
   * @component BubbleChatDownloadIcon
...
>
  ...
  <path d="M15 10.5C15 10.5 12.7906 13.5 12 13.5C11.2094 13.5 9.00002 10.5 9.00002 10.5M12 13V7.5M9.00002 16.5H15" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
