<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/file)
   * @see {@link https://clicons.dev/icon/file} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M8 7L16 7" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M8 11L12 11" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
