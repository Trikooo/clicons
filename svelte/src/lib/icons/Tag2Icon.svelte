<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/tag2} - Icon preview
...
>
  ...
  <path d="M7.5 14.5L9.5 16.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M18 6L22 2" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
