<script lang="ts">
  ...
  /**
   * @component FolderViewIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/folder-view)
   * @see {@link https://clicons.dev/icon/folder-view} - Icon preview
...
>
  ...
  <path d="M17 21C19.7614 21 22 18 22 18C22 18 19.7614 15 17 15C14.2386 15 12 18 12 18C12 18 14.2386 21 17 21Z" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M17.0156 18.002H17.0246" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
</svg>
