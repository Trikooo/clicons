...
<svg
  ...
  {...restProps}
>
  <path d="M16.5 3L14 5.5L16.5 8M21 5.5H14.6088" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
