<script lang="ts">
  ...
  /**
   * @component ComputerArrowDownIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/computer-arrow-down)
   * @see {@link https://clicons.dev/icon/computer-arrow-down} - Icon preview
...
>
  ...
  <path d="M9 10C9 10 11.2095 13 12 13C12.7906 13 15 10 15 10M12 12.5V7" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
