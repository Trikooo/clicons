...
>
  ...
  <path d="M21 18C21 18 18.7905 15 18 15C17.2094 15 15 18 15 18M18 15.5V22" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
