<script lang="ts">
  ...
  /**
   * @component Mouse3Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/mouse3)
   * @see {@link https://clicons.dev/icon/mouse3} - Icon preview
...
>
  ...
  <path d="M12 5.5L12 7.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
