<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/image-remove} - Icon preview
...
>
  ...
  <path d="M22 6H14" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
