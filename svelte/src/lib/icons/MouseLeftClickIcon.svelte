<script lang="ts">
  ...
  /**
   * @component MouseLeftClickIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/mouse-left-click)
   * @see {@link https://clicons.dev/icon/mouse-left-click} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M13.5 2L13.5 6M13.5 10L13.5 12" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M5 2C3.94531 3.13158 3.23544 4.50113 3 6" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
