<script lang="ts">
  ...
  /**
   * @component SunCloudLittleRain2Icon
...
<svg
  ...
  {...restProps}
>
  <path d="M11.9972 14.5V16M8.99609 17.5V19M14.9961 17.5V19M6.49609 20.5V22M17.4961 20.5V22M11.9961 20.5V22" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
