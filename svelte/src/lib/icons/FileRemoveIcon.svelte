<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/file-remove} - Icon preview
...
>
  ...
  <path d="M11 9L4 2M11 2L4 9" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
