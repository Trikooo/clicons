<script lang="ts">
  ...
  /**
   * @component BubbleChatOutcomeIcon
...
>
  ...
  <path d="M12.5 9C12.5 9 15.5 11.2095 15.5 12C15.5 12.7906 12.5 15 12.5 15M15 12L8.5 12" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
