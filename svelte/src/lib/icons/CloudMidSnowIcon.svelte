...
>
  ...
  <path d="M12 15V21M14.5 16.5L9.50013 19.5M9.5 16.5L14.4999 19.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
