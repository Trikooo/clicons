<script lang="ts">
  ...
  /**
   * @component WifiFullSignalIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/wifi-full-signal)
   * @see {@link https://clicons.dev/icon/wifi-full-signal} - Icon preview
...
>
  ...
  <path d="M19 14C14.6871 11.3333 9.31293 11.3333 5 14" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
  <path d="M21 11C15.4548 7 8.54519 7 3 11" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
  <path d="M16 17C13.465 15.6667 10.535 15.6667 8 17" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
</svg>
