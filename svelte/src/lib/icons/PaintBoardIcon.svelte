...
>
  ...
  <path d="M7 15.002L7.00868 14.9996" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
  <circle cx="9.5" cy="8.5" r="1.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
  <circle cx="16.5" cy="9.5" r="1.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
</svg>
