<script lang="ts">
  ...
  /**
   * @component ChartDownIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/chart-down)
   * @see {@link https://clicons.dev/icon/chart-down} - Icon preview
...
>
  ...
  <path d="M17.5 8L19.5 10.5L17 12.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M19.0001 10.502C19.0001 10.502 11.5001 10.502 4.00012 3.00195" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
