<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/forward} - Icon preview
...
>
  ...
  <path d="M4 5L4 19" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
