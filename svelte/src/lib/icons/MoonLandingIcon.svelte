<script lang="ts">
  ...
  /**
   * @component MoonLandingIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/moon-landing)
   * @see {@link https://clicons.dev/icon/moon-landing} - Icon preview
...
>
  ...
  <path d="M14.9998 17H15.0088" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
  <path d="M12 22C12 20.3431 10.6569 19 9 19C7.34315 19 6 20.3431 6 22" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
