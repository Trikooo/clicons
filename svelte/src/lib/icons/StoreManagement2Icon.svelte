<script lang="ts">
  ...
  /**
   * @component StoreManagement2Icon
...
<svg
  ...
  {...restProps}
>
  <path d="M3.00046 10.9995V14.9932C3.00046 17.8251 3.00046 19.241 3.87914 20.1208C4.75782 21.0005 6.17203 21.0005 9.00046 21.0005H11.0005" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
