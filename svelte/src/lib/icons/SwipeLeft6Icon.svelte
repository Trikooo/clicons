<script lang="ts">
  ...
  /**
   * @component SwipeLeft6Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/swipe-left6)
   * @see {@link https://clicons.dev/icon/swipe-left6} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M15.001 4.49988H21.001M15.001 4.49988C15.001 3.79965 16.9953 2.49141 17.501 1.99988M15.001 4.49988C15.001 5.20011 16.9953 6.50835 17.501 6.99988" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
