<script lang="ts">
  ...
  /**
   * @component PackageOutOfStockIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/package-out-of-stock)
   * @see {@link https://clicons.dev/icon/package-out-of-stock} - Icon preview
...
>
  ...
  <path d="M10 2L12 4M12 4L14 6M12 4L10 6M12 4L14 2" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
