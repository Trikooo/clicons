<script lang="ts">
  ...
  /**
   * @component AirplaneLandingIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/airplane-landing)
   * @see {@link https://clicons.dev/icon/airplane-landing} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M6.00146 19.9982H22.0015" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
