<script lang="ts">
  ...
  /**
   * @component ChatCancelIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/chat-cancel)
   * @see {@link https://clicons.dev/icon/chat-cancel} - Icon preview
...
>
  ...
  <path d="M22 7L17 2M22 2L17 7" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
