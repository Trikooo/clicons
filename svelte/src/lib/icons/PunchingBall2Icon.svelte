<script lang="ts">
  ...
  /**
   * @component PunchingBall2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/punching-ball2)
   * @see {@link https://clicons.dev/icon/punching-ball2} - Icon preview
...
>
  ...
  <path d="M12 12V18.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
