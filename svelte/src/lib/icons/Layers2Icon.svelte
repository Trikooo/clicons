<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/layers2} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <rect x="11" y="2" width="11" height="11" rx="2.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
