<script lang="ts">
  ...
  /**
   * @component CallEnd4Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/call-end4)
   * @see {@link https://clicons.dev/icon/call-end4} - Icon preview
...
>
  ...
  <path d="M9.49976 17.5L11.9998 20L14.4998 17.5M11.9998 12.5V19.3912" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
