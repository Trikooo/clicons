<script lang="ts">
   ...
   * @see {@link https://clicons.dev/icon/pin-off} - Icon preview
...
>
  ...
  <path d="M3 21L8 16" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
