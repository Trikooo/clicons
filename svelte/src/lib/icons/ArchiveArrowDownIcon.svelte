<script lang="ts">
  ...
  /**
   * @component ArchiveArrowDownIcon
...
>
  ...
  <path d="M15 7.00002C15 7.00002 12.7905 9.99999 12 10C11.2094 10 9 7 9 7" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M12 3V9.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
