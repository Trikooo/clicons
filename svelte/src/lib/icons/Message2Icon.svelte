<script lang="ts">
  ...
  /**
   * @component Message2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/message2)
   * @see {@link https://clicons.dev/icon/message2} - Icon preview
...
>
  ...
  <path d="M11.9953 12H12.0043M15.9908 12H15.9998M7.99982 12H8.00879" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
</svg>
