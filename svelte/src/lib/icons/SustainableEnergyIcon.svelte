<script lang="ts">
  ...
  /**
   * @component SustainableEnergyIcon
...
>
  ...
  <path d="M12.5 7L9 12H15L11.5 17" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
