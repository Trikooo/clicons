<script lang="ts">
  ...
  /**
   * @component BitcoinSmartphoneIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/bitcoin-smartphone)
   * @see {@link https://clicons.dev/icon/bitcoin-smartphone} - Icon preview
...
>
  ...
  <path d="M10.75 19H10.759" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
  <path d="M9.75 5H11.75" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
