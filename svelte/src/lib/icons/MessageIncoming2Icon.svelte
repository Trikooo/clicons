<script lang="ts">
  ...
  /**
   * @component MessageIncoming2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/message-incoming2)
   * @see {@link https://clicons.dev/icon/message-incoming2} - Icon preview
...
>
  ...
  <path d="M14 4.49997L22 4.49997M14 4.49997C14 3.79974 15.9943 2.4915 16.5 1.99997M14 4.49997C14 5.2002 15.9943 6.50844 16.5 6.99997" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
