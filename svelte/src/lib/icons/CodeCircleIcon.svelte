<script lang="ts">
  ...
  /**
   * @component CodeCircleIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/code-circle)
   * @see {@link https://clicons.dev/icon/code-circle} - Icon preview
...
>
  ...
  <path d="M9.99982 12H10.0088M13.9909 12H13.9998" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
