<script lang="ts">
  ...
  /**
   * @component MessageCancelIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/message-cancel)
   * @see {@link https://clicons.dev/icon/message-cancel} - Icon preview
...
>
  ...
  <path d="M16 2L22.0001 8M16 8L22.0001 2" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
