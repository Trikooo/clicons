<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/message)
   * @see {@link https://clicons.dev/icon/message} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M8.5 14.5H15.5M8.5 9.5H12" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
