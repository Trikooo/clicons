<script lang="ts">
  ...
  /**
   * @component LayoutTableIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/layout-table)
   * @see {@link https://clicons.dev/icon/layout-table} - Icon preview
...
>
  ...
  <path d="M16 21.5L16 2.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
  <path d="M8 21.4998L8 2.49976" stroke={"currentColor".replace('currentColor', finalColor)} strokeWidth="1.5" />
</svg>
