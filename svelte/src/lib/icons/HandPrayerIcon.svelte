<script lang="ts">
  ...
  /**
   * @component HandPrayerIcon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/hand-prayer)
   * @see {@link https://clicons.dev/icon/hand-prayer} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M15.5 15L14 10.5C12.3432 10.4999 12 11.843 12 13.4999V15" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  <path d="M8.5 15L10 10.5C11.6568 10.4999 12 11.843 12 13.4999V15" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
