<script lang="ts">
  ...
  /**
   * @component BubbleChatIncomeIcon
...
>
  ...
  <path d="M11.5 9C11.5 9 8.50001 11.2095 8.5 12C8.49999 12.7906 11.5 15 11.5 15M9 12L15.5 12" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</svg>
