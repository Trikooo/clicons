<script lang="ts">
  ...
  /**
   * @component PresentationLineChart2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/presentation-line-chart2)
   * @see {@link https://clicons.dev/icon/presentation-line-chart2} - Icon preview
