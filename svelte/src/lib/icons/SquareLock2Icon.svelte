<script lang="ts">
  ...
  /**
   * @component SquareLock2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/square-lock2)
   * @see {@link https://clicons.dev/icon/square-lock2} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M12 16.5V14.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
