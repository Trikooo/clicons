<script lang="ts">
  ...
  /**
   * @component Touchpad2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/touchpad2)
   * @see {@link https://clicons.dev/icon/touchpad2} - Icon preview
