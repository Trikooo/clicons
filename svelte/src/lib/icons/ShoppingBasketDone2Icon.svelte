<script lang="ts">
  ...
  /**
   * @component ShoppingBasketDone2Icon
   * @description SVG icon component from Clicons, renders SVG Element with children.
   * @preview ![img](https://clicons.dev/icon/shopping-basket-done2)
   * @see {@link https://clicons.dev/icon/shopping-basket-done2} - Icon preview
...
>
  ...
  <path d="M14 20.3333C14 20.3333 14.875 20.3333 15.75 22C15.75 22 18.5294 17.8333 21 17" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  ...
  <path d="M4.5 17.5H11.5" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeWidth="1.5" />
</svg>
