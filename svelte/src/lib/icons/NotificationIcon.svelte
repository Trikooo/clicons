<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/notification)
   * @see {@link https://clicons.dev/icon/notification} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M15.5 18C15.5 19.933 13.933 21.5 12 21.5C10.067 21.5 8.5 19.933 8.5 18" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
