<script lang="ts">
   ...
   * @preview ![img](https://clicons.dev/icon/comment-add)
   * @see {@link https://clicons.dev/icon/comment-add} - Icon preview
...
<svg
  ...
  {...restProps}
>
  <path d="M14 6H22M18 2L18 10" stroke={"currentColor".replace('currentColor', finalColor)} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
